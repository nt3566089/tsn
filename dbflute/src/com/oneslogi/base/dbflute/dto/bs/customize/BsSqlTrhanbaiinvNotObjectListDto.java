...
/**
 * The simple DTO of SqlTrhanbaiinvNotObjectList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTrhanbaiinvNotObjectListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTrhanbaiinvNotObjectListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTrhanbaiinvNotObjectListDto)) { return false; }
        final BsSqlTrhanbaiinvNotObjectListDto otherEntity = (BsSqlTrhanbaiinvNotObjectListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTrhanbaiinvNotObjectList");
