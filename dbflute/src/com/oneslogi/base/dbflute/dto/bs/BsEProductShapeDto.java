...
/**
 * The simple DTO of E_PRODUCT_SHAPE as TABLE. <br>
 * 商品荷姿マスタ受信
 * <pre>
 * [primary-key]
 *     PRODUCT_SHAPE_ID
...
public abstract class BsEProductShapeDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEProductShapeDto)) { return false; }
        final BsEProductShapeDto otherEntity = (BsEProductShapeDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_PRODUCT_SHAPE");
