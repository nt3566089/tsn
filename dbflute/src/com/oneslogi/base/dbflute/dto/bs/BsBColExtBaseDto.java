...
/**
 * The simple DTO of B_COL_EXT_BASE as TABLE. <br>
 * 列マスタ拡張基本
 * <pre>
 * [primary-key]
 *     COL_EXT_BASE_ID
...
public abstract class BsBColExtBaseDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBColExtBaseDto)) { return false; }
        final BsBColExtBaseDto otherEntity = (BsBColExtBaseDto)other;
        if (!helpComparingValue(getColExtBaseId(), otherEntity.getColExtBaseId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_COL_EXT_BASE");
        result = xCH(result, getColExtBaseId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getColExtBaseId());
    ...
    //                                                                            ========
    /**
     * [get] COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 列マスタ拡張基本
     * @return The value of the column 'COL_EXT_BASE_ID'. (NullAllowed)
     */
    public Long getColExtBaseId() {
        return _colExtBaseId;
    }

    /**
     * [set] COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 列マスタ拡張基本
     * @param colExtBaseId The value of the column 'COL_EXT_BASE_ID'. (NullAllowed)
     */
    public void setColExtBaseId(Long colExtBaseId) {
        __modifiedProperties.add("colExtBaseId");
        this._colExtBaseId = colExtBaseId;
    }

    /**
     * [get] ITEM_ID: {NotNull, bigint(19), FK to B_ITEM} <br>
     * 項目ID
    ...
    /**
     * [set] ITEM_ID: {NotNull, bigint(19), FK to B_ITEM} <br>
     * 項目ID
    ...
    /**
     * [get] COL_CD: {NotNull, varchar(100)} <br>
     * 列CD
    ...
    /**
     * [set] COL_CD: {NotNull, varchar(100)} <br>
     * 列CD
