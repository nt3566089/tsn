...
/**
 * The simple DTO of M_CENTER_ITEM as TABLE. <br>
 * 拠点項目マスタ
 * <pre>
 * [primary-key]
 *     CENTER_ITEM_ID
...
public abstract class BsMCenterItemDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMCenterItemDto)) { return false; }
        final BsMCenterItemDto otherEntity = (BsMCenterItemDto)other;
        if (!helpComparingValue(getCenterItemId(), otherEntity.getCenterItemId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_CENTER_ITEM");
        result = xCH(result, getCenterItemId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getCenterItemId());
     ...
     * 拠点項目ID
     * @return The value of the column 'CENTER_ITEM_ID'. (NullAllowed)
     */
     ...
     * 拠点項目ID
     * @param centerItemId The value of the column 'CENTER_ITEM_ID'. (NullAllowed)
     */
    public void setCenterItemId(Long centerItemId) {
        __modifiedProperties.add("centerItemId");
        this._centerItemId = centerItemId;
    }
