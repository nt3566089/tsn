...
/**
 * The simple DTO of H_SHIPPING_SPARE as TABLE. <br>
 * 出荷予備履歴
 * <pre>
 * [primary-key]
 *     SHIPPING_INST_B_ID
...
public abstract class BsHShippingSpareDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsHShippingSpareDto)) { return false; }
        final BsHShippingSpareDto otherEntity = (BsHShippingSpareDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "H_SHIPPING_SPARE");
