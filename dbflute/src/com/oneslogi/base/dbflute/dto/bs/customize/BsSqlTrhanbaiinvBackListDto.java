...
/**
 * The simple DTO of SqlTrhanbaiinvBackList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTrhanbaiinvBackListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTrhanbaiinvBackListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTrhanbaiinvBackListDto)) { return false; }
        final BsSqlTrhanbaiinvBackListDto otherEntity = (BsSqlTrhanbaiinvBackListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTrhanbaiinvBackList");
