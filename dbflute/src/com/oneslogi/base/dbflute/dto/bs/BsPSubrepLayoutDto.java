...
/**
 * The simple DTO of P_SUBREP_LAYOUT as TABLE. <br>
 * サブレポートレイアウトマスタ
 * <pre>
 * [primary-key]
 *     SUBREP_LAYOUT_ID
...
public abstract class BsPSubrepLayoutDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPSubrepLayoutDto)) { return false; }
        final BsPSubrepLayoutDto otherEntity = (BsPSubrepLayoutDto)other;
        if (!helpComparingValue(getSubrepLayoutId(), otherEntity.getSubrepLayoutId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "P_SUBREP_LAYOUT");
        result = xCH(result, getSubrepLayoutId());
        return result;
    }
    ...
    //                                                                            ========
    /**
     * [get] SUBREP_LAYOUT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * サブレポートレイアウトID
    ...
    /**
     * [set] SUBREP_LAYOUT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * サブレポートレイアウトID
    ...
    /**
     * [get] SUBREP_LAYOUT_DATA: {NotNull, varchar(2147483647)} <br>
     * サブレポートレイアウトデータ
    ...
    /**
     * [set] SUBREP_LAYOUT_DATA: {NotNull, varchar(2147483647)} <br>
     * サブレポートレイアウトデータ
