...
/**
 * The simple DTO of H_INVENTORY_H as TABLE. <br>
 * 棚卸ヘッダ履歴
 * <pre>
 * [primary-key]
 *     INVENTORY_H_ID
...
public abstract class BsHInventoryHDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsHInventoryHDto)) { return false; }
        final BsHInventoryHDto otherEntity = (BsHInventoryHDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "H_INVENTORY_H");
