...
/**
 * The simple DTO of E_TRIFCOMPANYDATA as TABLE. <br>
 * IF組織
 * <pre>
 * [primary-key]
 *     IFDATAKEY
...
public abstract class BsETrifcompanydataDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsETrifcompanydataDto)) { return false; }
        final BsETrifcompanydataDto otherEntity = (BsETrifcompanydataDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_TRIFCOMPANYDATA");
