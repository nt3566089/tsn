...
/**
 * The simple DTO of W_WKSOCANCELPICK2 as TABLE. <br>
 * 棚出済リスト情報中間2
 * <pre>
 * [primary-key]
 *     
...
public abstract class BsWWksocancelpick2Dto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWWksocancelpick2Dto)) { return false; }
        final BsWWksocancelpick2Dto otherEntity = (BsWWksocancelpick2Dto)other;
        ...
        if (!helpComparingValue(getPickedqtyB(), otherEntity.getPickedqtyB())) { return false; }
        if (!helpComparingValue(getPickedqtyP(), otherEntity.getPickedqtyP())) { return false; }
        if (!helpComparingValue(getPickedqtyC2(), otherEntity.getPickedqtyC2())) { return false; }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "W_WKSOCANCELPICK2");
        ...
        result = xCH(result, getPickedqtyB());
        result = xCH(result, getPickedqtyP());
        result = xCH(result, getPickedqtyC2());
    ...
    public String toString() {
        ...
        sb.append(c).append(getPickedqtyB());
        sb.append(c).append(getPickedqtyP());
        sb.append(c).append(getPickedqtyC2());
     ...
     * 棚出済数量（カートン）
     * @return The value of the column 'PICKEDQTY_B'. (NullAllowed)
     */
     ...
     * 棚出済数量（カートン）
     * @param pickedqtyB The value of the column 'PICKEDQTY_B'. (NullAllowed)
     */
    public void setPickedqtyB(java.math.BigDecimal pickedqtyB) {
        __modifiedProperties.add("pickedqtyB");
        this._pickedqtyB = pickedqtyB;
    }
     ...
     * 棚出済数量（ケース2）
     * @return The value of the column 'PICKEDQTY_C2'. (NullAllowed)
     */
     ...
     * 棚出済数量（ケース2）
     * @param pickedqtyC2 The value of the column 'PICKEDQTY_C2'. (NullAllowed)
     */
    public void setPickedqtyC2(java.math.BigDecimal pickedqtyC2) {
        __modifiedProperties.add("pickedqtyC2");
        this._pickedqtyC2 = pickedqtyC2;
    }
