...
/**
 * The simple DTO of B_ROLE_GRP as TABLE. <br>
 * 権限グループマスタ
 * <pre>
 * [primary-key]
 *     ROLE_GRP_ID
...
public abstract class BsBRoleGrpDto implements Serializable {
    ...
    protected BClassDtlDto _bClassDtlByRoleControlClass;

    public BClassDtlDto getBClassDtlByRoleControlClass() {
        return _bClassDtlByRoleControlClass;
    }

    public void setBClassDtlByRoleControlClass(BClassDtlDto bClassDtlByRoleControlClass) {
        this._bClassDtlByRoleControlClass = bClassDtlByRoleControlClass;
    }

    // ===================================================================================
    //                                                                      Referrer Table
    //                                                                      ==============
    protected List<BRoleGrpDtlDto> _bRoleGrpDtlList;

    public List<BRoleGrpDtlDto> getBRoleGrpDtlList() {
        if (_bRoleGrpDtlList == null) { _bRoleGrpDtlList = new ArrayList<BRoleGrpDtlDto>(); }
        return _bRoleGrpDtlList;
    }

    public void setBRoleGrpDtlList(List<BRoleGrpDtlDto> bRoleGrpDtlList) {
        this._bRoleGrpDtlList = bRoleGrpDtlList;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBRoleGrpDto)) { return false; }
        final BsBRoleGrpDto otherEntity = (BsBRoleGrpDto)other;
        if (!helpComparingValue(getRoleGrpId(), otherEntity.getRoleGrpId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_ROLE_GRP");
        result = xCH(result, getRoleGrpId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getRoleGrpCd());
        sb.append(c).append(getDictId());
        sb.append(c).append(getRoleControlClass());
     ...
     * 権限グループCD
     * @return The value of the column 'ROLE_GRP_CD'. (NullAllowed)
     */
     ...
     * 権限グループCD
     * @param roleGrpCd The value of the column 'ROLE_GRP_CD'. (NullAllowed)
     */
    public void setRoleGrpCd(String roleGrpCd) {
        __modifiedProperties.add("roleGrpCd");
        this._roleGrpCd = roleGrpCd;
    }
     ...
     * 権限制御区分
     * @return The value of the column 'ROLE_CONTROL_CLASS'. (NullAllowed)
     */
     ...
     * 権限制御区分
     * @param roleControlClass The value of the column 'ROLE_CONTROL_CLASS'. (NullAllowed)
     */
    public void setRoleControlClass(String roleControlClass) {
        __modifiedProperties.add("roleControlClass");
        this._roleControlClass = roleControlClass;
    }
