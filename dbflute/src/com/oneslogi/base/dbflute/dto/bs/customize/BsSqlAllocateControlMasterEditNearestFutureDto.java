...
/**
 * The simple DTO of SqlAllocateControlMasterEditNearestFuture. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlAllocateControlMasterEditNearestFutureDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlAllocateControlMasterEditNearestFutureDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlAllocateControlMasterEditNearestFutureDto)) { return false; }
        final BsSqlAllocateControlMasterEditNearestFutureDto otherEntity = (BsSqlAllocateControlMasterEditNearestFutureDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlAllocateControlMasterEditNearestFuture");
