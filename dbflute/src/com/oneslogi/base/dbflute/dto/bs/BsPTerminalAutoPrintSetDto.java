...
/**
 * The simple DTO of P_TERMINAL_AUTO_PRINT_SET as TABLE. <br>
 * 端末別自動印刷設定マスタ
 * <pre>
 * [primary-key]
...
public abstract class BsPTerminalAutoPrintSetDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsPTerminalAutoPrintSetDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPTerminalAutoPrintSetDto)) { return false; }
        final BsPTerminalAutoPrintSetDto otherEntity = (BsPTerminalAutoPrintSetDto)other;
        if (!helpComparingValue(getTerminalAutoPrintSetId(), otherEntity.getTerminalAutoPrintSetId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "P_TERMINAL_AUTO_PRINT_SET");
        result = xCH(result, getTerminalAutoPrintSetId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTerminalAutoPrintSetId());
     ...
     * 端末別自動印刷設定ID
     * @return The value of the column 'TERMINAL_AUTO_PRINT_SET_ID'. (NullAllowed)
     */
     ...
     * 端末別自動印刷設定ID
     * @param terminalAutoPrintSetId The value of the column 'TERMINAL_AUTO_PRINT_SET_ID'. (NullAllowed)
     */
    public void setTerminalAutoPrintSetId(Long terminalAutoPrintSetId) {
        __modifiedProperties.add("terminalAutoPrintSetId");
        this._terminalAutoPrintSetId = terminalAutoPrintSetId;
    }
