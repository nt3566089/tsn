...
/**
 * The simple DTO of T_WORK_DATA as TABLE. <br>
 * 作業中データ
 * <pre>
 * [primary-key]
 *     WORK_DATA_ID
...
public abstract class BsTWorkDataDto implements Serializable {
    ...
    //                                                                       Foreign Table
    //                                                                       =============
    protected TWorkLogDto _tWorkLog;

    public TWorkLogDto getTWorkLog() {
        return _tWorkLog;
    }

    public void setTWorkLog(TWorkLogDto tWorkLog) {
        this._tWorkLog = tWorkLog;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTWorkDataDto)) { return false; }
        final BsTWorkDataDto otherEntity = (BsTWorkDataDto)other;
        if (!helpComparingValue(getWorkDataId(), otherEntity.getWorkDataId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_WORK_DATA");
        result = xCH(result, getWorkDataId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getWorkDataId());
     ...
     * 作業中データID
     * @return The value of the column 'WORK_DATA_ID'. (NullAllowed)
     */
     ...
     * 作業中データID
     * @param workDataId The value of the column 'WORK_DATA_ID'. (NullAllowed)
     */
    public void setWorkDataId(Long workDataId) {
        __modifiedProperties.add("workDataId");
        this._workDataId = workDataId;
    }
