...
/**
 * The simple DTO of T_TRRCVBAT as TABLE. <br>
 * ＢＡＴ入庫予定情報
 * <pre>
 * [primary-key]
 *     TRRCVBAT_ID
...
public abstract class BsTTrrcvbatDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrrcvbatDto)) { return false; }
        final BsTTrrcvbatDto otherEntity = (BsTTrrcvbatDto)other;
        if (!helpComparingValue(getTrrcvbatId(), otherEntity.getTrrcvbatId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRRCVBAT");
        result = xCH(result, getTrrcvbatId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTrrcvbatId());
        ...
        sb.append(c).append(getDataMakeFlg());
     ...
     * ＢＡＴ入庫予定情報ID
     * @return The value of the column 'TRRCVBAT_ID'. (NullAllowed)
     */
     ...
     * ＢＡＴ入庫予定情報ID
     * @param trrcvbatId The value of the column 'TRRCVBAT_ID'. (NullAllowed)
     */
    public void setTrrcvbatId(Long trrcvbatId) {
        __modifiedProperties.add("trrcvbatId");
        this._trrcvbatId = trrcvbatId;
    }
     ...
     * データ作成フラグ
     * @return The value of the column 'DATA_MAKE_FLG'. (NullAllowed)
     */
     ...
     * データ作成フラグ
     * @param dataMakeFlg The value of the column 'DATA_MAKE_FLG'. (NullAllowed)
     */
    public void setDataMakeFlg(String dataMakeFlg) {
        __modifiedProperties.add("dataMakeFlg");
        this._dataMakeFlg = dataMakeFlg;
    }
