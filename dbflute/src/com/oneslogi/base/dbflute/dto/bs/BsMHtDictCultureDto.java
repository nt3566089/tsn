...
/**
 * The simple DTO of M_HT_DICT_CULTURE as TABLE. <br>
 * SD辞書カルチャマスタ
 * <pre>
 * [primary-key]
 *     DICT_CULTURE_ID
...
public abstract class BsMHtDictCultureDto implements Serializable {
    ...
    //                                                                       Foreign Table
    //                                                                       =============
    protected BDictCultureDto _bDictCulture;

    public BDictCultureDto getBDictCulture() {
        return _bDictCulture;
    }

    public void setBDictCulture(BDictCultureDto bDictCulture) {
        this._bDictCulture = bDictCulture;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMHtDictCultureDto)) { return false; }
        final BsMHtDictCultureDto otherEntity = (BsMHtDictCultureDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_HT_DICT_CULTURE");
