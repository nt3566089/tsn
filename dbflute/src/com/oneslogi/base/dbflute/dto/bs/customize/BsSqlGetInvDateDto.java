...
/**
 * The simple DTO of SqlGetInvDate. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlGetInvDateDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlGetInvDateDto)) { return false; }
        final BsSqlGetInvDateDto otherEntity = (BsSqlGetInvDateDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlGetInvDate");
