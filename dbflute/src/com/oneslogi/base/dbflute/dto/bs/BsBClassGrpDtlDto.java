...
/**
 * The simple DTO of B_CLASS_GRP_DTL as TABLE. <br>
 * 区分値グループ明細マスタ
 * <pre>
 * [primary-key]
 *     CLASS_GRP_DTL_ID
...
public abstract class BsBClassGrpDtlDto implements Serializable {
    ...
    //                                                                       Foreign Table
    //                                                                       =============
    protected BClassDtlDto _bClassDtl;

    public BClassDtlDto getBClassDtl() {
        return _bClassDtl;
    }

    public void setBClassDtl(BClassDtlDto bClassDtl) {
        this._bClassDtl = bClassDtl;
    }

    protected BClassGrpDto _bClassGrp;

    public BClassGrpDto getBClassGrp() {
        return _bClassGrp;
    }

    public void setBClassGrp(BClassGrpDto bClassGrp) {
        this._bClassGrp = bClassGrp;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBClassGrpDtlDto)) { return false; }
        final BsBClassGrpDtlDto otherEntity = (BsBClassGrpDtlDto)other;
        if (!helpComparingValue(getClassGrpDtlId(), otherEntity.getClassGrpDtlId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_CLASS_GRP_DTL");
        result = xCH(result, getClassGrpDtlId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getClassGrpDtlId());
     ...
     * 区分値グループ明細ID
     * @return The value of the column 'CLASS_GRP_DTL_ID'. (NullAllowed)
     */
     ...
     * 区分値グループ明細ID
     * @param classGrpDtlId The value of the column 'CLASS_GRP_DTL_ID'. (NullAllowed)
     */
    public void setClassGrpDtlId(Long classGrpDtlId) {
        __modifiedProperties.add("classGrpDtlId");
        this._classGrpDtlId = classGrpDtlId;
    }
