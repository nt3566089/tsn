...
/**
 * The simple DTO of M_CENTER_CLASS_GRP_DTL as TABLE. <br>
 * 拠点区分値グループ明細マスタ
 * <pre>
 * [primary-key]
...
public abstract class BsMCenterClassGrpDtlDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMCenterClassGrpDtlDto() {
    }
    ...
    protected MCenterClassGrpDto _mCenterClassGrp;

    public MCenterClassGrpDto getMCenterClassGrp() {
        return _mCenterClassGrp;
    }

    public void setMCenterClassGrp(MCenterClassGrpDto mCenterClassGrp) {
        this._mCenterClassGrp = mCenterClassGrp;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMCenterClassGrpDtlDto)) { return false; }
        final BsMCenterClassGrpDtlDto otherEntity = (BsMCenterClassGrpDtlDto)other;
        if (!helpComparingValue(getCenterClassGrpDtlId(), otherEntity.getCenterClassGrpDtlId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_CENTER_CLASS_GRP_DTL");
        result = xCH(result, getCenterClassGrpDtlId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getCenterClassGrpDtlId());
     ...
     * 拠点区分値グループ明細ID
     * @return The value of the column 'CENTER_CLASS_GRP_DTL_ID'. (NullAllowed)
     */
     ...
     * 拠点区分値グループ明細ID
     * @param centerClassGrpDtlId The value of the column 'CENTER_CLASS_GRP_DTL_ID'. (NullAllowed)
     */
    public void setCenterClassGrpDtlId(Long centerClassGrpDtlId) {
        __modifiedProperties.add("centerClassGrpDtlId");
        this._centerClassGrpDtlId = centerClassGrpDtlId;
    }
