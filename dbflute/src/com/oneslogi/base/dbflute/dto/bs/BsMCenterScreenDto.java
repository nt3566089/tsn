...
/**
 * The simple DTO of M_CENTER_SCREEN as TABLE. <br>
 * 拠点画面マスタ
 * <pre>
 * [primary-key]
 *     CENTER_SCREEN_ID
...
public abstract class BsMCenterScreenDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMCenterScreenDto)) { return false; }
        final BsMCenterScreenDto otherEntity = (BsMCenterScreenDto)other;
        if (!helpComparingValue(getCenterScreenId(), otherEntity.getCenterScreenId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_CENTER_SCREEN");
        result = xCH(result, getCenterScreenId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getCenterScreenId());
     ...
     * 拠点画面ID
     * @return The value of the column 'CENTER_SCREEN_ID'. (NullAllowed)
     */
     ...
     * 拠点画面ID
     * @param centerScreenId The value of the column 'CENTER_SCREEN_ID'. (NullAllowed)
     */
    public void setCenterScreenId(Long centerScreenId) {
        __modifiedProperties.add("centerScreenId");
        this._centerScreenId = centerScreenId;
    }
