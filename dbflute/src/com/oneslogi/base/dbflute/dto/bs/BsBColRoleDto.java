...
/**
 * The simple DTO of B_COL_ROLE as TABLE. <br>
 * 列権限マスタ
 * <pre>
 * [primary-key]
 *     COL_ROLE_ID
...
public abstract class BsBColRoleDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBColRoleDto)) { return false; }
        final BsBColRoleDto otherEntity = (BsBColRoleDto)other;
        if (!helpComparingValue(getColRoleId(), otherEntity.getColRoleId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_COL_ROLE");
        result = xCH(result, getColRoleId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getColRoleId());
     ...
     * 列権限ID
     * @return The value of the column 'COL_ROLE_ID'. (NullAllowed)
     */
     ...
     * 列権限ID
     * @param colRoleId The value of the column 'COL_ROLE_ID'. (NullAllowed)
     */
    public void setColRoleId(Long colRoleId) {
        __modifiedProperties.add("colRoleId");
        this._colRoleId = colRoleId;
    }
