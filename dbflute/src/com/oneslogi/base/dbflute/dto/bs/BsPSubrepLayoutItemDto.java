...
/**
 * The simple DTO of P_SUBREP_LAYOUT_ITEM as TABLE. <br>
 * サブレポートレイアウト項目マスタ
 * <pre>
 * [primary-key]
...
public abstract class BsPSubrepLayoutItemDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPSubrepLayoutItemDto)) { return false; }
        final BsPSubrepLayoutItemDto otherEntity = (BsPSubrepLayoutItemDto)other;
        if (!helpComparingValue(getSubrepLayoutItemId(), otherEntity.getSubrepLayoutItemId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "P_SUBREP_LAYOUT_ITEM");
        result = xCH(result, getSubrepLayoutItemId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getSubrepLayoutItemId());
        sb.append(c).append(getSubrepLayoutId());
     ...
     * サブレポートレイアウト項目ID
     * @return The value of the column 'SUBREP_LAYOUT_ITEM_ID'. (NullAllowed)
     */
     ...
     * サブレポートレイアウト項目ID
     * @param subrepLayoutItemId The value of the column 'SUBREP_LAYOUT_ITEM_ID'. (NullAllowed)
     */
    public void setSubrepLayoutItemId(Long subrepLayoutItemId) {
        __modifiedProperties.add("subrepLayoutItemId");
        this._subrepLayoutItemId = subrepLayoutItemId;
    }

    /**
     * [get] SUBREP_LAYOUT_ID: {UQ+, IX, NotNull, bigint(19), FK to P_SUBREP_LAYOUT} <br>
     * サブレポートレイアウトID
     * @return The value of the column 'SUBREP_LAYOUT_ID'. (NullAllowed)
     */
     ...
     * サブレポートレイアウトID
     * @param subrepLayoutId The value of the column 'SUBREP_LAYOUT_ID'. (NullAllowed)
     */
    public void setSubrepLayoutId(Long subrepLayoutId) {
        __modifiedProperties.add("subrepLayoutId");
        this._subrepLayoutId = subrepLayoutId;
    }
