...
/**
 * The simple DTO of T_KEEPING_LOT as TABLE. <br>
 * 保管ロット管理
 * <pre>
 * [primary-key]
 *     KEEPING_LOT_ID
...
public abstract class BsTKeepingLotDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTKeepingLotDto)) { return false; }
        final BsTKeepingLotDto otherEntity = (BsTKeepingLotDto)other;
        if (!helpComparingValue(getKeepingLotId(), otherEntity.getKeepingLotId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_KEEPING_LOT");
        result = xCH(result, getKeepingLotId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getKeepingLotId());
     ...
     * 保管ロットID
     * @return The value of the column 'KEEPING_LOT_ID'. (NullAllowed)
     */
     ...
     * 保管ロットID
     * @param keepingLotId The value of the column 'KEEPING_LOT_ID'. (NullAllowed)
     */
    public void setKeepingLotId(Long keepingLotId) {
        __modifiedProperties.add("keepingLotId");
        this._keepingLotId = keepingLotId;
    }
