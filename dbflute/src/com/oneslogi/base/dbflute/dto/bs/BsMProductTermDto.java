...
/**
 * The simple DTO of M_PRODUCT_TERM as TABLE. <br>
 * 銘柄マスタ適用期間
 * <pre>
 * [primary-key]
 *     PRODUCT_ID
...
public abstract class BsMProductTermDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMProductTermDto)) { return false; }
        final BsMProductTermDto otherEntity = (BsMProductTermDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_PRODUCT_TERM");
