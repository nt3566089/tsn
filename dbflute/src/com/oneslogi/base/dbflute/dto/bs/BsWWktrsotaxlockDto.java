...
/**
 * The simple DTO of W_WKTRSOTAXLOCK as TABLE. <br>
 * 国内免税　出庫予定確認ロック
 * <pre>
 * [primary-key]
 *     WAREHOUSECD
...
public abstract class BsWWktrsotaxlockDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWWktrsotaxlockDto)) { return false; }
        final BsWWktrsotaxlockDto otherEntity = (BsWWktrsotaxlockDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "W_WKTRSOTAXLOCK");
    ...
    public String toString() {
        ...
        sb.append(c).append(getLockcounter());
     ...
     * 更新カウンタ
     * @return The value of the column 'LOCKCOUNTER'. (NullAllowed)
     */
     ...
     * 更新カウンタ
     * @param lockcounter The value of the column 'LOCKCOUNTER'. (NullAllowed)
     */
    public void setLockcounter(Long lockcounter) {
        __modifiedProperties.add("lockcounter");
