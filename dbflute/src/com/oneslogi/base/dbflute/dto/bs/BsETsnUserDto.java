...
/**
 * The simple DTO of E_TSN_USER as TABLE. <br>
 * TSNユーザマスタ
 * <pre>
 * [primary-key]
 *     TSN_USER_ID
...
public abstract class BsETsnUserDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsETsnUserDto)) { return false; }
        final BsETsnUserDto otherEntity = (BsETsnUserDto)other;
        if (!helpComparingValue(getTsnUserId(), otherEntity.getTsnUserId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_TSN_USER");
        result = xCH(result, getTsnUserId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTsnUserId());
     ...
     * TSNユーザマスタID
     * @return The value of the column 'TSN_USER_ID'. (NullAllowed)
     */
     ...
     * TSNユーザマスタID
     * @param tsnUserId The value of the column 'TSN_USER_ID'. (NullAllowed)
     */
    public void setTsnUserId(Long tsnUserId) {
        __modifiedProperties.add("tsnUserId");
        this._tsnUserId = tsnUserId;
    }
