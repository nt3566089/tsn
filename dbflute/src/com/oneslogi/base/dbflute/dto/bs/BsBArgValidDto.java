...
/**
 * The simple DTO of B_ARG_VALID as TABLE. <br>
 * 引数検証マスタ
 * <pre>
 * [primary-key]
 *     ARG_ID
...
public abstract class BsBArgValidDto implements Serializable {
    ...
    //                                                                       Foreign Table
    //                                                                       =============
    protected BArgDto _bArg;

    public BArgDto getBArg() {
        return _bArg;
    }

    public void setBArg(BArgDto bArg) {
        this._bArg = bArg;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBArgValidDto)) { return false; }
        final BsBArgValidDto otherEntity = (BsBArgValidDto)other;
