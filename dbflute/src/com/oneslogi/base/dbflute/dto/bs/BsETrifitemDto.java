...
/**
 * The simple DTO of E_TRIFITEM as TABLE. <br>
 * 銘柄インタフェース
 * <pre>
 * [primary-key]
 *     IMPORTKEY
...
public abstract class BsETrifitemDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsETrifitemDto)) { return false; }
        final BsETrifitemDto otherEntity = (BsETrifitemDto)other;
        if (!helpComparingValue(getImportkey(), otherEntity.getImportkey())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_TRIFITEM");
        result = xCH(result, getImportkey());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getImportkey());
        sb.append(c).append(getSts());
        sb.append(c).append(getImpcheckkey());
     ...
     * インポートＫｅｙ
     * @return The value of the column 'IMPORTKEY'. (NullAllowed)
     */
     ...
     * インポートＫｅｙ
     * @param importkey The value of the column 'IMPORTKEY'. (NullAllowed)
     */
    public void setImportkey(java.math.BigDecimal importkey) {
        __modifiedProperties.add("importkey");
     ...
     * インポートチェックＫｅｙ
     * @return The value of the column 'IMPCHECKKEY'. (NullAllowed)
     */
     ...
     * インポートチェックＫｅｙ
     * @param impcheckkey The value of the column 'IMPCHECKKEY'. (NullAllowed)
     */
    public void setImpcheckkey(java.math.BigDecimal impcheckkey) {
        __modifiedProperties.add("impcheckkey");
        this._impcheckkey = impcheckkey;
    }
