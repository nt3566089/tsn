...
/**
 * The simple DTO of SqlMLocationMasterList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlMLocationMasterListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlMLocationMasterListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlMLocationMasterListDto)) { return false; }
        final BsSqlMLocationMasterListDto otherEntity = (BsSqlMLocationMasterListDto)other;
        if (!helpComparingValue(getLocGroup(), otherEntity.getLocGroup())) { return false; }
        if (!helpComparingValue(getLocGroupNm(), otherEntity.getLocGroupNm())) { return false; }
        ...
        if (!helpComparingValue(getAllocNgFlgNm(), otherEntity.getAllocNgFlgNm())) { return false; }
        ...
        if (!helpComparingValue(getLinOrBlock(), otherEntity.getLinOrBlock())) { return false; }
        if (!helpComparingValue(getLocid(), otherEntity.getLocid())) { return false; }
        if (!helpComparingValue(getLockbnNm(), otherEntity.getLockbnNm())) { return false; }
        ...
        if (!helpComparingValue(getReplenishmentRoundedupUnitNm(), otherEntity.getReplenishmentRoundedupUnitNm())) { return false; }
        ...
        if (!helpComparingValue(getTosplmdNm(), otherEntity.getTosplmdNm())) { return false; }
        if (!helpComparingValue(getPresplmd(), otherEntity.getPresplmd())) { return false; }
        if (!helpComparingValue(getPresplmdNm(), otherEntity.getPresplmdNm())) { return false; }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlMLocationMasterList");
        result = xCH(result, getLocGroup());
        result = xCH(result, getLocGroupNm());
        result = xCH(result, getLocationCd());
        result = xCH(result, getAllocNgFlg());
        result = xCH(result, getAllocNgFlgNm());
        ...
        result = xCH(result, getTosplmdNm());
        result = xCH(result, getPresplmd());
        result = xCH(result, getPresplmdNm());
    ...
    public String toString() {
        ...
        sb.append(c).append(getLocGroupNm());
        sb.append(c).append(getLocationCd());
        sb.append(c).append(getAllocNgFlg());
        sb.append(c).append(getAllocNgFlgNm());
        ...
        sb.append(c).append(getLinOrBlock());
        sb.append(c).append(getLocid());
        sb.append(c).append(getLockbnNm());
        sb.append(c).append(getProductCd());
        sb.append(c).append(getProductNm());
        sb.append(c).append(getBrctg());
        sb.append(c).append(getSplrevun());
        sb.append(c).append(getReplenishmentRoundedupUnitNm());
        ...
        sb.append(c).append(getTosplmdNm());
        sb.append(c).append(getPresplmd());
        sb.append(c).append(getPresplmdNm());
     ...
     * @return The value of the column 'LocGroupNm'. (NullAllowed)
     */
     ...
     * @param locGroupNm The value of the column 'LocGroupNm'. (NullAllowed)
     */
    public void setLocGroupNm(String locGroupNm) {
        __modifiedProperties.add("locGroupNm");
        this._locGroupNm = locGroupNm;
    }
     ...
     * @return The value of the column 'ALLOC_NG_FLG_NM'. (NullAllowed)
     */
    public String getAllocNgFlgNm() {
        return _allocNgFlgNm;
    }

    /**
     * [set] ALLOC_NG_FLG_NM: {int(10)} <br>
     * @param allocNgFlgNm The value of the column 'ALLOC_NG_FLG_NM'. (NullAllowed)
     */
    public void setAllocNgFlgNm(String allocNgFlgNm) {
        __modifiedProperties.add("allocNgFlgNm");
        this._allocNgFlgNm = allocNgFlgNm;
    }
     ...
     * @return The value of the column 'LIN_OR_BLOCK'. (NullAllowed)
     */
     ...
     * @param linOrBlock The value of the column 'LIN_OR_BLOCK'. (NullAllowed)
     */
    public void setLinOrBlock(String linOrBlock) {
        __modifiedProperties.add("linOrBlock");
        this._linOrBlock = linOrBlock;
    }
     ...
     * @return The value of the column 'LOCKBN_NM'. (NullAllowed)
     */
     ...
     * @param lockbnNm The value of the column 'LOCKBN_NM'. (NullAllowed)
     */
    public void setLockbnNm(String lockbnNm) {
        __modifiedProperties.add("lockbnNm");
        this._lockbnNm = lockbnNm;
    }
     ...
     * @return The value of the column 'REPLENISHMENT_ROUNDEDUP__UNIT_NM'. (NullAllowed)
     */
    public String getReplenishmentRoundedupUnitNm() {
        return _replenishmentRoundedupUnitNm;
    }

    /**
     * [set] REPLENISHMENT_ROUNDEDUP__UNIT_NM: {int(10)} <br>
     * @param replenishmentRoundedupUnitNm The value of the column 'REPLENISHMENT_ROUNDEDUP__UNIT_NM'. (NullAllowed)
     */
    public void setReplenishmentRoundedupUnitNm(String replenishmentRoundedupUnitNm) {
        __modifiedProperties.add("replenishmentRoundedupUnitNm");
        this._replenishmentRoundedupUnitNm = replenishmentRoundedupUnitNm;
    }
     ...
     * @return The value of the column 'TOSPLMD_NM'. (NullAllowed)
     */
     ...
     * @param tosplmdNm The value of the column 'TOSPLMD_NM'. (NullAllowed)
     */
    public void setTosplmdNm(String tosplmdNm) {
        __modifiedProperties.add("tosplmdNm");
        this._tosplmdNm = tosplmdNm;
    }
     ...
     * @return The value of the column 'PRESPLMD_NM'. (NullAllowed)
     */
     ...
     * @param presplmdNm The value of the column 'PRESPLMD_NM'. (NullAllowed)
     */
    public void setPresplmdNm(String presplmdNm) {
        __modifiedProperties.add("presplmdNm");
        this._presplmdNm = presplmdNm;
    }
