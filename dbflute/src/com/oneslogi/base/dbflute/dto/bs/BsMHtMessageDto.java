...
/**
 * The simple DTO of M_HT_MESSAGE as TABLE. <br>
 * SDメッセージマスタ
 * <pre>
 * [primary-key]
 *     MESSAGE_ID
...
public abstract class BsMHtMessageDto implements Serializable {
    ...
    //                                                                       Foreign Table
    //                                                                       =============
    protected BMessageDto _bMessage;

    public BMessageDto getBMessage() {
        return _bMessage;
    }

    public void setBMessage(BMessageDto bMessage) {
        this._bMessage = bMessage;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMHtMessageDto)) { return false; }
        final BsMHtMessageDto otherEntity = (BsMHtMessageDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_HT_MESSAGE");
