...
/**
 * The simple DTO of T_TRPALLETEXP as TABLE. <br>
 * パレットはり紙拡張情報
 * <pre>
 * [primary-key]
 *     TRPALLETEXP_ID
...
public abstract class BsTTrpalletexpDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrpalletexpDto)) { return false; }
        final BsTTrpalletexpDto otherEntity = (BsTTrpalletexpDto)other;
        if (!helpComparingValue(getTrpalletexpId(), otherEntity.getTrpalletexpId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRPALLETEXP");
        result = xCH(result, getTrpalletexpId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTrpalletexpId());
     ...
     * パレットはり紙拡張情報ID
     * @return The value of the column 'TRPALLETEXP_ID'. (NullAllowed)
     */
     ...
     * パレットはり紙拡張情報ID
     * @param trpalletexpId The value of the column 'TRPALLETEXP_ID'. (NullAllowed)
     */
    public void setTrpalletexpId(Long trpalletexpId) {
        __modifiedProperties.add("trpalletexpId");
        this._trpalletexpId = trpalletexpId;
    }
