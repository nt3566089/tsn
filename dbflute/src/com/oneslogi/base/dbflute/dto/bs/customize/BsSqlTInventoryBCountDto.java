...
/**
 * The simple DTO of SqlTInventoryBCount. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTInventoryBCountDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTInventoryBCountDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTInventoryBCountDto)) { return false; }
        final BsSqlTInventoryBCountDto otherEntity = (BsSqlTInventoryBCountDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTInventoryBCount");
