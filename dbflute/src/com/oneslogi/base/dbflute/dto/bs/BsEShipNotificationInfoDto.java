...
/**
 * The simple DTO of E_SHIP_NOTIFICATION_INFO as TABLE. <br>
 * 輸送通知情報受信テーブル
 * <pre>
 * [primary-key]
...
public abstract class BsEShipNotificationInfoDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEShipNotificationInfoDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEShipNotificationInfoDto)) { return false; }
        final BsEShipNotificationInfoDto otherEntity = (BsEShipNotificationInfoDto)other;
        if (!helpComparingValue(getShipNotificationInfoId(), otherEntity.getShipNotificationInfoId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_SHIP_NOTIFICATION_INFO");
        result = xCH(result, getShipNotificationInfoId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getShipNotificationInfoId());
     ...
     * 輸送通知情報受信ID
     * @return The value of the column 'SHIP_NOTIFICATION_INFO_ID'. (NullAllowed)
     */
     ...
     * 輸送通知情報受信ID
     * @param shipNotificationInfoId The value of the column 'SHIP_NOTIFICATION_INFO_ID'. (NullAllowed)
     */
    public void setShipNotificationInfoId(Long shipNotificationInfoId) {
        __modifiedProperties.add("shipNotificationInfoId");
        this._shipNotificationInfoId = shipNotificationInfoId;
    }
