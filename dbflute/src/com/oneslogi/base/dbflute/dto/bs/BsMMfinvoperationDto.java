...
/**
 * The simple DTO of M_MFINVOPERATION as TABLE. <br>
 * たな卸実施日マスタ
 * <pre>
 * [primary-key]
 *     MFINVOPERATION_ID
...
public abstract class BsMMfinvoperationDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMMfinvoperationDto)) { return false; }
        final BsMMfinvoperationDto otherEntity = (BsMMfinvoperationDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_MFINVOPERATION");
