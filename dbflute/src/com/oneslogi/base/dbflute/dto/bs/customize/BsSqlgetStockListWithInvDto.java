...
/**
 * The simple DTO of SqlgetStockListWithInv. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlgetStockListWithInvDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlgetStockListWithInvDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlgetStockListWithInvDto)) { return false; }
        final BsSqlgetStockListWithInvDto otherEntity = (BsSqlgetStockListWithInvDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlgetStockListWithInv");
