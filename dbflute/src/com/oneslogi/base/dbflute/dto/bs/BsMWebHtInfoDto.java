...
/**
 * The simple DTO of M_WEB_HT_INFO as TABLE. <br>
 * ＷＥＢＳＤ管理マスタ
 * <pre>
 * [primary-key]
 *     WEB_HT_INFO_ID
...
public abstract class BsMWebHtInfoDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMWebHtInfoDto)) { return false; }
        final BsMWebHtInfoDto otherEntity = (BsMWebHtInfoDto)other;
        if (!helpComparingValue(getWebHtInfoId(), otherEntity.getWebHtInfoId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_WEB_HT_INFO");
        result = xCH(result, getWebHtInfoId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getWebHtInfoId());
     ...
     * 管理情報ID
     * @return The value of the column 'WEB_HT_INFO_ID'. (NullAllowed)
     */
     ...
     * 管理情報ID
     * @param webHtInfoId The value of the column 'WEB_HT_INFO_ID'. (NullAllowed)
     */
    public void setWebHtInfoId(Long webHtInfoId) {
        __modifiedProperties.add("webHtInfoId");
        this._webHtInfoId = webHtInfoId;
    }
