...
/**
 * The simple DTO of SqlAllocateControlMasterEditMostRecent. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlAllocateControlMasterEditMostRecentDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlAllocateControlMasterEditMostRecentDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlAllocateControlMasterEditMostRecentDto)) { return false; }
        final BsSqlAllocateControlMasterEditMostRecentDto otherEntity = (BsSqlAllocateControlMasterEditMostRecentDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlAllocateControlMasterEditMostRecent");
