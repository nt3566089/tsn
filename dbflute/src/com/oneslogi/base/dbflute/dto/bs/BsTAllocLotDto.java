...
/**
 * The simple DTO of T_ALLOC_LOT as TABLE. <br>
 * 引当ロット管理
 * <pre>
 * [primary-key]
 *     ALLOC_INST_B_ID
...
public abstract class BsTAllocLotDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTAllocLotDto)) { return false; }
        final BsTAllocLotDto otherEntity = (BsTAllocLotDto)other;
    ...
    //                                                                            ========
    /**
     * [get] ALLOC_INST_B_ID: {PK, ID, NotNull, bigint identity(19), FK to T_ALLOC_INST_B} <br>
     * 引当指示ボディID
    ...
    /**
     * [set] ALLOC_INST_B_ID: {PK, ID, NotNull, bigint identity(19), FK to T_ALLOC_INST_B} <br>
     * 引当指示ボディID
