...
/**
 * The simple DTO of B_SYSTEM as TABLE. <br>
 * システム管理マスタ
 * <pre>
 * [primary-key]
 *     SYSTEM_ID
...
public abstract class BsBSystemDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBSystemDto)) { return false; }
        final BsBSystemDto otherEntity = (BsBSystemDto)other;
        if (!helpComparingValue(getSystemId(), otherEntity.getSystemId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_SYSTEM");
        result = xCH(result, getSystemId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getSystemId());
        sb.append(c).append(getSystemNm());
    ...
    //                                                                            ========
    /**
     * [get] SYSTEM_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * システムID
     * @return The value of the column 'SYSTEM_ID'. (NullAllowed)
     */
    ...
    /**
     * [set] SYSTEM_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * システムID
     * @param systemId The value of the column 'SYSTEM_ID'. (NullAllowed)
     */
    public void setSystemId(Long systemId) {
        __modifiedProperties.add("systemId");
        this._systemId = systemId;
    }

    /**
     * [get] SYSTEM_NM: {varchar(60)} <br>
     * システム名称
     * @return The value of the column 'SYSTEM_NM'. (NullAllowed)
     */
    ...
    /**
     * [set] SYSTEM_NM: {varchar(60)} <br>
     * システム名称
     * @param systemNm The value of the column 'SYSTEM_NM'. (NullAllowed)
     */
    public void setSystemNm(String systemNm) {
        __modifiedProperties.add("systemNm");
        this._systemNm = systemNm;
    }
