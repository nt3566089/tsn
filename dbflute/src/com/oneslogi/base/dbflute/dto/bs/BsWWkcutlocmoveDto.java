...
/**
 * The simple DTO of W_WKCUTLOCMOVE as TABLE. <br>
 * パレット分割ワーク
 * <pre>
 * [primary-key]
 *     SEQNO, SYMBOLNO
...
public abstract class BsWWkcutlocmoveDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWWkcutlocmoveDto)) { return false; }
        final BsWWkcutlocmoveDto otherEntity = (BsWWkcutlocmoveDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "W_WKCUTLOCMOVE");
