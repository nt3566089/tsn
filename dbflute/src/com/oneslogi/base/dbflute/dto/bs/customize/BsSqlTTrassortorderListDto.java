...
/**
 * The simple DTO of SqlTTrassortorderList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTTrassortorderListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTTrassortorderListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTTrassortorderListDto)) { return false; }
        final BsSqlTTrassortorderListDto otherEntity = (BsSqlTTrassortorderListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTTrassortorderList");
