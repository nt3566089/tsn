...
/**
 * The simple DTO of SqlBondedShippingRelationListPrintGetId. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlBondedShippingRelationListPrintGetIdDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlBondedShippingRelationListPrintGetIdDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlBondedShippingRelationListPrintGetIdDto)) { return false; }
        final BsSqlBondedShippingRelationListPrintGetIdDto otherEntity = (BsSqlBondedShippingRelationListPrintGetIdDto)other;
        ...
        if (!helpComparingValue(getTrsoliststs(), otherEntity.getTrsoliststs())) { return false; }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlBondedShippingRelationListPrintGetId");
        ...
        result = xCH(result, getTrsoliststs());
