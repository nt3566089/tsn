...
/**
 * The simple DTO of SqlDrcdizqaInventoryCreateList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlDrcdizqaInventoryCreateListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlDrcdizqaInventoryCreateListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlDrcdizqaInventoryCreateListDto)) { return false; }
        final BsSqlDrcdizqaInventoryCreateListDto otherEntity = (BsSqlDrcdizqaInventoryCreateListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlDrcdizqaInventoryCreateList");
