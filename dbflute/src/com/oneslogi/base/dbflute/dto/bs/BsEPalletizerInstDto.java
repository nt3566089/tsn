...
/**
 * The simple DTO of E_PALLETIZER_INST as TABLE. <br>
 * パレタイザー投入実績受信テーブル
 * <pre>
 * [primary-key]
 *     PALLETIZER_INST_ID
...
public abstract class BsEPalletizerInstDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEPalletizerInstDto)) { return false; }
        final BsEPalletizerInstDto otherEntity = (BsEPalletizerInstDto)other;
        if (!helpComparingValue(getPalletizerInstId(), otherEntity.getPalletizerInstId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_PALLETIZER_INST");
        result = xCH(result, getPalletizerInstId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getPalletizerInstId());
        ...
        sb.append(c).append(getPrintMachineNumber());
        sb.append(c).append(getCreateno());
        sb.append(c).append(getCustorderlineno());
        sb.append(c).append(getPalletizeStartFlg());
     ...
     * パレタイザー投入実績受信ID
     * @return The value of the column 'PALLETIZER_INST_ID'. (NullAllowed)
     */
     ...
     * パレタイザー投入実績受信ID
     * @param palletizerInstId The value of the column 'PALLETIZER_INST_ID'. (NullAllowed)
     */
    public void setPalletizerInstId(Long palletizerInstId) {
        __modifiedProperties.add("palletizerInstId");
        this._palletizerInstId = palletizerInstId;
    }
     ...
     * 印刷機番号
     * @return The value of the column 'PRINT_MACHINE_NUMBER'. (NullAllowed)
     */
     ...
     * 印刷機番号
     * @param printMachineNumber The value of the column 'PRINT_MACHINE_NUMBER'. (NullAllowed)
     */
    public void setPrintMachineNumber(String printMachineNumber) {
        __modifiedProperties.add("printMachineNumber");
        this._printMachineNumber = printMachineNumber;
    }
     ...
     * パレタイズ開始フラグ
     * @return The value of the column 'PALLETIZE_START_FLG'. (NullAllowed)
     */
     ...
     * パレタイズ開始フラグ
     * @param palletizeStartFlg The value of the column 'PALLETIZE_START_FLG'. (NullAllowed)
     */
    public void setPalletizeStartFlg(String palletizeStartFlg) {
        __modifiedProperties.add("palletizeStartFlg");
        this._palletizeStartFlg = palletizeStartFlg;
    }
