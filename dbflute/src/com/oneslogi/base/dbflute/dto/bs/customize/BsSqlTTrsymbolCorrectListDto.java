...
/**
 * The simple DTO of SqlTTrsymbolCorrectList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTTrsymbolCorrectListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTTrsymbolCorrectListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTTrsymbolCorrectListDto)) { return false; }
        final BsSqlTTrsymbolCorrectListDto otherEntity = (BsSqlTTrsymbolCorrectListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTTrsymbolCorrectList");
