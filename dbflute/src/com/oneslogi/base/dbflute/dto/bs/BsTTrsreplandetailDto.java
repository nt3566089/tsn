...
/**
 * The simple DTO of T_TRSREPLANDETAIL as TABLE. <br>
 * 返品入庫予定明細
 * <pre>
 * [primary-key]
 *     TRSREPLANDETAIL_ID
...
public abstract class BsTTrsreplandetailDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrsreplandetailDto)) { return false; }
        final BsTTrsreplandetailDto otherEntity = (BsTTrsreplandetailDto)other;
        if (!helpComparingValue(getTrsreplandetailId(), otherEntity.getTrsreplandetailId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRSREPLANDETAIL");
        result = xCH(result, getTrsreplandetailId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTrsreplandetailId());
        ...
        sb.append(c).append(getOwnerpono());
     ...
     * 返品入庫予定明細ID
     * @return The value of the column 'TRSREPLANDETAIL_ID'. (NullAllowed)
     */
     ...
     * 返品入庫予定明細ID
     * @param trsreplandetailId The value of the column 'TRSREPLANDETAIL_ID'. (NullAllowed)
     */
    public void setTrsreplandetailId(Long trsreplandetailId) {
        __modifiedProperties.add("trsreplandetailId");
        this._trsreplandetailId = trsreplandetailId;
    }
     ...
     * 発注元ＰＯ番号
     * @return The value of the column 'OWNERPONO'. (NullAllowed)
     */
     ...
     * 発注元ＰＯ番号
     * @param ownerpono The value of the column 'OWNERPONO'. (NullAllowed)
     */
    public void setOwnerpono(String ownerpono) {
        __modifiedProperties.add("ownerpono");
        this._ownerpono = ownerpono;
    }
