...
/**
 * The simple DTO of P_USER_PRINT_SETTING as TABLE. <br>
 * ユーザ別印刷設定情報
 * <pre>
 * [primary-key]
...
public abstract class BsPUserPrintSettingDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPUserPrintSettingDto)) { return false; }
        final BsPUserPrintSettingDto otherEntity = (BsPUserPrintSettingDto)other;
        if (!helpComparingValue(getUserPrintSettingId(), otherEntity.getUserPrintSettingId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "P_USER_PRINT_SETTING");
        result = xCH(result, getUserPrintSettingId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getUserPrintSettingId());
     ...
     * ユーザ別印刷設定ID
     * @return The value of the column 'USER_PRINT_SETTING_ID'. (NullAllowed)
     */
     ...
     * ユーザ別印刷設定ID
     * @param userPrintSettingId The value of the column 'USER_PRINT_SETTING_ID'. (NullAllowed)
     */
    public void setUserPrintSettingId(Long userPrintSettingId) {
        __modifiedProperties.add("userPrintSettingId");
        this._userPrintSettingId = userPrintSettingId;
    }
