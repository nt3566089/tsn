...
/**
 * The simple DTO of B_ROLE as TABLE. <br>
 * 権限マスタ
 * <pre>
 * [primary-key]
 *     ROLE_ID
...
public abstract class BsBRoleDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBRoleDto)) { return false; }
        final BsBRoleDto otherEntity = (BsBRoleDto)other;
        if (!helpComparingValue(getRoleId(), otherEntity.getRoleId())) { return false; }
        return true;
    }
     ...
     * 権限CD
     * @return The value of the column 'ROLE_CD'. (NullAllowed)
     */
     ...
     * 権限CD
     * @param roleCd The value of the column 'ROLE_CD'. (NullAllowed)
     */
    public void setRoleCd(String roleCd) {
        __modifiedProperties.add("roleCd");
        this._roleCd = roleCd;
    }
