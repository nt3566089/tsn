...
/**
 * The simple DTO of SqlSortingPlaceMasterListSrw. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlSortingPlaceMasterListSrwDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlSortingPlaceMasterListSrwDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlSortingPlaceMasterListSrwDto)) { return false; }
        final BsSqlSortingPlaceMasterListSrwDto otherEntity = (BsSqlSortingPlaceMasterListSrwDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlSortingPlaceMasterListSrw");
