...
/**
 * The simple DTO of E_SORTING_STOCK as TABLE. <br>
 * 仕分在庫実績受信テーブル
 * <pre>
 * [primary-key]
 *     SORTING_STOCK_ID
...
public abstract class BsESortingStockDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsESortingStockDto)) { return false; }
        final BsESortingStockDto otherEntity = (BsESortingStockDto)other;
        if (!helpComparingValue(getSortingStockId(), otherEntity.getSortingStockId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_SORTING_STOCK");
        result = xCH(result, getSortingStockId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getSortingStockId());
     ...
     * 仕分在庫実績受信ID
     * @return The value of the column 'SORTING_STOCK_ID'. (NullAllowed)
     */
     ...
     * 仕分在庫実績受信ID
     * @param sortingStockId The value of the column 'SORTING_STOCK_ID'. (NullAllowed)
     */
    public void setSortingStockId(Long sortingStockId) {
        __modifiedProperties.add("sortingStockId");
        this._sortingStockId = sortingStockId;
    }
