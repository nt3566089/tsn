...
/**
 * The simple DTO of SqlgetStockwarehoseList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlgetStockwarehoseListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlgetStockwarehoseListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlgetStockwarehoseListDto)) { return false; }
        final BsSqlgetStockwarehoseListDto otherEntity = (BsSqlgetStockwarehoseListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlgetStockwarehoseList");
