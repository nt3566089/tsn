...
/**
 * The simple DTO of P_REPORT as TABLE. <br>
 * 帳票マスタ
 * <pre>
 * [primary-key]
 *     REPORT_ID
...
public abstract class BsPReportDto implements Serializable {
    ...
    //                                                                      Referrer Table
    //                                                                      ==============
    protected List<PReportLayoutDto> _pReportLayoutList;

    public List<PReportLayoutDto> getPReportLayoutList() {
        if (_pReportLayoutList == null) { _pReportLayoutList = new ArrayList<PReportLayoutDto>(); }
        return _pReportLayoutList;
    }

    public void setPReportLayoutList(List<PReportLayoutDto> pReportLayoutList) {
        this._pReportLayoutList = pReportLayoutList;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPReportDto)) { return false; }
        final BsPReportDto otherEntity = (BsPReportDto)other;
        if (!helpComparingValue(getReportId(), otherEntity.getReportId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "P_REPORT");
        result = xCH(result, getReportId());
        return result;
    }
    ...
    //                                                                            ========
    /**
     * [get] REPORT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 帳票ID
    ...
    /**
     * [set] REPORT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 帳票ID
    ...
    /**
     * [get] REPORT_CD: {UQ, NotNull, varchar(100)} <br>
     * 帳票CD
    ...
    /**
     * [set] REPORT_CD: {UQ, NotNull, varchar(100)} <br>
     * 帳票CD
