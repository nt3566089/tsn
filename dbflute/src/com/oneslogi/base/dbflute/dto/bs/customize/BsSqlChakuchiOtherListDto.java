...
/**
 * The simple DTO of SqlChakuchiOtherList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlChakuchiOtherListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlChakuchiOtherListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlChakuchiOtherListDto)) { return false; }
        final BsSqlChakuchiOtherListDto otherEntity = (BsSqlChakuchiOtherListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlChakuchiOtherList");
