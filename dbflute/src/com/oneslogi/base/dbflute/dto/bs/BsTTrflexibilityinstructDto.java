...
/**
 * The simple DTO of T_TRFLEXIBILITYINSTRUCT as TABLE. <br>
 * 融通指示一括登録情報
 * <pre>
 * [primary-key]
...
public abstract class BsTTrflexibilityinstructDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrflexibilityinstructDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrflexibilityinstructDto)) { return false; }
        final BsTTrflexibilityinstructDto otherEntity = (BsTTrflexibilityinstructDto)other;
        if (!helpComparingValue(getFlexinstructno(), otherEntity.getFlexinstructno())) { return false; }
        if (!helpComparingValue(getFlexinslineno(), otherEntity.getFlexinslineno())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRFLEXIBILITYINSTRUCT");
        result = xCH(result, getFlexinstructno());
        result = xCH(result, getFlexinslineno());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getFlexinstructno());
        sb.append(c).append(getFlexinslineno());
        sb.append(c).append(getFlexinsno());
        ...
        sb.append(c).append(getFlexupduser());
        sb.append(c).append(getFlexinstructsts());
     ...
     * 融通指示番号
     * @return The value of the column 'FLEXINSTRUCTNO'. (NullAllowed)
     */
     ...
     * 融通指示番号
     * @param flexinstructno The value of the column 'FLEXINSTRUCTNO'. (NullAllowed)
     */
    public void setFlexinstructno(java.math.BigDecimal flexinstructno) {
        __modifiedProperties.add("flexinstructno");
        this._flexinstructno = flexinstructno;
    }

    /**
     * [get] FLEXINSLINENO: {PK, NotNull, bigint(19)} <br>
     * 融通指示行番号
     * @return The value of the column 'FLEXINSLINENO'. (NullAllowed)
     */
     ...
     * 融通指示行番号
     * @param flexinslineno The value of the column 'FLEXINSLINENO'. (NullAllowed)
     */
    public void setFlexinslineno(Long flexinslineno) {
        __modifiedProperties.add("flexinslineno");
        this._flexinslineno = flexinslineno;
    }

    /**
     * [get] FLEXINSNO: {varchar(30)} <br>
     * 指示No.
     * @return The value of the column 'FLEXINSNO'. (NullAllowed)
     */
     ...
     * 指示No.
     * @param flexinsno The value of the column 'FLEXINSNO'. (NullAllowed)
     */
    public void setFlexinsno(String flexinsno) {
        __modifiedProperties.add("flexinsno");
        this._flexinsno = flexinsno;
    }
     ...
     * 画面更新者
     * @return The value of the column 'FLEXUPDUSER'. (NullAllowed)
     */
     ...
     * 画面更新者
     * @param flexupduser The value of the column 'FLEXUPDUSER'. (NullAllowed)
     */
    public void setFlexupduser(String flexupduser) {
        __modifiedProperties.add("flexupduser");
        this._flexupduser = flexupduser;
    }

    /**
     * [get] FLEXINSTRUCTSTS: {char(1)} <br>
     * 融通指示登録ステータス
     * @return The value of the column 'FLEXINSTRUCTSTS'. (NullAllowed)
     */
     ...
     * 融通指示登録ステータス
     * @param flexinstructsts The value of the column 'FLEXINSTRUCTSTS'. (NullAllowed)
     */
    public void setFlexinstructsts(String flexinstructsts) {
        __modifiedProperties.add("flexinstructsts");
        this._flexinstructsts = flexinstructsts;
    }
