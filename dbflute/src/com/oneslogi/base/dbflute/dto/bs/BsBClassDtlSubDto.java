...
/**
 * The simple DTO of B_CLASS_DTL_SUB as TABLE. <br>
 * 区分値明細マスタサブ
 * <pre>
 * [primary-key]
 *     CLASS_DTL_ID
...
public abstract class BsBClassDtlSubDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBClassDtlSubDto)) { return false; }
        final BsBClassDtlSubDto otherEntity = (BsBClassDtlSubDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_CLASS_DTL_SUB");
    ...
    //                                                                            ========
    /**
     * [get] CLASS_DTL_ID: {PK, NotNull, bigint(19), FK to B_CLASS_DTL} <br>
     * 区分値明細ID
    ...
    /**
     * [set] CLASS_DTL_ID: {PK, NotNull, bigint(19), FK to B_CLASS_DTL} <br>
     * 区分値明細ID
