...
/**
 * The simple DTO of SqlTCcopamPrintData. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTCcopamPrintDataDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTCcopamPrintDataDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTCcopamPrintDataDto)) { return false; }
        final BsSqlTCcopamPrintDataDto otherEntity = (BsSqlTCcopamPrintDataDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTCcopamPrintData");
