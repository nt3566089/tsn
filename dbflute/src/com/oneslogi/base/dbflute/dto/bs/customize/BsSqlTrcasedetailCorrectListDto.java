...
/**
 * The simple DTO of SqlTrcasedetailCorrectList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTrcasedetailCorrectListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTrcasedetailCorrectListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTrcasedetailCorrectListDto)) { return false; }
        final BsSqlTrcasedetailCorrectListDto otherEntity = (BsSqlTrcasedetailCorrectListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTrcasedetailCorrectList");
