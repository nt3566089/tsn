...
/**
 * The simple DTO of M_USER_LOGIN as TABLE. <br>
 * ユーザログインマスタ
 * <pre>
 * [primary-key]
 *     USER_ID
...
public abstract class BsMUserLoginDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMUserLoginDto)) { return false; }
        final BsMUserLoginDto otherEntity = (BsMUserLoginDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_USER_LOGIN");
    ...
    //                                                                            ========
    /**
     * [get] USER_ID: {PK, ID, NotNull, bigint identity(19), FK to B_USER} <br>
     * ユーザID
    ...
    /**
     * [set] USER_ID: {PK, ID, NotNull, bigint identity(19), FK to B_USER} <br>
     * ユーザID
