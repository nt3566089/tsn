...
/**
 * The simple DTO of T_CORDDTAEC as TABLE. <br>
 * さしずデータ(取替用）
 * <pre>
 * [primary-key]
 *     ORDER_CHANGE_ID
...
public abstract class BsTCorddtaecDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTCorddtaecDto)) { return false; }
        final BsTCorddtaecDto otherEntity = (BsTCorddtaecDto)other;
        if (!helpComparingValue(getOrderChangeId(), otherEntity.getOrderChangeId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_CORDDTAEC");
        result = xCH(result, getOrderChangeId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getOrderChangeId());
     ...
     * さしずデータ(取替用)ID
     * @return The value of the column 'ORDER_CHANGE_ID'. (NullAllowed)
     */
     ...
     * さしずデータ(取替用)ID
     * @param orderChangeId The value of the column 'ORDER_CHANGE_ID'. (NullAllowed)
     */
    public void setOrderChangeId(Long orderChangeId) {
        __modifiedProperties.add("orderChangeId");
        this._orderChangeId = orderChangeId;
    }
