...
/**
 * The simple DTO of H_STOCK_REPORT as TABLE. <br>
 * 在庫日報履歴
 * <pre>
 * [primary-key]
 *     STOCK_REPORT_ID
...
public abstract class BsHStockReportDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsHStockReportDto)) { return false; }
        final BsHStockReportDto otherEntity = (BsHStockReportDto)other;
        if (!helpComparingValue(getStockReportId(), otherEntity.getStockReportId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "H_STOCK_REPORT");
        result = xCH(result, getStockReportId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getStockReportId());
     ...
     * 在庫履歴ID
     * @return The value of the column 'STOCK_REPORT_ID'. (NullAllowed)
     */
     ...
     * 在庫履歴ID
     * @param stockReportId The value of the column 'STOCK_REPORT_ID'. (NullAllowed)
     */
    public void setStockReportId(Long stockReportId) {
        __modifiedProperties.add("stockReportId");
        this._stockReportId = stockReportId;
    }
