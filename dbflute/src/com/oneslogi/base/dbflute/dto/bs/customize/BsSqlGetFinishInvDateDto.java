...
/**
 * The simple DTO of SqlGetFinishInvDate. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlGetFinishInvDateDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlGetFinishInvDateDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlGetFinishInvDateDto)) { return false; }
        final BsSqlGetFinishInvDateDto otherEntity = (BsSqlGetFinishInvDateDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlGetFinishInvDate");
