...
/**
 * The simple DTO of M_SET_PARENT as TABLE. <br>
 * セット品親マスタ
 * <pre>
 * [primary-key]
 *     SET_PARENT_ID
...
public abstract class BsMSetParentDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMSetParentDto)) { return false; }
        final BsMSetParentDto otherEntity = (BsMSetParentDto)other;
        if (!helpComparingValue(getSetParentId(), otherEntity.getSetParentId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_SET_PARENT");
        result = xCH(result, getSetParentId());
        return result;
    }
    ...
    //                                                                            ========
    /**
     * [get] SET_PARENT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 親ID
    ...
    /**
     * [set] SET_PARENT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 親ID
