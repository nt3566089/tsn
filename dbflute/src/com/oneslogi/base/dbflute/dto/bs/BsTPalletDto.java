...
/**
 * The simple DTO of T_PALLET as TABLE. <br>
 * パレット
 * <pre>
 * [primary-key]
 *     PALLET_ID
...
public abstract class BsTPalletDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTPalletDto)) { return false; }
        final BsTPalletDto otherEntity = (BsTPalletDto)other;
        if (!helpComparingValue(getPalletId(), otherEntity.getPalletId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_PALLET");
        result = xCH(result, getPalletId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getDummyPalletKbn());
     ...
     * 仮パレット区分
     * @return The value of the column 'DUMMY_PALLET_KBN'. (NullAllowed)
     */
     ...
     * 仮パレット区分
     * @param dummyPalletKbn The value of the column 'DUMMY_PALLET_KBN'. (NullAllowed)
     */
    public void setDummyPalletKbn(Long dummyPalletKbn) {
        __modifiedProperties.add("dummyPalletKbn");
        this._dummyPalletKbn = dummyPalletKbn;
    }
