...
/**
 * The simple DTO of T_TRMANUFACTUREDATE as TABLE. <br>
 * 製造年月日
 * <pre>
 * [primary-key]
...
public abstract class BsTTrmanufacturedateDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrmanufacturedateDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrmanufacturedateDto)) { return false; }
        final BsTTrmanufacturedateDto otherEntity = (BsTTrmanufacturedateDto)other;
        if (!helpComparingValue(getTrmanufacturedateId(), otherEntity.getTrmanufacturedateId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRMANUFACTUREDATE");
        result = xCH(result, getTrmanufacturedateId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTrmanufacturedateId());
     ...
     * 製造年月日ID
     * @return The value of the column 'TRMANUFACTUREDATE_ID'. (NullAllowed)
     */
     ...
     * 製造年月日ID
     * @param trmanufacturedateId The value of the column 'TRMANUFACTUREDATE_ID'. (NullAllowed)
     */
    public void setTrmanufacturedateId(Long trmanufacturedateId) {
        __modifiedProperties.add("trmanufacturedateId");
        this._trmanufacturedateId = trmanufacturedateId;
    }
