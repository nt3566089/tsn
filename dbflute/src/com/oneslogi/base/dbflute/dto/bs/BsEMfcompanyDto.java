...
/**
 * The simple DTO of E_MFCOMPANY as TABLE. <br>
 * 組織マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     MFCOMPANY_ID
...
public abstract class BsEMfcompanyDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEMfcompanyDto)) { return false; }
        final BsEMfcompanyDto otherEntity = (BsEMfcompanyDto)other;
        if (!helpComparingValue(getMfcompanyId(), otherEntity.getMfcompanyId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_MFCOMPANY");
        result = xCH(result, getMfcompanyId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getMfcompanyId());
     ...
     * 組織マスタ受信ID
     * @return The value of the column 'MFCOMPANY_ID'. (NullAllowed)
     */
     ...
     * 組織マスタ受信ID
     * @param mfcompanyId The value of the column 'MFCOMPANY_ID'. (NullAllowed)
     */
    public void setMfcompanyId(Long mfcompanyId) {
        __modifiedProperties.add("mfcompanyId");
        this._mfcompanyId = mfcompanyId;
    }
