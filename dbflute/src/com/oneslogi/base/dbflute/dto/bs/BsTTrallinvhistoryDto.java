...
/**
 * The simple DTO of T_TRALLINVHISTORY as TABLE. <br>
 * 統合在庫実績参照用
 * <pre>
 * [primary-key]
 *     TRALLINVHISTORY_ID
...
public abstract class BsTTrallinvhistoryDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrallinvhistoryDto)) { return false; }
        final BsTTrallinvhistoryDto otherEntity = (BsTTrallinvhistoryDto)other;
        if (!helpComparingValue(getTrallinvhistoryId(), otherEntity.getTrallinvhistoryId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRALLINVHISTORY");
        result = xCH(result, getTrallinvhistoryId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getTrallinvhistoryId());
     ...
     * 統合在庫実績参照用ID
     * @return The value of the column 'TRALLINVHISTORY_ID'. (NullAllowed)
     */
     ...
     * 統合在庫実績参照用ID
     * @param trallinvhistoryId The value of the column 'TRALLINVHISTORY_ID'. (NullAllowed)
     */
    public void setTrallinvhistoryId(Long trallinvhistoryId) {
        __modifiedProperties.add("trallinvhistoryId");
        this._trallinvhistoryId = trallinvhistoryId;
    }
