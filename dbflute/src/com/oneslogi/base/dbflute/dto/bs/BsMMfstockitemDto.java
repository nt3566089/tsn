...
/**
 * The simple DTO of M_MFSTOCKITEM as TABLE. <br>
 * 銘柄別補充先マスタ
 * <pre>
 * [primary-key]
 *     MFSTOCKITEM_ID
...
public abstract class BsMMfstockitemDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMMfstockitemDto)) { return false; }
        final BsMMfstockitemDto otherEntity = (BsMMfstockitemDto)other;
        if (!helpComparingValue(getMfstockitemId(), otherEntity.getMfstockitemId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_MFSTOCKITEM");
        result = xCH(result, getMfstockitemId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getMfstockitemId());
     ...
     * 銘柄別補充先ID
     * @return The value of the column 'MFSTOCKITEM_ID'. (NullAllowed)
     */
     ...
     * 銘柄別補充先ID
     * @param mfstockitemId The value of the column 'MFSTOCKITEM_ID'. (NullAllowed)
     */
    public void setMfstockitemId(Long mfstockitemId) {
        __modifiedProperties.add("mfstockitemId");
        this._mfstockitemId = mfstockitemId;
    }
