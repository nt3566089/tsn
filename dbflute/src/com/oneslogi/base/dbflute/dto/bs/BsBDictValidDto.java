...
/**
 * The simple DTO of B_DICT_VALID as TABLE. <br>
 * 辞書検証マスタ
 * <pre>
 * [primary-key]
 *     DICT_ID
...
public abstract class BsBDictValidDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBDictValidDto)) { return false; }
        final BsBDictValidDto otherEntity = (BsBDictValidDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_DICT_VALID");
