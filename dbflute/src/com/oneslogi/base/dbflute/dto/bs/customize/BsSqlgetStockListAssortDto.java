...
/**
 * The simple DTO of SqlgetStockListAssort. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlgetStockListAssortDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlgetStockListAssortDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlgetStockListAssortDto)) { return false; }
        final BsSqlgetStockListAssortDto otherEntity = (BsSqlgetStockListAssortDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlgetStockListAssort");
