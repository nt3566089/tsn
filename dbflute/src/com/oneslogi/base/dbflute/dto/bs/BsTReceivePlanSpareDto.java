...
/**
 * The simple DTO of T_RECEIVE_PLAN_SPARE as TABLE. <br>
 * 入荷予定予備
 * <pre>
 * [primary-key]
 *     RECEIVE_PLAN_B_ID
...
public abstract class BsTReceivePlanSpareDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTReceivePlanSpareDto)) { return false; }
        final BsTReceivePlanSpareDto otherEntity = (BsTReceivePlanSpareDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_RECEIVE_PLAN_SPARE");
