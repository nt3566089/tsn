...
/**
 * The simple DTO of T_TRPALLETSYMBOL as TABLE. <br>
 * パレット内個体情報
 * <pre>
 * [primary-key]
...
public abstract class BsTTrpalletsymbolDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrpalletsymbolDto)) { return false; }
        final BsTTrpalletsymbolDto otherEntity = (BsTTrpalletsymbolDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRPALLETSYMBOL");
    ...
    public String toString() {
        ...
        sb.append(c).append(getPalletsymbolprintflg());
     ...
     * パレット内個体情報CD一覧印刷区分
     * @return The value of the column 'PALLETSYMBOLPRINTFLG'. (NullAllowed)
     */
     ...
     * パレット内個体情報CD一覧印刷区分
     * @param palletsymbolprintflg The value of the column 'PALLETSYMBOLPRINTFLG'. (NullAllowed)
     */
    public void setPalletsymbolprintflg(java.math.BigDecimal palletsymbolprintflg) {
        __modifiedProperties.add("palletsymbolprintflg");
        this._palletsymbolprintflg = palletsymbolprintflg;
    }
