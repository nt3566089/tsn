...
/**
 * The simple DTO of T_TRBADITEMCASE as TABLE. <br>
 * 不適品ラベル情報
 * <pre>
 * [primary-key]
 *     TRBADITEMCASE_ID
...
public abstract class BsTTrbaditemcaseDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrbaditemcaseDto)) { return false; }
        final BsTTrbaditemcaseDto otherEntity = (BsTTrbaditemcaseDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRBADITEMCASE");
    ...
    public String toString() {
        ...
        sb.append(c).append(getExpitemcd());
     ...
     * 拡張銘柄CD
     * @return The value of the column 'EXPITEMCD'. (NullAllowed)
     */
     ...
     * 拡張銘柄CD
     * @param expitemcd The value of the column 'EXPITEMCD'. (NullAllowed)
     */
    public void setExpitemcd(String expitemcd) {
        __modifiedProperties.add("expitemcd");
        this._expitemcd = expitemcd;
    }
