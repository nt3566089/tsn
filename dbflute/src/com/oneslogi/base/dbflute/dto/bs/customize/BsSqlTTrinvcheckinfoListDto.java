...
/**
 * The simple DTO of SqlTTrinvcheckinfoList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTTrinvcheckinfoListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTTrinvcheckinfoListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTTrinvcheckinfoListDto)) { return false; }
        final BsSqlTTrinvcheckinfoListDto otherEntity = (BsSqlTTrinvcheckinfoListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTTrinvcheckinfoList");
