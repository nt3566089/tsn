...
/**
 * The simple DTO of E_NOTIFICATION_IMPORT as TABLE. <br>
 * 受入通知情報受信テーブル（輸入）
 * <pre>
 * [primary-key]
...
public abstract class BsENotificationImportDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsENotificationImportDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsENotificationImportDto)) { return false; }
        final BsENotificationImportDto otherEntity = (BsENotificationImportDto)other;
        if (!helpComparingValue(getNotificationImportId(), otherEntity.getNotificationImportId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_NOTIFICATION_IMPORT");
        result = xCH(result, getNotificationImportId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getNotificationImportId());
     ...
     * 受入通知情報受信（輸入）ID
     * @return The value of the column 'NOTIFICATION_IMPORT_ID'. (NullAllowed)
     */
     ...
     * 受入通知情報受信（輸入）ID
     * @param notificationImportId The value of the column 'NOTIFICATION_IMPORT_ID'. (NullAllowed)
     */
    public void setNotificationImportId(Long notificationImportId) {
        __modifiedProperties.add("notificationImportId");
        this._notificationImportId = notificationImportId;
    }
