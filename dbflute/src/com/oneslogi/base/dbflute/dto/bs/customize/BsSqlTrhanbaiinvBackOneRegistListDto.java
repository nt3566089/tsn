...
/**
 * The simple DTO of SqlTrhanbaiinvBackOneRegistList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTrhanbaiinvBackOneRegistListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTrhanbaiinvBackOneRegistListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTrhanbaiinvBackOneRegistListDto)) { return false; }
        final BsSqlTrhanbaiinvBackOneRegistListDto otherEntity = (BsSqlTrhanbaiinvBackOneRegistListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTrhanbaiinvBackOneRegistList");
