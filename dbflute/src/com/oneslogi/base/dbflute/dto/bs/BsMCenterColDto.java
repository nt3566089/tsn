...
/**
 * The simple DTO of M_CENTER_COL as TABLE. <br>
 * 拠点列マスタ
 * <pre>
 * [primary-key]
 *     CENTER_COL_ID
...
public abstract class BsMCenterColDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMCenterColDto)) { return false; }
        final BsMCenterColDto otherEntity = (BsMCenterColDto)other;
        if (!helpComparingValue(getCenterColId(), otherEntity.getCenterColId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_CENTER_COL");
        result = xCH(result, getCenterColId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getCenterColId());
     ...
     * 拠点列 ID
     * @return The value of the column 'CENTER_COL_ID'. (NullAllowed)
     */
     ...
     * 拠点列 ID
     * @param centerColId The value of the column 'CENTER_COL_ID'. (NullAllowed)
     */
    public void setCenterColId(Long centerColId) {
        __modifiedProperties.add("centerColId");
        this._centerColId = centerColId;
    }
