...
/**
 * The simple DTO of W_HT_SERIAL_RECEIVE_INSP as TABLE. <br>
 * シリアル登録(入荷)ワーク
 * <pre>
 * [primary-key]
...
public abstract class BsWHtSerialReceiveInspDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtSerialReceiveInspDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsWHtSerialReceiveInspDto)) { return false; }
        final BsWHtSerialReceiveInspDto otherEntity = (BsWHtSerialReceiveInspDto)other;
        if (!helpComparingValue(getHtSerialReceiveInspId(), otherEntity.getHtSerialReceiveInspId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "W_HT_SERIAL_RECEIVE_INSP");
        result = xCH(result, getHtSerialReceiveInspId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getHtSerialReceiveInspId());
     ...
     * シリアル登録(入荷)ワークID
     * @return The value of the column 'HT_SERIAL_RECEIVE_INSP_ID'. (NullAllowed)
     */
     ...
     * シリアル登録(入荷)ワークID
     * @param htSerialReceiveInspId The value of the column 'HT_SERIAL_RECEIVE_INSP_ID'. (NullAllowed)
     */
    public void setHtSerialReceiveInspId(Long htSerialReceiveInspId) {
        __modifiedProperties.add("htSerialReceiveInspId");
        this._htSerialReceiveInspId = htSerialReceiveInspId;
    }
