...
/**
 * The simple DTO of SqlSortingInventoryInspection. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlSortingInventoryInspectionDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlSortingInventoryInspectionDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlSortingInventoryInspectionDto)) { return false; }
        final BsSqlSortingInventoryInspectionDto otherEntity = (BsSqlSortingInventoryInspectionDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlSortingInventoryInspection");
