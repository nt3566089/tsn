...
/**
 * The simple DTO of H_RECEIVE_SPARE as TABLE. <br>
 * 入荷予備履歴
 * <pre>
 * [primary-key]
 *     STORE_RECORD_B_ID
...
public abstract class BsHReceiveSpareDto implements Serializable {
    ...
    //                                                                       Foreign Table
    //                                                                       =============
    protected HReceiveBDto _hReceiveB;

    public HReceiveBDto getHReceiveB() {
        return _hReceiveB;
    }

    public void setHReceiveB(HReceiveBDto hReceiveB) {
        this._hReceiveB = hReceiveB;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsHReceiveSpareDto)) { return false; }
        final BsHReceiveSpareDto otherEntity = (BsHReceiveSpareDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "H_RECEIVE_SPARE");
