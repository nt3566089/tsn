...
/**
 * The simple DTO of E_SHIPPING_INOUT_PLAN_RECEIVE as TABLE. <br>
 * 輸送受払計画受信テーブル(受入)(国産)
 * <pre>
 * [primary-key]
...
public abstract class BsEShippingInoutPlanReceiveDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEShippingInoutPlanReceiveDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEShippingInoutPlanReceiveDto)) { return false; }
        final BsEShippingInoutPlanReceiveDto otherEntity = (BsEShippingInoutPlanReceiveDto)other;
        if (!helpComparingValue(getShippingInoutPlanReceiveId(), otherEntity.getShippingInoutPlanReceiveId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_SHIPPING_INOUT_PLAN_RECEIVE");
        result = xCH(result, getShippingInoutPlanReceiveId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getShippingInoutPlanReceiveId());
     ...
     * 輸送受払計画受信(受入)(国産)ID
     * @return The value of the column 'SHIPPING_INOUT_PLAN_RECEIVE_ID'. (NullAllowed)
     */
     ...
     * 輸送受払計画受信(受入)(国産)ID
     * @param shippingInoutPlanReceiveId The value of the column 'SHIPPING_INOUT_PLAN_RECEIVE_ID'. (NullAllowed)
     */
    public void setShippingInoutPlanReceiveId(Long shippingInoutPlanReceiveId) {
        __modifiedProperties.add("shippingInoutPlanReceiveId");
        this._shippingInoutPlanReceiveId = shippingInoutPlanReceiveId;
    }
