...
/**
 * The simple DTO of B_TIME_ZONE as TABLE. <br>
 * タイムゾーンマスタ
 * <pre>
 * [primary-key]
 *     TIME_ZONE_ID
...
public abstract class BsBTimeZoneDto implements Serializable {
    ...
    //                                                                      Referrer Table
    //                                                                      ==============
    protected List<BSystemDto> _bSystemList;

    public List<BSystemDto> getBSystemList() {
        if (_bSystemList == null) { _bSystemList = new ArrayList<BSystemDto>(); }
        return _bSystemList;
    }

    public void setBSystemList(List<BSystemDto> bSystemList) {
        this._bSystemList = bSystemList;
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsBTimeZoneDto)) { return false; }
        final BsBTimeZoneDto otherEntity = (BsBTimeZoneDto)other;
        if (!helpComparingValue(getTimeZoneId(), otherEntity.getTimeZoneId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "B_TIME_ZONE");
        result = xCH(result, getTimeZoneId());
        return result;
    }
