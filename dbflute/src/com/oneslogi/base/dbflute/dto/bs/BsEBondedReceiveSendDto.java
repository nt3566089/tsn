...
/**
 * The simple DTO of E_BONDED_RECEIVE_SEND as TABLE. <br>
 * 入庫実績送信（需給）
 * <pre>
 * [primary-key]
...
public abstract class BsEBondedReceiveSendDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEBondedReceiveSendDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsEBondedReceiveSendDto)) { return false; }
        final BsEBondedReceiveSendDto otherEntity = (BsEBondedReceiveSendDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_BONDED_RECEIVE_SEND");
