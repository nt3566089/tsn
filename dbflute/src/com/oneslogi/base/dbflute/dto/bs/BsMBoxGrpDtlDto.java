...
/**
 * The simple DTO of M_BOX_GRP_DTL as TABLE. <br>
 * 荷材グループ明細マスタ
 * <pre>
 * [primary-key]
 *     BOX_GRP_DTL_ID
...
public abstract class BsMBoxGrpDtlDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMBoxGrpDtlDto)) { return false; }
        final BsMBoxGrpDtlDto otherEntity = (BsMBoxGrpDtlDto)other;
        if (!helpComparingValue(getBoxGrpDtlId(), otherEntity.getBoxGrpDtlId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_BOX_GRP_DTL");
        result = xCH(result, getBoxGrpDtlId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getBoxGrpDtlId());
    ...
    //                                                                            ========
    /**
     * [get] BOX_GRP_DTL_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 荷材グループ明細ID
     * @return The value of the column 'BOX_GRP_DTL_ID'. (NullAllowed)
     */
    ...
    /**
     * [set] BOX_GRP_DTL_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 荷材グループ明細ID
     * @param boxGrpDtlId The value of the column 'BOX_GRP_DTL_ID'. (NullAllowed)
     */
    public void setBoxGrpDtlId(Long boxGrpDtlId) {
        __modifiedProperties.add("boxGrpDtlId");
        this._boxGrpDtlId = boxGrpDtlId;
    }
