...
/**
 * The simple DTO of T_TRFLEXIBILITYBREAKDOWN as TABLE. <br>
 * 融通内訳情報
 * <pre>
 * [primary-key]
...
public abstract class BsTTrflexibilitybreakdownDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrflexibilitybreakdownDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrflexibilitybreakdownDto)) { return false; }
        final BsTTrflexibilitybreakdownDto otherEntity = (BsTTrflexibilitybreakdownDto)other;
        if (!helpComparingValue(getFlexibleBreakdownInfoId(), otherEntity.getFlexibleBreakdownInfoId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRFLEXIBILITYBREAKDOWN");
        result = xCH(result, getFlexibleBreakdownInfoId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getFlexibleBreakdownInfoId());
        sb.append(c).append(getBreakdownkey());
     ...
     * 融通内訳情報ID
     * @return The value of the column 'FLEXIBLE_BREAKDOWN_INFO_ID'. (NullAllowed)
     */
     ...
     * 融通内訳情報ID
     * @param flexibleBreakdownInfoId The value of the column 'FLEXIBLE_BREAKDOWN_INFO_ID'. (NullAllowed)
     */
    public void setFlexibleBreakdownInfoId(Long flexibleBreakdownInfoId) {
        __modifiedProperties.add("flexibleBreakdownInfoId");
        this._flexibleBreakdownInfoId = flexibleBreakdownInfoId;
    }

    /**
     * [get] BREAKDOWNKEY: {NotNull, decimal(16, 6)} <br>
     * 融通内訳キー
     * @return The value of the column 'BREAKDOWNKEY'. (NullAllowed)
     */
     ...
     * 融通内訳キー
     * @param breakdownkey The value of the column 'BREAKDOWNKEY'. (NullAllowed)
     */
    public void setBreakdownkey(java.math.BigDecimal breakdownkey) {
        __modifiedProperties.add("breakdownkey");
        this._breakdownkey = breakdownkey;
    }
