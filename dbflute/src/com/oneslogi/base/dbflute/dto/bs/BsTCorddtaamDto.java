...
/**
 * The simple DTO of T_CORDDTAAM as TABLE. <br>
 * さしずデータ（実績）
 * <pre>
 * [primary-key]
 *     ORDER_RECORD_ID
...
public abstract class BsTCorddtaamDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTCorddtaamDto)) { return false; }
        final BsTCorddtaamDto otherEntity = (BsTCorddtaamDto)other;
        if (!helpComparingValue(getOrderRecordId(), otherEntity.getOrderRecordId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_CORDDTAAM");
        result = xCH(result, getOrderRecordId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getOrderRecordId());
     ...
     * さしずデータ(実績)ID
     * @return The value of the column 'ORDER_RECORD_ID'. (NullAllowed)
     */
     ...
     * さしずデータ(実績)ID
     * @param orderRecordId The value of the column 'ORDER_RECORD_ID'. (NullAllowed)
     */
    public void setOrderRecordId(Long orderRecordId) {
        __modifiedProperties.add("orderRecordId");
        this._orderRecordId = orderRecordId;
    }
