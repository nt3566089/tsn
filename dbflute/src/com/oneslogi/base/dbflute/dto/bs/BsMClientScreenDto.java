...
/**
 * The simple DTO of M_CLIENT_SCREEN as TABLE. <br>
 * 荷主画面マスタ
 * <pre>
 * [primary-key]
 *     CLIENT_SCREEN_ID
...
public abstract class BsMClientScreenDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsMClientScreenDto)) { return false; }
        final BsMClientScreenDto otherEntity = (BsMClientScreenDto)other;
        if (!helpComparingValue(getClientScreenId(), otherEntity.getClientScreenId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "M_CLIENT_SCREEN");
        result = xCH(result, getClientScreenId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getClientScreenId());
    ...
    //                                                                            ========
    /**
     * [get] CLIENT_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 荷主画面ID
     * @return The value of the column 'CLIENT_SCREEN_ID'. (NullAllowed)
     */
    ...
    /**
     * [set] CLIENT_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 荷主画面ID
     * @param clientScreenId The value of the column 'CLIENT_SCREEN_ID'. (NullAllowed)
     */
    public void setClientScreenId(Long clientScreenId) {
        __modifiedProperties.add("clientScreenId");
        this._clientScreenId = clientScreenId;
    }
