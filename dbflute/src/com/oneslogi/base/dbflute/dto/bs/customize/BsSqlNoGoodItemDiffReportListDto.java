...
/**
 * The simple DTO of SqlNoGoodItemDiffReportList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlNoGoodItemDiffReportListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlNoGoodItemDiffReportListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlNoGoodItemDiffReportListDto)) { return false; }
        final BsSqlNoGoodItemDiffReportListDto otherEntity = (BsSqlNoGoodItemDiffReportListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlNoGoodItemDiffReportList");
