...
/**
 * The simple DTO of SqlInventoryBInventoryCreateList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlInventoryBInventoryCreateListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlInventoryBInventoryCreateListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlInventoryBInventoryCreateListDto)) { return false; }
        final BsSqlInventoryBInventoryCreateListDto otherEntity = (BsSqlInventoryBInventoryCreateListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlInventoryBInventoryCreateList");
