...
/**
 * The simple DTO of SqlTCcopamReleaseControlNoUsed. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTCcopamReleaseControlNoUsedDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTCcopamReleaseControlNoUsedDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTCcopamReleaseControlNoUsedDto)) { return false; }
        final BsSqlTCcopamReleaseControlNoUsedDto otherEntity = (BsSqlTCcopamReleaseControlNoUsedDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTCcopamReleaseControlNoUsed");
