...
/**
 * The simple DTO of E_NOTIFICATION_DOMESTIC as TABLE. <br>
 * 受入通知情報受信テーブル（国産）
 * <pre>
 * [primary-key]
...
public abstract class BsENotificationDomesticDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsENotificationDomesticDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsENotificationDomesticDto)) { return false; }
        final BsENotificationDomesticDto otherEntity = (BsENotificationDomesticDto)other;
        if (!helpComparingValue(getNotificationDomesticId(), otherEntity.getNotificationDomesticId())) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "E_NOTIFICATION_DOMESTIC");
        result = xCH(result, getNotificationDomesticId());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(c).append(getNotificationDomesticId());
     ...
     * 受入通知情報受信（国産）ID
     * @return The value of the column 'NOTIFICATION_DOMESTIC_ID'. (NullAllowed)
     */
     ...
     * 受入通知情報受信（国産）ID
     * @param notificationDomesticId The value of the column 'NOTIFICATION_DOMESTIC_ID'. (NullAllowed)
     */
    public void setNotificationDomesticId(Long notificationDomesticId) {
        __modifiedProperties.add("notificationDomesticId");
        this._notificationDomesticId = notificationDomesticId;
    }
