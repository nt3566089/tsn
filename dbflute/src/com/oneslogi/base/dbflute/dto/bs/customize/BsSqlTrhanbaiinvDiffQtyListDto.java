...
/**
 * The simple DTO of SqlTrhanbaiinvDiffQtyList. <br>
 * <pre>
 * [primary-key]
 *     
 *
...
public abstract class BsSqlTrhanbaiinvDiffQtyListDto implements Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTrhanbaiinvDiffQtyListDto() {
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSqlTrhanbaiinvDiffQtyListDto)) { return false; }
        final BsSqlTrhanbaiinvDiffQtyListDto otherEntity = (BsSqlTrhanbaiinvDiffQtyListDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SqlTrhanbaiinvDiffQtyList");
