...
/**
 * The simple DTO of T_TRINVREANSWER as TABLE. <br>
 * 在庫照会回答情報
 * <pre>
 * [primary-key]
 *     TRINVREANSWER_ID
...
public abstract class BsTTrinvreanswerDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTTrinvreanswerDto)) { return false; }
        final BsTTrinvreanswerDto otherEntity = (BsTTrinvreanswerDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "T_TRINVREANSWER");
    ...
    public String toString() {
        ...
        sb.append(c).append(getAnswerlineno());
     ...
     * 在庫照会回答行No.
     * @return The value of the column 'ANSWERLINENO'. (NullAllowed)
     */
     ...
     * 在庫照会回答行No.
     * @param answerlineno The value of the column 'ANSWERLINENO'. (NullAllowed)
     */
    public void setAnswerlineno(java.math.BigDecimal answerlineno) {
        __modifiedProperties.add("answerlineno");
        this._answerlineno = answerlineno;
    }
