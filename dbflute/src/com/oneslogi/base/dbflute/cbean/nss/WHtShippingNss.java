...
import com.oneslogi.base.dbflute.cbean.cq.WHtShippingCQ;

/**
 * The nest select set-upper of W_HT_SHIPPING.
 * @author DBFlute(AutoGenerator)
 */
public class WHtShippingNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final WHtShippingCQ _query;
    public WHtShippingNss(WHtShippingCQ query) { _query = query; }
