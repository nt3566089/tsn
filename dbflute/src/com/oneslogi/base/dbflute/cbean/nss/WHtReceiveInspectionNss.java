...
import com.oneslogi.base.dbflute.cbean.cq.WHtReceiveInspectionCQ;

/**
 * The nest select set-upper of W_HT_RECEIVE_INSPECTION.
 * @author DBFlute(AutoGenerator)
 */
public class WHtReceiveInspectionNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final WHtReceiveInspectionCQ _query;
    public WHtReceiveInspectionNss(WHtReceiveInspectionCQ query) { _query = query; }
