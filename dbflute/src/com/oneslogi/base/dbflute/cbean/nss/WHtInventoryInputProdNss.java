...
import com.oneslogi.base.dbflute.cbean.cq.WHtInventoryInputProdCQ;

/**
 * The nest select set-upper of W_HT_INVENTORY_INPUT_PROD.
 * @author DBFlute(AutoGenerator)
 */
public class WHtInventoryInputProdNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final WHtInventoryInputProdCQ _query;
    public WHtInventoryInputProdNss(WHtInventoryInputProdCQ query) { _query = query; }
