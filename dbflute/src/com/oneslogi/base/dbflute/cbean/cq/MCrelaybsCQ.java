...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMCrelaybsCQ;

/**
 * The condition-query of M_CRELAYBS.
 * <p>
 ...
 */
public class MCrelaybsCQ extends BsMCrelaybsCQ {
     ...
     */
    public MCrelaybsCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
