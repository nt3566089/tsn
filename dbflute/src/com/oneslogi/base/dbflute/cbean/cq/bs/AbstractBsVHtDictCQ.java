...
/**
 * The abstract condition-query of V_HT_DICT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsVHtDictCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsVHtDictCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<VHtDictCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, VHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VHtDictCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, VHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VHtDictCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, VHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VHtDictCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, VHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VHtDictCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, VHtDictCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;VHtDictCB&gt;() {
     *     public void query(VHtDictCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VHtDictCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, VHtDictCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        VHtDictCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(VHtDictCQ sq);

    protected VHtDictCB xcreateScalarConditionCB() {
        VHtDictCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected VHtDictCB xcreateScalarConditionPartitionByCB() {
        VHtDictCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected VHtDictCB newMyCB() {
        return new VHtDictCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return VHtDictCQ.class.getName(); }
