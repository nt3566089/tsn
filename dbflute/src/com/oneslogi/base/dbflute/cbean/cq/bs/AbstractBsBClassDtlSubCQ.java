...
/**
 * The abstract condition-query of B_CLASS_DTL_SUB.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBClassDtlSubCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBClassDtlSubCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<BClassDtlSubCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, BClassDtlSubCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BClassDtlSubCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, BClassDtlSubCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BClassDtlSubCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, BClassDtlSubCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BClassDtlSubCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, BClassDtlSubCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BClassDtlSubCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, BClassDtlSubCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BClassDtlSubCB&gt;() {
     *     public void query(BClassDtlSubCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BClassDtlSubCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, BClassDtlSubCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        BClassDtlSubCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(BClassDtlSubCQ sq);

    protected BClassDtlSubCB xcreateScalarConditionCB() {
        BClassDtlSubCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected BClassDtlSubCB xcreateScalarConditionPartitionByCB() {
        BClassDtlSubCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<BClassDtlSubCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BClassDtlSubCB cb = new BClassDtlSubCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CLASS_DTL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(BClassDtlSubCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<BClassDtlSubCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(BClassDtlSubCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BClassDtlSubCB cb = new BClassDtlSubCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CLASS_DTL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(BClassDtlSubCQ sq);
     ...
     */
    public void myselfExists(SubQuery<BClassDtlSubCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BClassDtlSubCB cb = new BClassDtlSubCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(BClassDtlSubCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected BClassDtlSubCB newMyCB() {
        return new BClassDtlSubCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return BClassDtlSubCQ.class.getName(); }
