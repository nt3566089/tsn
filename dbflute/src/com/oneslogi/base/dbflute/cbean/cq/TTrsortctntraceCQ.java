...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrsortctntraceCQ;

/**
 * The condition-query of T_TRSORTCTNTRACE.
 * <p>
 ...
 */
public class TTrsortctntraceCQ extends BsTTrsortctntraceCQ {
     ...
     */
    public TTrsortctntraceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
