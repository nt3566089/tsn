...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMCarrierBoxCQ;

/**
 * The condition-query of m_carrier_box.
 * <p>
 ...
 */
public class MCarrierBoxCQ extends BsMCarrierBoxCQ {
     ...
     */
    public MCarrierBoxCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
