...
/**
 * The condition-query for in-line of E_STOCK_INQUIRY_ANSWER.
 * @author DBFlute(AutoGenerator)
 */
public class EStockInquiryAnswerCIQ extends AbstractBsEStockInquiryAnswerCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEStockInquiryAnswerCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EStockInquiryAnswerCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEStockInquiryAnswerCQ myCQ) {
    ...
    public String keepScalarCondition(EStockInquiryAnswerCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EStockInquiryAnswerCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EStockInquiryAnswerCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EStockInquiryAnswerCQ sq)
    ...
    protected String xinCB() { return EStockInquiryAnswerCB.class.getName(); }
    protected String xinCQ() { return EStockInquiryAnswerCQ.class.getName(); }
}
