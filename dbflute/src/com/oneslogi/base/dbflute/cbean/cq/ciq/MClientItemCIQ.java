...
/**
 * The condition-query for in-line of M_CLIENT_ITEM.
 * @author DBFlute(AutoGenerator)
 */
public class MClientItemCIQ extends AbstractBsMClientItemCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsMClientItemCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MClientItemCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMClientItemCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueClientItemId() { return _myCQ.xdfgetClientItemId(); }
    ...
    public String keepScalarCondition(MClientItemCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MClientItemCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MClientItemCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MClientItemCQ sq)
    ...
    protected String xinCB() { return MClientItemCB.class.getName(); }
    protected String xinCQ() { return MClientItemCQ.class.getName(); }
}
