...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrpalletsymbolCQ;

/**
 * The condition-query of T_TRPALLETSYMBOL.
 * <p>
 ...
 */
public class TTrpalletsymbolCQ extends BsTTrpalletsymbolCQ {
     ...
     */
    public TTrpalletsymbolCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
