...
/**
 * The abstract condition-query of V_DICT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsVDictCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsVDictCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * DICT_NM: {varchar(100)}
     */
    public void setDictNm_IsNull() { regDictNm(CK_ISN, DOBJ); }

    /**
     * IsNullOrEmpty {is null or empty}. And OnlyOnceRegistered. <br>
     * DICT_NM: {varchar(100)}
     */
    public void setDictNm_IsNullOrEmpty() { regDictNm(CK_ISNOE, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * DICT_NM: {varchar(100)}
     */
    public void setDictNm_IsNotNull() { regDictNm(CK_ISNN, DOBJ); }
     ...
     */
    public HpSLCFunction<VDictCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, VDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VDictCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, VDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VDictCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, VDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VDictCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, VDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VDictCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, VDictCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;VDictCB&gt;() {
     *     public void query(VDictCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VDictCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, VDictCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        VDictCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(VDictCQ sq);

    protected VDictCB xcreateScalarConditionCB() {
        VDictCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected VDictCB xcreateScalarConditionPartitionByCB() {
        VDictCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected VDictCB newMyCB() {
        return new VDictCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return VDictCQ.class.getName(); }
