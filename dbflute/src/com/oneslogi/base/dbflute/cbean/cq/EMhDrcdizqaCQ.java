...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEMhDrcdizqaCQ;

/**
 * The condition-query of E_MH_DRCDIZQA.
 * <p>
 ...
 */
public class EMhDrcdizqaCQ extends BsEMhDrcdizqaCQ {
     ...
     */
    public EMhDrcdizqaCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
