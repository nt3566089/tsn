...
/**
 * The abstract condition-query of E_USER.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEUserCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEUserCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param receiveLoginInfoId The value of receiveLoginInfoId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_Equal(Long receiveLoginInfoId) {
        doSetReceiveLoginInfoId_Equal(receiveLoginInfoId);
    }

    protected void doSetReceiveLoginInfoId_Equal(Long receiveLoginInfoId) {
        regReceiveLoginInfoId(CK_EQ, receiveLoginInfoId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoId The value of receiveLoginInfoId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_NotEqual(Long receiveLoginInfoId) {
        doSetReceiveLoginInfoId_NotEqual(receiveLoginInfoId);
    }

    protected void doSetReceiveLoginInfoId_NotEqual(Long receiveLoginInfoId) {
        regReceiveLoginInfoId(CK_NES, receiveLoginInfoId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoId The value of receiveLoginInfoId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_GreaterThan(Long receiveLoginInfoId) {
        regReceiveLoginInfoId(CK_GT, receiveLoginInfoId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoId The value of receiveLoginInfoId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_LessThan(Long receiveLoginInfoId) {
        regReceiveLoginInfoId(CK_LT, receiveLoginInfoId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoId The value of receiveLoginInfoId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_GreaterEqual(Long receiveLoginInfoId) {
        regReceiveLoginInfoId(CK_GE, receiveLoginInfoId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoId The value of receiveLoginInfoId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_LessEqual(Long receiveLoginInfoId) {
        regReceiveLoginInfoId(CK_LE, receiveLoginInfoId);
    }
     ...
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of receiveLoginInfoId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of receiveLoginInfoId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setReceiveLoginInfoId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueReceiveLoginInfoId(), "RECEIVE_LOGIN_INFO_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoIdList The collection of receiveLoginInfoId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_InScope(Collection<Long> receiveLoginInfoIdList) {
        doSetReceiveLoginInfoId_InScope(receiveLoginInfoIdList);
    }

    protected void doSetReceiveLoginInfoId_InScope(Collection<Long> receiveLoginInfoIdList) {
        regINS(CK_INS, cTL(receiveLoginInfoIdList), xgetCValueReceiveLoginInfoId(), "RECEIVE_LOGIN_INFO_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param receiveLoginInfoIdList The collection of receiveLoginInfoId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveLoginInfoId_NotInScope(Collection<Long> receiveLoginInfoIdList) {
        doSetReceiveLoginInfoId_NotInScope(receiveLoginInfoIdList);
    }

    protected void doSetReceiveLoginInfoId_NotInScope(Collection<Long> receiveLoginInfoIdList) {
        regINS(CK_NINS, cTL(receiveLoginInfoIdList), xgetCValueReceiveLoginInfoId(), "RECEIVE_LOGIN_INFO_ID");
    }
     ...
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setReceiveLoginInfoId_IsNull() { regReceiveLoginInfoId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * RECEIVE_LOGIN_INFO_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setReceiveLoginInfoId_IsNotNull() { regReceiveLoginInfoId(CK_ISNN, DOBJ); }

    protected void regReceiveLoginInfoId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueReceiveLoginInfoId(), "RECEIVE_LOGIN_INFO_ID"); }
    protected abstract ConditionValue xgetCValueReceiveLoginInfoId();
     ...
     * COMMON_AUTH_ID: {varchar(255)}
     */
    public void setCommonAuthId_IsNullOrEmpty() { regCommonAuthId(CK_ISNOE, DOBJ); }
     ...
     */
    public HpSLCFunction<EUserCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EUserCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EUserCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EUserCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EUserCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EUserCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EUserCB&gt;() {
     *     public void query(EUserCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EUserCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EUserCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EUserCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EUserCQ sq);

    protected EUserCB xcreateScalarConditionCB() {
        EUserCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EUserCB xcreateScalarConditionPartitionByCB() {
        EUserCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EUserCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EUserCB cb = new EUserCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "RECEIVE_LOGIN_INFO_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EUserCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EUserCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EUserCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EUserCB cb = new EUserCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "RECEIVE_LOGIN_INFO_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EUserCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EUserCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EUserCB cb = new EUserCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EUserCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EUserCB newMyCB() {
        return new EUserCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EUserCQ.class.getName(); }
