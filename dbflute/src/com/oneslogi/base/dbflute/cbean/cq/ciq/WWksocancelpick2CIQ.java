...
/**
 * The condition-query for in-line of W_WKSOCANCELPICK2.
 * @author DBFlute(AutoGenerator)
 */
public class WWksocancelpick2CIQ extends AbstractBsWWksocancelpick2CQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWWksocancelpick2CQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WWksocancelpick2CIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWWksocancelpick2CQ myCQ) {
    ...
    protected ConditionValue xgetCValuePickedqtyB() { return _myCQ.xdfgetPickedqtyB(); }
    protected ConditionValue xgetCValuePickedqtyP() { return _myCQ.xdfgetPickedqtyP(); }
    protected ConditionValue xgetCValuePickedqtyC2() { return _myCQ.xdfgetPickedqtyC2(); }
    ...
    public String keepScalarCondition(WWksocancelpick2CQ sq)
    ...
    protected String xinCB() { return WWksocancelpick2CB.class.getName(); }
    protected String xinCQ() { return WWksocancelpick2CQ.class.getName(); }
}
