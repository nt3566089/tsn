...
/**
 * The abstract condition-query of M_CENTER_COL.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMCenterColCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMCenterColCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param centerColId The value of centerColId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterColId_Equal(Long centerColId) {
        doSetCenterColId_Equal(centerColId);
    }

    protected void doSetCenterColId_Equal(Long centerColId) {
        regCenterColId(CK_EQ, centerColId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColId The value of centerColId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterColId_NotEqual(Long centerColId) {
        doSetCenterColId_NotEqual(centerColId);
    }

    protected void doSetCenterColId_NotEqual(Long centerColId) {
        regCenterColId(CK_NES, centerColId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColId The value of centerColId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterColId_GreaterThan(Long centerColId) {
        regCenterColId(CK_GT, centerColId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColId The value of centerColId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterColId_LessThan(Long centerColId) {
        regCenterColId(CK_LT, centerColId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColId The value of centerColId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterColId_GreaterEqual(Long centerColId) {
        regCenterColId(CK_GE, centerColId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColId The value of centerColId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterColId_LessEqual(Long centerColId) {
        regCenterColId(CK_LE, centerColId);
    }
     ...
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of centerColId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of centerColId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setCenterColId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueCenterColId(), "CENTER_COL_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColIdList The collection of centerColId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCenterColId_InScope(Collection<Long> centerColIdList) {
        doSetCenterColId_InScope(centerColIdList);
    }

    protected void doSetCenterColId_InScope(Collection<Long> centerColIdList) {
        regINS(CK_INS, cTL(centerColIdList), xgetCValueCenterColId(), "CENTER_COL_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerColIdList The collection of centerColId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCenterColId_NotInScope(Collection<Long> centerColIdList) {
        doSetCenterColId_NotInScope(centerColIdList);
    }

    protected void doSetCenterColId_NotInScope(Collection<Long> centerColIdList) {
        regINS(CK_NINS, cTL(centerColIdList), xgetCValueCenterColId(), "CENTER_COL_ID");
    }
     ...
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setCenterColId_IsNull() { regCenterColId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setCenterColId_IsNotNull() { regCenterColId(CK_ISNN, DOBJ); }

    protected void regCenterColId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCenterColId(), "CENTER_COL_ID"); }
    protected abstract ConditionValue xgetCValueCenterColId();
     ...
     */
    public HpSLCFunction<MCenterColCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, MCenterColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterColCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, MCenterColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterColCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, MCenterColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterColCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, MCenterColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterColCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, MCenterColCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MCenterColCB&gt;() {
     *     public void query(MCenterColCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterColCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, MCenterColCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterColCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(MCenterColCQ sq);

    protected MCenterColCB xcreateScalarConditionCB() {
        MCenterColCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MCenterColCB xcreateScalarConditionPartitionByCB() {
        MCenterColCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MCenterColCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterColCB cb = new MCenterColCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CENTER_COL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MCenterColCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MCenterColCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MCenterColCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterColCB cb = new MCenterColCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CENTER_COL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MCenterColCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MCenterColCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MCenterColCB cb = new MCenterColCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MCenterColCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MCenterColCB newMyCB() {
        return new MCenterColCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return MCenterColCQ.class.getName(); }
