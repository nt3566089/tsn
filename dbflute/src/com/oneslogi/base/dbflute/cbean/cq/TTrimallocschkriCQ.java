...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrimallocschkriCQ;

/**
 * The condition-query of T_TRIMALLOCSCHKRI.
 * <p>
 ...
 */
public class TTrimallocschkriCQ extends BsTTrimallocschkriCQ {
     ...
     */
    public TTrimallocschkriCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
