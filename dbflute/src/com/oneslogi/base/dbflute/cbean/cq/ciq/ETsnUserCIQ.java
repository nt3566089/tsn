...
/**
 * The condition-query for in-line of E_TSN_USER.
 * @author DBFlute(AutoGenerator)
 */
public class ETsnUserCIQ extends AbstractBsETsnUserCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsETsnUserCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ETsnUserCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsETsnUserCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTsnUserId() { return _myCQ.xdfgetTsnUserId(); }
    ...
    public String keepScalarCondition(ETsnUserCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ETsnUserCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ETsnUserCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ETsnUserCQ sq)
    ...
    protected String xinCB() { return ETsnUserCB.class.getName(); }
    protected String xinCQ() { return ETsnUserCQ.class.getName(); }
}
