...
/**
 * The abstract condition-query of W_PRODUCT_INPUT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWProductInputCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWProductInputCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param productInputId The value of productInputId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setProductInputId_Equal(Long productInputId) {
        doSetProductInputId_Equal(productInputId);
    }

    protected void doSetProductInputId_Equal(Long productInputId) {
        regProductInputId(CK_EQ, productInputId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputId The value of productInputId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setProductInputId_NotEqual(Long productInputId) {
        doSetProductInputId_NotEqual(productInputId);
    }

    protected void doSetProductInputId_NotEqual(Long productInputId) {
        regProductInputId(CK_NES, productInputId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputId The value of productInputId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setProductInputId_GreaterThan(Long productInputId) {
        regProductInputId(CK_GT, productInputId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputId The value of productInputId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setProductInputId_LessThan(Long productInputId) {
        regProductInputId(CK_LT, productInputId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputId The value of productInputId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setProductInputId_GreaterEqual(Long productInputId) {
        regProductInputId(CK_GE, productInputId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputId The value of productInputId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setProductInputId_LessEqual(Long productInputId) {
        regProductInputId(CK_LE, productInputId);
    }
     ...
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of productInputId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of productInputId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setProductInputId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueProductInputId(), "PRODUCT_INPUT_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputIdList The collection of productInputId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setProductInputId_InScope(Collection<Long> productInputIdList) {
        doSetProductInputId_InScope(productInputIdList);
    }

    protected void doSetProductInputId_InScope(Collection<Long> productInputIdList) {
        regINS(CK_INS, cTL(productInputIdList), xgetCValueProductInputId(), "PRODUCT_INPUT_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param productInputIdList The collection of productInputId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setProductInputId_NotInScope(Collection<Long> productInputIdList) {
        doSetProductInputId_NotInScope(productInputIdList);
    }

    protected void doSetProductInputId_NotInScope(Collection<Long> productInputIdList) {
        regINS(CK_NINS, cTL(productInputIdList), xgetCValueProductInputId(), "PRODUCT_INPUT_ID");
    }
     ...
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setProductInputId_IsNull() { regProductInputId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * PRODUCT_INPUT_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setProductInputId_IsNotNull() { regProductInputId(CK_ISNN, DOBJ); }

    protected void regProductInputId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueProductInputId(), "PRODUCT_INPUT_ID"); }
    protected abstract ConditionValue xgetCValueProductInputId();
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_LIMIT_NUM: {varchar(255)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * SHIPPING_LIMIT_NUM: {varchar(255)} <br>
     ...
     */
    public HpSLCFunction<WProductInputCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WProductInputCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WProductInputCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WProductInputCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WProductInputCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WProductInputCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WProductInputCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WProductInputCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WProductInputCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WProductInputCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WProductInputCB&gt;() {
     *     public void query(WProductInputCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WProductInputCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WProductInputCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WProductInputCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WProductInputCQ sq);

    protected WProductInputCB xcreateScalarConditionCB() {
        WProductInputCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WProductInputCB xcreateScalarConditionPartitionByCB() {
        WProductInputCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<WProductInputCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WProductInputCB cb = new WProductInputCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PRODUCT_INPUT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(WProductInputCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<WProductInputCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(WProductInputCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WProductInputCB cb = new WProductInputCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PRODUCT_INPUT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(WProductInputCQ sq);
     ...
     */
    public void myselfExists(SubQuery<WProductInputCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        WProductInputCB cb = new WProductInputCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(WProductInputCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WProductInputCB newMyCB() {
        return new WProductInputCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WProductInputCQ.class.getName(); }
