...
/**
 * The abstract condition-query of T_TREXCSEND.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTTrexcsendCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTTrexcsendCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<TTrexcsendCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TTrexcsendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrexcsendCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TTrexcsendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrexcsendCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TTrexcsendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrexcsendCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TTrexcsendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrexcsendCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TTrexcsendCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TTrexcsendCB&gt;() {
     *     public void query(TTrexcsendCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrexcsendCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TTrexcsendCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrexcsendCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TTrexcsendCQ sq);

    protected TTrexcsendCB xcreateScalarConditionCB() {
        TTrexcsendCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TTrexcsendCB xcreateScalarConditionPartitionByCB() {
        TTrexcsendCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TTrexcsendCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrexcsendCB cb = new TTrexcsendCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SYMBOLNO";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TTrexcsendCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TTrexcsendCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TTrexcsendCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrexcsendCB cb = new TTrexcsendCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SYMBOLNO";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TTrexcsendCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TTrexcsendCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrexcsendCB cb = new TTrexcsendCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TTrexcsendCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TTrexcsendCB newMyCB() {
        return new TTrexcsendCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TTrexcsendCQ.class.getName(); }
