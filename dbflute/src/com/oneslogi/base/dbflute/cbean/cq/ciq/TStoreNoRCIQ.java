...
/**
 * The condition-query for in-line of T_STORE_NO_R.
 * @author DBFlute(AutoGenerator)
 */
public class TStoreNoRCIQ extends AbstractBsTStoreNoRCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTStoreNoRCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TStoreNoRCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTStoreNoRCQ myCQ) {
    ...
    public String keepScalarCondition(TStoreNoRCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TStoreNoRCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TStoreNoRCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TStoreNoRCQ sq)
    ...
    protected String xinCB() { return TStoreNoRCB.class.getName(); }
    protected String xinCQ() { return TStoreNoRCQ.class.getName(); }
}
