...
/**
 * The condition-query for in-line of T_CORDDTAAM.
 * @author DBFlute(AutoGenerator)
 */
public class TCorddtaamCIQ extends AbstractBsTCorddtaamCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTCorddtaamCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TCorddtaamCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTCorddtaamCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueOrderRecordId() { return _myCQ.xdfgetOrderRecordId(); }
    ...
    public String keepScalarCondition(TCorddtaamCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TCorddtaamCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TCorddtaamCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TCorddtaamCQ sq)
    ...
    protected String xinCB() { return TCorddtaamCB.class.getName(); }
    protected String xinCQ() { return TCorddtaamCQ.class.getName(); }
}
