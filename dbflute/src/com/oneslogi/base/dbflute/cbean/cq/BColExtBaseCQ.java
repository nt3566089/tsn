...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsBColExtBaseCQ;

/**
 * The condition-query of b_col_ext_base.
 * <p>
 ...
 */
public class BColExtBaseCQ extends BsBColExtBaseCQ {
     ...
     */
    public BColExtBaseCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
