...
/**
 * The abstract condition-query of M_HT_DICT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMHtDictCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMHtDictCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<MHtDictCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, MHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MHtDictCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, MHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MHtDictCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, MHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MHtDictCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, MHtDictCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MHtDictCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, MHtDictCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MHtDictCB&gt;() {
     *     public void query(MHtDictCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MHtDictCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, MHtDictCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        MHtDictCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(MHtDictCQ sq);

    protected MHtDictCB xcreateScalarConditionCB() {
        MHtDictCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MHtDictCB xcreateScalarConditionPartitionByCB() {
        MHtDictCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MHtDictCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MHtDictCB cb = new MHtDictCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "DICT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MHtDictCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MHtDictCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MHtDictCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MHtDictCB cb = new MHtDictCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "DICT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MHtDictCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MHtDictCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MHtDictCB cb = new MHtDictCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MHtDictCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MHtDictCB newMyCB() {
        return new MHtDictCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return MHtDictCQ.class.getName(); }
