...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEReceivePlanCQ;

/**
 * The condition-query of e_receive_plan.
 * <p>
 ...
 */
public class EReceivePlanCQ extends BsEReceivePlanCQ {
     ...
     */
    public EReceivePlanCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
