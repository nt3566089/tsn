...
/**
 * The condition-query for in-line of W_STOCK_INPUT.
 * @author DBFlute(AutoGenerator)
 */
public class WStockInputCIQ extends AbstractBsWStockInputCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWStockInputCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WStockInputCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWStockInputCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueStockInputId() { return _myCQ.xdfgetStockInputId(); }
    ...
    protected ConditionValue xgetCValueLotCd() { return _myCQ.xdfgetLotCd(); }
    ...
    protected ConditionValue xgetCValueStockInputComment() { return _myCQ.xdfgetStockInputComment(); }
    ...
    public String keepScalarCondition(WStockInputCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(WStockInputCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(WStockInputCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(WStockInputCQ sq)
    ...
    protected String xinCB() { return WStockInputCB.class.getName(); }
    protected String xinCQ() { return WStockInputCQ.class.getName(); }
}
