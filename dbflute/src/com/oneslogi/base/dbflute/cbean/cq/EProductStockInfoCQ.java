...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEProductStockInfoCQ;

/**
 * The condition-query of E_PRODUCT_STOCK_INFO.
 * <p>
 ...
 */
public class EProductStockInfoCQ extends BsEProductStockInfoCQ {
     ...
     */
    public EProductStockInfoCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
