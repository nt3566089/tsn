...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMDataInputTypeCQ;

/**
 * The condition-query of m_data_input_type.
 * <p>
 ...
 */
public class MDataInputTypeCQ extends BsMDataInputTypeCQ {
     ...
     */
    public MDataInputTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
