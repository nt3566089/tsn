...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTAmazonOrderCQ;

/**
 * The condition-query of t_amazon_order.
 * <p>
 ...
 */
public class TAmazonOrderCQ extends BsTAmazonOrderCQ {
     ...
     */
    public TAmazonOrderCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
