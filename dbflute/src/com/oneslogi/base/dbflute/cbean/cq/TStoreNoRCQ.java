...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTStoreNoRCQ;

/**
 * The condition-query of t_store_no_r.
 * <p>
 ...
 */
public class TStoreNoRCQ extends BsTStoreNoRCQ {
     ...
     */
    public TStoreNoRCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
