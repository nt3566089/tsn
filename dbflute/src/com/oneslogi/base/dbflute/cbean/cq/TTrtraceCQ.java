...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrtraceCQ;

/**
 * The condition-query of T_TRTRACE.
 * <p>
 ...
 */
public class TTrtraceCQ extends BsTTrtraceCQ {
     ...
     */
    public TTrtraceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
