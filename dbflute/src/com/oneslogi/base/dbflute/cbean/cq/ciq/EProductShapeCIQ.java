...
/**
 * The condition-query for in-line of E_PRODUCT_SHAPE.
 * @author DBFlute(AutoGenerator)
 */
public class EProductShapeCIQ extends AbstractBsEProductShapeCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEProductShapeCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EProductShapeCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEProductShapeCQ myCQ) {
    ...
    public String keepScalarCondition(EProductShapeCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EProductShapeCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EProductShapeCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EProductShapeCQ sq)
    ...
    protected String xinCB() { return EProductShapeCB.class.getName(); }
    protected String xinCQ() { return EProductShapeCQ.class.getName(); }
}
