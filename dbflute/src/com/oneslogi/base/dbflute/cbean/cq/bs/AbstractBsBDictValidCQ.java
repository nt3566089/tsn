...
/**
 * The abstract condition-query of B_DICT_VALID.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBDictValidCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBDictValidCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<BDictValidCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, BDictValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BDictValidCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, BDictValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BDictValidCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, BDictValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BDictValidCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, BDictValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BDictValidCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, BDictValidCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BDictValidCB&gt;() {
     *     public void query(BDictValidCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BDictValidCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, BDictValidCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        BDictValidCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(BDictValidCQ sq);

    protected BDictValidCB xcreateScalarConditionCB() {
        BDictValidCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected BDictValidCB xcreateScalarConditionPartitionByCB() {
        BDictValidCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<BDictValidCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BDictValidCB cb = new BDictValidCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "DICT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(BDictValidCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<BDictValidCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(BDictValidCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BDictValidCB cb = new BDictValidCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "DICT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(BDictValidCQ sq);
     ...
     */
    public void myselfExists(SubQuery<BDictValidCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BDictValidCB cb = new BDictValidCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(BDictValidCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected BDictValidCB newMyCB() {
        return new BDictValidCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return BDictValidCQ.class.getName(); }
