...
/**
 * The condition-query for in-line of W_HT_SERIAL_RECEIVE_INSP.
 * @author DBFlute(AutoGenerator)
 */
public class WHtSerialReceiveInspCIQ extends AbstractBsWHtSerialReceiveInspCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWHtSerialReceiveInspCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WHtSerialReceiveInspCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWHtSerialReceiveInspCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueHtSerialReceiveInspId() { return _myCQ.xdfgetHtSerialReceiveInspId(); }
    ...
    public String keepScalarCondition(WHtSerialReceiveInspCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(WHtSerialReceiveInspCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(WHtSerialReceiveInspCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(WHtSerialReceiveInspCQ sq)
    ...
    protected String xinCB() { return WHtSerialReceiveInspCB.class.getName(); }
    protected String xinCQ() { return WHtSerialReceiveInspCQ.class.getName(); }
}
