...
/**
 * The condition-query for in-line of T_TRIFDTLTRANS.
 * @author DBFlute(AutoGenerator)
 */
public class TTrifdtltransCIQ extends AbstractBsTTrifdtltransCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTrifdtltransCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTrifdtltransCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTrifdtltransCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTrifdtltransId() { return _myCQ.xdfgetTrifdtltransId(); }
    ...
    protected ConditionValue xgetCValueProductionym() { return _myCQ.xdfgetProductionym(); }
    protected ConditionValue xgetCValueDesigncd() { return _myCQ.xdfgetDesigncd(); }
    protected ConditionValue xgetCValueQano() { return _myCQ.xdfgetQano(); }
    ...
    public String keepScalarCondition(TTrifdtltransCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTrifdtltransCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTrifdtltransCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTrifdtltransCQ sq)
    ...
    protected String xinCB() { return TTrifdtltransCB.class.getName(); }
    protected String xinCQ() { return TTrifdtltransCQ.class.getName(); }
}
