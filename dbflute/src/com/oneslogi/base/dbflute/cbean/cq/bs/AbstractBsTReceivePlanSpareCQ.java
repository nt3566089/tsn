...
/**
 * The abstract condition-query of T_RECEIVE_PLAN_SPARE.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTReceivePlanSpareCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTReceivePlanSpareCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<TReceivePlanSpareCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TReceivePlanSpareCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TReceivePlanSpareCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TReceivePlanSpareCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TReceivePlanSpareCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TReceivePlanSpareCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TReceivePlanSpareCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TReceivePlanSpareCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TReceivePlanSpareCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TReceivePlanSpareCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TReceivePlanSpareCB&gt;() {
     *     public void query(TReceivePlanSpareCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TReceivePlanSpareCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TReceivePlanSpareCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TReceivePlanSpareCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TReceivePlanSpareCQ sq);

    protected TReceivePlanSpareCB xcreateScalarConditionCB() {
        TReceivePlanSpareCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TReceivePlanSpareCB xcreateScalarConditionPartitionByCB() {
        TReceivePlanSpareCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TReceivePlanSpareCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TReceivePlanSpareCB cb = new TReceivePlanSpareCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "RECEIVE_PLAN_B_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TReceivePlanSpareCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TReceivePlanSpareCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TReceivePlanSpareCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TReceivePlanSpareCB cb = new TReceivePlanSpareCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "RECEIVE_PLAN_B_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TReceivePlanSpareCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TReceivePlanSpareCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TReceivePlanSpareCB cb = new TReceivePlanSpareCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TReceivePlanSpareCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TReceivePlanSpareCB newMyCB() {
        return new TReceivePlanSpareCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TReceivePlanSpareCQ.class.getName(); }
