...
/**
 * The condition-query for in-line of T_TRACCEPT.
 * @author DBFlute(AutoGenerator)
 */
public class TTracceptCIQ extends AbstractBsTTracceptCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTracceptCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTracceptCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTracceptCQ myCQ) {
    ...
    protected ConditionValue xgetCValueAccepttype() { return _myCQ.xdfgetAccepttype(); }
    protected ConditionValue xgetCValueAcceptgroup() { return _myCQ.xdfgetAcceptgroup(); }
    ...
    protected ConditionValue xgetCValueCompletetime() { return _myCQ.xdfgetCompletetime(); }
    protected ConditionValue xgetCValueAcceptlinetotal() { return _myCQ.xdfgetAcceptlinetotal(); }
    protected ConditionValue xgetCValueTaglabelprintflg() { return _myCQ.xdfgetTaglabelprintflg(); }
    ...
    public String keepScalarCondition(TTracceptCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTracceptCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTracceptCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTracceptCQ sq)
    ...
    protected String xinCB() { return TTracceptCB.class.getName(); }
    protected String xinCQ() { return TTracceptCQ.class.getName(); }
}
