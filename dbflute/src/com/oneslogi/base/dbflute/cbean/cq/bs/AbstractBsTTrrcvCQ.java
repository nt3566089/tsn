...
/**
 * The abstract condition-query of T_TRRCV.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTTrrcvCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTTrrcvCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * {exists (select RECEIVE_PLAN_H_ID from T_TRRCVDETAIL where ...)} <br>
     * T_TRRCVDETAIL by RECEIVE_PLAN_H_ID, named 'TTrrcvdetailAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsTTrrcvdetailList</span>(trrcvdetailCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     trrcvdetailCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of TTrrcvdetailList for 'exists'. (NotNull)
     */
    public void existsTTrrcvdetailList(SubQuery<TTrrcvdetailCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrrcvdetailCB cb = new TTrrcvdetailCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepReceivePlanHId_ExistsReferrer_TTrrcvdetailList(cb.query());
        registerExistsReferrer(cb.query(), "RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", pp, "tTrrcvdetailList");
    }
    public abstract String keepReceivePlanHId_ExistsReferrer_TTrrcvdetailList(TTrrcvdetailCQ sq);

    /**
     * Set up ExistsReferrer (correlated sub-query). <br>
     * {exists (select RECEIVE_PLAN_H_ID from T_TRRCVEXTEND where ...)} <br>
     * T_TRRCVEXTEND by RECEIVE_PLAN_H_ID, named 'TTrrcvextendAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">existsTTrrcvextendAsOne</span>(trrcvextendCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     trrcvextendCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of TTrrcvextendAsOne for 'exists'. (NotNull)
     */
    public void existsTTrrcvextendAsOne(SubQuery<TTrrcvextendCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrrcvextendCB cb = new TTrrcvextendCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepReceivePlanHId_ExistsReferrer_TTrrcvextendAsOne(cb.query());
        registerExistsReferrer(cb.query(), "RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", pp, "tTrrcvextendAsOne");
    }
    public abstract String keepReceivePlanHId_ExistsReferrer_TTrrcvextendAsOne(TTrrcvextendCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select RECEIVE_PLAN_H_ID from T_TRRCVDETAIL where ...)} <br>
     * T_TRRCVDETAIL by RECEIVE_PLAN_H_ID, named 'TTrrcvdetailAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsTTrrcvdetailList</span>(trrcvdetailCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     trrcvdetailCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ReceivePlanHId_NotExistsReferrer_TTrrcvdetailList for 'not exists'. (NotNull)
     */
    public void notExistsTTrrcvdetailList(SubQuery<TTrrcvdetailCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrrcvdetailCB cb = new TTrrcvdetailCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepReceivePlanHId_NotExistsReferrer_TTrrcvdetailList(cb.query());
        registerNotExistsReferrer(cb.query(), "RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", pp, "tTrrcvdetailList");
    }
    public abstract String keepReceivePlanHId_NotExistsReferrer_TTrrcvdetailList(TTrrcvdetailCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select RECEIVE_PLAN_H_ID from T_TRRCVEXTEND where ...)} <br>
     * T_TRRCVEXTEND by RECEIVE_PLAN_H_ID, named 'TTrrcvextendAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">notExistsTTrrcvextendAsOne</span>(trrcvextendCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     trrcvextendCB.query().set...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of ReceivePlanHId_NotExistsReferrer_TTrrcvextendAsOne for 'not exists'. (NotNull)
     */
    public void notExistsTTrrcvextendAsOne(SubQuery<TTrrcvextendCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrrcvextendCB cb = new TTrrcvextendCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepReceivePlanHId_NotExistsReferrer_TTrrcvextendAsOne(cb.query());
        registerNotExistsReferrer(cb.query(), "RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", pp, "tTrrcvextendAsOne");
    }
    public abstract String keepReceivePlanHId_NotExistsReferrer_TTrrcvextendAsOne(TTrrcvextendCQ sq);

    public void xsderiveTTrrcvdetailList(String fn, SubQuery<TTrrcvdetailCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrrcvdetailCB cb = new TTrrcvdetailCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepReceivePlanHId_SpecifyDerivedReferrer_TTrrcvdetailList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", pp, "tTrrcvdetailList", al, op);
    }
    public abstract String keepReceivePlanHId_SpecifyDerivedReferrer_TTrrcvdetailList(TTrrcvdetailCQ sq);

    /**
     * Prepare for (Query)DerivedReferrer (correlated sub-query). <br>
     * {FOO &lt;= (select max(BAR) from T_TRRCVDETAIL where ...)} <br>
     * T_TRRCVDETAIL by RECEIVE_PLAN_H_ID, named 'TTrrcvdetailAsOne'.
     * <pre>
     * cb.query().<span style="color: #CC4747">derivedTTrrcvdetailList()</span>.<span style="color: #CC4747">max</span>(trrcvdetailCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     trrcvdetailCB.specify().<span style="color: #CC4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *     trrcvdetailCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     * }).<span style="color: #CC4747">greaterEqual</span>(123); <span style="color: #3F7E5E">// condition to derived column</span>
     * </pre>
     * @return The object to set up a function for referrer table. (NotNull)
     */
    public HpQDRFunction<TTrrcvdetailCB> derivedTTrrcvdetailList() {
        return xcreateQDRFunctionTTrrcvdetailList();
    }
    protected HpQDRFunction<TTrrcvdetailCB> xcreateQDRFunctionTTrrcvdetailList() {
        return xcQDRFunc((fn, sq, rd, vl, op) -> xqderiveTTrrcvdetailList(fn, sq, rd, vl, op));
    }
    public void xqderiveTTrrcvdetailList(String fn, SubQuery<TTrrcvdetailCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrrcvdetailCB cb = new TTrrcvdetailCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepReceivePlanHId_QueryDerivedReferrer_TTrrcvdetailList(cb.query()); String prpp = keepReceivePlanHId_QueryDerivedReferrer_TTrrcvdetailListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", sqpp, "tTrrcvdetailList", rd, vl, prpp, op);
    }
    public abstract String keepReceivePlanHId_QueryDerivedReferrer_TTrrcvdetailList(TTrrcvdetailCQ sq);
    public abstract String keepReceivePlanHId_QueryDerivedReferrer_TTrrcvdetailListParameter(Object vl);
     ...
     * @param receiveSts The value of receiveSts as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_Equal(String receiveSts) {
        doSetReceiveSts_Equal(fRES(receiveSts));
    }

    protected void doSetReceiveSts_Equal(String receiveSts) {
        regReceiveSts(CK_EQ, receiveSts);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_NotEqual(String receiveSts) {
        doSetReceiveSts_NotEqual(fRES(receiveSts));
    }

    protected void doSetReceiveSts_NotEqual(String receiveSts) {
        regReceiveSts(CK_NES, receiveSts);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_GreaterThan(String receiveSts) {
        regReceiveSts(CK_GT, fRES(receiveSts));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_LessThan(String receiveSts) {
        regReceiveSts(CK_LT, fRES(receiveSts));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_GreaterEqual(String receiveSts) {
        regReceiveSts(CK_GE, fRES(receiveSts));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_LessEqual(String receiveSts) {
        regReceiveSts(CK_LE, fRES(receiveSts));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveStsList The collection of receiveSts as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_InScope(Collection<String> receiveStsList) {
        doSetReceiveSts_InScope(receiveStsList);
    }

    protected void doSetReceiveSts_InScope(Collection<String> receiveStsList) {
        regINS(CK_INS, cTL(receiveStsList), xgetCValueReceiveSts(), "RECEIVE_STS");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveStsList The collection of receiveSts as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_NotInScope(Collection<String> receiveStsList) {
        doSetReceiveSts_NotInScope(receiveStsList);
    }

    protected void doSetReceiveSts_NotInScope(Collection<String> receiveStsList) {
        regINS(CK_NINS, cTL(receiveStsList), xgetCValueReceiveSts(), "RECEIVE_STS");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)} <br>
     * <pre>e.g. setReceiveSts_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param receiveSts The value of receiveSts as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setReceiveSts_LikeSearch(String receiveSts, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(receiveSts), xgetCValueReceiveSts(), "RECEIVE_STS", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setReceiveSts_NotLikeSearch(String receiveSts, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(receiveSts), xgetCValueReceiveSts(), "RECEIVE_STS", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * RECEIVE_STS: {IX, NotNull, varchar(30)}
     * @param receiveSts The value of receiveSts as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setReceiveSts_PrefixSearch(String receiveSts) {
        setReceiveSts_LikeSearch(receiveSts, xcLSOPPre());
    }

    protected void regReceiveSts(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueReceiveSts(), "RECEIVE_STS"); }
    protected abstract ConditionValue xgetCValueReceiveSts();
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * COMPANYCD: {IX, NotNull, varchar(30)} <br>
    ...
    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * FROMNAME: {NotNull, char(1), default=[0]} <br>
     ...
     */
    public void setProducekey_Equal(java.math.BigDecimal producekey) {
        doSetProducekey_Equal(producekey);
    }

    protected void doSetProducekey_Equal(java.math.BigDecimal producekey) {
     ...
     */
    public void setProducekey_NotEqual(java.math.BigDecimal producekey) {
        doSetProducekey_NotEqual(producekey);
    }

    protected void doSetProducekey_NotEqual(java.math.BigDecimal producekey) {
     ...
     */
    public void setProducekey_GreaterThan(java.math.BigDecimal producekey) {
     ...
     */
    public void setProducekey_LessThan(java.math.BigDecimal producekey) {
     ...
     */
    public void setProducekey_GreaterEqual(java.math.BigDecimal producekey) {
     ...
     */
    public void setProducekey_LessEqual(java.math.BigDecimal producekey) {
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setProducekey_RangeOf(java.math.BigDecimal minNumber, java.math.BigDecimal maxNumber, RangeOfOption rangeOfOption) {
     ...
     */
    public void setProducekey_InScope(Collection<java.math.BigDecimal> producekeyList) {
        doSetProducekey_InScope(producekeyList);
    }

    protected void doSetProducekey_InScope(Collection<java.math.BigDecimal> producekeyList) {
     ...
     */
    public void setProducekey_NotInScope(Collection<java.math.BigDecimal> producekeyList) {
        doSetProducekey_NotInScope(producekeyList);
    }

    protected void doSetProducekey_NotInScope(Collection<java.math.BigDecimal> producekeyList) {
    ...
    protected void doSetFcFlg_InScope(Collection<String> fcFlgList) {
        regINS(CK_INS, cTL(fcFlgList), xgetCValueFcFlg(), "FC_FLG");
    }
    ...
    protected void doSetFcFlg_NotInScope(Collection<String> fcFlgList) {
        regINS(CK_NINS, cTL(fcFlgList), xgetCValueFcFlg(), "FC_FLG");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * FC_FLG: {varchar(30)} <br>
    ...
    public void setFcFlg_LikeSearch(String fcFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(fcFlg), xgetCValueFcFlg(), "FC_FLG", likeSearchOption);
    }
    ...
    public void setFcFlg_NotLikeSearch(String fcFlg, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(fcFlg), xgetCValueFcFlg(), "FC_FLG", likeSearchOption);
    }
    ...
    protected void regFcFlg(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueFcFlg(), "FC_FLG"); }
     ...
     */
    public HpSLCFunction<TTrrcvCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TTrrcvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrrcvCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TTrrcvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrrcvCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TTrrcvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrrcvCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TTrrcvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrrcvCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TTrrcvCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TTrrcvCB&gt;() {
     *     public void query(TTrrcvCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrrcvCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TTrrcvCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrrcvCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TTrrcvCQ sq);

    protected TTrrcvCB xcreateScalarConditionCB() {
        TTrrcvCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TTrrcvCB xcreateScalarConditionPartitionByCB() {
        TTrrcvCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TTrrcvCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrrcvCB cb = new TTrrcvCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "RECEIVE_PLAN_H_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TTrrcvCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TTrrcvCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TTrrcvCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrrcvCB cb = new TTrrcvCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "RECEIVE_PLAN_H_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TTrrcvCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TTrrcvCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrrcvCB cb = new TTrrcvCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TTrrcvCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TTrrcvCB newMyCB() {
        return new TTrrcvCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TTrrcvCQ.class.getName(); }
