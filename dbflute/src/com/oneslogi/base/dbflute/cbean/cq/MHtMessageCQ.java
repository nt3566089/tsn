...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMHtMessageCQ;

/**
 * The condition-query of m_ht_message.
 * <p>
 ...
 */
public class MHtMessageCQ extends BsMHtMessageCQ {
     ...
     */
    public MHtMessageCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
