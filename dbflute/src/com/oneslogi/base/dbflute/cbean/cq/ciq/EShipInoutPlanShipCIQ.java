...
/**
 * The condition-query for in-line of E_SHIP_INOUT_PLAN_SHIP.
 * @author DBFlute(AutoGenerator)
 */
public class EShipInoutPlanShipCIQ extends AbstractBsEShipInoutPlanShipCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEShipInoutPlanShipCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EShipInoutPlanShipCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEShipInoutPlanShipCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueShipInoutPlanShipId() { return _myCQ.xdfgetShipInoutPlanShipId(); }
    ...
    public String keepScalarCondition(EShipInoutPlanShipCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EShipInoutPlanShipCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EShipInoutPlanShipCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EShipInoutPlanShipCQ sq)
    ...
    protected String xinCB() { return EShipInoutPlanShipCB.class.getName(); }
    protected String xinCQ() { return EShipInoutPlanShipCQ.class.getName(); }
}
