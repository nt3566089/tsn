...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEReceiveRecordSendCQ;

/**
 * The condition-query of E_RECEIVE_RECORD_SEND.
 * <p>
 ...
 */
public class EReceiveRecordSendCQ extends BsEReceiveRecordSendCQ {
     ...
     */
    public EReceiveRecordSendCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
