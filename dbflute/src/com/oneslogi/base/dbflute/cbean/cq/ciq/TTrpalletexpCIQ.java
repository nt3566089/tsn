...
/**
 * The condition-query for in-line of T_TRPALLETEXP.
 * @author DBFlute(AutoGenerator)
 */
public class TTrpalletexpCIQ extends AbstractBsTTrpalletexpCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTrpalletexpCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTrpalletexpCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTrpalletexpCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTrpalletexpId() { return _myCQ.xdfgetTrpalletexpId(); }
    ...
    public String keepScalarCondition(TTrpalletexpCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTrpalletexpCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTrpalletexpCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTrpalletexpCQ sq)
    ...
    protected String xinCB() { return TTrpalletexpCB.class.getName(); }
    protected String xinCQ() { return TTrpalletexpCQ.class.getName(); }
}
