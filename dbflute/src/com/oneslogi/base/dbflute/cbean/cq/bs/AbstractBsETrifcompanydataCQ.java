...
/**
 * The abstract condition-query of E_TRIFCOMPANYDATA.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsETrifcompanydataCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsETrifcompanydataCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ETrifcompanydataCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ETrifcompanydataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETrifcompanydataCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ETrifcompanydataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETrifcompanydataCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ETrifcompanydataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETrifcompanydataCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ETrifcompanydataCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETrifcompanydataCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ETrifcompanydataCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ETrifcompanydataCB&gt;() {
     *     public void query(ETrifcompanydataCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETrifcompanydataCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ETrifcompanydataCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ETrifcompanydataCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ETrifcompanydataCQ sq);

    protected ETrifcompanydataCB xcreateScalarConditionCB() {
        ETrifcompanydataCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ETrifcompanydataCB xcreateScalarConditionPartitionByCB() {
        ETrifcompanydataCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ETrifcompanydataCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ETrifcompanydataCB cb = new ETrifcompanydataCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "IFDATAKEY";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ETrifcompanydataCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ETrifcompanydataCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ETrifcompanydataCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ETrifcompanydataCB cb = new ETrifcompanydataCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "IFDATAKEY";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ETrifcompanydataCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ETrifcompanydataCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ETrifcompanydataCB cb = new ETrifcompanydataCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ETrifcompanydataCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ETrifcompanydataCB newMyCB() {
        return new ETrifcompanydataCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ETrifcompanydataCQ.class.getName(); }
