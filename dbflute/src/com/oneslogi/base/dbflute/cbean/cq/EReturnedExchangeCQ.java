...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEReturnedExchangeCQ;

/**
 * The condition-query of E_RETURNED_EXCHANGE.
 * <p>
 ...
 */
public class EReturnedExchangeCQ extends BsEReturnedExchangeCQ {
     ...
     */
    public EReturnedExchangeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
