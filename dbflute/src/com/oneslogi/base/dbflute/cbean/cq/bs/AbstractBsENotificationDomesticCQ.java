...
/**
 * The abstract condition-query of E_NOTIFICATION_DOMESTIC.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsENotificationDomesticCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsENotificationDomesticCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public String asTableDbName() {
        return "E_NOTIFICATION_DOMESTIC";
    }
     ...
     * @param notificationDomesticId The value of notificationDomesticId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_Equal(Long notificationDomesticId) {
        doSetNotificationDomesticId_Equal(notificationDomesticId);
    }

    protected void doSetNotificationDomesticId_Equal(Long notificationDomesticId) {
        regNotificationDomesticId(CK_EQ, notificationDomesticId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticId The value of notificationDomesticId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_NotEqual(Long notificationDomesticId) {
        doSetNotificationDomesticId_NotEqual(notificationDomesticId);
    }

    protected void doSetNotificationDomesticId_NotEqual(Long notificationDomesticId) {
        regNotificationDomesticId(CK_NES, notificationDomesticId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticId The value of notificationDomesticId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_GreaterThan(Long notificationDomesticId) {
        regNotificationDomesticId(CK_GT, notificationDomesticId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticId The value of notificationDomesticId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_LessThan(Long notificationDomesticId) {
        regNotificationDomesticId(CK_LT, notificationDomesticId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticId The value of notificationDomesticId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_GreaterEqual(Long notificationDomesticId) {
        regNotificationDomesticId(CK_GE, notificationDomesticId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticId The value of notificationDomesticId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_LessEqual(Long notificationDomesticId) {
        regNotificationDomesticId(CK_LE, notificationDomesticId);
    }
     ...
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of notificationDomesticId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of notificationDomesticId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setNotificationDomesticId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueNotificationDomesticId(), "NOTIFICATION_DOMESTIC_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticIdList The collection of notificationDomesticId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_InScope(Collection<Long> notificationDomesticIdList) {
        doSetNotificationDomesticId_InScope(notificationDomesticIdList);
    }

    protected void doSetNotificationDomesticId_InScope(Collection<Long> notificationDomesticIdList) {
        regINS(CK_INS, cTL(notificationDomesticIdList), xgetCValueNotificationDomesticId(), "NOTIFICATION_DOMESTIC_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param notificationDomesticIdList The collection of notificationDomesticId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setNotificationDomesticId_NotInScope(Collection<Long> notificationDomesticIdList) {
        doSetNotificationDomesticId_NotInScope(notificationDomesticIdList);
    }

    protected void doSetNotificationDomesticId_NotInScope(Collection<Long> notificationDomesticIdList) {
        regINS(CK_NINS, cTL(notificationDomesticIdList), xgetCValueNotificationDomesticId(), "NOTIFICATION_DOMESTIC_ID");
    }
     ...
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setNotificationDomesticId_IsNull() { regNotificationDomesticId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setNotificationDomesticId_IsNotNull() { regNotificationDomesticId(CK_ISNN, DOBJ); }

    protected void regNotificationDomesticId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueNotificationDomesticId(), "NOTIFICATION_DOMESTIC_ID"); }
    protected abstract ConditionValue xgetCValueNotificationDomesticId();
     ...
     */
    public HpSLCFunction<ENotificationDomesticCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ENotificationDomesticCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ENotificationDomesticCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ENotificationDomesticCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ENotificationDomesticCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ENotificationDomesticCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ENotificationDomesticCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ENotificationDomesticCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ENotificationDomesticCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ENotificationDomesticCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ENotificationDomesticCB&gt;() {
     *     public void query(ENotificationDomesticCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ENotificationDomesticCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ENotificationDomesticCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ENotificationDomesticCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ENotificationDomesticCQ sq);

    protected ENotificationDomesticCB xcreateScalarConditionCB() {
        ENotificationDomesticCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ENotificationDomesticCB xcreateScalarConditionPartitionByCB() {
        ENotificationDomesticCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ENotificationDomesticCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ENotificationDomesticCB cb = new ENotificationDomesticCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "NOTIFICATION_DOMESTIC_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ENotificationDomesticCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ENotificationDomesticCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ENotificationDomesticCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ENotificationDomesticCB cb = new ENotificationDomesticCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "NOTIFICATION_DOMESTIC_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ENotificationDomesticCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ENotificationDomesticCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ENotificationDomesticCB cb = new ENotificationDomesticCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ENotificationDomesticCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ENotificationDomesticCB newMyCB() {
        return new ENotificationDomesticCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ENotificationDomesticCQ.class.getName(); }
