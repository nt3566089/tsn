...
/**
 * The condition-query for in-line of T_TRALLINVHISTORY.
 * @author DBFlute(AutoGenerator)
 */
public class TTrallinvhistoryCIQ extends AbstractBsTTrallinvhistoryCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTrallinvhistoryCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTrallinvhistoryCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTrallinvhistoryCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTrallinvhistoryId() { return _myCQ.xdfgetTrallinvhistoryId(); }
    ...
    public String keepScalarCondition(TTrallinvhistoryCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTrallinvhistoryCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTrallinvhistoryCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTrallinvhistoryCQ sq)
    ...
    protected String xinCB() { return TTrallinvhistoryCB.class.getName(); }
    protected String xinCQ() { return TTrallinvhistoryCQ.class.getName(); }
}
