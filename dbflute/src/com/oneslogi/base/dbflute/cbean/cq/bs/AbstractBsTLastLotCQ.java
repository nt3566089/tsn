...
/**
 * The abstract condition-query of T_LAST_LOT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTLastLotCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTLastLotCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param lastLotId The value of lastLotId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setLastLotId_Equal(Long lastLotId) {
        doSetLastLotId_Equal(lastLotId);
    }

    protected void doSetLastLotId_Equal(Long lastLotId) {
        regLastLotId(CK_EQ, lastLotId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotId The value of lastLotId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setLastLotId_NotEqual(Long lastLotId) {
        doSetLastLotId_NotEqual(lastLotId);
    }

    protected void doSetLastLotId_NotEqual(Long lastLotId) {
        regLastLotId(CK_NES, lastLotId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotId The value of lastLotId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setLastLotId_GreaterThan(Long lastLotId) {
        regLastLotId(CK_GT, lastLotId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotId The value of lastLotId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setLastLotId_LessThan(Long lastLotId) {
        regLastLotId(CK_LT, lastLotId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotId The value of lastLotId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setLastLotId_GreaterEqual(Long lastLotId) {
        regLastLotId(CK_GE, lastLotId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotId The value of lastLotId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setLastLotId_LessEqual(Long lastLotId) {
        regLastLotId(CK_LE, lastLotId);
    }
     ...
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of lastLotId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of lastLotId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setLastLotId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueLastLotId(), "LAST_LOT_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotIdList The collection of lastLotId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setLastLotId_InScope(Collection<Long> lastLotIdList) {
        doSetLastLotId_InScope(lastLotIdList);
    }

    protected void doSetLastLotId_InScope(Collection<Long> lastLotIdList) {
        regINS(CK_INS, cTL(lastLotIdList), xgetCValueLastLotId(), "LAST_LOT_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param lastLotIdList The collection of lastLotId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setLastLotId_NotInScope(Collection<Long> lastLotIdList) {
        doSetLastLotId_NotInScope(lastLotIdList);
    }

    protected void doSetLastLotId_NotInScope(Collection<Long> lastLotIdList) {
        regINS(CK_NINS, cTL(lastLotIdList), xgetCValueLastLotId(), "LAST_LOT_ID");
    }
     ...
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setLastLotId_IsNull() { regLastLotId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setLastLotId_IsNotNull() { regLastLotId(CK_ISNN, DOBJ); }

    protected void regLastLotId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueLastLotId(), "LAST_LOT_ID"); }
    protected abstract ConditionValue xgetCValueLastLotId();
     ...
     */
    public HpSLCFunction<TLastLotCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TLastLotCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TLastLotCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TLastLotCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TLastLotCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TLastLotCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TLastLotCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TLastLotCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TLastLotCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TLastLotCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TLastLotCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TLastLotCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TLastLotCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TLastLotCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TLastLotCQ sq);

    protected TLastLotCB xcreateScalarConditionCB() {
        TLastLotCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TLastLotCB xcreateScalarConditionPartitionByCB() {
        TLastLotCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TLastLotCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TLastLotCB cb = new TLastLotCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "LAST_LOT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TLastLotCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TLastLotCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TLastLotCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TLastLotCB cb = new TLastLotCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "LAST_LOT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TLastLotCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TLastLotCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TLastLotCB cb = new TLastLotCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TLastLotCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TLastLotCB newMyCB() {
        return new TLastLotCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TLastLotCQ.class.getName(); }
