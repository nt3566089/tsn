...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsWShippingInterruptCQ;

/**
 * The condition-query of w_shipping_interrupt.
 * <p>
 ...
 */
public class WShippingInterruptCQ extends BsWShippingInterruptCQ {
     ...
     */
    public WShippingInterruptCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
