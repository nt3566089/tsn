...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsWWkcutlocmoveCQ;

/**
 * The condition-query of W_WKCUTLOCMOVE.
 * <p>
 ...
 */
public class WWkcutlocmoveCQ extends BsWWkcutlocmoveCQ {
     ...
     */
    public WWkcutlocmoveCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
