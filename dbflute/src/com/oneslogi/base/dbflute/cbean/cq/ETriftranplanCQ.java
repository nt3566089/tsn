...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsETriftranplanCQ;

/**
 * The condition-query of E_TRIFTRANPLAN.
 * <p>
 ...
 */
public class ETriftranplanCQ extends BsETriftranplanCQ {
     ...
     */
    public ETriftranplanCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
