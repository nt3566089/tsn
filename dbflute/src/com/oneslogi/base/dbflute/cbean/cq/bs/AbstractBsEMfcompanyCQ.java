...
/**
 * The abstract condition-query of E_MFCOMPANY.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEMfcompanyCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEMfcompanyCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param mfcompanyId The value of mfcompanyId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setMfcompanyId_Equal(Long mfcompanyId) {
        doSetMfcompanyId_Equal(mfcompanyId);
    }

    protected void doSetMfcompanyId_Equal(Long mfcompanyId) {
        regMfcompanyId(CK_EQ, mfcompanyId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyId The value of mfcompanyId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMfcompanyId_NotEqual(Long mfcompanyId) {
        doSetMfcompanyId_NotEqual(mfcompanyId);
    }

    protected void doSetMfcompanyId_NotEqual(Long mfcompanyId) {
        regMfcompanyId(CK_NES, mfcompanyId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyId The value of mfcompanyId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMfcompanyId_GreaterThan(Long mfcompanyId) {
        regMfcompanyId(CK_GT, mfcompanyId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyId The value of mfcompanyId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setMfcompanyId_LessThan(Long mfcompanyId) {
        regMfcompanyId(CK_LT, mfcompanyId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyId The value of mfcompanyId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMfcompanyId_GreaterEqual(Long mfcompanyId) {
        regMfcompanyId(CK_GE, mfcompanyId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyId The value of mfcompanyId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setMfcompanyId_LessEqual(Long mfcompanyId) {
        regMfcompanyId(CK_LE, mfcompanyId);
    }
     ...
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of mfcompanyId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of mfcompanyId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setMfcompanyId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueMfcompanyId(), "MFCOMPANY_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyIdList The collection of mfcompanyId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMfcompanyId_InScope(Collection<Long> mfcompanyIdList) {
        doSetMfcompanyId_InScope(mfcompanyIdList);
    }

    protected void doSetMfcompanyId_InScope(Collection<Long> mfcompanyIdList) {
        regINS(CK_INS, cTL(mfcompanyIdList), xgetCValueMfcompanyId(), "MFCOMPANY_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param mfcompanyIdList The collection of mfcompanyId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setMfcompanyId_NotInScope(Collection<Long> mfcompanyIdList) {
        doSetMfcompanyId_NotInScope(mfcompanyIdList);
    }

    protected void doSetMfcompanyId_NotInScope(Collection<Long> mfcompanyIdList) {
        regINS(CK_NINS, cTL(mfcompanyIdList), xgetCValueMfcompanyId(), "MFCOMPANY_ID");
    }
     ...
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setMfcompanyId_IsNull() { regMfcompanyId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * MFCOMPANY_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setMfcompanyId_IsNotNull() { regMfcompanyId(CK_ISNN, DOBJ); }

    protected void regMfcompanyId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueMfcompanyId(), "MFCOMPANY_ID"); }
    protected abstract ConditionValue xgetCValueMfcompanyId();

    /**
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param receiveCd The value of receiveCd as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveCd_Equal(Long receiveCd) {
        doSetReceiveCd_Equal(receiveCd);
    }

    protected void doSetReceiveCd_Equal(Long receiveCd) {
     ...
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param receiveCd The value of receiveCd as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveCd_NotEqual(Long receiveCd) {
        doSetReceiveCd_NotEqual(receiveCd);
    }

    protected void doSetReceiveCd_NotEqual(Long receiveCd) {
     ...
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param receiveCd The value of receiveCd as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveCd_GreaterThan(Long receiveCd) {
        regReceiveCd(CK_GT, receiveCd);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param receiveCd The value of receiveCd as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveCd_LessThan(Long receiveCd) {
        regReceiveCd(CK_LT, receiveCd);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param receiveCd The value of receiveCd as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveCd_GreaterEqual(Long receiveCd) {
        regReceiveCd(CK_GE, receiveCd);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param receiveCd The value of receiveCd as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setReceiveCd_LessEqual(Long receiveCd) {
        regReceiveCd(CK_LE, receiveCd);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * RECEIVE_CD: {NotNull, bigint(19)}
     * @param minNumber The min number of receiveCd. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of receiveCd. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setReceiveCd_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueReceiveCd(), "RECEIVE_CD", rangeOfOption);
    }
     ...
     */
    public void setReceiveCd_InScope(Collection<Long> receiveCdList) {
        doSetReceiveCd_InScope(receiveCdList);
    }

    protected void doSetReceiveCd_InScope(Collection<Long> receiveCdList) {
     ...
     */
    public void setReceiveCd_NotInScope(Collection<Long> receiveCdList) {
        doSetReceiveCd_NotInScope(receiveCdList);
    }

    protected void doSetReceiveCd_NotInScope(Collection<Long> receiveCdList) {
     ...
     * Equal(=). And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param stmid The value of stmid as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setStmid_Equal(Long stmid) {
        doSetStmid_Equal(stmid);
    }

    protected void doSetStmid_Equal(Long stmid) {
     ...
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param stmid The value of stmid as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setStmid_NotEqual(Long stmid) {
        doSetStmid_NotEqual(stmid);
    }

    protected void doSetStmid_NotEqual(Long stmid) {
     ...
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param stmid The value of stmid as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setStmid_GreaterThan(Long stmid) {
        regStmid(CK_GT, stmid);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param stmid The value of stmid as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setStmid_LessThan(Long stmid) {
        regStmid(CK_LT, stmid);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param stmid The value of stmid as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setStmid_GreaterEqual(Long stmid) {
        regStmid(CK_GE, stmid);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param stmid The value of stmid as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setStmid_LessEqual(Long stmid) {
        regStmid(CK_LE, stmid);
    }
     ...
     * And NullIgnored, OnlyOnceRegistered. <br>
     * STMID: {bigint(19)}
     * @param minNumber The min number of stmid. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of stmid. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setStmid_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueStmid(), "STMID", rangeOfOption);
    }
     ...
     */
    public void setStmid_InScope(Collection<Long> stmidList) {
        doSetStmid_InScope(stmidList);
    }

    protected void doSetStmid_InScope(Collection<Long> stmidList) {
     ...
     */
    public void setStmid_NotInScope(Collection<Long> stmidList) {
        doSetStmid_NotInScope(stmidList);
    }

    protected void doSetStmid_NotInScope(Collection<Long> stmidList) {
     ...
     */
    public HpSLCFunction<EMfcompanyCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EMfcompanyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EMfcompanyCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EMfcompanyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EMfcompanyCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EMfcompanyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EMfcompanyCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EMfcompanyCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EMfcompanyCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EMfcompanyCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EMfcompanyCB&gt;() {
     *     public void query(EMfcompanyCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EMfcompanyCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EMfcompanyCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EMfcompanyCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EMfcompanyCQ sq);

    protected EMfcompanyCB xcreateScalarConditionCB() {
        EMfcompanyCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EMfcompanyCB xcreateScalarConditionPartitionByCB() {
        EMfcompanyCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EMfcompanyCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EMfcompanyCB cb = new EMfcompanyCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "MFCOMPANY_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EMfcompanyCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EMfcompanyCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EMfcompanyCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EMfcompanyCB cb = new EMfcompanyCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "MFCOMPANY_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EMfcompanyCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EMfcompanyCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EMfcompanyCB cb = new EMfcompanyCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EMfcompanyCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EMfcompanyCB newMyCB() {
        return new EMfcompanyCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EMfcompanyCQ.class.getName(); }
