...
/**
 * The condition-query for in-line of E_USER.
 * @author DBFlute(AutoGenerator)
 */
public class EUserCIQ extends AbstractBsEUserCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEUserCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EUserCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEUserCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueReceiveLoginInfoId() { return _myCQ.xdfgetReceiveLoginInfoId(); }
    ...
    public String keepScalarCondition(EUserCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EUserCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EUserCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EUserCQ sq)
    ...
    protected String xinCB() { return EUserCB.class.getName(); }
    protected String xinCQ() { return EUserCQ.class.getName(); }
}
