...
/**
 * The condition-query for in-line of E_NOTIFICATION_DOMESTIC.
 * @author DBFlute(AutoGenerator)
 */
public class ENotificationDomesticCIQ extends AbstractBsENotificationDomesticCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsENotificationDomesticCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ENotificationDomesticCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsENotificationDomesticCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueNotificationDomesticId() { return _myCQ.xdfgetNotificationDomesticId(); }
    ...
    public String keepScalarCondition(ENotificationDomesticCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ENotificationDomesticCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ENotificationDomesticCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ENotificationDomesticCQ sq)
    ...
    protected String xinCB() { return ENotificationDomesticCB.class.getName(); }
    protected String xinCQ() { return ENotificationDomesticCQ.class.getName(); }
}
