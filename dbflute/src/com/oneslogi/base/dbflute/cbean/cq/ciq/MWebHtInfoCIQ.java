...
/**
 * The condition-query for in-line of M_WEB_HT_INFO.
 * @author DBFlute(AutoGenerator)
 */
public class MWebHtInfoCIQ extends AbstractBsMWebHtInfoCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsMWebHtInfoCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MWebHtInfoCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMWebHtInfoCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueWebHtInfoId() { return _myCQ.xdfgetWebHtInfoId(); }
    ...
    public String keepScalarCondition(MWebHtInfoCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MWebHtInfoCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MWebHtInfoCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MWebHtInfoCQ sq)
    ...
    protected String xinCB() { return MWebHtInfoCB.class.getName(); }
    protected String xinCQ() { return MWebHtInfoCQ.class.getName(); }
}
