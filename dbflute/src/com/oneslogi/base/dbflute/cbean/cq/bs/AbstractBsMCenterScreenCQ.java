...
/**
 * The abstract condition-query of M_CENTER_SCREEN.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMCenterScreenCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMCenterScreenCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param centerScreenId The value of centerScreenId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterScreenId_Equal(Long centerScreenId) {
        doSetCenterScreenId_Equal(centerScreenId);
    }

    protected void doSetCenterScreenId_Equal(Long centerScreenId) {
        regCenterScreenId(CK_EQ, centerScreenId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenId The value of centerScreenId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterScreenId_NotEqual(Long centerScreenId) {
        doSetCenterScreenId_NotEqual(centerScreenId);
    }

    protected void doSetCenterScreenId_NotEqual(Long centerScreenId) {
        regCenterScreenId(CK_NES, centerScreenId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenId The value of centerScreenId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterScreenId_GreaterThan(Long centerScreenId) {
        regCenterScreenId(CK_GT, centerScreenId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenId The value of centerScreenId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterScreenId_LessThan(Long centerScreenId) {
        regCenterScreenId(CK_LT, centerScreenId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenId The value of centerScreenId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterScreenId_GreaterEqual(Long centerScreenId) {
        regCenterScreenId(CK_GE, centerScreenId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenId The value of centerScreenId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterScreenId_LessEqual(Long centerScreenId) {
        regCenterScreenId(CK_LE, centerScreenId);
    }
     ...
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of centerScreenId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of centerScreenId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setCenterScreenId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueCenterScreenId(), "CENTER_SCREEN_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenIdList The collection of centerScreenId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCenterScreenId_InScope(Collection<Long> centerScreenIdList) {
        doSetCenterScreenId_InScope(centerScreenIdList);
    }

    protected void doSetCenterScreenId_InScope(Collection<Long> centerScreenIdList) {
        regINS(CK_INS, cTL(centerScreenIdList), xgetCValueCenterScreenId(), "CENTER_SCREEN_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerScreenIdList The collection of centerScreenId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCenterScreenId_NotInScope(Collection<Long> centerScreenIdList) {
        doSetCenterScreenId_NotInScope(centerScreenIdList);
    }

    protected void doSetCenterScreenId_NotInScope(Collection<Long> centerScreenIdList) {
        regINS(CK_NINS, cTL(centerScreenIdList), xgetCValueCenterScreenId(), "CENTER_SCREEN_ID");
    }
     ...
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setCenterScreenId_IsNull() { regCenterScreenId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setCenterScreenId_IsNotNull() { regCenterScreenId(CK_ISNN, DOBJ); }

    protected void regCenterScreenId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCenterScreenId(), "CENTER_SCREEN_ID"); }
    protected abstract ConditionValue xgetCValueCenterScreenId();
     ...
     */
    public HpSLCFunction<MCenterScreenCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, MCenterScreenCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterScreenCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, MCenterScreenCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterScreenCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, MCenterScreenCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterScreenCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, MCenterScreenCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterScreenCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, MCenterScreenCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MCenterScreenCB&gt;() {
     *     public void query(MCenterScreenCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterScreenCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, MCenterScreenCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterScreenCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(MCenterScreenCQ sq);

    protected MCenterScreenCB xcreateScalarConditionCB() {
        MCenterScreenCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MCenterScreenCB xcreateScalarConditionPartitionByCB() {
        MCenterScreenCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MCenterScreenCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterScreenCB cb = new MCenterScreenCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CENTER_SCREEN_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MCenterScreenCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MCenterScreenCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MCenterScreenCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterScreenCB cb = new MCenterScreenCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CENTER_SCREEN_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MCenterScreenCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MCenterScreenCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MCenterScreenCB cb = new MCenterScreenCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MCenterScreenCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MCenterScreenCB newMyCB() {
        return new MCenterScreenCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return MCenterScreenCQ.class.getName(); }
