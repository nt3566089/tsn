...
/**
 * The condition-query for in-line of H_STOCK_REPORT.
 * @author DBFlute(AutoGenerator)
 */
public class HStockReportCIQ extends AbstractBsHStockReportCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsHStockReportCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public HStockReportCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsHStockReportCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueStockReportId() { return _myCQ.xdfgetStockReportId(); }
    ...
    public String keepScalarCondition(HStockReportCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(HStockReportCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(HStockReportCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(HStockReportCQ sq)
    ...
    protected String xinCB() { return HStockReportCB.class.getName(); }
    protected String xinCQ() { return HStockReportCQ.class.getName(); }
}
