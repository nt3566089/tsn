...
/**
 * The condition-query for in-line of P_REPORT_LAYOUT_ITEM.
 * @author DBFlute(AutoGenerator)
 */
public class PReportLayoutItemCIQ extends AbstractBsPReportLayoutItemCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsPReportLayoutItemCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public PReportLayoutItemCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsPReportLayoutItemCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueReportLayoutItemId() { return _myCQ.xdfgetReportLayoutItemId(); }
    ...
    public String keepScalarCondition(PReportLayoutItemCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(PReportLayoutItemCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(PReportLayoutItemCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(PReportLayoutItemCQ sq)
    ...
    protected String xinCB() { return PReportLayoutItemCB.class.getName(); }
    protected String xinCQ() { return PReportLayoutItemCQ.class.getName(); }
}
