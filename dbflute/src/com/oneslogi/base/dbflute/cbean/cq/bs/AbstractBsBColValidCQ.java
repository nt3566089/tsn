...
/**
 * The abstract condition-query of B_COL_VALID.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBColValidCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBColValidCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<BColValidCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, BColValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColValidCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, BColValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColValidCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, BColValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColValidCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, BColValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColValidCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, BColValidCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BColValidCB&gt;() {
     *     public void query(BColValidCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColValidCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, BColValidCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        BColValidCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(BColValidCQ sq);

    protected BColValidCB xcreateScalarConditionCB() {
        BColValidCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected BColValidCB xcreateScalarConditionPartitionByCB() {
        BColValidCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<BColValidCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BColValidCB cb = new BColValidCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "COL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(BColValidCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<BColValidCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(BColValidCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BColValidCB cb = new BColValidCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "COL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(BColValidCQ sq);
     ...
     */
    public void myselfExists(SubQuery<BColValidCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BColValidCB cb = new BColValidCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(BColValidCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected BColValidCB newMyCB() {
        return new BColValidCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return BColValidCQ.class.getName(); }
