...
/**
 * The condition-query for in-line of T_TRPALLETSYMBOL.
 * @author DBFlute(AutoGenerator)
 */
public class TTrpalletsymbolCIQ extends AbstractBsTTrpalletsymbolCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTrpalletsymbolCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTrpalletsymbolCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTrpalletsymbolCQ myCQ) {
    ...
    protected ConditionValue xgetCValuePalletsymbolprintflg() { return _myCQ.xdfgetPalletsymbolprintflg(); }
    ...
    public String keepScalarCondition(TTrpalletsymbolCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTrpalletsymbolCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTrpalletsymbolCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTrpalletsymbolCQ sq)
    ...
    protected String xinCB() { return TTrpalletsymbolCB.class.getName(); }
    protected String xinCQ() { return TTrpalletsymbolCQ.class.getName(); }
}
