...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMHtDictCQ;

/**
 * The condition-query of m_ht_dict.
 * <p>
 ...
 */
public class MHtDictCQ extends BsMHtDictCQ {
     ...
     */
    public MHtDictCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
