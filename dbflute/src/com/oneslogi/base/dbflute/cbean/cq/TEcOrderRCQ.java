...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTEcOrderRCQ;

/**
 * The condition-query of t_ec_order_r.
 * <p>
 ...
 */
public class TEcOrderRCQ extends BsTEcOrderRCQ {
     ...
     */
    public TEcOrderRCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
