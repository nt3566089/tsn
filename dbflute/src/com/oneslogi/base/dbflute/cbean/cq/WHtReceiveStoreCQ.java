...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsWHtReceiveStoreCQ;

/**
 * The condition-query of w_ht_receive_store.
 * <p>
 ...
 */
public class WHtReceiveStoreCQ extends BsWHtReceiveStoreCQ {
     ...
     */
    public WHtReceiveStoreCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
