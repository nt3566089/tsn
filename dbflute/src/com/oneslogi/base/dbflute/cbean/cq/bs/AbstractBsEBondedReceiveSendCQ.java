...
/**
 * The abstract condition-query of E_BONDED_RECEIVE_SEND.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEBondedReceiveSendCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEBondedReceiveSendCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<EBondedReceiveSendCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EBondedReceiveSendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EBondedReceiveSendCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EBondedReceiveSendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EBondedReceiveSendCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EBondedReceiveSendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EBondedReceiveSendCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EBondedReceiveSendCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EBondedReceiveSendCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EBondedReceiveSendCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EBondedReceiveSendCB&gt;() {
     *     public void query(EBondedReceiveSendCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EBondedReceiveSendCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EBondedReceiveSendCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EBondedReceiveSendCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EBondedReceiveSendCQ sq);

    protected EBondedReceiveSendCB xcreateScalarConditionCB() {
        EBondedReceiveSendCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EBondedReceiveSendCB xcreateScalarConditionPartitionByCB() {
        EBondedReceiveSendCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EBondedReceiveSendCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EBondedReceiveSendCB cb = new EBondedReceiveSendCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "BONDED_RECEIVE_RECORD_SEND_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EBondedReceiveSendCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EBondedReceiveSendCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EBondedReceiveSendCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EBondedReceiveSendCB cb = new EBondedReceiveSendCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "BONDED_RECEIVE_RECORD_SEND_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EBondedReceiveSendCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EBondedReceiveSendCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EBondedReceiveSendCB cb = new EBondedReceiveSendCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EBondedReceiveSendCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EBondedReceiveSendCB newMyCB() {
        return new EBondedReceiveSendCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EBondedReceiveSendCQ.class.getName(); }
