...
/**
 * The condition-query for in-line of T_LAST_LOT.
 * @author DBFlute(AutoGenerator)
 */
public class TLastLotCIQ extends AbstractBsTLastLotCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTLastLotCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TLastLotCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTLastLotCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueLastLotId() { return _myCQ.xdfgetLastLotId(); }
    ...
    public String keepScalarCondition(TLastLotCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TLastLotCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TLastLotCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TLastLotCQ sq)
    ...
    protected String xinCB() { return TLastLotCB.class.getName(); }
    protected String xinCQ() { return TLastLotCQ.class.getName(); }
}
