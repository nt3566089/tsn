...
/**
 * The condition-query for in-line of P_USER_AUTO_PRINT_SETTING.
 * @author DBFlute(AutoGenerator)
 */
public class PUserAutoPrintSettingCIQ extends AbstractBsPUserAutoPrintSettingCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsPUserAutoPrintSettingCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public PUserAutoPrintSettingCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsPUserAutoPrintSettingCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueUserAutoPrintSettingId() { return _myCQ.xdfgetUserAutoPrintSettingId(); }
    ...
    public String keepScalarCondition(PUserAutoPrintSettingCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(PUserAutoPrintSettingCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(PUserAutoPrintSettingCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(PUserAutoPrintSettingCQ sq)
    ...
    protected String xinCB() { return PUserAutoPrintSettingCB.class.getName(); }
    protected String xinCQ() { return PUserAutoPrintSettingCQ.class.getName(); }
}
