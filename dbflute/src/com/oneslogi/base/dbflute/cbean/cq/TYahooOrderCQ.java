...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTYahooOrderCQ;

/**
 * The condition-query of t_yahoo_order.
 * <p>
 ...
 */
public class TYahooOrderCQ extends BsTYahooOrderCQ {
     ...
     */
    public TYahooOrderCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
