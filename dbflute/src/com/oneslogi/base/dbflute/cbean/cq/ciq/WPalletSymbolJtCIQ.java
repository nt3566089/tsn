...
/**
 * The condition-query for in-line of W_PALLET_SYMBOL_JT.
 * @author DBFlute(AutoGenerator)
 */
public class WPalletSymbolJtCIQ extends AbstractBsWPalletSymbolJtCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsWPalletSymbolJtCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public WPalletSymbolJtCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsWPalletSymbolJtCQ myCQ) {
    ...
    public String keepScalarCondition(WPalletSymbolJtCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(WPalletSymbolJtCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(WPalletSymbolJtCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(WPalletSymbolJtCQ sq)
    ...
    protected String xinCB() { return WPalletSymbolJtCB.class.getName(); }
    protected String xinCQ() { return WPalletSymbolJtCQ.class.getName(); }
}
