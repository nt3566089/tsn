...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrrcvplanCQ;

/**
 * The condition-query of T_TRRCVPLAN.
 * <p>
 ...
 */
public class TTrrcvplanCQ extends BsTTrrcvplanCQ {
     ...
     */
    public TTrrcvplanCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
