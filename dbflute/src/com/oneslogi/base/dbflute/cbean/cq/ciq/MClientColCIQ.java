...
/**
 * The condition-query for in-line of M_CLIENT_COL.
 * @author DBFlute(AutoGenerator)
 */
public class MClientColCIQ extends AbstractBsMClientColCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsMClientColCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MClientColCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMClientColCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueClientColId() { return _myCQ.xdfgetClientColId(); }
    ...
    public String keepScalarCondition(MClientColCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MClientColCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MClientColCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MClientColCQ sq)
    ...
    protected String xinCB() { return MClientColCB.class.getName(); }
    protected String xinCQ() { return MClientColCQ.class.getName(); }
}
