...
/**
 * The condition-query for in-line of T_CORDDTAEC.
 * @author DBFlute(AutoGenerator)
 */
public class TCorddtaecCIQ extends AbstractBsTCorddtaecCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTCorddtaecCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TCorddtaecCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTCorddtaecCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueOrderChangeId() { return _myCQ.xdfgetOrderChangeId(); }
    ...
    public String keepScalarCondition(TCorddtaecCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TCorddtaecCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TCorddtaecCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TCorddtaecCQ sq)
    ...
    protected String xinCB() { return TCorddtaecCB.class.getName(); }
    protected String xinCQ() { return TCorddtaecCQ.class.getName(); }
}
