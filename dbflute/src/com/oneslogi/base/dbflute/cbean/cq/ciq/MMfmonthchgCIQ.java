...
/**
 * The condition-query for in-line of M_MFMONTHCHG.
 * @author DBFlute(AutoGenerator)
 */
public class MMfmonthchgCIQ extends AbstractBsMMfmonthchgCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsMMfmonthchgCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MMfmonthchgCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMMfmonthchgCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueMfmonthchgId() { return _myCQ.xdfgetMfmonthchgId(); }
    ...
    protected ConditionValue xgetCValuePicklisttype() { return _myCQ.xdfgetPicklisttype(); }
    ...
    public String keepScalarCondition(MMfmonthchgCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MMfmonthchgCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MMfmonthchgCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MMfmonthchgCQ sq)
    ...
    protected String xinCB() { return MMfmonthchgCB.class.getName(); }
    protected String xinCQ() { return MMfmonthchgCQ.class.getName(); }
}
