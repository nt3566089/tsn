...
/**
 * The abstract condition-query of E_CRELAYBS.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsECrelaybsCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsECrelaybsCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<ECrelaybsCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ECrelaybsCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECrelaybsCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ECrelaybsCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECrelaybsCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ECrelaybsCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECrelaybsCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ECrelaybsCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECrelaybsCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ECrelaybsCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ECrelaybsCB&gt;() {
     *     public void query(ECrelaybsCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECrelaybsCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ECrelaybsCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ECrelaybsCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ECrelaybsCQ sq);

    protected ECrelaybsCB xcreateScalarConditionCB() {
        ECrelaybsCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ECrelaybsCB xcreateScalarConditionPartitionByCB() {
        ECrelaybsCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ECrelaybsCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ECrelaybsCB cb = new ECrelaybsCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CRELAYBS_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ECrelaybsCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ECrelaybsCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ECrelaybsCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ECrelaybsCB cb = new ECrelaybsCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CRELAYBS_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ECrelaybsCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ECrelaybsCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ECrelaybsCB cb = new ECrelaybsCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ECrelaybsCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ECrelaybsCB newMyCB() {
        return new ECrelaybsCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ECrelaybsCQ.class.getName(); }
