...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsHReceiveSpareCQ;

/**
 * The condition-query of h_receive_spare.
 * <p>
 ...
 */
public class HReceiveSpareCQ extends BsHReceiveSpareCQ {
     ...
     */
    public HReceiveSpareCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
