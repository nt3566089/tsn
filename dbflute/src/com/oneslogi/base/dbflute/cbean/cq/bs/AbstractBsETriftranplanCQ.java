...
/**
 * The abstract condition-query of E_TRIFTRANPLAN.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsETriftranplanCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsETriftranplanCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param ujtype The value of ujtype as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_Equal(String ujtype) {
        doSetUjtype_Equal(fRES(ujtype));
    }

    protected void doSetUjtype_Equal(String ujtype) {
        regUjtype(CK_EQ, ujtype);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_NotEqual(String ujtype) {
        doSetUjtype_NotEqual(fRES(ujtype));
    }

    protected void doSetUjtype_NotEqual(String ujtype) {
        regUjtype(CK_NES, ujtype);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_GreaterThan(String ujtype) {
        regUjtype(CK_GT, fRES(ujtype));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_LessThan(String ujtype) {
        regUjtype(CK_LT, fRES(ujtype));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_GreaterEqual(String ujtype) {
        regUjtype(CK_GE, fRES(ujtype));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_LessEqual(String ujtype) {
        regUjtype(CK_LE, fRES(ujtype));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtypeList The collection of ujtype as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_InScope(Collection<String> ujtypeList) {
        doSetUjtype_InScope(ujtypeList);
    }

    protected void doSetUjtype_InScope(Collection<String> ujtypeList) {
        regINS(CK_INS, cTL(ujtypeList), xgetCValueUjtype(), "UJTYPE");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtypeList The collection of ujtype as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_NotInScope(Collection<String> ujtypeList) {
        doSetUjtype_NotInScope(ujtypeList);
    }

    protected void doSetUjtype_NotInScope(Collection<String> ujtypeList) {
        regINS(CK_NINS, cTL(ujtypeList), xgetCValueUjtype(), "UJTYPE");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)} <br>
     * <pre>e.g. setUjtype_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param ujtype The value of ujtype as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setUjtype_LikeSearch(String ujtype, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(ujtype), xgetCValueUjtype(), "UJTYPE", likeSearchOption);
    }
     ...
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setUjtype_NotLikeSearch(String ujtype, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(ujtype), xgetCValueUjtype(), "UJTYPE", likeSearchOption);
    }

    /**
     * PrefixSearch {like 'xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     * @param ujtype The value of ujtype as prefixSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setUjtype_PrefixSearch(String ujtype) {
        setUjtype_LikeSearch(ujtype, xcLSOPPre());
    }
     ...
     * UJTYPE: {PK, NotNull, char(1)}
     */
    public void setUjtype_IsNull() { regUjtype(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * UJTYPE: {PK, NotNull, char(1)}
     */
    public void setUjtype_IsNotNull() { regUjtype(CK_ISNN, DOBJ); }

    protected void regUjtype(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueUjtype(), "UJTYPE"); }
    protected abstract ConditionValue xgetCValueUjtype();
     ...
     */
    public HpSLCFunction<ETriftranplanCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ETriftranplanCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETriftranplanCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ETriftranplanCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETriftranplanCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ETriftranplanCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETriftranplanCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ETriftranplanCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETriftranplanCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ETriftranplanCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ETriftranplanCB&gt;() {
     *     public void query(ETriftranplanCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ETriftranplanCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ETriftranplanCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ETriftranplanCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ETriftranplanCQ sq);

    protected ETriftranplanCB xcreateScalarConditionCB() {
        ETriftranplanCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ETriftranplanCB xcreateScalarConditionPartitionByCB() {
        ETriftranplanCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ETriftranplanCB newMyCB() {
        return new ETriftranplanCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ETriftranplanCQ.class.getName(); }
