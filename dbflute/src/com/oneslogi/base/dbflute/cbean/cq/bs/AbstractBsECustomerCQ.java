...
/**
 * The abstract condition-query of E_CUSTOMER.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsECustomerCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsECustomerCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected void doSetDeliveryReadtime_InScope(Collection<String> deliveryReadtimeList) {
        regINS(CK_INS, cTL(deliveryReadtimeList), xgetCValueDeliveryReadtime(), "DELIVERY_READTIME");
    }
    ...
    protected void doSetDeliveryReadtime_NotInScope(Collection<String> deliveryReadtimeList) {
        regINS(CK_NINS, cTL(deliveryReadtimeList), xgetCValueDeliveryReadtime(), "DELIVERY_READTIME");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * DELIVERY_READTIME: {varchar(255)} <br>
    ...
    public void setDeliveryReadtime_LikeSearch(String deliveryReadtime, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(deliveryReadtime), xgetCValueDeliveryReadtime(), "DELIVERY_READTIME", likeSearchOption);
    }
    ...
    public void setDeliveryReadtime_NotLikeSearch(String deliveryReadtime, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(deliveryReadtime), xgetCValueDeliveryReadtime(), "DELIVERY_READTIME", likeSearchOption);
    }
    ...
    protected void regDeliveryReadtime(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueDeliveryReadtime(), "DELIVERY_READTIME"); }
     ...
     */
    public HpSLCFunction<ECustomerCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, ECustomerCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECustomerCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, ECustomerCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECustomerCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, ECustomerCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECustomerCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, ECustomerCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECustomerCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, ECustomerCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ECustomerCB&gt;() {
     *     public void query(ECustomerCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<ECustomerCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, ECustomerCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        ECustomerCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(ECustomerCQ sq);

    protected ECustomerCB xcreateScalarConditionCB() {
        ECustomerCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected ECustomerCB xcreateScalarConditionPartitionByCB() {
        ECustomerCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<ECustomerCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ECustomerCB cb = new ECustomerCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CUSTOMER_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(ECustomerCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ECustomerCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(ECustomerCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        ECustomerCB cb = new ECustomerCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CUSTOMER_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(ECustomerCQ sq);
     ...
     */
    public void myselfExists(SubQuery<ECustomerCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        ECustomerCB cb = new ECustomerCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(ECustomerCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected ECustomerCB newMyCB() {
        return new ECustomerCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return ECustomerCQ.class.getName(); }
