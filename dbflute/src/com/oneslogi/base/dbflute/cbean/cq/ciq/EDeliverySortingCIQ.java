...
/**
 * The condition-query for in-line of E_DELIVERY_SORTING.
 * @author DBFlute(AutoGenerator)
 */
public class EDeliverySortingCIQ extends AbstractBsEDeliverySortingCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEDeliverySortingCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EDeliverySortingCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEDeliverySortingCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueDeliverySortingId() { return _myCQ.xdfgetDeliverySortingId(); }
    ...
    public String keepScalarCondition(EDeliverySortingCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(EDeliverySortingCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(EDeliverySortingCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(EDeliverySortingCQ sq)
    ...
    protected String xinCB() { return EDeliverySortingCB.class.getName(); }
    protected String xinCQ() { return EDeliverySortingCQ.class.getName(); }
}
