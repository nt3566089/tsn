...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrimallocstockCQ;

/**
 * The condition-query of T_TRIMALLOCSTOCK.
 * <p>
 ...
 */
public class TTrimallocstockCQ extends BsTTrimallocstockCQ {
     ...
     */
    public TTrimallocstockCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
