...
/**
 * The abstract condition-query of W_WKSOCANCELPICK1.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWWksocancelpick1CQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWWksocancelpick1CQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<WWksocancelpick1CB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WWksocancelpick1CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WWksocancelpick1CB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WWksocancelpick1CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WWksocancelpick1CB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WWksocancelpick1CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WWksocancelpick1CB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WWksocancelpick1CB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WWksocancelpick1CB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WWksocancelpick1CB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WWksocancelpick1CB&gt;() {
     *     public void query(WWksocancelpick1CB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WWksocancelpick1CB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WWksocancelpick1CB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WWksocancelpick1CB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WWksocancelpick1CQ sq);

    protected WWksocancelpick1CB xcreateScalarConditionCB() {
        WWksocancelpick1CB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WWksocancelpick1CB xcreateScalarConditionPartitionByCB() {
        WWksocancelpick1CB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WWksocancelpick1CB newMyCB() {
        return new WWksocancelpick1CB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WWksocancelpick1CQ.class.getName(); }
