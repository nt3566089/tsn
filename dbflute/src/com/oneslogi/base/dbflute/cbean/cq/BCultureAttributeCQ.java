...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsBCultureAttributeCQ;

/**
 * The condition-query of b_culture_attribute.
 * <p>
 ...
 */
public class BCultureAttributeCQ extends BsBCultureAttributeCQ {
     ...
     */
    public BCultureAttributeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
