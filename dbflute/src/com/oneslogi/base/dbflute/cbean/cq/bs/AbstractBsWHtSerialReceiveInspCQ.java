...
/**
 * The abstract condition-query of W_HT_SERIAL_RECEIVE_INSP.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsWHtSerialReceiveInspCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsWHtSerialReceiveInspCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    public String asTableDbName() {
        return "W_HT_SERIAL_RECEIVE_INSP";
    }
     ...
     * @param htSerialReceiveInspId The value of htSerialReceiveInspId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_Equal(Long htSerialReceiveInspId) {
        doSetHtSerialReceiveInspId_Equal(htSerialReceiveInspId);
    }

    protected void doSetHtSerialReceiveInspId_Equal(Long htSerialReceiveInspId) {
        regHtSerialReceiveInspId(CK_EQ, htSerialReceiveInspId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspId The value of htSerialReceiveInspId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_NotEqual(Long htSerialReceiveInspId) {
        doSetHtSerialReceiveInspId_NotEqual(htSerialReceiveInspId);
    }

    protected void doSetHtSerialReceiveInspId_NotEqual(Long htSerialReceiveInspId) {
        regHtSerialReceiveInspId(CK_NES, htSerialReceiveInspId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspId The value of htSerialReceiveInspId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_GreaterThan(Long htSerialReceiveInspId) {
        regHtSerialReceiveInspId(CK_GT, htSerialReceiveInspId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspId The value of htSerialReceiveInspId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_LessThan(Long htSerialReceiveInspId) {
        regHtSerialReceiveInspId(CK_LT, htSerialReceiveInspId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspId The value of htSerialReceiveInspId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_GreaterEqual(Long htSerialReceiveInspId) {
        regHtSerialReceiveInspId(CK_GE, htSerialReceiveInspId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspId The value of htSerialReceiveInspId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_LessEqual(Long htSerialReceiveInspId) {
        regHtSerialReceiveInspId(CK_LE, htSerialReceiveInspId);
    }
     ...
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of htSerialReceiveInspId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of htSerialReceiveInspId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setHtSerialReceiveInspId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueHtSerialReceiveInspId(), "HT_SERIAL_RECEIVE_INSP_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspIdList The collection of htSerialReceiveInspId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_InScope(Collection<Long> htSerialReceiveInspIdList) {
        doSetHtSerialReceiveInspId_InScope(htSerialReceiveInspIdList);
    }

    protected void doSetHtSerialReceiveInspId_InScope(Collection<Long> htSerialReceiveInspIdList) {
        regINS(CK_INS, cTL(htSerialReceiveInspIdList), xgetCValueHtSerialReceiveInspId(), "HT_SERIAL_RECEIVE_INSP_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param htSerialReceiveInspIdList The collection of htSerialReceiveInspId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setHtSerialReceiveInspId_NotInScope(Collection<Long> htSerialReceiveInspIdList) {
        doSetHtSerialReceiveInspId_NotInScope(htSerialReceiveInspIdList);
    }

    protected void doSetHtSerialReceiveInspId_NotInScope(Collection<Long> htSerialReceiveInspIdList) {
        regINS(CK_NINS, cTL(htSerialReceiveInspIdList), xgetCValueHtSerialReceiveInspId(), "HT_SERIAL_RECEIVE_INSP_ID");
    }
     ...
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setHtSerialReceiveInspId_IsNull() { regHtSerialReceiveInspId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * HT_SERIAL_RECEIVE_INSP_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setHtSerialReceiveInspId_IsNotNull() { regHtSerialReceiveInspId(CK_ISNN, DOBJ); }

    protected void regHtSerialReceiveInspId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueHtSerialReceiveInspId(), "HT_SERIAL_RECEIVE_INSP_ID"); }
    protected abstract ConditionValue xgetCValueHtSerialReceiveInspId();
     ...
     */
    public HpSLCFunction<WHtSerialReceiveInspCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WHtSerialReceiveInspCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtSerialReceiveInspCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WHtSerialReceiveInspCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtSerialReceiveInspCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WHtSerialReceiveInspCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtSerialReceiveInspCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WHtSerialReceiveInspCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtSerialReceiveInspCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WHtSerialReceiveInspCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;WHtSerialReceiveInspCB&gt;() {
     *     public void query(WHtSerialReceiveInspCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WHtSerialReceiveInspCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WHtSerialReceiveInspCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtSerialReceiveInspCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(WHtSerialReceiveInspCQ sq);

    protected WHtSerialReceiveInspCB xcreateScalarConditionCB() {
        WHtSerialReceiveInspCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected WHtSerialReceiveInspCB xcreateScalarConditionPartitionByCB() {
        WHtSerialReceiveInspCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<WHtSerialReceiveInspCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "HT_SERIAL_RECEIVE_INSP_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(WHtSerialReceiveInspCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<WHtSerialReceiveInspCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(WHtSerialReceiveInspCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "HT_SERIAL_RECEIVE_INSP_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(WHtSerialReceiveInspCQ sq);
     ...
     */
    public void myselfExists(SubQuery<WHtSerialReceiveInspCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(WHtSerialReceiveInspCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected WHtSerialReceiveInspCB newMyCB() {
        return new WHtSerialReceiveInspCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return WHtSerialReceiveInspCQ.class.getName(); }
