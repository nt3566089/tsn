...
/**
 * The condition-query for in-line of T_TRMANUFACTUREDATEDETAIL.
 * @author DBFlute(AutoGenerator)
 */
public class TTrmanufacturedatedetailCIQ extends AbstractBsTTrmanufacturedatedetailCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTrmanufacturedatedetailCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTrmanufacturedatedetailCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTrmanufacturedatedetailCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTrmanufacturedatedetailId() { return _myCQ.xdfgetTrmanufacturedatedetailId(); }
    ...
    public String keepScalarCondition(TTrmanufacturedatedetailCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTrmanufacturedatedetailCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTrmanufacturedatedetailCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTrmanufacturedatedetailCQ sq)
    ...
    protected String xinCB() { return TTrmanufacturedatedetailCB.class.getName(); }
    protected String xinCQ() { return TTrmanufacturedatedetailCQ.class.getName(); }
}
