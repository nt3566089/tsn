...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrtranplanCQ;

/**
 * The condition-query of T_TRTRANPLAN.
 * <p>
 ...
 */
public class TTrtranplanCQ extends BsTTrtranplanCQ {
     ...
     */
    public TTrtranplanCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
