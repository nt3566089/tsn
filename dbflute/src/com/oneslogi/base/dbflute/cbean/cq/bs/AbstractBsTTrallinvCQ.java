...
/**
 * The abstract condition-query of T_TRALLINV.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTTrallinvCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTTrallinvCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<TTrallinvCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TTrallinvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrallinvCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TTrallinvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrallinvCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TTrallinvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrallinvCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TTrallinvCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrallinvCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TTrallinvCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TTrallinvCB&gt;() {
     *     public void query(TTrallinvCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrallinvCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TTrallinvCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrallinvCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TTrallinvCQ sq);

    protected TTrallinvCB xcreateScalarConditionCB() {
        TTrallinvCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TTrallinvCB xcreateScalarConditionPartitionByCB() {
        TTrallinvCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TTrallinvCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
    ...
    public abstract String keepSpecifyMyselfDerived(TTrallinvCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TTrallinvCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TTrallinvCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrallinvCB cb = new TTrallinvCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "TRALLINV_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TTrallinvCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TTrallinvCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrallinvCB cb = new TTrallinvCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TTrallinvCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TTrallinvCB newMyCB() {
        return new TTrallinvCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TTrallinvCQ.class.getName(); }
