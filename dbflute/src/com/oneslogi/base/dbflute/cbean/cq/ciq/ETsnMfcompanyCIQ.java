...
/**
 * The condition-query for in-line of E_TSN_MFCOMPANY.
 * @author DBFlute(AutoGenerator)
 */
public class ETsnMfcompanyCIQ extends AbstractBsETsnMfcompanyCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsETsnMfcompanyCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ETsnMfcompanyCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsETsnMfcompanyCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTsnMfcompanyId() { return _myCQ.xdfgetTsnMfcompanyId(); }
    ...
    public String keepScalarCondition(ETsnMfcompanyCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ETsnMfcompanyCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ETsnMfcompanyCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ETsnMfcompanyCQ sq)
    ...
    protected String xinCB() { return ETsnMfcompanyCB.class.getName(); }
    protected String xinCQ() { return ETsnMfcompanyCQ.class.getName(); }
}
