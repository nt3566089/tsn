...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTPackingBCQ;

/**
 * The condition-query of t_packing_b.
 * <p>
 ...
 */
public class TPackingBCQ extends BsTPackingBCQ {
     ...
     */
    public TPackingBCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
