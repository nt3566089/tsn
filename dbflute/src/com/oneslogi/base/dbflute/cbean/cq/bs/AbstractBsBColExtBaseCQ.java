...
/**
 * The abstract condition-query of B_COL_EXT_BASE.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBColExtBaseCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBColExtBaseCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param colExtBaseId The value of colExtBaseId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setColExtBaseId_Equal(Long colExtBaseId) {
        doSetColExtBaseId_Equal(colExtBaseId);
    }

    protected void doSetColExtBaseId_Equal(Long colExtBaseId) {
        regColExtBaseId(CK_EQ, colExtBaseId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseId The value of colExtBaseId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setColExtBaseId_NotEqual(Long colExtBaseId) {
        doSetColExtBaseId_NotEqual(colExtBaseId);
    }

    protected void doSetColExtBaseId_NotEqual(Long colExtBaseId) {
        regColExtBaseId(CK_NES, colExtBaseId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseId The value of colExtBaseId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setColExtBaseId_GreaterThan(Long colExtBaseId) {
        regColExtBaseId(CK_GT, colExtBaseId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseId The value of colExtBaseId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setColExtBaseId_LessThan(Long colExtBaseId) {
        regColExtBaseId(CK_LT, colExtBaseId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseId The value of colExtBaseId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setColExtBaseId_GreaterEqual(Long colExtBaseId) {
        regColExtBaseId(CK_GE, colExtBaseId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseId The value of colExtBaseId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setColExtBaseId_LessEqual(Long colExtBaseId) {
        regColExtBaseId(CK_LE, colExtBaseId);
    }
     ...
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of colExtBaseId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of colExtBaseId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setColExtBaseId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueColExtBaseId(), "COL_EXT_BASE_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseIdList The collection of colExtBaseId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setColExtBaseId_InScope(Collection<Long> colExtBaseIdList) {
        doSetColExtBaseId_InScope(colExtBaseIdList);
    }

    protected void doSetColExtBaseId_InScope(Collection<Long> colExtBaseIdList) {
        regINS(CK_INS, cTL(colExtBaseIdList), xgetCValueColExtBaseId(), "COL_EXT_BASE_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param colExtBaseIdList The collection of colExtBaseId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setColExtBaseId_NotInScope(Collection<Long> colExtBaseIdList) {
        doSetColExtBaseId_NotInScope(colExtBaseIdList);
    }

    protected void doSetColExtBaseId_NotInScope(Collection<Long> colExtBaseIdList) {
        regINS(CK_NINS, cTL(colExtBaseIdList), xgetCValueColExtBaseId(), "COL_EXT_BASE_ID");
    }
     ...
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setColExtBaseId_IsNull() { regColExtBaseId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * COL_EXT_BASE_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setColExtBaseId_IsNotNull() { regColExtBaseId(CK_ISNN, DOBJ); }

    protected void regColExtBaseId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueColExtBaseId(), "COL_EXT_BASE_ID"); }
    protected abstract ConditionValue xgetCValueColExtBaseId();
     ...
     */
    public HpSLCFunction<BColExtBaseCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, BColExtBaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColExtBaseCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, BColExtBaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColExtBaseCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, BColExtBaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColExtBaseCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, BColExtBaseCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColExtBaseCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, BColExtBaseCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BColExtBaseCB&gt;() {
     *     public void query(BColExtBaseCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BColExtBaseCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, BColExtBaseCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        BColExtBaseCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(BColExtBaseCQ sq);

    protected BColExtBaseCB xcreateScalarConditionCB() {
        BColExtBaseCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected BColExtBaseCB xcreateScalarConditionPartitionByCB() {
        BColExtBaseCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<BColExtBaseCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BColExtBaseCB cb = new BColExtBaseCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "COL_EXT_BASE_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(BColExtBaseCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<BColExtBaseCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(BColExtBaseCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BColExtBaseCB cb = new BColExtBaseCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "COL_EXT_BASE_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(BColExtBaseCQ sq);
     ...
     */
    public void myselfExists(SubQuery<BColExtBaseCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BColExtBaseCB cb = new BColExtBaseCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(BColExtBaseCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected BColExtBaseCB newMyCB() {
        return new BColExtBaseCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return BColExtBaseCQ.class.getName(); }
