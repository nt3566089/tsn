...
/**
 * The condition-query for in-line of T_TRSREPLANDETAIL.
 * @author DBFlute(AutoGenerator)
 */
public class TTrsreplandetailCIQ extends AbstractBsTTrsreplandetailCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTrsreplandetailCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTrsreplandetailCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsTTrsreplandetailCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueTrsreplandetailId() { return _myCQ.xdfgetTrsreplandetailId(); }
    ...
    protected ConditionValue xgetCValueOwnerpono() { return _myCQ.xdfgetOwnerpono(); }
    ...
    public String keepScalarCondition(TTrsreplandetailCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(TTrsreplandetailCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(TTrsreplandetailCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(TTrsreplandetailCQ sq)
    ...
    protected String xinCB() { return TTrsreplandetailCB.class.getName(); }
    protected String xinCQ() { return TTrsreplandetailCQ.class.getName(); }
}
