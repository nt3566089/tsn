...
/**
 * The condition-query for in-line of E_SORTING_STOCK.
 * @author DBFlute(AutoGenerator)
 */
public class ESortingStockCIQ extends AbstractBsESortingStockCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsESortingStockCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ESortingStockCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsESortingStockCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueSortingStockId() { return _myCQ.xdfgetSortingStockId(); }
    ...
    public String keepScalarCondition(ESortingStockCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ESortingStockCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ESortingStockCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ESortingStockCQ sq)
    ...
    protected String xinCB() { return ESortingStockCB.class.getName(); }
    protected String xinCQ() { return ESortingStockCQ.class.getName(); }
}
