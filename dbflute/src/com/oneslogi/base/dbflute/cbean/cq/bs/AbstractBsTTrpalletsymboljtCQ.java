...
/**
 * The abstract condition-query of T_TRPALLETSYMBOLJT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTTrpalletsymboljtCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTTrpalletsymboljtCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void setSojtid_Equal(java.math.BigDecimal sojtid) {
        doSetSojtid_Equal(sojtid);
    }

    protected void doSetSojtid_Equal(java.math.BigDecimal sojtid) {
     ...
     */
    public void setSojtid_NotEqual(java.math.BigDecimal sojtid) {
        doSetSojtid_NotEqual(sojtid);
    }

    protected void doSetSojtid_NotEqual(java.math.BigDecimal sojtid) {
     ...
     */
    public void setSojtid_GreaterThan(java.math.BigDecimal sojtid) {
     ...
     */
    public void setSojtid_LessThan(java.math.BigDecimal sojtid) {
     ...
     */
    public void setSojtid_GreaterEqual(java.math.BigDecimal sojtid) {
     ...
     */
    public void setSojtid_LessEqual(java.math.BigDecimal sojtid) {
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setSojtid_RangeOf(java.math.BigDecimal minNumber, java.math.BigDecimal maxNumber, RangeOfOption rangeOfOption) {
     ...
     */
    public void setSojtid_InScope(Collection<java.math.BigDecimal> sojtidList) {
        doSetSojtid_InScope(sojtidList);
    }

    protected void doSetSojtid_InScope(Collection<java.math.BigDecimal> sojtidList) {
     ...
     */
    public void setSojtid_NotInScope(Collection<java.math.BigDecimal> sojtidList) {
        doSetSojtid_NotInScope(sojtidList);
    }

    protected void doSetSojtid_NotInScope(Collection<java.math.BigDecimal> sojtidList) {
     ...
     * SOJTLINENO: {bigint(19)}
     */
    public void setSojtlineno_IsNull() { regSojtlineno(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * SOJTLINENO: {bigint(19)}
     */
    public void setSojtlineno_IsNotNull() { regSojtlineno(CK_ISNN, DOBJ); }
     ...
     */
    public HpSLCFunction<TTrpalletsymboljtCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, TTrpalletsymboljtCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrpalletsymboljtCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, TTrpalletsymboljtCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrpalletsymboljtCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, TTrpalletsymboljtCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrpalletsymboljtCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, TTrpalletsymboljtCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrpalletsymboljtCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, TTrpalletsymboljtCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;TTrpalletsymboljtCB&gt;() {
     *     public void query(TTrpalletsymboljtCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<TTrpalletsymboljtCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, TTrpalletsymboljtCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrpalletsymboljtCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(TTrpalletsymboljtCQ sq);

    protected TTrpalletsymboljtCB xcreateScalarConditionCB() {
        TTrpalletsymboljtCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected TTrpalletsymboljtCB xcreateScalarConditionPartitionByCB() {
        TTrpalletsymboljtCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<TTrpalletsymboljtCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrpalletsymboljtCB cb = new TTrpalletsymboljtCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "PALLET_INDIVIDUAL_INFO_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(TTrpalletsymboljtCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<TTrpalletsymboljtCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(TTrpalletsymboljtCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        TTrpalletsymboljtCB cb = new TTrpalletsymboljtCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "PALLET_INDIVIDUAL_INFO_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(TTrpalletsymboljtCQ sq);
     ...
     */
    public void myselfExists(SubQuery<TTrpalletsymboljtCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        TTrpalletsymboljtCB cb = new TTrpalletsymboljtCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(TTrpalletsymboljtCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected TTrpalletsymboljtCB newMyCB() {
        return new TTrpalletsymboljtCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return TTrpalletsymboljtCQ.class.getName(); }
