...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrrcvinspectCQ;

/**
 * The condition-query of T_TRRCVINSPECT.
 * <p>
 ...
 */
public class TTrrcvinspectCQ extends BsTTrrcvinspectCQ {
     ...
     */
    public TTrrcvinspectCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
