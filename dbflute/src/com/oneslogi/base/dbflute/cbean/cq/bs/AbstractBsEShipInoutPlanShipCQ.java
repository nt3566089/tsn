...
/**
 * The abstract condition-query of E_SHIP_INOUT_PLAN_SHIP.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsEShipInoutPlanShipCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsEShipInoutPlanShipCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param shipInoutPlanShipId The value of shipInoutPlanShipId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_Equal(Long shipInoutPlanShipId) {
        doSetShipInoutPlanShipId_Equal(shipInoutPlanShipId);
    }

    protected void doSetShipInoutPlanShipId_Equal(Long shipInoutPlanShipId) {
        regShipInoutPlanShipId(CK_EQ, shipInoutPlanShipId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipId The value of shipInoutPlanShipId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_NotEqual(Long shipInoutPlanShipId) {
        doSetShipInoutPlanShipId_NotEqual(shipInoutPlanShipId);
    }

    protected void doSetShipInoutPlanShipId_NotEqual(Long shipInoutPlanShipId) {
        regShipInoutPlanShipId(CK_NES, shipInoutPlanShipId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipId The value of shipInoutPlanShipId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_GreaterThan(Long shipInoutPlanShipId) {
        regShipInoutPlanShipId(CK_GT, shipInoutPlanShipId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipId The value of shipInoutPlanShipId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_LessThan(Long shipInoutPlanShipId) {
        regShipInoutPlanShipId(CK_LT, shipInoutPlanShipId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipId The value of shipInoutPlanShipId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_GreaterEqual(Long shipInoutPlanShipId) {
        regShipInoutPlanShipId(CK_GE, shipInoutPlanShipId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipId The value of shipInoutPlanShipId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_LessEqual(Long shipInoutPlanShipId) {
        regShipInoutPlanShipId(CK_LE, shipInoutPlanShipId);
    }
     ...
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of shipInoutPlanShipId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of shipInoutPlanShipId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setShipInoutPlanShipId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueShipInoutPlanShipId(), "SHIP_INOUT_PLAN_SHIP_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipIdList The collection of shipInoutPlanShipId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_InScope(Collection<Long> shipInoutPlanShipIdList) {
        doSetShipInoutPlanShipId_InScope(shipInoutPlanShipIdList);
    }

    protected void doSetShipInoutPlanShipId_InScope(Collection<Long> shipInoutPlanShipIdList) {
        regINS(CK_INS, cTL(shipInoutPlanShipIdList), xgetCValueShipInoutPlanShipId(), "SHIP_INOUT_PLAN_SHIP_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param shipInoutPlanShipIdList The collection of shipInoutPlanShipId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setShipInoutPlanShipId_NotInScope(Collection<Long> shipInoutPlanShipIdList) {
        doSetShipInoutPlanShipId_NotInScope(shipInoutPlanShipIdList);
    }

    protected void doSetShipInoutPlanShipId_NotInScope(Collection<Long> shipInoutPlanShipIdList) {
        regINS(CK_NINS, cTL(shipInoutPlanShipIdList), xgetCValueShipInoutPlanShipId(), "SHIP_INOUT_PLAN_SHIP_ID");
    }
     ...
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setShipInoutPlanShipId_IsNull() { regShipInoutPlanShipId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * SHIP_INOUT_PLAN_SHIP_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setShipInoutPlanShipId_IsNotNull() { regShipInoutPlanShipId(CK_ISNN, DOBJ); }

    protected void regShipInoutPlanShipId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueShipInoutPlanShipId(), "SHIP_INOUT_PLAN_SHIP_ID"); }
    protected abstract ConditionValue xgetCValueShipInoutPlanShipId();
     ...
     */
    public HpSLCFunction<EShipInoutPlanShipCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, EShipInoutPlanShipCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShipInoutPlanShipCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, EShipInoutPlanShipCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShipInoutPlanShipCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, EShipInoutPlanShipCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShipInoutPlanShipCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, EShipInoutPlanShipCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShipInoutPlanShipCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, EShipInoutPlanShipCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;EShipInoutPlanShipCB&gt;() {
     *     public void query(EShipInoutPlanShipCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<EShipInoutPlanShipCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, EShipInoutPlanShipCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        EShipInoutPlanShipCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(EShipInoutPlanShipCQ sq);

    protected EShipInoutPlanShipCB xcreateScalarConditionCB() {
        EShipInoutPlanShipCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected EShipInoutPlanShipCB xcreateScalarConditionPartitionByCB() {
        EShipInoutPlanShipCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<EShipInoutPlanShipCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EShipInoutPlanShipCB cb = new EShipInoutPlanShipCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "SHIP_INOUT_PLAN_SHIP_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(EShipInoutPlanShipCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<EShipInoutPlanShipCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(EShipInoutPlanShipCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        EShipInoutPlanShipCB cb = new EShipInoutPlanShipCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "SHIP_INOUT_PLAN_SHIP_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(EShipInoutPlanShipCQ sq);
     ...
     */
    public void myselfExists(SubQuery<EShipInoutPlanShipCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        EShipInoutPlanShipCB cb = new EShipInoutPlanShipCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(EShipInoutPlanShipCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected EShipInoutPlanShipCB newMyCB() {
        return new EShipInoutPlanShipCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return EShipInoutPlanShipCQ.class.getName(); }
