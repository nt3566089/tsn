...
/**
 * The condition-query for in-line of E_TRIFITEMDATA.
 * @author DBFlute(AutoGenerator)
 */
public class ETrifitemdataCIQ extends AbstractBsETrifitemdataCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsETrifitemdataCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ETrifitemdataCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsETrifitemdataCQ myCQ) {
    ...
    public String keepScalarCondition(ETrifitemdataCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ETrifitemdataCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ETrifitemdataCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ETrifitemdataCQ sq)
    ...
    protected String xinCB() { return ETrifitemdataCB.class.getName(); }
    protected String xinCQ() { return ETrifitemdataCQ.class.getName(); }
}
