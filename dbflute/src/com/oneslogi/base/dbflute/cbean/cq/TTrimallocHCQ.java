...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTTrimallocHCQ;

/**
 * The condition-query of T_TRIMALLOC_H.
 * <p>
 ...
 */
public class TTrimallocHCQ extends BsTTrimallocHCQ {
     ...
     */
    public TTrimallocHCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
