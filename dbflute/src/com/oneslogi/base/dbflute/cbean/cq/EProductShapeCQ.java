...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsEProductShapeCQ;

/**
 * The condition-query of e_product_shape.
 * <p>
 ...
 */
public class EProductShapeCQ extends BsEProductShapeCQ {
     ...
     */
    public EProductShapeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
