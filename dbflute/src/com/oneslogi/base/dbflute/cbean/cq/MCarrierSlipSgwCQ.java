...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsMCarrierSlipSgwCQ;

/**
 * The condition-query of m_carrier_slip_sgw.
 * <p>
 ...
 */
public class MCarrierSlipSgwCQ extends BsMCarrierSlipSgwCQ {
     ...
     */
    public MCarrierSlipSgwCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
