...
/**
 * The abstract condition-query of M_CENTER_ITEM.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMCenterItemCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMCenterItemCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param centerItemId The value of centerItemId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterItemId_Equal(Long centerItemId) {
        doSetCenterItemId_Equal(centerItemId);
    }

    protected void doSetCenterItemId_Equal(Long centerItemId) {
        regCenterItemId(CK_EQ, centerItemId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemId The value of centerItemId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterItemId_NotEqual(Long centerItemId) {
        doSetCenterItemId_NotEqual(centerItemId);
    }

    protected void doSetCenterItemId_NotEqual(Long centerItemId) {
        regCenterItemId(CK_NES, centerItemId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemId The value of centerItemId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterItemId_GreaterThan(Long centerItemId) {
        regCenterItemId(CK_GT, centerItemId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemId The value of centerItemId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterItemId_LessThan(Long centerItemId) {
        regCenterItemId(CK_LT, centerItemId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemId The value of centerItemId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterItemId_GreaterEqual(Long centerItemId) {
        regCenterItemId(CK_GE, centerItemId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemId The value of centerItemId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCenterItemId_LessEqual(Long centerItemId) {
        regCenterItemId(CK_LE, centerItemId);
    }
     ...
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of centerItemId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of centerItemId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setCenterItemId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueCenterItemId(), "CENTER_ITEM_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemIdList The collection of centerItemId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCenterItemId_InScope(Collection<Long> centerItemIdList) {
        doSetCenterItemId_InScope(centerItemIdList);
    }

    protected void doSetCenterItemId_InScope(Collection<Long> centerItemIdList) {
        regINS(CK_INS, cTL(centerItemIdList), xgetCValueCenterItemId(), "CENTER_ITEM_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param centerItemIdList The collection of centerItemId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setCenterItemId_NotInScope(Collection<Long> centerItemIdList) {
        doSetCenterItemId_NotInScope(centerItemIdList);
    }

    protected void doSetCenterItemId_NotInScope(Collection<Long> centerItemIdList) {
        regINS(CK_NINS, cTL(centerItemIdList), xgetCValueCenterItemId(), "CENTER_ITEM_ID");
    }
     ...
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setCenterItemId_IsNull() { regCenterItemId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CENTER_ITEM_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setCenterItemId_IsNotNull() { regCenterItemId(CK_ISNN, DOBJ); }

    protected void regCenterItemId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCenterItemId(), "CENTER_ITEM_ID"); }
    protected abstract ConditionValue xgetCValueCenterItemId();
     ...
     */
    public HpSLCFunction<MCenterItemCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, MCenterItemCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterItemCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, MCenterItemCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterItemCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, MCenterItemCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterItemCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, MCenterItemCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterItemCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, MCenterItemCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MCenterItemCB&gt;() {
     *     public void query(MCenterItemCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MCenterItemCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, MCenterItemCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterItemCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(MCenterItemCQ sq);

    protected MCenterItemCB xcreateScalarConditionCB() {
        MCenterItemCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MCenterItemCB xcreateScalarConditionPartitionByCB() {
        MCenterItemCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MCenterItemCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterItemCB cb = new MCenterItemCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CENTER_ITEM_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MCenterItemCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MCenterItemCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MCenterItemCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MCenterItemCB cb = new MCenterItemCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CENTER_ITEM_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MCenterItemCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MCenterItemCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MCenterItemCB cb = new MCenterItemCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MCenterItemCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MCenterItemCB newMyCB() {
        return new MCenterItemCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return MCenterItemCQ.class.getName(); }
