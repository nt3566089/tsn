...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTMoveInstRCQ;

/**
 * The condition-query of t_move_inst_r.
 * <p>
 ...
 */
public class TMoveInstRCQ extends BsTMoveInstRCQ {
     ...
     */
    public TMoveInstRCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
