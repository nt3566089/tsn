...
/**
 * The condition-query for in-line of M_TSN_PRODUCT.
 * @author DBFlute(AutoGenerator)
 */
public class MTsnProductCIQ extends AbstractBsMTsnProductCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsMTsnProductCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MTsnProductCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsMTsnProductCQ myCQ) {
    ...
    public String keepScalarCondition(MTsnProductCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(MTsnProductCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(MTsnProductCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(MTsnProductCQ sq)
    ...
    protected String xinCB() { return MTsnProductCB.class.getName(); }
    protected String xinCQ() { return MTsnProductCQ.class.getName(); }
}
