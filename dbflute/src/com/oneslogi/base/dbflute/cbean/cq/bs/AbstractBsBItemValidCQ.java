...
/**
 * The abstract condition-query of B_ITEM_VALID.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsBItemValidCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsBItemValidCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<BItemValidCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, BItemValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BItemValidCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, BItemValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BItemValidCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, BItemValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BItemValidCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, BItemValidCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BItemValidCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, BItemValidCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;BItemValidCB&gt;() {
     *     public void query(BItemValidCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<BItemValidCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, BItemValidCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        BItemValidCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(BItemValidCQ sq);

    protected BItemValidCB xcreateScalarConditionCB() {
        BItemValidCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected BItemValidCB xcreateScalarConditionPartitionByCB() {
        BItemValidCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<BItemValidCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BItemValidCB cb = new BItemValidCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "ITEM_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(BItemValidCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<BItemValidCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(BItemValidCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        BItemValidCB cb = new BItemValidCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "ITEM_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(BItemValidCQ sq);
     ...
     */
    public void myselfExists(SubQuery<BItemValidCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        BItemValidCB cb = new BItemValidCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(BItemValidCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected BItemValidCB newMyCB() {
        return new BItemValidCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return BItemValidCQ.class.getName(); }
