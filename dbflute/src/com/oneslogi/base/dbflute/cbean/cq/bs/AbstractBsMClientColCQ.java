...
/**
 * The abstract condition-query of M_CLIENT_COL.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsMClientColCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsMClientColCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param clientColId The value of clientColId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setClientColId_Equal(Long clientColId) {
        doSetClientColId_Equal(clientColId);
    }

    protected void doSetClientColId_Equal(Long clientColId) {
        regClientColId(CK_EQ, clientColId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColId The value of clientColId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setClientColId_NotEqual(Long clientColId) {
        doSetClientColId_NotEqual(clientColId);
    }

    protected void doSetClientColId_NotEqual(Long clientColId) {
        regClientColId(CK_NES, clientColId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColId The value of clientColId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setClientColId_GreaterThan(Long clientColId) {
        regClientColId(CK_GT, clientColId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColId The value of clientColId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setClientColId_LessThan(Long clientColId) {
        regClientColId(CK_LT, clientColId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColId The value of clientColId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setClientColId_GreaterEqual(Long clientColId) {
        regClientColId(CK_GE, clientColId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColId The value of clientColId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setClientColId_LessEqual(Long clientColId) {
        regClientColId(CK_LE, clientColId);
    }
     ...
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param minNumber The min number of clientColId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param maxNumber The max number of clientColId. (basically NotNull: if op.allowOneSide(), null allowed)
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    public void setClientColId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueClientColId(), "CLIENT_COL_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColIdList The collection of clientColId as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setClientColId_InScope(Collection<Long> clientColIdList) {
        doSetClientColId_InScope(clientColIdList);
    }

    protected void doSetClientColId_InScope(Collection<Long> clientColIdList) {
        regINS(CK_INS, cTL(clientColIdList), xgetCValueClientColId(), "CLIENT_COL_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     * @param clientColIdList The collection of clientColId as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setClientColId_NotInScope(Collection<Long> clientColIdList) {
        doSetClientColId_NotInScope(clientColIdList);
    }

    protected void doSetClientColId_NotInScope(Collection<Long> clientColIdList) {
        regINS(CK_NINS, cTL(clientColIdList), xgetCValueClientColId(), "CLIENT_COL_ID");
    }
     ...
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setClientColId_IsNull() { regClientColId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * CLIENT_COL_ID: {PK, ID, NotNull, bigint identity(19)}
     */
    public void setClientColId_IsNotNull() { regClientColId(CK_ISNN, DOBJ); }

    protected void regClientColId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueClientColId(), "CLIENT_COL_ID"); }
    protected abstract ConditionValue xgetCValueClientColId();
     ...
     */
    public HpSLCFunction<MClientColCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, MClientColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MClientColCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, MClientColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MClientColCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, MClientColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MClientColCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, MClientColCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MClientColCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, MClientColCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;MClientColCB&gt;() {
     *     public void query(MClientColCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<MClientColCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, MClientColCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        MClientColCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(MClientColCQ sq);

    protected MClientColCB xcreateScalarConditionCB() {
        MClientColCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected MClientColCB xcreateScalarConditionPartitionByCB() {
        MClientColCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<MClientColCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MClientColCB cb = new MClientColCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "CLIENT_COL_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(MClientColCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<MClientColCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(MClientColCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        MClientColCB cb = new MClientColCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "CLIENT_COL_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(MClientColCQ sq);
     ...
     */
    public void myselfExists(SubQuery<MClientColCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        MClientColCB cb = new MClientColCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(MClientColCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected MClientColCB newMyCB() {
        return new MClientColCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return MClientColCQ.class.getName(); }
