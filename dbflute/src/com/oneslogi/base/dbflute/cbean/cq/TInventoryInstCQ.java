...
import com.oneslogi.base.dbflute.cbean.cq.bs.BsTInventoryInstCQ;

/**
 * The condition-query of T_INVENTORY_INST.
 * <p>
 ...
 */
public class TInventoryInstCQ extends BsTInventoryInstCQ {
     ...
     */
    public TInventoryInstCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
