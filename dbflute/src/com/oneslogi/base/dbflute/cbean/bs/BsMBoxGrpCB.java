...
/**
 * The base condition-bean of M_BOX_GRP.
 * @author DBFlute(AutoGenerator)
 */
public class BsMBoxGrpCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MBoxGrpCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public MBoxGrpCB acceptPK(Long boxGrpId) {
        assertObjectNotNull("boxGrpId", boxGrpId);
        BsMBoxGrpCB cb = this;
        cb.query().setBoxGrpId_Equal(boxGrpId);
        return (MBoxGrpCB)this;
    }
     ...
     * @param boxGrpId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long boxGrpId) {
        assertObjectNotNull("boxGrpId", boxGrpId);
        BsMBoxGrpCB cb = this;
        cb.query().setBoxGrpId_Equal(boxGrpId);
    }
     ...
     * @return this. (NotNull)
     */
    public MBoxGrpCB acceptUniqueOf(Long centerId, String boxGrpCd) {
        assertObjectNotNull("centerId", centerId);assertObjectNotNull("boxGrpCd", boxGrpCd);
        BsMBoxGrpCB cb = this;
        cb.query().setCenterId_Equal(centerId);cb.query().setBoxGrpCd_Equal(boxGrpCd);
        return (MBoxGrpCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_BoxGrpId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_BoxGrpId_Desc();
        return this;
    }
     ...
     */
    public MBoxGrpCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MBoxGrpCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MBoxGrpCQ doGetConditionQuery() {
    ...
    protected MBoxGrpCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MBoxGrpCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MBoxGrpCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MBoxGrpCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MBoxGrpCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MBoxGrpCB> unionCBLambda) {
        final MBoxGrpCB cb = new MBoxGrpCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MBoxGrpCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MBoxGrpCB> unionCBLambda) {
        final MBoxGrpCB cb = new MBoxGrpCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MBoxGrpCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mBoxGrpBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mBoxGrp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mBoxGrp</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mBoxGrp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mBoxGrp</span>.<span style="color: #CC4747">getMBox()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mBoxGrp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mBoxGrp</span>.<span style="color: #CC4747">getBClassDtlByDelFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MBoxGrpCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MBoxGrpCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBoxGrpCd() { return doColumn("BOX_GRP_CD"); }
        /**
         * BOX_GRP_NM: {NotNull, varchar(255)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBoxGrpNm() { return doColumn("BOX_GRP_NM"); }
        /**
         * STANDARD_BOX_ID: {IX, NotNull, bigint(19), FK to M_BOX}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnStandardBoxId() { return doColumn("STANDARD_BOX_ID"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryMBox()
                ...
                columnStandardBoxId(); // FK or one-to-one referrer
            }
        ...
        @Override
        protected String getTableDbName() { return "M_BOX_GRP"; }
        /**
         ...
         */
        public HpSDRFunction<MBoxGrpDtlCB, MBoxGrpCQ> derivedMBoxGrpDtlList() {
            assertDerived("mBoxGrpDtlList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBoxGrpDtlCB> sq, MBoxGrpCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MParamCB, MBoxGrpCQ> derivedMParamList() {
            assertDerived("mParamList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MParamCB> sq, MBoxGrpCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<MBoxGrpCB, MBoxGrpCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBoxGrpCB> sq, MBoxGrpCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MBoxGrpCB dreamCruiseCB() {
        MBoxGrpCB cb = new MBoxGrpCB();
        cb.xsetupForDreamCruise((MBoxGrpCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MBoxGrpCB> columnQuery(final SpecifyQuery<MBoxGrpCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MBoxGrpCB xcreateColumnQueryCB() {
        MBoxGrpCB cb = new MBoxGrpCB();
        cb.xsetupForColumnQuery((MBoxGrpCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MBoxGrpCB> orCBLambda) {
        xorSQ((MBoxGrpCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MBoxGrpCB> andCBLambda) {
        xorSQAP((MBoxGrpCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MBoxGrpCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MBoxGrpCQ.class.getName(); }
