...
/**
 * The base condition-bean of M_CLIENT_CENTER.
 * @author DBFlute(AutoGenerator)
 */
public class BsMClientCenterCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MClientCenterCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMClientCenterCB() {
     ...
     * @return this. (NotNull)
     */
    public MClientCenterCB acceptPK(Long clientCenterId) {
        assertObjectNotNull("clientCenterId", clientCenterId);
        BsMClientCenterCB cb = this;
        cb.query().setClientCenterId_Equal(clientCenterId);
        return (MClientCenterCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MClientCenterCB acceptUniqueOf(Long clientId, Long centerId) {
        assertObjectNotNull("clientId", clientId);assertObjectNotNull("centerId", centerId);
        BsMClientCenterCB cb = this;
        cb.query().setClientId_Equal(clientId);cb.query().setCenterId_Equal(centerId);
        return (MClientCenterCB)this;
    }
     ...
     */
    public MClientCenterCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MClientCenterCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MClientCenterCQ doGetConditionQuery() {
    ...
    protected MClientCenterCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MClientCenterCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MClientCenterCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MClientCenterCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MClientCenterCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MClientCenterCB> unionCBLambda) {
        final MClientCenterCB cb = new MClientCenterCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientCenterCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MClientCenterCB> unionCBLambda) {
        final MClientCenterCB cb = new MClientCenterCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientCenterCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientCenter</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCenter</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public BClassDtlNss xdfgetNssBClassDtlByBatchProgressFlg() {
        if (_nssBClassDtlByBatchProgressFlg == null) { _nssBClassDtlByBatchProgressFlg = new BClassDtlNss(null); }
        return _nssBClassDtlByBatchProgressFlg;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">mClientCenterBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BClassDtlByBatchProgressFlg()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientCenter</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCenter</span>.<span style="color: #CC4747">getBClassDtlByBatchProgressFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BClassDtlNss setupSelect_BClassDtlByBatchProgressFlg() {
        assertSetupSelectPurpose("bClassDtlByBatchProgressFlg");
        if (hasSpecifiedLocalColumn()) {
            specify().columnBatchProgressFlg();
        }
        doSetupSelect(() -> query().queryBClassDtlByBatchProgressFlg());
        if (_nssBClassDtlByBatchProgressFlg == null || !_nssBClassDtlByBatchProgressFlg.hasConditionQuery())
        { _nssBClassDtlByBatchProgressFlg = new BClassDtlNss(query().queryBClassDtlByBatchProgressFlg()); }
        return _nssBClassDtlByBatchProgressFlg;
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientCenter</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCenter</span>.<span style="color: #CC4747">getBClassDtlByDelFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    protected MParamNss _nssMParamAsOne;
    public MParamNss xdfgetNssMParamAsOne() {
        if (_nssMParamAsOne == null) { _nssMParamAsOne = new MParamNss(null); }
        return _nssMParamAsOne;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">mClientCenterBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_MParamAsOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientCenter</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCenter</span>.<span style="color: #CC4747">getMParamAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public MParamNss setupSelect_MParamAsOne() {
        assertSetupSelectPurpose("mParamAsOne");
        doSetupSelect(() -> query().queryMParamAsOne());
        if (_nssMParamAsOne == null || !_nssMParamAsOne.hasConditionQuery())
        { _nssMParamAsOne = new MParamNss(query().queryMParamAsOne()); }
        return _nssMParamAsOne;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MClientCenterCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MClientCenterCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSystemDt() { return doColumn("SYSTEM_DT"); }
        /**
         * BATCH_PROGRESS_FLG: {NotNull, char(1), default=[0], FK to B_CLASS_DTL, classification=BatchProgressFlg}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBatchProgressFlg() { return doColumn("BATCH_PROGRESS_FLG"); }
        /**
         * BEFORE_SYSTEM_DT: {varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBeforeSystemDt() { return doColumn("BEFORE_SYSTEM_DT"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBClassDtlByBatchProgressFlg()
                ...
                columnBatchProgressFlg(); // FK or one-to-one referrer
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BClassDtlCB.HpSpecification specifyBClassDtlByBatchProgressFlg() {
            assertRelation("bClassDtlByBatchProgressFlg");
            if (_bClassDtlByBatchProgressFlg == null) {
                _bClassDtlByBatchProgressFlg = new BClassDtlCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBClassDtlByBatchProgressFlg()
                                    , () -> _qyCall.qy().queryBClassDtlByBatchProgressFlg())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bClassDtlByBatchProgressFlg.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBClassDtlByBatchProgressFlg()
                      , () -> xsyncQyCall().qy().queryBClassDtlByBatchProgressFlg()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public MParamCB.HpSpecification specifyMParamAsOne() {
            assertRelation("mParamAsOne");
            if (_mParamAsOne == null) {
                _mParamAsOne = new MParamCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryMParamAsOne()
                                    , () -> _qyCall.qy().queryMParamAsOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _mParamAsOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryMParamAsOne()
                      , () -> xsyncQyCall().qy().queryMParamAsOne()));
                }
            }
            return _mParamAsOne;
        }
         ...
         */
        public HpSDRFunction<MClientCenterCB, MClientCenterCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MClientCenterCB> sq, MClientCenterCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MClientCenterCB dreamCruiseCB() {
        MClientCenterCB cb = new MClientCenterCB();
        cb.xsetupForDreamCruise((MClientCenterCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MClientCenterCB> columnQuery(final SpecifyQuery<MClientCenterCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MClientCenterCB xcreateColumnQueryCB() {
        MClientCenterCB cb = new MClientCenterCB();
        cb.xsetupForColumnQuery((MClientCenterCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MClientCenterCB> orCBLambda) {
        xorSQ((MClientCenterCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MClientCenterCB> andCBLambda) {
        xorSQAP((MClientCenterCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MClientCenterCB cb;
        if (mainCB != null) {
            cb = (MClientCenterCB)mainCB;
        } else {
            cb = new MClientCenterCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MClientCenterCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MClientCenterCQ.class.getName(); }
