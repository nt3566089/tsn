...
/**
 * The base condition-bean of T_PIC_MTHD_RCMD.
 * @author DBFlute(AutoGenerator)
 */
public class BsTPicMthdRcmdCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TPicMthdRcmdCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTPicMthdRcmdCB() {
     ...
     * @return this. (NotNull)
     */
    public TPicMthdRcmdCB acceptPK(Long picMthdRcmdId) {
        assertObjectNotNull("picMthdRcmdId", picMthdRcmdId);
        BsTPicMthdRcmdCB cb = this;
        cb.query().setPicMthdRcmdId_Equal(picMthdRcmdId);
        return (TPicMthdRcmdCB)this;
    }
     ...
     * @param picMthdRcmdId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long picMthdRcmdId) {
        assertObjectNotNull("picMthdRcmdId", picMthdRcmdId);
        BsTPicMthdRcmdCB cb = this;
        cb.query().setPicMthdRcmdId_Equal(picMthdRcmdId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_PicMthdRcmdId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_PicMthdRcmdId_Desc();
        return this;
    }
     ...
     */
    public TPicMthdRcmdCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TPicMthdRcmdCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TPicMthdRcmdCQ doGetConditionQuery() {
    ...
    protected TPicMthdRcmdCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TPicMthdRcmdCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TPicMthdRcmdCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TPicMthdRcmdCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TPicMthdRcmdCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TPicMthdRcmdCB> unionCBLambda) {
        final TPicMthdRcmdCB cb = new TPicMthdRcmdCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TPicMthdRcmdCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TPicMthdRcmdCB> unionCBLambda) {
        final TPicMthdRcmdCB cb = new TPicMthdRcmdCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TPicMthdRcmdCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tPicMthdRcmdBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tPicMthdRcmd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPicMthdRcmd</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPicMthdRcmd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPicMthdRcmd</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    protected BClassDtlNss _nssBClassDtlByRcmdPickingCls;
    public BClassDtlNss xdfgetNssBClassDtlByRcmdPickingCls() {
        if (_nssBClassDtlByRcmdPickingCls == null) { _nssBClassDtlByRcmdPickingCls = new BClassDtlNss(null); }
        return _nssBClassDtlByRcmdPickingCls;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tPicMthdRcmdBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BClassDtlByRcmdPickingCls()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPicMthdRcmd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPicMthdRcmd</span>.<span style="color: #CC4747">getBClassDtlByRcmdPickingCls()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BClassDtlNss setupSelect_BClassDtlByRcmdPickingCls() {
        assertSetupSelectPurpose("bClassDtlByRcmdPickingCls");
        if (hasSpecifiedLocalColumn()) {
            specify().columnRcmdPickingCls();
        }
        doSetupSelect(() -> query().queryBClassDtlByRcmdPickingCls());
        if (_nssBClassDtlByRcmdPickingCls == null || !_nssBClassDtlByRcmdPickingCls.hasConditionQuery())
        { _nssBClassDtlByRcmdPickingCls = new BClassDtlNss(query().queryBClassDtlByRcmdPickingCls()); }
        return _nssBClassDtlByRcmdPickingCls;
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tPicMthdRcmd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tPicMthdRcmd</span>.<span style="color: #CC4747">getBClassDtlByEmergencyFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TPicMthdRcmdCQ> {
        protected MCenterCB.HpSpecification _mCenter;
        protected MClientCB.HpSpecification _mClient;
        protected BClassDtlCB.HpSpecification _bClassDtlByRcmdPickingCls;
        protected BClassDtlCB.HpSpecification _bClassDtlByEmergencyFlg;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TPicMthdRcmdCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRcmdPickingCls() { return doColumn("RCMD_PICKING_CLS"); }
        /**
         * PACKING_NUM: {bigint(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPackingNum() { return doColumn("PACKING_NUM"); }
        /**
         * WORK_VOLUME: {decimal(16, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnWorkVolume() { return doColumn("WORK_VOLUME"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBClassDtlByRcmdPickingCls()
                    || qyCall().qy().xgetReferrerQuery() instanceof BClassDtlCQ) {
                columnRcmdPickingCls(); // FK or one-to-one referrer
            }
        ...
        @Override
        protected String getTableDbName() { return "T_PIC_MTHD_RCMD"; }
        /**
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BClassDtlCB.HpSpecification specifyBClassDtlByRcmdPickingCls() {
            assertRelation("bClassDtlByRcmdPickingCls");
            if (_bClassDtlByRcmdPickingCls == null) {
                _bClassDtlByRcmdPickingCls = new BClassDtlCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBClassDtlByRcmdPickingCls()
                                    , () -> _qyCall.qy().queryBClassDtlByRcmdPickingCls())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bClassDtlByRcmdPickingCls.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBClassDtlByRcmdPickingCls()
                      , () -> xsyncQyCall().qy().queryBClassDtlByRcmdPickingCls()));
                }
            }
         ...
         */
        public HpSDRFunction<TPicMthdRcmdCartCB, TPicMthdRcmdCQ> derivedTPicMthdRcmdCartList() {
            assertDerived("tPicMthdRcmdCartList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPicMthdRcmdCartCB> sq, TPicMthdRcmdCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPicMthdRcmdDataCB, TPicMthdRcmdCQ> derivedTPicMthdRcmdDataList() {
            assertDerived("tPicMthdRcmdDataList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPicMthdRcmdDataCB> sq, TPicMthdRcmdCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<TPicMthdRcmdCB, TPicMthdRcmdCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPicMthdRcmdCB> sq, TPicMthdRcmdCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TPicMthdRcmdCB dreamCruiseCB() {
        TPicMthdRcmdCB cb = new TPicMthdRcmdCB();
        cb.xsetupForDreamCruise((TPicMthdRcmdCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TPicMthdRcmdCB> columnQuery(final SpecifyQuery<TPicMthdRcmdCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TPicMthdRcmdCB xcreateColumnQueryCB() {
        TPicMthdRcmdCB cb = new TPicMthdRcmdCB();
        cb.xsetupForColumnQuery((TPicMthdRcmdCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TPicMthdRcmdCB> orCBLambda) {
        xorSQ((TPicMthdRcmdCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TPicMthdRcmdCB> andCBLambda) {
        xorSQAP((TPicMthdRcmdCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TPicMthdRcmdCB cb;
        if (mainCB != null) {
            cb = (TPicMthdRcmdCB)mainCB;
        } else {
            cb = new TPicMthdRcmdCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TPicMthdRcmdCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TPicMthdRcmdCQ.class.getName(); }
