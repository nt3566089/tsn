...
/**
 * The base condition-bean of M_CLIENT_ITEM.
 * @author DBFlute(AutoGenerator)
 */
public class BsMClientItemCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MClientItemCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMClientItemCB() {
     ...
     * @return this. (NotNull)
     */
    public MClientItemCB acceptPK(Long clientItemId) {
        assertObjectNotNull("clientItemId", clientItemId);
        BsMClientItemCB cb = this;
        cb.query().setClientItemId_Equal(clientItemId);
        return (MClientItemCB)this;
    }
     ...
     * @param clientItemId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long clientItemId) {
        assertObjectNotNull("clientItemId", clientItemId);
        BsMClientItemCB cb = this;
        cb.query().setClientItemId_Equal(clientItemId);
    }
     ...
     * @return this. (NotNull)
     */
    public MClientItemCB acceptUniqueOf(Long clientId, Long itemId, Long dictId) {
        assertObjectNotNull("clientId", clientId);assertObjectNotNull("itemId", itemId);assertObjectNotNull("dictId", dictId);
        BsMClientItemCB cb = this;
        cb.query().setClientId_Equal(clientId);cb.query().setItemId_Equal(itemId);cb.query().setDictId_Equal(dictId);
        return (MClientItemCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ClientItemId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ClientItemId_Desc();
        return this;
    }
     ...
     */
    public MClientItemCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MClientItemCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MClientItemCQ doGetConditionQuery() {
    ...
    protected MClientItemCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MClientItemCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MClientItemCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MClientItemCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MClientItemCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MClientItemCB> unionCBLambda) {
        final MClientItemCB cb = new MClientItemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientItemCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MClientItemCB> unionCBLambda) {
        final MClientItemCB cb = new MClientItemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientItemCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">mClientItem</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientItem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientItem</span>.<span style="color: #CC4747">getVDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MClientItemCQ> {
         ...
         */
        public SpecifiedColumn columnClientItemId() { return doColumn("CLIENT_ITEM_ID"); }
        /**
         ...
         */
        public HpSDRFunction<MClientItemCB, MClientItemCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MClientItemCB> sq, MClientItemCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MClientItemCB dreamCruiseCB() {
        MClientItemCB cb = new MClientItemCB();
        cb.xsetupForDreamCruise((MClientItemCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MClientItemCB> columnQuery(final SpecifyQuery<MClientItemCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MClientItemCB xcreateColumnQueryCB() {
        MClientItemCB cb = new MClientItemCB();
        cb.xsetupForColumnQuery((MClientItemCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MClientItemCB> orCBLambda) {
        xorSQ((MClientItemCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MClientItemCB> andCBLambda) {
        xorSQAP((MClientItemCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MClientItemCB cb;
        if (mainCB != null) {
            cb = (MClientItemCB)mainCB;
        } else {
            cb = new MClientItemCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MClientItemCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MClientItemCQ.class.getName(); }
