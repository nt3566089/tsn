...
/**
 * The base condition-bean of E_TRIFITEMDATA.
 * @author DBFlute(AutoGenerator)
 */
public class BsETrifitemdataCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ETrifitemdataCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsETrifitemdataCB() {
     ...
     * @return this. (NotNull)
     */
    public ETrifitemdataCB acceptPK(java.math.BigDecimal ifdatakey) {
        assertObjectNotNull("ifdatakey", ifdatakey);
        BsETrifitemdataCB cb = this;
        cb.query().setIfdatakey_Equal(ifdatakey);
        return (ETrifitemdataCB)this;
    }
     ...
     */
    public ETrifitemdataCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ETrifitemdataCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ETrifitemdataCQ doGetConditionQuery() {
    ...
    protected ETrifitemdataCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ETrifitemdataCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ETrifitemdataCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ETrifitemdataCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ETrifitemdataCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ETrifitemdataCB> unionCBLambda) {
        final ETrifitemdataCB cb = new ETrifitemdataCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETrifitemdataCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ETrifitemdataCB> unionCBLambda) {
        final ETrifitemdataCB cb = new ETrifitemdataCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETrifitemdataCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ETrifitemdataCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ETrifitemdataCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "E_TRIFITEMDATA"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ETrifitemdataCB, ETrifitemdataCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ETrifitemdataCB> sq, ETrifitemdataCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ETrifitemdataCB dreamCruiseCB() {
        ETrifitemdataCB cb = new ETrifitemdataCB();
        cb.xsetupForDreamCruise((ETrifitemdataCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ETrifitemdataCB> columnQuery(final SpecifyQuery<ETrifitemdataCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ETrifitemdataCB xcreateColumnQueryCB() {
        ETrifitemdataCB cb = new ETrifitemdataCB();
        cb.xsetupForColumnQuery((ETrifitemdataCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ETrifitemdataCB> orCBLambda) {
        xorSQ((ETrifitemdataCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ETrifitemdataCB> andCBLambda) {
        xorSQAP((ETrifitemdataCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ETrifitemdataCB cb;
        if (mainCB != null) {
            cb = (ETrifitemdataCB)mainCB;
        } else {
            cb = new ETrifitemdataCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ETrifitemdataCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ETrifitemdataCQ.class.getName(); }
