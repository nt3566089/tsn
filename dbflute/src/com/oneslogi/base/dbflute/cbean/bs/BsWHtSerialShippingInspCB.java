...
/**
 * The base condition-bean of W_HT_SERIAL_SHIPPING_INSP.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtSerialShippingInspCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtSerialShippingInspCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtSerialShippingInspCB() {
     ...
     * @return this. (NotNull)
     */
    public WHtSerialShippingInspCB acceptPK(Long htSerialShippingInspId) {
        assertObjectNotNull("htSerialShippingInspId", htSerialShippingInspId);
        BsWHtSerialShippingInspCB cb = this;
        cb.query().setHtSerialShippingInspId_Equal(htSerialShippingInspId);
        return (WHtSerialShippingInspCB)this;
    }
     ...
     * @param htSerialShippingInspId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htSerialShippingInspId) {
        assertObjectNotNull("htSerialShippingInspId", htSerialShippingInspId);
        BsWHtSerialShippingInspCB cb = this;
        cb.query().setHtSerialShippingInspId_Equal(htSerialShippingInspId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtSerialShippingInspId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtSerialShippingInspId_Desc();
        return this;
    }
     ...
     */
    public WHtSerialShippingInspCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtSerialShippingInspCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtSerialShippingInspCQ doGetConditionQuery() {
    ...
    protected WHtSerialShippingInspCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtSerialShippingInspCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtSerialShippingInspCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtSerialShippingInspCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtSerialShippingInspCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtSerialShippingInspCB> unionCBLambda) {
        final WHtSerialShippingInspCB cb = new WHtSerialShippingInspCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtSerialShippingInspCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtSerialShippingInspCB> unionCBLambda) {
        final WHtSerialShippingInspCB cb = new WHtSerialShippingInspCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtSerialShippingInspCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">wHtSerialShippingInspBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">wHtSerialShippingInsp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtSerialShippingInsp</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtSerialShippingInsp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtSerialShippingInsp</span>.<span style="color: #CC4747">getMCustomer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtSerialShippingInsp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtSerialShippingInsp</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtSerialShippingInspCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WHtSerialShippingInspCQ> qyCall
         ...
         */
        public SpecifiedColumn columnHtSerialShippingInspId() { return doColumn("HT_SERIAL_SHIPPING_INSP_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSerialNo() { return doColumn("SERIAL_NO"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnHtSerialShippingInspId(); // PK
        ...
        @Override
        protected String getTableDbName() { return "W_HT_SERIAL_SHIPPING_INSP"; }
        /**
         ...
         */
        public HpSDRFunction<WHtSerialShippingInspCB, WHtSerialShippingInspCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtSerialShippingInspCB> sq, WHtSerialShippingInspCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtSerialShippingInspCB dreamCruiseCB() {
        WHtSerialShippingInspCB cb = new WHtSerialShippingInspCB();
        cb.xsetupForDreamCruise((WHtSerialShippingInspCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtSerialShippingInspCB> columnQuery(final SpecifyQuery<WHtSerialShippingInspCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtSerialShippingInspCB xcreateColumnQueryCB() {
        WHtSerialShippingInspCB cb = new WHtSerialShippingInspCB();
        cb.xsetupForColumnQuery((WHtSerialShippingInspCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtSerialShippingInspCB> orCBLambda) {
        xorSQ((WHtSerialShippingInspCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtSerialShippingInspCB> andCBLambda) {
        xorSQAP((WHtSerialShippingInspCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtSerialShippingInspCB cb;
        if (mainCB != null) {
            cb = (WHtSerialShippingInspCB)mainCB;
        } else {
            cb = new WHtSerialShippingInspCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtSerialShippingInspCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtSerialShippingInspCQ.class.getName(); }
