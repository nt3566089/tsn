...
/**
 * The base condition-bean of W_HT_RECEIVE_INSPECTION.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtReceiveInspectionCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtReceiveInspectionCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtReceiveInspectionCB() {
     ...
     * @return this. (NotNull)
     */
    public WHtReceiveInspectionCB acceptPK(Long htReceiveInspectionId) {
        assertObjectNotNull("htReceiveInspectionId", htReceiveInspectionId);
        BsWHtReceiveInspectionCB cb = this;
        cb.query().setHtReceiveInspectionId_Equal(htReceiveInspectionId);
        return (WHtReceiveInspectionCB)this;
    }
     ...
     * @param htReceiveInspectionId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htReceiveInspectionId) {
        assertObjectNotNull("htReceiveInspectionId", htReceiveInspectionId);
        BsWHtReceiveInspectionCB cb = this;
        cb.query().setHtReceiveInspectionId_Equal(htReceiveInspectionId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtReceiveInspectionId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtReceiveInspectionId_Desc();
        return this;
    }
     ...
     */
    public WHtReceiveInspectionCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtReceiveInspectionCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtReceiveInspectionCQ doGetConditionQuery() {
    ...
    protected WHtReceiveInspectionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtReceiveInspectionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtReceiveInspectionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtReceiveInspectionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtReceiveInspectionCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtReceiveInspectionCB> unionCBLambda) {
        final WHtReceiveInspectionCB cb = new WHtReceiveInspectionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtReceiveInspectionCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtReceiveInspectionCB> unionCBLambda) {
        final WHtReceiveInspectionCB cb = new WHtReceiveInspectionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtReceiveInspectionCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">wHtReceiveInspectionBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getTLot()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getMLocation()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getMStockType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtReceiveInspection</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtReceiveInspection</span>.<span style="color: #CC4747">getMWarehouse()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtReceiveInspectionCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WHtReceiveInspectionCQ> qyCall
         ...
         */
        public SpecifiedColumn columnHtReceiveInspectionId() { return doColumn("HT_RECEIVE_INSPECTION_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPieceQtyRcvOrd() { return doColumn("PIECE_QTY_RCV_ORD"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnHtReceiveInspectionId(); // PK
        ...
        @Override
        protected String getTableDbName() { return "W_HT_RECEIVE_INSPECTION"; }
        /**
         ...
         */
        public HpSDRFunction<WHtReceiveInspectionCB, WHtReceiveInspectionCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtReceiveInspectionCB> sq, WHtReceiveInspectionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtReceiveInspectionCB dreamCruiseCB() {
        WHtReceiveInspectionCB cb = new WHtReceiveInspectionCB();
        cb.xsetupForDreamCruise((WHtReceiveInspectionCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtReceiveInspectionCB> columnQuery(final SpecifyQuery<WHtReceiveInspectionCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtReceiveInspectionCB xcreateColumnQueryCB() {
        WHtReceiveInspectionCB cb = new WHtReceiveInspectionCB();
        cb.xsetupForColumnQuery((WHtReceiveInspectionCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtReceiveInspectionCB> orCBLambda) {
        xorSQ((WHtReceiveInspectionCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtReceiveInspectionCB> andCBLambda) {
        xorSQAP((WHtReceiveInspectionCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtReceiveInspectionCB cb;
        if (mainCB != null) {
            cb = (WHtReceiveInspectionCB)mainCB;
        } else {
            cb = new WHtReceiveInspectionCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtReceiveInspectionCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtReceiveInspectionCQ.class.getName(); }
