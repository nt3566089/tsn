...
/**
 * The base condition-bean of T_CORDDTAEC.
 * @author DBFlute(AutoGenerator)
 */
public class BsTCorddtaecCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TCorddtaecCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTCorddtaecCB() {
     ...
     * @return this. (NotNull)
     */
    public TCorddtaecCB acceptPK(Long orderChangeId) {
        assertObjectNotNull("orderChangeId", orderChangeId);
        BsTCorddtaecCB cb = this;
        cb.query().setOrderChangeId_Equal(orderChangeId);
        return (TCorddtaecCB)this;
    }
     ...
     * @param orderChangeId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long orderChangeId) {
        assertObjectNotNull("orderChangeId", orderChangeId);
        BsTCorddtaecCB cb = this;
        cb.query().setOrderChangeId_Equal(orderChangeId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_OrderChangeId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_OrderChangeId_Desc();
        return this;
    }
     ...
     */
    public TCorddtaecCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TCorddtaecCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TCorddtaecCQ doGetConditionQuery() {
    ...
    protected TCorddtaecCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TCorddtaecCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TCorddtaecCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TCorddtaecCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TCorddtaecCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TCorddtaecCB> unionCBLambda) {
        final TCorddtaecCB cb = new TCorddtaecCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TCorddtaecCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TCorddtaecCB> unionCBLambda) {
        final TCorddtaecCB cb = new TCorddtaecCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TCorddtaecCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tCorddtaecBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tCorddtaec</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tCorddtaec</span>.<span style="color: #CC4747">getTCordhdr()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<TCorddtaecCQ> {
        protected TCordhdrCB.HpSpecification _tCordhdr;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TCorddtaecCQ> qyCall
         ...
         */
        public SpecifiedColumn columnOrderChangeId() { return doColumn("ORDER_CHANGE_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "T_CORDDTAEC"; }
        /**
         ...
         */
        public HpSDRFunction<TCorddtaecCB, TCorddtaecCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TCorddtaecCB> sq, TCorddtaecCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TCorddtaecCB dreamCruiseCB() {
        TCorddtaecCB cb = new TCorddtaecCB();
        cb.xsetupForDreamCruise((TCorddtaecCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TCorddtaecCB> columnQuery(final SpecifyQuery<TCorddtaecCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TCorddtaecCB xcreateColumnQueryCB() {
        TCorddtaecCB cb = new TCorddtaecCB();
        cb.xsetupForColumnQuery((TCorddtaecCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TCorddtaecCB> orCBLambda) {
        xorSQ((TCorddtaecCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TCorddtaecCB> andCBLambda) {
        xorSQAP((TCorddtaecCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TCorddtaecCB cb;
        if (mainCB != null) {
            cb = (TCorddtaecCB)mainCB;
        } else {
            cb = new TCorddtaecCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TCorddtaecCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TCorddtaecCQ.class.getName(); }
