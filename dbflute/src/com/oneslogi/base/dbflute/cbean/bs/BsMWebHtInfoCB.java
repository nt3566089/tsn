...
/**
 * The base condition-bean of M_WEB_HT_INFO.
 * @author DBFlute(AutoGenerator)
 */
public class BsMWebHtInfoCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MWebHtInfoCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMWebHtInfoCB() {
     ...
     * @return this. (NotNull)
     */
    public MWebHtInfoCB acceptPK(Long webHtInfoId) {
        assertObjectNotNull("webHtInfoId", webHtInfoId);
        BsMWebHtInfoCB cb = this;
        cb.query().setWebHtInfoId_Equal(webHtInfoId);
        return (MWebHtInfoCB)this;
    }
     ...
     * @param webHtInfoId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long webHtInfoId) {
        assertObjectNotNull("webHtInfoId", webHtInfoId);
        BsMWebHtInfoCB cb = this;
        cb.query().setWebHtInfoId_Equal(webHtInfoId);
    }
     ...
     * @return this. (NotNull)
     */
    public MWebHtInfoCB acceptUniqueOf(String macAddress) {
        assertObjectNotNull("macAddress", macAddress);
        BsMWebHtInfoCB cb = this;
        cb.query().setMacAddress_Equal(macAddress);
        return (MWebHtInfoCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_WebHtInfoId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_WebHtInfoId_Desc();
        return this;
    }
     ...
     */
    public MWebHtInfoCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MWebHtInfoCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MWebHtInfoCQ doGetConditionQuery() {
    ...
    protected MWebHtInfoCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MWebHtInfoCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MWebHtInfoCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MWebHtInfoCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MWebHtInfoCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MWebHtInfoCB> unionCBLambda) {
        final MWebHtInfoCB cb = new MWebHtInfoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MWebHtInfoCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MWebHtInfoCB> unionCBLambda) {
        final MWebHtInfoCB cb = new MWebHtInfoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MWebHtInfoCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">mWebHtInfo</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mWebHtInfo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mWebHtInfo</span>.<span style="color: #CC4747">getMWarehouse()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mWebHtInfo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mWebHtInfo</span>.<span style="color: #CC4747">getBClassDtlByDelFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MWebHtInfoCQ> {
         ...
         */
        public SpecifiedColumn columnWebHtInfoId() { return doColumn("WEB_HT_INFO_ID"); }
        /**
         ...
         */
        public HpSDRFunction<MWebHtInfoCB, MWebHtInfoCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MWebHtInfoCB> sq, MWebHtInfoCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MWebHtInfoCB dreamCruiseCB() {
        MWebHtInfoCB cb = new MWebHtInfoCB();
        cb.xsetupForDreamCruise((MWebHtInfoCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MWebHtInfoCB> columnQuery(final SpecifyQuery<MWebHtInfoCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MWebHtInfoCB xcreateColumnQueryCB() {
        MWebHtInfoCB cb = new MWebHtInfoCB();
        cb.xsetupForColumnQuery((MWebHtInfoCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MWebHtInfoCB> orCBLambda) {
        xorSQ((MWebHtInfoCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MWebHtInfoCB> andCBLambda) {
        xorSQAP((MWebHtInfoCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MWebHtInfoCB cb;
        if (mainCB != null) {
            cb = (MWebHtInfoCB)mainCB;
        } else {
            cb = new MWebHtInfoCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MWebHtInfoCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MWebHtInfoCQ.class.getName(); }
