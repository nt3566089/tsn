...
/**
 * The base condition-bean of E_CUSTOMER.
 * @author DBFlute(AutoGenerator)
 */
public class BsECustomerCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ECustomerCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsECustomerCB() {
     ...
     * @return this. (NotNull)
     */
    public ECustomerCB acceptPK(Long customerId) {
        assertObjectNotNull("customerId", customerId);
        BsECustomerCB cb = this;
        cb.query().setCustomerId_Equal(customerId);
        return (ECustomerCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ECustomerCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
     ...
     */
    public ECustomerCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ECustomerCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ECustomerCQ doGetConditionQuery() {
    ...
    protected ECustomerCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ECustomerCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ECustomerCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ECustomerCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ECustomerCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ECustomerCB> unionCBLambda) {
        final ECustomerCB cb = new ECustomerCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ECustomerCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ECustomerCB> unionCBLambda) {
        final ECustomerCB cb = new ECustomerCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ECustomerCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ECustomerCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ECustomerCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDeliveryReadtime() { return doColumn("DELIVERY_READTIME"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "E_CUSTOMER"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ECustomerCB, ECustomerCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ECustomerCB> sq, ECustomerCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ECustomerCB dreamCruiseCB() {
        ECustomerCB cb = new ECustomerCB();
        cb.xsetupForDreamCruise((ECustomerCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ECustomerCB> columnQuery(final SpecifyQuery<ECustomerCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ECustomerCB xcreateColumnQueryCB() {
        ECustomerCB cb = new ECustomerCB();
        cb.xsetupForColumnQuery((ECustomerCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ECustomerCB> orCBLambda) {
        xorSQ((ECustomerCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ECustomerCB> andCBLambda) {
        xorSQAP((ECustomerCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ECustomerCB cb;
        if (mainCB != null) {
            cb = (ECustomerCB)mainCB;
        } else {
            cb = new ECustomerCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ECustomerCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ECustomerCQ.class.getName(); }
