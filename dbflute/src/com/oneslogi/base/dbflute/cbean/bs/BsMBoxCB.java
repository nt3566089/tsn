...
/**
 * The base condition-bean of M_BOX.
 * @author DBFlute(AutoGenerator)
 */
public class BsMBoxCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MBoxCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public MBoxCB acceptPK(Long boxId) {
     ...
     * @param boxId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long boxId) {
        assertObjectNotNull("boxId", boxId);
        BsMBoxCB cb = this;
        cb.query().setBoxId_Equal(boxId);
    }
     ...
     * @return this. (NotNull)
     */
    public MBoxCB acceptUniqueOf(Long centerId, String boxCd) {
        assertObjectNotNull("centerId", centerId);assertObjectNotNull("boxCd", boxCd);
        BsMBoxCB cb = this;
        cb.query().setCenterId_Equal(centerId);cb.query().setBoxCd_Equal(boxCd);
        return (MBoxCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_BoxId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_BoxId_Desc();
        return this;
    }
    ...
    public MBoxCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MBoxCQ doGetConditionQuery() {
    ...
    protected MBoxCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MBoxCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MBoxCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MBoxCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MBoxCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MBoxCB> unionCBLambda) {
        final MBoxCB cb = new MBoxCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MBoxCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MBoxCB> unionCBLambda) {
        final MBoxCB cb = new MBoxCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MBoxCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mBoxBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mBox</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mBox</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mBox</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mBox</span>.<span style="color: #CC4747">getBClassDtlByDelFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MBoxCQ> {
        protected MCenterCB.HpSpecification _mCenter;
        protected BClassDtlCB.HpSpecification _bClassDtlByDelFlg;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MBoxCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnWidth() { return doColumn("WIDTH"); }
        /**
         * HEIGHT: {decimal(16, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnHeight() { return doColumn("HEIGHT"); }
        /**
         * VOLUME: {decimal(16, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVolume() { return doColumn("VOLUME"); }
        /**
         * VOLUME_RATE: {bigint(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnVolumeRate() { return doColumn("VOLUME_RATE"); }
        /**
         * PERMIT_VOLUME: {decimal(16, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPermitVolume() { return doColumn("PERMIT_VOLUME"); }
        /**
         * PERMIT_WEIGHT: {decimal(16, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPermitWeight() { return doColumn("PERMIT_WEIGHT"); }
        /**
         * BOX_TYPE: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        ...
        @Override
        protected String getTableDbName() { return "M_BOX"; }
        /**
         ...
         */
        public HpSDRFunction<MBoxGrpCB, MBoxCQ> derivedMBoxGrpList() {
            assertDerived("mBoxGrpList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBoxGrpCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMBoxGrpList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from M_BOX_GRP_DTL where ...) as FOO_MAX} <br>
         ...
         * }, MBoxGrpDtl.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MBoxGrpDtlCB, MBoxCQ> derivedMBoxGrpDtlList() {
            assertDerived("mBoxGrpDtlList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBoxGrpDtlCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMBoxGrpDtlList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MCarrierBoxCB, MBoxCQ> derivedMCarrierBoxList() {
            assertDerived("mCarrierBoxList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierBoxCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MParamCB, MBoxCQ> derivedMParamList() {
            assertDerived("mParamList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MParamCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TPackingHCB, MBoxCQ> derivedTPackingHList() {
            assertDerived("tPackingHList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TPackingHCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtShippingCB, MBoxCQ> derivedWHtShippingList() {
            assertDerived("wHtShippingList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtShippingCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WSglRowShipInspHCB, MBoxCQ> derivedWSglRowShipInspHList() {
            assertDerived("wSglRowShipInspHList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WSglRowShipInspHCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WShippingInterruptCB, MBoxCQ> derivedWShippingInterruptList() {
            assertDerived("wShippingInterruptList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WShippingInterruptCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<MBoxCB, MBoxCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBoxCB> sq, MBoxCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MBoxCB dreamCruiseCB() {
        MBoxCB cb = new MBoxCB();
        cb.xsetupForDreamCruise((MBoxCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MBoxCB> columnQuery(final SpecifyQuery<MBoxCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MBoxCB xcreateColumnQueryCB() {
        MBoxCB cb = new MBoxCB();
        cb.xsetupForColumnQuery((MBoxCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MBoxCB> orCBLambda) {
        xorSQ((MBoxCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MBoxCB> andCBLambda) {
        xorSQAP((MBoxCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MBoxCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MBoxCQ.class.getName(); }
