...
/**
 * The base condition-bean of H_STOCK_INOUT.
 * @author DBFlute(AutoGenerator)
 */
public class BsHStockInoutCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected HStockInoutCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsHStockInoutCB() {
     ...
     * @return this. (NotNull)
     */
    public HStockInoutCB acceptPK(Long stockInoutId) {
        assertObjectNotNull("stockInoutId", stockInoutId);
        BsHStockInoutCB cb = this;
        cb.query().setStockInoutId_Equal(stockInoutId);
        return (HStockInoutCB)this;
    }
     ...
     */
    public HStockInoutCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public HStockInoutCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected HStockInoutCQ doGetConditionQuery() {
    ...
    protected HStockInoutCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected HStockInoutCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        HStockInoutCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected HStockInoutCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new HStockInoutCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<HStockInoutCB> unionCBLambda) {
        final HStockInoutCB cb = new HStockInoutCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HStockInoutCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<HStockInoutCB> unionCBLambda) {
        final HStockInoutCB cb = new HStockInoutCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HStockInoutCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">hStockInoutBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">hStockInout</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hStockInout</span>.<span style="color: #CC4747">getMProcessType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hStockInout</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hStockInout</span>.<span style="color: #CC4747">getHStock()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hStockInout</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hStockInout</span>.<span style="color: #CC4747">getBClassDtlByCorrectType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hStockInout</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hStockInout</span>.<span style="color: #CC4747">getBClassDtlByInoutType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<HStockInoutCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<HStockInoutCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "H_STOCK_INOUT"; }
        /**
         ...
         */
        public HpSDRFunction<HStockInoutCB, HStockInoutCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HStockInoutCB> sq, HStockInoutCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public HStockInoutCB dreamCruiseCB() {
        HStockInoutCB cb = new HStockInoutCB();
        cb.xsetupForDreamCruise((HStockInoutCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<HStockInoutCB> columnQuery(final SpecifyQuery<HStockInoutCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected HStockInoutCB xcreateColumnQueryCB() {
        HStockInoutCB cb = new HStockInoutCB();
        cb.xsetupForColumnQuery((HStockInoutCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<HStockInoutCB> orCBLambda) {
        xorSQ((HStockInoutCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<HStockInoutCB> andCBLambda) {
        xorSQAP((HStockInoutCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final HStockInoutCB cb;
        if (mainCB != null) {
            cb = (HStockInoutCB)mainCB;
        } else {
            cb = new HStockInoutCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return HStockInoutCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return HStockInoutCQ.class.getName(); }
