...
/**
 * The base condition-bean of M_BOX_GRP_DTL.
 * @author DBFlute(AutoGenerator)
 */
public class BsMBoxGrpDtlCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MBoxGrpDtlCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMBoxGrpDtlCB() {
     ...
     * @return this. (NotNull)
     */
    public MBoxGrpDtlCB acceptPK(Long boxGrpDtlId) {
        assertObjectNotNull("boxGrpDtlId", boxGrpDtlId);
        BsMBoxGrpDtlCB cb = this;
        cb.query().setBoxGrpDtlId_Equal(boxGrpDtlId);
        return (MBoxGrpDtlCB)this;
    }
     ...
     * @param boxGrpDtlId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long boxGrpDtlId) {
        assertObjectNotNull("boxGrpDtlId", boxGrpDtlId);
        BsMBoxGrpDtlCB cb = this;
        cb.query().setBoxGrpDtlId_Equal(boxGrpDtlId);
    }
     ...
     * @return this. (NotNull)
     */
    public MBoxGrpDtlCB acceptUniqueOf(Long boxGrpId, Long boxId) {
        assertObjectNotNull("boxGrpId", boxGrpId);assertObjectNotNull("boxId", boxId);
        BsMBoxGrpDtlCB cb = this;
        cb.query().setBoxGrpId_Equal(boxGrpId);cb.query().setBoxId_Equal(boxId);
        return (MBoxGrpDtlCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_BoxGrpDtlId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_BoxGrpDtlId_Desc();
        return this;
    }
     ...
     */
    public MBoxGrpDtlCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MBoxGrpDtlCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MBoxGrpDtlCQ doGetConditionQuery() {
    ...
    protected MBoxGrpDtlCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MBoxGrpDtlCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MBoxGrpDtlCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MBoxGrpDtlCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MBoxGrpDtlCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MBoxGrpDtlCB> unionCBLambda) {
        final MBoxGrpDtlCB cb = new MBoxGrpDtlCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MBoxGrpDtlCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MBoxGrpDtlCB> unionCBLambda) {
        final MBoxGrpDtlCB cb = new MBoxGrpDtlCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MBoxGrpDtlCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">mBoxGrpDtl</span>.<span style="color: #CC4747">getMBoxGrp()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MBoxGrpDtlCQ> {
         ...
         */
        public SpecifiedColumn columnBoxGrpDtlId() { return doColumn("BOX_GRP_DTL_ID"); }
        /**
         * BOX_GRP_ID: {UQ+, IX, NotNull, bigint(19), FK to M_BOX_GRP}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBoxGrpId() { return doColumn("BOX_GRP_ID"); }
        /**
         ...
         */
        public HpSDRFunction<MBoxGrpDtlCB, MBoxGrpDtlCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MBoxGrpDtlCB> sq, MBoxGrpDtlCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MBoxGrpDtlCB dreamCruiseCB() {
        MBoxGrpDtlCB cb = new MBoxGrpDtlCB();
        cb.xsetupForDreamCruise((MBoxGrpDtlCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MBoxGrpDtlCB> columnQuery(final SpecifyQuery<MBoxGrpDtlCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MBoxGrpDtlCB xcreateColumnQueryCB() {
        MBoxGrpDtlCB cb = new MBoxGrpDtlCB();
        cb.xsetupForColumnQuery((MBoxGrpDtlCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MBoxGrpDtlCB> orCBLambda) {
        xorSQ((MBoxGrpDtlCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MBoxGrpDtlCB> andCBLambda) {
        xorSQAP((MBoxGrpDtlCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MBoxGrpDtlCB cb;
        if (mainCB != null) {
            cb = (MBoxGrpDtlCB)mainCB;
        } else {
            cb = new MBoxGrpDtlCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MBoxGrpDtlCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MBoxGrpDtlCQ.class.getName(); }
