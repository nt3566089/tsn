...
/**
 * The base condition-bean of H_MOVE_H.
 * @author DBFlute(AutoGenerator)
 */
public class BsHMoveHCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected HMoveHCQ _conditionQuery;
     ...
     */
    public HMoveHCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public HMoveHCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected HMoveHCQ doGetConditionQuery() {
    ...
    protected HMoveHCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected HMoveHCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        HMoveHCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected HMoveHCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new HMoveHCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<HMoveHCB> unionCBLambda) {
        final HMoveHCB cb = new HMoveHCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HMoveHCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<HMoveHCB> unionCBLambda) {
        final HMoveHCB cb = new HMoveHCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HMoveHCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">hMoveHBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">hMoveH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hMoveH</span>.<span style="color: #CC4747">getMProcessType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<HMoveHCQ> {
        protected MProcessTypeCB.HpSpecification _mProcessType;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<HMoveHCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "H_MOVE_H"; }
        /**
         ...
         */
        public HpSDRFunction<HInventoryBCB, HMoveHCQ> derivedHInventoryBList() {
            assertDerived("hInventoryBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HInventoryBCB> sq, HMoveHCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<HMoveBCB, HMoveHCQ> derivedHMoveBList() {
            assertDerived("hMoveBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HMoveBCB> sq, HMoveHCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<HMoveHCB, HMoveHCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HMoveHCB> sq, HMoveHCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public HMoveHCB dreamCruiseCB() {
        HMoveHCB cb = new HMoveHCB();
        cb.xsetupForDreamCruise((HMoveHCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<HMoveHCB> columnQuery(final SpecifyQuery<HMoveHCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected HMoveHCB xcreateColumnQueryCB() {
        HMoveHCB cb = new HMoveHCB();
        cb.xsetupForColumnQuery((HMoveHCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<HMoveHCB> orCBLambda) {
        xorSQ((HMoveHCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<HMoveHCB> andCBLambda) {
        xorSQAP((HMoveHCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return HMoveHCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return HMoveHCQ.class.getName(); }
