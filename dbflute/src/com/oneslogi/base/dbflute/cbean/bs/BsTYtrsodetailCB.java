...
/**
 * The base condition-bean of T_YTRSODETAIL.
 * @author DBFlute(AutoGenerator)
 */
public class BsTYtrsodetailCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TYtrsodetailCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTYtrsodetailCB() {
     ...
     * @return this. (NotNull)
     */
    public TYtrsodetailCB acceptPK(Long trsodetailId) {
        assertObjectNotNull("trsodetailId", trsodetailId);
        BsTYtrsodetailCB cb = this;
        cb.query().setTrsodetailId_Equal(trsodetailId);
        return (TYtrsodetailCB)this;
    }
     ...
     * @param trsodetailId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long trsodetailId) {
        assertObjectNotNull("trsodetailId", trsodetailId);
        BsTYtrsodetailCB cb = this;
        cb.query().setTrsodetailId_Equal(trsodetailId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_TrsodetailId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TrsodetailId_Desc();
        return this;
    }
     ...
     */
    public TYtrsodetailCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TYtrsodetailCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TYtrsodetailCQ doGetConditionQuery() {
    ...
    protected TYtrsodetailCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TYtrsodetailCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TYtrsodetailCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TYtrsodetailCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TYtrsodetailCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TYtrsodetailCB> unionCBLambda) {
        final TYtrsodetailCB cb = new TYtrsodetailCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TYtrsodetailCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TYtrsodetailCB> unionCBLambda) {
        final TYtrsodetailCB cb = new TYtrsodetailCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TYtrsodetailCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tYtrsodetail</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tYtrsodetail</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TYtrsodetailCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTrsoId() { return doColumn("TRSO_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSoLineNo() { return doColumn("SO_LINE_NO"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDamageFlg() { return doColumn("DAMAGE_FLG"); }
        /**
         * NO_SHIPPING_FLG: {NotNull, bigint(19), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnNoShippingFlg() { return doColumn("NO_SHIPPING_FLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAllocQty() { return doColumn("ALLOC_QTY"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInspectedQty() { return doColumn("INSPECTED_QTY"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAdjustQty() { return doColumn("ADJUST_QTY"); }
        /**
         ...
         */
        public HpSDRFunction<TTrimallocschkriCB, TYtrsodetailCQ> derivedTTrimallocschkriList() {
            assertDerived("tTrimallocschkriList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TTrimallocschkriCB> sq, TYtrsodetailCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TTrpickdetailCB, TYtrsodetailCQ> derivedTTrpickdetailList() {
            assertDerived("tTrpickdetailList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TTrpickdetailCB> sq, TYtrsodetailCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<TYtrsodetailCB, TYtrsodetailCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TYtrsodetailCB> sq, TYtrsodetailCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TYtrsodetailCB dreamCruiseCB() {
        TYtrsodetailCB cb = new TYtrsodetailCB();
        cb.xsetupForDreamCruise((TYtrsodetailCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TYtrsodetailCB> columnQuery(final SpecifyQuery<TYtrsodetailCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TYtrsodetailCB xcreateColumnQueryCB() {
        TYtrsodetailCB cb = new TYtrsodetailCB();
        cb.xsetupForColumnQuery((TYtrsodetailCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TYtrsodetailCB> orCBLambda) {
        xorSQ((TYtrsodetailCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TYtrsodetailCB> andCBLambda) {
        xorSQAP((TYtrsodetailCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TYtrsodetailCB cb;
        if (mainCB != null) {
            cb = (TYtrsodetailCB)mainCB;
        } else {
            cb = new TYtrsodetailCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TYtrsodetailCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TYtrsodetailCQ.class.getName(); }
