...
/**
 * The base condition-bean of M_MFWHxITEM.
 * @author DBFlute(AutoGenerator)
 */
public class BsMMfwhxitemCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MMfwhxitemCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMMfwhxitemCB() {
     ...
     * @return this. (NotNull)
     */
    public MMfwhxitemCB acceptPK(Long mfwhItemId) {
        assertObjectNotNull("mfwhItemId", mfwhItemId);
        BsMMfwhxitemCB cb = this;
        cb.query().setMfwhItemId_Equal(mfwhItemId);
        return (MMfwhxitemCB)this;
    }
     ...
     * @param mfwhItemId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long mfwhItemId) {
        assertObjectNotNull("mfwhItemId", mfwhItemId);
        BsMMfwhxitemCB cb = this;
        cb.query().setMfwhItemId_Equal(mfwhItemId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_MfwhItemId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_MfwhItemId_Desc();
        return this;
    }
     ...
     */
    public MMfwhxitemCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MMfwhxitemCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MMfwhxitemCQ doGetConditionQuery() {
    ...
    protected MMfwhxitemCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MMfwhxitemCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MMfwhxitemCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MMfwhxitemCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MMfwhxitemCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MMfwhxitemCB> unionCBLambda) {
        final MMfwhxitemCB cb = new MMfwhxitemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MMfwhxitemCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MMfwhxitemCB> unionCBLambda) {
        final MMfwhxitemCB cb = new MMfwhxitemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MMfwhxitemCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mMfwhxitemBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mMfwhxitem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mMfwhxitem</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mMfwhxitem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mMfwhxitem</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mMfwhxitem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mMfwhxitem</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MMfwhxitemCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MMfwhxitemCQ> qyCall
         ...
         */
        public SpecifiedColumn columnMfwhItemId() { return doColumn("MFWH_ITEM_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSlotlocname() { return doColumn("SLOTLOCNAME"); }
        /**
         * PICKLOCNAME: {varchar(255)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPicklocname() { return doColumn("PICKLOCNAME"); }
        /**
         * PHYSICALTYPE: {NotNull, varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPhysicaltype() { return doColumn("PHYSICALTYPE"); }
        /**
         * PHYSICALCYCLE: {decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPhysicalcycle() { return doColumn("PHYSICALCYCLE"); }
        /**
         * PHYSICALGROUP: {varchar(60)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPhysicalgroup() { return doColumn("PHYSICALGROUP"); }
        /**
         * PHYSICALDATE: {varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPhysicaldate() { return doColumn("PHYSICALDATE"); }
        /**
         * REORDERTYPE: {NotNull, varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReordertype() { return doColumn("REORDERTYPE"); }
        /**
         * REORDERINTERVAL: {decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReorderinterval() { return doColumn("REORDERINTERVAL"); }
        /**
         * REORDERPOINT: {decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReorderpoint() { return doColumn("REORDERPOINT"); }
        /**
         * REORDERQTY: {decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReorderqty() { return doColumn("REORDERQTY"); }
        /**
         * REORDERLEADTIME: {decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReorderleadtime() { return doColumn("REORDERLEADTIME"); }
        /**
         * REORDERLASTDAY: {varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReorderlastday() { return doColumn("REORDERLASTDAY"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReplenishpoint() { return doColumn("REPLENISHPOINT"); }
        /**
         * MAXQTY: {decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMaxqty() { return doColumn("MAXQTY"); }
        /**
         * CAUSELOC: {varchar(255)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCauseloc() { return doColumn("CAUSELOC"); }
        /**
         * SHIPPINGTYPE: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShippingtype() { return doColumn("SHIPPINGTYPE"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnProcessworkingkey() { return doColumn("PROCESSWORKINGKEY"); }
        /**
         * USERUSE1: {varchar(60)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSerialflg() { return doColumn("SERIALFLG"); }
        /**
         * FULLPALLETFLG: {NotNull, decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnFullpalletflg() { return doColumn("FULLPALLETFLG"); }
        /**
         * PLSLOTLOCNAME: {varchar(255)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlslotlocname() { return doColumn("PLSLOTLOCNAME"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "M_MFWHxITEM"; }
        /**
         ...
         */
        public HpSDRFunction<MMfwhxitemCB, MMfwhxitemCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MMfwhxitemCB> sq, MMfwhxitemCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MMfwhxitemCB dreamCruiseCB() {
        MMfwhxitemCB cb = new MMfwhxitemCB();
        cb.xsetupForDreamCruise((MMfwhxitemCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MMfwhxitemCB> columnQuery(final SpecifyQuery<MMfwhxitemCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MMfwhxitemCB xcreateColumnQueryCB() {
        MMfwhxitemCB cb = new MMfwhxitemCB();
        cb.xsetupForColumnQuery((MMfwhxitemCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MMfwhxitemCB> orCBLambda) {
        xorSQ((MMfwhxitemCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MMfwhxitemCB> andCBLambda) {
        xorSQAP((MMfwhxitemCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MMfwhxitemCB cb;
        if (mainCB != null) {
            cb = (MMfwhxitemCB)mainCB;
        } else {
            cb = new MMfwhxitemCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MMfwhxitemCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MMfwhxitemCQ.class.getName(); }
