...
/**
 * The base condition-bean of T_KEEPING_LOT.
 * @author DBFlute(AutoGenerator)
 */
public class BsTKeepingLotCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TKeepingLotCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTKeepingLotCB() {
     ...
     * @return this. (NotNull)
     */
    public TKeepingLotCB acceptPK(Long keepingLotId) {
        assertObjectNotNull("keepingLotId", keepingLotId);
        BsTKeepingLotCB cb = this;
        cb.query().setKeepingLotId_Equal(keepingLotId);
        return (TKeepingLotCB)this;
    }
     ...
     * @param keepingLotId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long keepingLotId) {
        assertObjectNotNull("keepingLotId", keepingLotId);
        BsTKeepingLotCB cb = this;
        cb.query().setKeepingLotId_Equal(keepingLotId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_KeepingLotId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_KeepingLotId_Desc();
        return this;
    }
     ...
     */
    public TKeepingLotCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TKeepingLotCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TKeepingLotCQ doGetConditionQuery() {
    ...
    protected TKeepingLotCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TKeepingLotCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TKeepingLotCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TKeepingLotCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TKeepingLotCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TKeepingLotCB> unionCBLambda) {
        final TKeepingLotCB cb = new TKeepingLotCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TKeepingLotCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TKeepingLotCB> unionCBLambda) {
        final TKeepingLotCB cb = new TKeepingLotCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TKeepingLotCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tKeepingLotBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tKeepingLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tKeepingLot</span>.<span style="color: #CC4747">getMCustomer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tKeepingLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tKeepingLot</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tKeepingLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tKeepingLot</span>.<span style="color: #CC4747">getTLot()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TKeepingLotCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TKeepingLotCQ> qyCall
         ...
         */
        public SpecifiedColumn columnKeepingLotId() { return doColumn("KEEPING_LOT_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "T_KEEPING_LOT"; }
        /**
         ...
         */
        public HpSDRFunction<TKeepingLotCB, TKeepingLotCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TKeepingLotCB> sq, TKeepingLotCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TKeepingLotCB dreamCruiseCB() {
        TKeepingLotCB cb = new TKeepingLotCB();
        cb.xsetupForDreamCruise((TKeepingLotCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TKeepingLotCB> columnQuery(final SpecifyQuery<TKeepingLotCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TKeepingLotCB xcreateColumnQueryCB() {
        TKeepingLotCB cb = new TKeepingLotCB();
        cb.xsetupForColumnQuery((TKeepingLotCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TKeepingLotCB> orCBLambda) {
        xorSQ((TKeepingLotCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TKeepingLotCB> andCBLambda) {
        xorSQAP((TKeepingLotCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TKeepingLotCB cb;
        if (mainCB != null) {
            cb = (TKeepingLotCB)mainCB;
        } else {
            cb = new TKeepingLotCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TKeepingLotCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TKeepingLotCQ.class.getName(); }
