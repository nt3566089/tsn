...
/**
 * The base condition-bean of T_SERIAL_NO.
 * @author DBFlute(AutoGenerator)
 */
public class BsTSerialNoCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TSerialNoCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTSerialNoCB() {
     ...
     * @return this. (NotNull)
     */
    public TSerialNoCB acceptPK(Long serialNoId) {
        assertObjectNotNull("serialNoId", serialNoId);
        BsTSerialNoCB cb = this;
        cb.query().setSerialNoId_Equal(serialNoId);
        return (TSerialNoCB)this;
    }
     ...
     * @param serialNoId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long serialNoId) {
        assertObjectNotNull("serialNoId", serialNoId);
        BsTSerialNoCB cb = this;
        cb.query().setSerialNoId_Equal(serialNoId);
    }
     ...
     * @return this. (NotNull)
     */
    public TSerialNoCB acceptUniqueOf(Long centerId, Long clientId, Long productId, String serialNo) {
        ...
        BsTSerialNoCB cb = this;
        cb.query().setCenterId_Equal(centerId);cb.query().setClientId_Equal(clientId);cb.query().setProductId_Equal(productId);cb.query().setSerialNo_Equal(serialNo);
        return (TSerialNoCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_SerialNoId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_SerialNoId_Desc();
        return this;
    }
     ...
     */
    public TSerialNoCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TSerialNoCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TSerialNoCQ doGetConditionQuery() {
    ...
    protected TSerialNoCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TSerialNoCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TSerialNoCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TSerialNoCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TSerialNoCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TSerialNoCB> unionCBLambda) {
        final TSerialNoCB cb = new TSerialNoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TSerialNoCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TSerialNoCB> unionCBLambda) {
        final TSerialNoCB cb = new TSerialNoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TSerialNoCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tSerialNoBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tSerialNo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tSerialNo</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tSerialNo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tSerialNo</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tSerialNo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tSerialNo</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TSerialNoCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TSerialNoCQ> qyCall
         ...
         */
        public SpecifiedColumn columnSerialNoId() { return doColumn("SERIAL_NO_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReceiveDt() { return doColumn("RECEIVE_DT"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "T_SERIAL_NO"; }
        /**
         ...
         */
        public HpSDRFunction<TSerialNoCB, TSerialNoCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TSerialNoCB> sq, TSerialNoCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TSerialNoCB dreamCruiseCB() {
        TSerialNoCB cb = new TSerialNoCB();
        cb.xsetupForDreamCruise((TSerialNoCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TSerialNoCB> columnQuery(final SpecifyQuery<TSerialNoCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TSerialNoCB xcreateColumnQueryCB() {
        TSerialNoCB cb = new TSerialNoCB();
        cb.xsetupForColumnQuery((TSerialNoCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TSerialNoCB> orCBLambda) {
        xorSQ((TSerialNoCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TSerialNoCB> andCBLambda) {
        xorSQAP((TSerialNoCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TSerialNoCB cb;
        if (mainCB != null) {
            cb = (TSerialNoCB)mainCB;
        } else {
            cb = new TSerialNoCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TSerialNoCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TSerialNoCQ.class.getName(); }
