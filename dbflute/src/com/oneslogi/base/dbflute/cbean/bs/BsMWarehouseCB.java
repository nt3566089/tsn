...
/**
 * The base condition-bean of M_WAREHOUSE.
 * @author DBFlute(AutoGenerator)
 */
public class BsMWarehouseCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MWarehouseCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMWarehouseCB() {
     ...
     * @return this. (NotNull)
     */
    public MWarehouseCB acceptPK(Long warehouseId) {
        assertObjectNotNull("warehouseId", warehouseId);
        BsMWarehouseCB cb = this;
        cb.query().setWarehouseId_Equal(warehouseId);
        return (MWarehouseCB)this;
    }
     ...
     * @param warehouseId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long warehouseId) {
        assertObjectNotNull("warehouseId", warehouseId);
        BsMWarehouseCB cb = this;
        cb.query().setWarehouseId_Equal(warehouseId);
    }
     ...
     * @return this. (NotNull)
     */
    public MWarehouseCB acceptUniqueOf(Long centerId, String warehouseCd) {
        assertObjectNotNull("centerId", centerId);assertObjectNotNull("warehouseCd", warehouseCd);
        BsMWarehouseCB cb = this;
        cb.query().setCenterId_Equal(centerId);cb.query().setWarehouseCd_Equal(warehouseCd);
        return (MWarehouseCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_WarehouseId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_WarehouseId_Desc();
        return this;
    }
     ...
     */
    public MWarehouseCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MWarehouseCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MWarehouseCQ doGetConditionQuery() {
    ...
    protected MWarehouseCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MWarehouseCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MWarehouseCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MWarehouseCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MWarehouseCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MWarehouseCB> unionCBLambda) {
        final MWarehouseCB cb = new MWarehouseCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MWarehouseCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MWarehouseCB> unionCBLambda) {
        final MWarehouseCB cb = new MWarehouseCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MWarehouseCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mWarehouseBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mWarehouse</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mWarehouse</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mWarehouse</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mWarehouse</span>.<span style="color: #CC4747">getBClassDtlByDelFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    protected BClassDtlNss _nssBClassDtlByForeignFlg;
    public BClassDtlNss xdfgetNssBClassDtlByForeignFlg() {
        if (_nssBClassDtlByForeignFlg == null) { _nssBClassDtlByForeignFlg = new BClassDtlNss(null); }
        return _nssBClassDtlByForeignFlg;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">mWarehouseBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BClassDtlByForeignFlg()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mWarehouse</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mWarehouse</span>.<span style="color: #CC4747">getBClassDtlByForeignFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BClassDtlNss setupSelect_BClassDtlByForeignFlg() {
        assertSetupSelectPurpose("bClassDtlByForeignFlg");
        if (hasSpecifiedLocalColumn()) {
            specify().columnForeignFlg();
        }
        doSetupSelect(() -> query().queryBClassDtlByForeignFlg());
        if (_nssBClassDtlByForeignFlg == null || !_nssBClassDtlByForeignFlg.hasConditionQuery())
        { _nssBClassDtlByForeignFlg = new BClassDtlNss(query().queryBClassDtlByForeignFlg()); }
        return _nssBClassDtlByForeignFlg;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<MWarehouseCQ> {
        protected MCenterCB.HpSpecification _mCenter;
        protected BClassDtlCB.HpSpecification _bClassDtlByDelFlg;
        protected BClassDtlCB.HpSpecification _bClassDtlByForeignFlg;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MWarehouseCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnWarehouseAbbr() { return doColumn("WAREHOUSE_ABBR"); }
        /**
         * FOREIGN_FLG: {char(1), FK to B_CLASS_DTL, classification=ForeignFlg}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnForeignFlg() { return doColumn("FOREIGN_FLG"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryBClassDtlByForeignFlg()
                    || qyCall().qy().xgetReferrerQuery() instanceof BClassDtlCQ) {
                columnForeignFlg(); // FK or one-to-one referrer
            }
        }
        @Override
        protected String getTableDbName() { return "M_WAREHOUSE"; }
        /**
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BClassDtlCB.HpSpecification specifyBClassDtlByForeignFlg() {
            assertRelation("bClassDtlByForeignFlg");
            if (_bClassDtlByForeignFlg == null) {
                _bClassDtlByForeignFlg = new BClassDtlCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBClassDtlByForeignFlg()
                                    , () -> _qyCall.qy().queryBClassDtlByForeignFlg())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bClassDtlByForeignFlg.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBClassDtlByForeignFlg()
                      , () -> xsyncQyCall().qy().queryBClassDtlByForeignFlg()));
                }
            }
         ...
         */
        public HpSDRFunction<MWebHtInfoCB, MWarehouseCQ> derivedMWebHtInfoList() {
            assertDerived("mWebHtInfoList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MWebHtInfoCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMWebHtInfoList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from M_ZONE where ...) as FOO_MAX} <br>
         * M_ZONE by WAREHOUSE_ID, named 'MZoneList'.
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(zoneCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     zoneCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     zoneCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, MZone.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<MZoneCB, MWarehouseCQ> derivedMZoneList() {
            assertDerived("mZoneList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MZoneCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveMZoneList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TAllocInstBCB, MWarehouseCQ> derivedTAllocInstBList() {
            assertDerived("tAllocInstBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TAllocInstBCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryBCB, MWarehouseCQ> derivedTInventoryBList() {
            assertDerived("tInventoryBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryBCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TMoveInstBCB, MWarehouseCQ> derivedTMoveInstBList() {
            assertDerived("tMoveInstBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TMoveInstBCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TReceivePlanBCB, MWarehouseCQ> derivedTReceivePlanBList() {
            assertDerived("tReceivePlanBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TReceivePlanBCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TShippingInstBCB, MWarehouseCQ> derivedTShippingInstBList() {
            assertDerived("tShippingInstBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TShippingInstBCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TStockCB, MWarehouseCQ> derivedTStockList() {
            assertDerived("tStockList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TStockCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtInventoryInputProdCB, MWarehouseCQ> derivedWHtInventoryInputProdList() {
            assertDerived("wHtInventoryInputProdList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtInventoryInputProdCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtReceiveInspectionCB, MWarehouseCQ> derivedWHtReceiveInspectionList() {
            assertDerived("wHtReceiveInspectionList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtReceiveInspectionCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtReceiveNoPlanInspCB, MWarehouseCQ> derivedWHtReceiveNoPlanInspList() {
            assertDerived("wHtReceiveNoPlanInspList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtReceiveNoPlanInspCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<WHtReceiveStoreCB, MWarehouseCQ> derivedWHtReceiveStoreList() {
            assertDerived("wHtReceiveStoreList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtReceiveStoreCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<MWarehouseCB, MWarehouseCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MWarehouseCB> sq, MWarehouseCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MWarehouseCB dreamCruiseCB() {
        MWarehouseCB cb = new MWarehouseCB();
        cb.xsetupForDreamCruise((MWarehouseCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MWarehouseCB> columnQuery(final SpecifyQuery<MWarehouseCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MWarehouseCB xcreateColumnQueryCB() {
        MWarehouseCB cb = new MWarehouseCB();
        cb.xsetupForColumnQuery((MWarehouseCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MWarehouseCB> orCBLambda) {
        xorSQ((MWarehouseCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MWarehouseCB> andCBLambda) {
        xorSQAP((MWarehouseCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MWarehouseCB cb;
        if (mainCB != null) {
            cb = (MWarehouseCB)mainCB;
        } else {
            cb = new MWarehouseCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MWarehouseCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MWarehouseCQ.class.getName(); }
