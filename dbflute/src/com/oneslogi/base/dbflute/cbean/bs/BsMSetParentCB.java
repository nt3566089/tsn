...
/**
 * The base condition-bean of M_SET_PARENT.
 * @author DBFlute(AutoGenerator)
 */
public class BsMSetParentCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MSetParentCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMSetParentCB() {
     ...
     * @return this. (NotNull)
     */
    public MSetParentCB acceptPK(Long setParentId) {
        assertObjectNotNull("setParentId", setParentId);
        BsMSetParentCB cb = this;
        cb.query().setSetParentId_Equal(setParentId);
        return (MSetParentCB)this;
    }
     ...
     * @param setParentId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long setParentId) {
        assertObjectNotNull("setParentId", setParentId);
        BsMSetParentCB cb = this;
        cb.query().setSetParentId_Equal(setParentId);
    }
     ...
     * @return this. (NotNull)
     */
    public MSetParentCB acceptUniqueOf(Long productId) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_SetParentId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_SetParentId_Desc();
        return this;
    }
     ...
     */
    public MSetParentCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MSetParentCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MSetParentCQ doGetConditionQuery() {
    ...
    protected MSetParentCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MSetParentCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MSetParentCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MSetParentCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MSetParentCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MSetParentCB> unionCBLambda) {
        final MSetParentCB cb = new MSetParentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MSetParentCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MSetParentCB> unionCBLambda) {
        final MSetParentCB cb = new MSetParentCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MSetParentCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mSetParentBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mSetParent</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mSetParent</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mSetParent</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mSetParent</span>.<span style="color: #CC4747">getBClassDtlByDelFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MSetParentCQ> {
        protected MProductCB.HpSpecification _mProduct;
        protected BClassDtlCB.HpSpecification _bClassDtlByDelFlg;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MSetParentCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "M_SET_PARENT"; }
        /**
         ...
         */
        public HpSDRFunction<MSetStructureCB, MSetParentCQ> derivedMSetStructureList() {
            assertDerived("mSetStructureList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MSetStructureCB> sq, MSetParentCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<MSetParentCB, MSetParentCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MSetParentCB> sq, MSetParentCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MSetParentCB dreamCruiseCB() {
        MSetParentCB cb = new MSetParentCB();
        cb.xsetupForDreamCruise((MSetParentCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MSetParentCB> columnQuery(final SpecifyQuery<MSetParentCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MSetParentCB xcreateColumnQueryCB() {
        MSetParentCB cb = new MSetParentCB();
        cb.xsetupForColumnQuery((MSetParentCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MSetParentCB> orCBLambda) {
        xorSQ((MSetParentCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MSetParentCB> andCBLambda) {
        xorSQAP((MSetParentCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MSetParentCB cb;
        if (mainCB != null) {
            cb = (MSetParentCB)mainCB;
        } else {
            cb = new MSetParentCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MSetParentCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MSetParentCQ.class.getName(); }
