...
/**
 * The base condition-bean of B_ROLE_GRP_DTL.
 * @author DBFlute(AutoGenerator)
 */
public class BsBRoleGrpDtlCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BRoleGrpDtlCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsBRoleGrpDtlCB() {
     ...
     * @return this. (NotNull)
     */
    public BRoleGrpDtlCB acceptPK(Long roleGrpDtlId) {
        assertObjectNotNull("roleGrpDtlId", roleGrpDtlId);
        BsBRoleGrpDtlCB cb = this;
        cb.query().setRoleGrpDtlId_Equal(roleGrpDtlId);
        return (BRoleGrpDtlCB)this;
    }
     ...
     * @param roleGrpDtlId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long roleGrpDtlId) {
        assertObjectNotNull("roleGrpDtlId", roleGrpDtlId);
        BsBRoleGrpDtlCB cb = this;
        cb.query().setRoleGrpDtlId_Equal(roleGrpDtlId);
    }
     ...
     * @return this. (NotNull)
     */
    public BRoleGrpDtlCB acceptUniqueOf(Long roleGrpId, Long roleId, Long applyOrder) {
        assertObjectNotNull("roleGrpId", roleGrpId);assertObjectNotNull("roleId", roleId);assertObjectNotNull("applyOrder", applyOrder);
        BsBRoleGrpDtlCB cb = this;
        cb.query().setRoleGrpId_Equal(roleGrpId);cb.query().setRoleId_Equal(roleId);cb.query().setApplyOrder_Equal(applyOrder);
        return (BRoleGrpDtlCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_RoleGrpDtlId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_RoleGrpDtlId_Desc();
        return this;
    }
     ...
     */
    public BRoleGrpDtlCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public BRoleGrpDtlCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected BRoleGrpDtlCQ doGetConditionQuery() {
    ...
    protected BRoleGrpDtlCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected BRoleGrpDtlCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        BRoleGrpDtlCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected BRoleGrpDtlCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new BRoleGrpDtlCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<BRoleGrpDtlCB> unionCBLambda) {
        final BRoleGrpDtlCB cb = new BRoleGrpDtlCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BRoleGrpDtlCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<BRoleGrpDtlCB> unionCBLambda) {
        final BRoleGrpDtlCB cb = new BRoleGrpDtlCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BRoleGrpDtlCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">bRoleGrpDtl</span>.<span style="color: #CC4747">getBRoleGrp()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<BRoleGrpDtlCQ> {
         ...
         */
        public SpecifiedColumn columnRoleGrpDtlId() { return doColumn("ROLE_GRP_DTL_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnApplyOrder() { return doColumn("APPLY_ORDER"); }
        /**
         ...
         */
        public HpSDRFunction<BRoleGrpDtlCB, BRoleGrpDtlCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<BRoleGrpDtlCB> sq, BRoleGrpDtlCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public BRoleGrpDtlCB dreamCruiseCB() {
        BRoleGrpDtlCB cb = new BRoleGrpDtlCB();
        cb.xsetupForDreamCruise((BRoleGrpDtlCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<BRoleGrpDtlCB> columnQuery(final SpecifyQuery<BRoleGrpDtlCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected BRoleGrpDtlCB xcreateColumnQueryCB() {
        BRoleGrpDtlCB cb = new BRoleGrpDtlCB();
        cb.xsetupForColumnQuery((BRoleGrpDtlCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<BRoleGrpDtlCB> orCBLambda) {
        xorSQ((BRoleGrpDtlCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<BRoleGrpDtlCB> andCBLambda) {
        xorSQAP((BRoleGrpDtlCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final BRoleGrpDtlCB cb;
        if (mainCB != null) {
            cb = (BRoleGrpDtlCB)mainCB;
        } else {
            cb = new BRoleGrpDtlCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return BRoleGrpDtlCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return BRoleGrpDtlCQ.class.getName(); }
