...
/**
 * The base condition-bean of M_CENTER_SCREEN.
 * @author DBFlute(AutoGenerator)
 */
public class BsMCenterScreenCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MCenterScreenCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMCenterScreenCB() {
     ...
     * @return this. (NotNull)
     */
    public MCenterScreenCB acceptPK(Long centerScreenId) {
        assertObjectNotNull("centerScreenId", centerScreenId);
        BsMCenterScreenCB cb = this;
        cb.query().setCenterScreenId_Equal(centerScreenId);
        return (MCenterScreenCB)this;
    }
     ...
     * @param centerScreenId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long centerScreenId) {
        assertObjectNotNull("centerScreenId", centerScreenId);
        BsMCenterScreenCB cb = this;
        cb.query().setCenterScreenId_Equal(centerScreenId);
    }
     ...
     * @return this. (NotNull)
     */
    public MCenterScreenCB acceptUniqueOf(Long centerId, Long screenId, Long dictId) {
        assertObjectNotNull("centerId", centerId);assertObjectNotNull("screenId", screenId);assertObjectNotNull("dictId", dictId);
        BsMCenterScreenCB cb = this;
        cb.query().setCenterId_Equal(centerId);cb.query().setScreenId_Equal(screenId);cb.query().setDictId_Equal(dictId);
        return (MCenterScreenCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_CenterScreenId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_CenterScreenId_Desc();
        return this;
    }
     ...
     */
    public MCenterScreenCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MCenterScreenCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MCenterScreenCQ doGetConditionQuery() {
    ...
    protected MCenterScreenCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MCenterScreenCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MCenterScreenCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MCenterScreenCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MCenterScreenCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MCenterScreenCB> unionCBLambda) {
        final MCenterScreenCB cb = new MCenterScreenCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCenterScreenCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MCenterScreenCB> unionCBLambda) {
        final MCenterScreenCB cb = new MCenterScreenCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCenterScreenCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCenterScreenBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mCenterScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterScreen</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCenterScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterScreen</span>.<span style="color: #CC4747">getBScreen()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCenterScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterScreen</span>.<span style="color: #CC4747">getVDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCenterScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterScreen</span>.<span style="color: #CC4747">getVHtDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @param cultureId The bind parameter of fixed condition for cultureId. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MCenterScreenCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MCenterScreenCQ> qyCall
         ...
         */
        public SpecifiedColumn columnCenterScreenId() { return doColumn("CENTER_SCREEN_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "M_CENTER_SCREEN"; }
        /**
         ...
         */
        public HpSDRFunction<MCenterScreenCB, MCenterScreenCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCenterScreenCB> sq, MCenterScreenCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MCenterScreenCB dreamCruiseCB() {
        MCenterScreenCB cb = new MCenterScreenCB();
        cb.xsetupForDreamCruise((MCenterScreenCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MCenterScreenCB> columnQuery(final SpecifyQuery<MCenterScreenCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MCenterScreenCB xcreateColumnQueryCB() {
        MCenterScreenCB cb = new MCenterScreenCB();
        cb.xsetupForColumnQuery((MCenterScreenCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MCenterScreenCB> orCBLambda) {
        xorSQ((MCenterScreenCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MCenterScreenCB> andCBLambda) {
        xorSQAP((MCenterScreenCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MCenterScreenCB cb;
        if (mainCB != null) {
            cb = (MCenterScreenCB)mainCB;
        } else {
            cb = new MCenterScreenCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MCenterScreenCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MCenterScreenCQ.class.getName(); }
