...
/**
 * The base condition-bean of M_CENTER_ITEM.
 * @author DBFlute(AutoGenerator)
 */
public class BsMCenterItemCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MCenterItemCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMCenterItemCB() {
     ...
     * @return this. (NotNull)
     */
    public MCenterItemCB acceptPK(Long centerItemId) {
        assertObjectNotNull("centerItemId", centerItemId);
        BsMCenterItemCB cb = this;
        cb.query().setCenterItemId_Equal(centerItemId);
        return (MCenterItemCB)this;
    }
     ...
     * @param centerItemId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long centerItemId) {
        assertObjectNotNull("centerItemId", centerItemId);
        BsMCenterItemCB cb = this;
        cb.query().setCenterItemId_Equal(centerItemId);
    }
     ...
     * @return this. (NotNull)
     */
    public MCenterItemCB acceptUniqueOf(Long centerId, Long itemId, Long dictId) {
        assertObjectNotNull("centerId", centerId);assertObjectNotNull("itemId", itemId);assertObjectNotNull("dictId", dictId);
        BsMCenterItemCB cb = this;
        cb.query().setCenterId_Equal(centerId);cb.query().setItemId_Equal(itemId);cb.query().setDictId_Equal(dictId);
        return (MCenterItemCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_CenterItemId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_CenterItemId_Desc();
        return this;
    }
     ...
     */
    public MCenterItemCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MCenterItemCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MCenterItemCQ doGetConditionQuery() {
    ...
    protected MCenterItemCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MCenterItemCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MCenterItemCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MCenterItemCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MCenterItemCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MCenterItemCB> unionCBLambda) {
        final MCenterItemCB cb = new MCenterItemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCenterItemCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MCenterItemCB> unionCBLambda) {
        final MCenterItemCB cb = new MCenterItemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCenterItemCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mCenterItemBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mCenterItem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterItem</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCenterItem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterItem</span>.<span style="color: #CC4747">getBItem()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCenterItem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCenterItem</span>.<span style="color: #CC4747">getVDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MCenterItemCQ> {
         ...
         */
        public SpecifiedColumn columnCenterItemId() { return doColumn("CENTER_ITEM_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "M_CENTER_ITEM"; }
        /**
         ...
         */
        public HpSDRFunction<MCenterItemCB, MCenterItemCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCenterItemCB> sq, MCenterItemCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MCenterItemCB dreamCruiseCB() {
        MCenterItemCB cb = new MCenterItemCB();
        cb.xsetupForDreamCruise((MCenterItemCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MCenterItemCB> columnQuery(final SpecifyQuery<MCenterItemCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MCenterItemCB xcreateColumnQueryCB() {
        MCenterItemCB cb = new MCenterItemCB();
        cb.xsetupForColumnQuery((MCenterItemCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MCenterItemCB> orCBLambda) {
        xorSQ((MCenterItemCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MCenterItemCB> andCBLambda) {
        xorSQAP((MCenterItemCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MCenterItemCB cb;
        if (mainCB != null) {
            cb = (MCenterItemCB)mainCB;
        } else {
            cb = new MCenterItemCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MCenterItemCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MCenterItemCQ.class.getName(); }
