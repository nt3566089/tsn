...
/**
 * The base condition-bean of B_ARG.
 * @author DBFlute(AutoGenerator)
 */
public class BsBArgCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BArgCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public BArgCB acceptPK(Long argId) {
        assertObjectNotNull("argId", argId);
        BsBArgCB cb = this;
        cb.query().setArgId_Equal(argId);
        return (BArgCB)this;
    }
     ...
     * @param argId : PK, NotNull, bigint(19). (NotNull)
     */
    public void acceptPrimaryKey(Long argId) {
        assertObjectNotNull("argId", argId);
        BsBArgCB cb = this;
        cb.query().setArgId_Equal(argId);
    }
     ...
     * @return this. (NotNull)
     */
    public BArgCB acceptUniqueOf(Long funcId, String argCd) {
        assertObjectNotNull("funcId", funcId);assertObjectNotNull("argCd", argCd);
        BsBArgCB cb = this;
        cb.query().setFuncId_Equal(funcId);cb.query().setArgCd_Equal(argCd);
        return (BArgCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ArgId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ArgId_Desc();
        return this;
    }
    ...
    public BArgCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected BArgCQ doGetConditionQuery() {
    ...
    protected BArgCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected BArgCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        BArgCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected BArgCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new BArgCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<BArgCB> unionCBLambda) {
        final BArgCB cb = new BArgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BArgCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<BArgCB> unionCBLambda) {
        final BArgCB cb = new BArgCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BArgCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bArg</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bArg</span>.<span style="color: #CC4747">getBDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bArg</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bArg</span>.<span style="color: #CC4747">getVHtDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    protected BArgValidNss _nssBArgValidAsOne;
    public BArgValidNss xdfgetNssBArgValidAsOne() {
        if (_nssBArgValidAsOne == null) { _nssBArgValidAsOne = new BArgValidNss(null); }
        return _nssBArgValidAsOne;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">bArgBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_BArgValidAsOne(cultureId)</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bArg</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bArg</span>.<span style="color: #CC4747">getBArgValidAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public BArgValidNss setupSelect_BArgValidAsOne() {
        assertSetupSelectPurpose("bArgValidAsOne");
        doSetupSelect(() -> query().queryBArgValidAsOne());
        if (_nssBArgValidAsOne == null || !_nssBArgValidAsOne.hasConditionQuery())
        { _nssBArgValidAsOne = new BArgValidNss(query().queryBArgValidAsOne()); }
        return _nssBArgValidAsOne;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<BArgCQ> {
         ...
         */
        public SpecifiedColumn columnArgId() { return doColumn("ARG_ID"); }
        /**
         * FUNC_ID: {UQ+, IX, NotNull, bigint(19), FK to B_FUNC}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnFuncId() { return doColumn("FUNC_ID"); }
        /**
         * ARG_CD: {+UQ, NotNull, varchar(100)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnArgCd() { return doColumn("ARG_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnArgType() { return doColumn("ARG_TYPE"); }
        /**
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public BArgValidCB.HpSpecification specifyBArgValidAsOne() {
            assertRelation("bArgValidAsOne");
            if (_bArgValidAsOne == null) {
                _bArgValidAsOne = new BArgValidCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryBArgValidAsOne()
                                    , () -> _qyCall.qy().queryBArgValidAsOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _bArgValidAsOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryBArgValidAsOne()
                      , () -> xsyncQyCall().qy().queryBArgValidAsOne()));
                }
            }
         ...
         */
        public HpSDRFunction<BArgCB, BArgCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<BArgCB> sq, BArgCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public BArgCB dreamCruiseCB() {
        BArgCB cb = new BArgCB();
        cb.xsetupForDreamCruise((BArgCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<BArgCB> columnQuery(final SpecifyQuery<BArgCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected BArgCB xcreateColumnQueryCB() {
        BArgCB cb = new BArgCB();
        cb.xsetupForColumnQuery((BArgCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<BArgCB> orCBLambda) {
        xorSQ((BArgCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<BArgCB> andCBLambda) {
        xorSQAP((BArgCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return BArgCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return BArgCQ.class.getName(); }
