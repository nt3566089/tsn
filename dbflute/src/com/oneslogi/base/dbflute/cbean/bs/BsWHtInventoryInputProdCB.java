...
/**
 * The base condition-bean of W_HT_INVENTORY_INPUT_PROD.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtInventoryInputProdCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtInventoryInputProdCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtInventoryInputProdCB() {
     ...
     * @param htInventoryInputProdId : PK, ID, NotNull, bigint identity(19). (NotNull)
     * @return this. (NotNull)
     */
    public WHtInventoryInputProdCB acceptPK(Long htInventoryInputProdId) {
        assertObjectNotNull("htInventoryInputProdId", htInventoryInputProdId);
        BsWHtInventoryInputProdCB cb = this;
        cb.query().setHtInventoryInputProdId_Equal(htInventoryInputProdId);
        return (WHtInventoryInputProdCB)this;
    }
     ...
     * @param htInventoryInputProdId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htInventoryInputProdId) {
        assertObjectNotNull("htInventoryInputProdId", htInventoryInputProdId);
        BsWHtInventoryInputProdCB cb = this;
        cb.query().setHtInventoryInputProdId_Equal(htInventoryInputProdId);
    }
     ...
     * @return this. (NotNull)
     */
    public WHtInventoryInputProdCB acceptUniqueOf(Long inventoryHId, Long productId, Long locId, Long consignmentClsId, Long stockTypeId, String lot, String limitDt, Long inventoryBVersionNo) {
        ...
        BsWHtInventoryInputProdCB cb = this;
        cb.query().setInventoryHId_Equal(inventoryHId);cb.query().setProductId_Equal(productId);cb.query().setLocId_Equal(locId);cb.query().setConsignmentClsId_Equal(consignmentClsId);cb.query().setStockTypeId_Equal(stockTypeId);cb.query().setLot_Equal(lot);cb.query().setLimitDt_Equal(limitDt);cb.query().setInventoryBVersionNo_Equal(inventoryBVersionNo);
        return (WHtInventoryInputProdCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtInventoryInputProdId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtInventoryInputProdId_Desc();
        return this;
    }
     ...
     */
    public WHtInventoryInputProdCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtInventoryInputProdCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtInventoryInputProdCQ doGetConditionQuery() {
    ...
    protected WHtInventoryInputProdCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtInventoryInputProdCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtInventoryInputProdCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtInventoryInputProdCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtInventoryInputProdCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtInventoryInputProdCB> unionCBLambda) {
        final WHtInventoryInputProdCB cb = new WHtInventoryInputProdCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtInventoryInputProdCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtInventoryInputProdCB> unionCBLambda) {
        final WHtInventoryInputProdCB cb = new WHtInventoryInputProdCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtInventoryInputProdCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">wHtInventoryInputProdBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMStockType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMCustomer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public MCustomerNss setupSelect_MCustomer() {
        ...
        if (hasSpecifiedLocalColumn()) {
            specify().columnConsignmentClsId();
        }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMWarehouse()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getTLot()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMLocation()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtInventoryInputProd</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtInventoryInputProd</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtInventoryInputProdCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WHtInventoryInputProdCQ> qyCall
         ...
         */
        public SpecifiedColumn columnHtInventoryInputProdId() { return doColumn("HT_INVENTORY_INPUT_PROD_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRcvLabelNo() { return doColumn("RCV_LABEL_NO"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnConsignmentClsId() { return doColumn("CONSIGNMENT_CLS_ID"); }
        /**
         * CONSIGNMENT_CLS_NM: {varchar(60)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnConsignmentClsNm() { return doColumn("CONSIGNMENT_CLS_NM"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInventoryBVersionNo() { return doColumn("INVENTORY_B_VERSION_NO"); }
        /**
         * CR_DT: {datetime2(26, 6)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCrDt() { return doColumn("CR_DT"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnHtInventoryInputProdId(); // PK
            ...
            if (qyCall().qy().hasConditionQueryMCustomer()
                ...
                columnConsignmentClsId(); // FK or one-to-one referrer
            }
        ...
        @Override
        protected String getTableDbName() { return "W_HT_INVENTORY_INPUT_PROD"; }
        /**
         ...
         */
        public HpSDRFunction<WHtInventoryInputProdCB, WHtInventoryInputProdCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtInventoryInputProdCB> sq, WHtInventoryInputProdCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtInventoryInputProdCB dreamCruiseCB() {
        WHtInventoryInputProdCB cb = new WHtInventoryInputProdCB();
        cb.xsetupForDreamCruise((WHtInventoryInputProdCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtInventoryInputProdCB> columnQuery(final SpecifyQuery<WHtInventoryInputProdCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtInventoryInputProdCB xcreateColumnQueryCB() {
        WHtInventoryInputProdCB cb = new WHtInventoryInputProdCB();
        cb.xsetupForColumnQuery((WHtInventoryInputProdCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtInventoryInputProdCB> orCBLambda) {
        xorSQ((WHtInventoryInputProdCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtInventoryInputProdCB> andCBLambda) {
        xorSQAP((WHtInventoryInputProdCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtInventoryInputProdCB cb;
        if (mainCB != null) {
            cb = (WHtInventoryInputProdCB)mainCB;
        } else {
            cb = new WHtInventoryInputProdCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtInventoryInputProdCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtInventoryInputProdCQ.class.getName(); }
