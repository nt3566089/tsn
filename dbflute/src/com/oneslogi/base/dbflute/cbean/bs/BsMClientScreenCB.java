...
/**
 * The base condition-bean of M_CLIENT_SCREEN.
 * @author DBFlute(AutoGenerator)
 */
public class BsMClientScreenCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MClientScreenCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMClientScreenCB() {
     ...
     * @return this. (NotNull)
     */
    public MClientScreenCB acceptPK(Long clientScreenId) {
        assertObjectNotNull("clientScreenId", clientScreenId);
        BsMClientScreenCB cb = this;
        cb.query().setClientScreenId_Equal(clientScreenId);
        return (MClientScreenCB)this;
    }
     ...
     * @param clientScreenId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long clientScreenId) {
        assertObjectNotNull("clientScreenId", clientScreenId);
        BsMClientScreenCB cb = this;
        cb.query().setClientScreenId_Equal(clientScreenId);
    }
     ...
     * @return this. (NotNull)
     */
    public MClientScreenCB acceptUniqueOf(Long clientId, Long screenId, Long dictId) {
        assertObjectNotNull("clientId", clientId);assertObjectNotNull("screenId", screenId);assertObjectNotNull("dictId", dictId);
        BsMClientScreenCB cb = this;
        cb.query().setClientId_Equal(clientId);cb.query().setScreenId_Equal(screenId);cb.query().setDictId_Equal(dictId);
        return (MClientScreenCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ClientScreenId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ClientScreenId_Desc();
        return this;
    }
     ...
     */
    public MClientScreenCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MClientScreenCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MClientScreenCQ doGetConditionQuery() {
    ...
    protected MClientScreenCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MClientScreenCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MClientScreenCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MClientScreenCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MClientScreenCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MClientScreenCB> unionCBLambda) {
        final MClientScreenCB cb = new MClientScreenCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientScreenCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MClientScreenCB> unionCBLambda) {
        final MClientScreenCB cb = new MClientScreenCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientScreenCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mClientScreenBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mClientScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientScreen</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientScreen</span>.<span style="color: #CC4747">getBScreen()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientScreen</span>.<span style="color: #CC4747">getVDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientScreen</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientScreen</span>.<span style="color: #CC4747">getVHtDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @param cultureId The bind parameter of fixed condition for cultureId. (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MClientScreenCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MClientScreenCQ> qyCall
         ...
         */
        public SpecifiedColumn columnClientScreenId() { return doColumn("CLIENT_SCREEN_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "M_CLIENT_SCREEN"; }
        /**
         ...
         */
        public HpSDRFunction<MClientScreenCB, MClientScreenCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MClientScreenCB> sq, MClientScreenCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MClientScreenCB dreamCruiseCB() {
        MClientScreenCB cb = new MClientScreenCB();
        cb.xsetupForDreamCruise((MClientScreenCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MClientScreenCB> columnQuery(final SpecifyQuery<MClientScreenCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MClientScreenCB xcreateColumnQueryCB() {
        MClientScreenCB cb = new MClientScreenCB();
        cb.xsetupForColumnQuery((MClientScreenCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MClientScreenCB> orCBLambda) {
        xorSQ((MClientScreenCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MClientScreenCB> andCBLambda) {
        xorSQAP((MClientScreenCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MClientScreenCB cb;
        if (mainCB != null) {
            cb = (MClientScreenCB)mainCB;
        } else {
            cb = new MClientScreenCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MClientScreenCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MClientScreenCQ.class.getName(); }
