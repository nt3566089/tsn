...
/**
 * The base condition-bean of T_STOCK_REPORT.
 * @author DBFlute(AutoGenerator)
 */
public class BsTStockReportCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TStockReportCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTStockReportCB() {
     ...
     * @return this. (NotNull)
     */
    public TStockReportCB acceptPK(Long stockId) {
        assertObjectNotNull("stockId", stockId);
        BsTStockReportCB cb = this;
        cb.query().setStockId_Equal(stockId);
        return (TStockReportCB)this;
    }
     ...
     */
    public TStockReportCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TStockReportCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TStockReportCQ doGetConditionQuery() {
    ...
    protected TStockReportCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TStockReportCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TStockReportCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TStockReportCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TStockReportCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TStockReportCB> unionCBLambda) {
        final TStockReportCB cb = new TStockReportCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TStockReportCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TStockReportCB> unionCBLambda) {
        final TStockReportCB cb = new TStockReportCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TStockReportCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tStockReportBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tStockReport</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tStockReport</span>.<span style="color: #CC4747">getTStock()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<TStockReportCQ> {
        protected TStockCB.HpSpecification _tStock;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TStockReportCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLastreceivedate() { return doColumn("LASTRECEIVEDATE"); }
        /**
         * LASTSHIPDATE: {varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnLastshipdate() { return doColumn("LASTSHIPDATE"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "T_STOCK_REPORT"; }
        /**
         ...
         */
        public HpSDRFunction<TStockReportCB, TStockReportCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TStockReportCB> sq, TStockReportCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TStockReportCB dreamCruiseCB() {
        TStockReportCB cb = new TStockReportCB();
        cb.xsetupForDreamCruise((TStockReportCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TStockReportCB> columnQuery(final SpecifyQuery<TStockReportCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TStockReportCB xcreateColumnQueryCB() {
        TStockReportCB cb = new TStockReportCB();
        cb.xsetupForColumnQuery((TStockReportCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TStockReportCB> orCBLambda) {
        xorSQ((TStockReportCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TStockReportCB> andCBLambda) {
        xorSQAP((TStockReportCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TStockReportCB cb;
        if (mainCB != null) {
            cb = (TStockReportCB)mainCB;
        } else {
            cb = new TStockReportCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TStockReportCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TStockReportCQ.class.getName(); }
