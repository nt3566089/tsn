...
/**
 * The base condition-bean of T_RECEIVE_PLAN_B.
 * @author DBFlute(AutoGenerator)
 */
public class BsTReceivePlanBCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TReceivePlanBCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTReceivePlanBCB() {
     ...
     * @return this. (NotNull)
     */
    public TReceivePlanBCB acceptPK(Long receivePlanBId) {
        assertObjectNotNull("receivePlanBId", receivePlanBId);
        BsTReceivePlanBCB cb = this;
        cb.query().setReceivePlanBId_Equal(receivePlanBId);
        return (TReceivePlanBCB)this;
    }
     ...
     * @param receivePlanBId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long receivePlanBId) {
        assertObjectNotNull("receivePlanBId", receivePlanBId);
        BsTReceivePlanBCB cb = this;
        cb.query().setReceivePlanBId_Equal(receivePlanBId);
    }
     ...
     */
    public TReceivePlanBCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TReceivePlanBCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TReceivePlanBCQ doGetConditionQuery() {
    ...
    protected TReceivePlanBCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TReceivePlanBCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TReceivePlanBCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TReceivePlanBCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TReceivePlanBCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TReceivePlanBCB> unionCBLambda) {
        final TReceivePlanBCB cb = new TReceivePlanBCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TReceivePlanBCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TReceivePlanBCB> unionCBLambda) {
        final TReceivePlanBCB cb = new TReceivePlanBCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TReceivePlanBCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getMLocation()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getMWarehouse()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getTReceivePlanH()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getBClassDtlByErrorFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getBClassDtlByReceiveStatus()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    protected TReceivePlanSpareNss _nssTReceivePlanSpareAsOne;
    public TReceivePlanSpareNss xdfgetNssTReceivePlanSpareAsOne() {
        if (_nssTReceivePlanSpareAsOne == null) { _nssTReceivePlanSpareAsOne = new TReceivePlanSpareNss(null); }
        return _nssTReceivePlanSpareAsOne;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_TReceivePlanSpareAsOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getTReceivePlanSpareAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public TReceivePlanSpareNss setupSelect_TReceivePlanSpareAsOne() {
        assertSetupSelectPurpose("tReceivePlanSpareAsOne");
        doSetupSelect(() -> query().queryTReceivePlanSpareAsOne());
        if (_nssTReceivePlanSpareAsOne == null || !_nssTReceivePlanSpareAsOne.hasConditionQuery())
        { _nssTReceivePlanSpareAsOne = new TReceivePlanSpareNss(query().queryTReceivePlanSpareAsOne()); }
        return _nssTReceivePlanSpareAsOne;
    }

    protected TTrrcvdetailNss _nssTTrrcvdetailAsOne;
    public TTrrcvdetailNss xdfgetNssTTrrcvdetailAsOne() {
        if (_nssTTrrcvdetailAsOne == null) { _nssTTrrcvdetailAsOne = new TTrrcvdetailNss(null); }
        return _nssTTrrcvdetailAsOne;
    }
    /**
     * Set up relation columns to select clause. <br>
     ...
     * <pre>
     * <span style="color: #0000C0">tReceivePlanBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_TTrrcvdetailAsOne()</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tReceivePlanB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tReceivePlanB</span>.<span style="color: #CC4747">getTTrrcvdetailAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public TTrrcvdetailNss setupSelect_TTrrcvdetailAsOne() {
        assertSetupSelectPurpose("tTrrcvdetailAsOne");
        doSetupSelect(() -> query().queryTTrrcvdetailAsOne());
        if (_nssTTrrcvdetailAsOne == null || !_nssTTrrcvdetailAsOne.hasConditionQuery())
        { _nssTTrrcvdetailAsOne = new TTrrcvdetailNss(query().queryTTrrcvdetailAsOne()); }
        return _nssTTrrcvdetailAsOne;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TReceivePlanBCQ> {
        ...
        protected TReceivePlanSpareCB.HpSpecification _tReceivePlanSpareAsOne;
        protected TTrrcvdetailCB.HpSpecification _tTrrcvdetailAsOne;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TReceivePlanBCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanClientOrderNo() { return doColumn("PLAN_CLIENT_ORDER_NO"); }
        /**
         * PLAN_WAREHOUSE_ID: {bigint(19), FK to M_WAREHOUSE}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanWarehouseId() { return doColumn("PLAN_WAREHOUSE_ID"); }
        /**
         * PLAN_WAREHOUSE_CD: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanWarehouseCd() { return doColumn("PLAN_WAREHOUSE_CD"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanLot() { return doColumn("PLAN_LOT"); }
        /**
         * PLAN_LIMIT_DT: {varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanLimitDt() { return doColumn("PLAN_LIMIT_DT"); }
        /**
         * PLAN_LOCATION_ID: {IX, bigint(19), FK to M_LOCATION}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanLocationId() { return doColumn("PLAN_LOCATION_ID"); }
        /**
         * PLAN_LOCATION_CD: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanLocationCd() { return doColumn("PLAN_LOCATION_CD"); }
        /**
         * PLAN_STORE_LABEL_NO: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPlanStoreLabelNo() { return doColumn("PLAN_STORE_LABEL_NO"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryMLocation()
                ...
                columnPlanLocationId(); // FK or one-to-one referrer
            }
            if (qyCall().qy().hasConditionQueryMWarehouse()
                    || qyCall().qy().xgetReferrerQuery() instanceof MWarehouseCQ) {
                columnPlanWarehouseId(); // FK or one-to-one referrer
            }
        ...
        @Override
        protected String getTableDbName() { return "T_RECEIVE_PLAN_B"; }
        /**
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public TReceivePlanSpareCB.HpSpecification specifyTReceivePlanSpareAsOne() {
            assertRelation("tReceivePlanSpareAsOne");
            if (_tReceivePlanSpareAsOne == null) {
                _tReceivePlanSpareAsOne = new TReceivePlanSpareCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryTReceivePlanSpareAsOne()
                                    , () -> _qyCall.qy().queryTReceivePlanSpareAsOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _tReceivePlanSpareAsOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryTReceivePlanSpareAsOne()
                      , () -> xsyncQyCall().qy().queryTReceivePlanSpareAsOne()));
                }
            }
         ...
         * @return The instance for specification for relation table to specify. (NotNull)
         */
        public TTrrcvdetailCB.HpSpecification specifyTTrrcvdetailAsOne() {
            assertRelation("tTrrcvdetailAsOne");
            if (_tTrrcvdetailAsOne == null) {
                _tTrrcvdetailAsOne = new TTrrcvdetailCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryTTrrcvdetailAsOne()
                                    , () -> _qyCall.qy().queryTTrrcvdetailAsOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _tTrrcvdetailAsOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryTTrrcvdetailAsOne()
                      , () -> xsyncQyCall().qy().queryTTrrcvdetailAsOne()));
                }
            }
         ...
         */
        public HpSDRFunction<TStoreRecordBCB, TReceivePlanBCQ> derivedTStoreRecordBList() {
            assertDerived("tStoreRecordBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TStoreRecordBCB> sq, TReceivePlanBCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<TReceivePlanBCB, TReceivePlanBCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TReceivePlanBCB> sq, TReceivePlanBCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TReceivePlanBCB dreamCruiseCB() {
        TReceivePlanBCB cb = new TReceivePlanBCB();
        cb.xsetupForDreamCruise((TReceivePlanBCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TReceivePlanBCB> columnQuery(final SpecifyQuery<TReceivePlanBCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TReceivePlanBCB xcreateColumnQueryCB() {
        TReceivePlanBCB cb = new TReceivePlanBCB();
        cb.xsetupForColumnQuery((TReceivePlanBCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TReceivePlanBCB> orCBLambda) {
        xorSQ((TReceivePlanBCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TReceivePlanBCB> andCBLambda) {
        xorSQAP((TReceivePlanBCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TReceivePlanBCB cb;
        if (mainCB != null) {
            cb = (TReceivePlanBCB)mainCB;
        } else {
            cb = new TReceivePlanBCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TReceivePlanBCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TReceivePlanBCQ.class.getName(); }
