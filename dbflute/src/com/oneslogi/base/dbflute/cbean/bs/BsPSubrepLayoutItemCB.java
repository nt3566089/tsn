...
/**
 * The base condition-bean of P_SUBREP_LAYOUT_ITEM.
 * @author DBFlute(AutoGenerator)
 */
public class BsPSubrepLayoutItemCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected PSubrepLayoutItemCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsPSubrepLayoutItemCB() {
     ...
     * @return this. (NotNull)
     */
    public PSubrepLayoutItemCB acceptPK(Long subrepLayoutItemId) {
        assertObjectNotNull("subrepLayoutItemId", subrepLayoutItemId);
        BsPSubrepLayoutItemCB cb = this;
        cb.query().setSubrepLayoutItemId_Equal(subrepLayoutItemId);
        return (PSubrepLayoutItemCB)this;
    }
     ...
     * @param subrepLayoutItemId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long subrepLayoutItemId) {
        assertObjectNotNull("subrepLayoutItemId", subrepLayoutItemId);
        BsPSubrepLayoutItemCB cb = this;
        cb.query().setSubrepLayoutItemId_Equal(subrepLayoutItemId);
    }
     ...
     * @return this. (NotNull)
     */
    public PSubrepLayoutItemCB acceptUniqueOf(Long subrepLayoutId, String itemCd) {
        assertObjectNotNull("subrepLayoutId", subrepLayoutId);assertObjectNotNull("itemCd", itemCd);
        BsPSubrepLayoutItemCB cb = this;
        cb.query().setSubrepLayoutId_Equal(subrepLayoutId);cb.query().setItemCd_Equal(itemCd);
        return (PSubrepLayoutItemCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_SubrepLayoutItemId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_SubrepLayoutItemId_Desc();
        return this;
    }
     ...
     */
    public PSubrepLayoutItemCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public PSubrepLayoutItemCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected PSubrepLayoutItemCQ doGetConditionQuery() {
    ...
    protected PSubrepLayoutItemCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected PSubrepLayoutItemCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        PSubrepLayoutItemCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected PSubrepLayoutItemCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new PSubrepLayoutItemCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<PSubrepLayoutItemCB> unionCBLambda) {
        final PSubrepLayoutItemCB cb = new PSubrepLayoutItemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PSubrepLayoutItemCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<PSubrepLayoutItemCB> unionCBLambda) {
        final PSubrepLayoutItemCB cb = new PSubrepLayoutItemCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PSubrepLayoutItemCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">pSubrepLayoutItem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">pSubrepLayoutItem</span>.<span style="color: #CC4747">getBDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">pSubrepLayoutItem</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">pSubrepLayoutItem</span>.<span style="color: #CC4747">getVDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<PSubrepLayoutItemCQ> {
         ...
         */
        public SpecifiedColumn columnSubrepLayoutItemId() { return doColumn("SUBREP_LAYOUT_ITEM_ID"); }
        /**
         * SUBREP_LAYOUT_ID: {UQ+, IX, NotNull, bigint(19), FK to P_SUBREP_LAYOUT}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSubrepLayoutId() { return doColumn("SUBREP_LAYOUT_ID"); }
        /**
         ...
         */
        public HpSDRFunction<PSubrepLayoutItemCB, PSubrepLayoutItemCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PSubrepLayoutItemCB> sq, PSubrepLayoutItemCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public PSubrepLayoutItemCB dreamCruiseCB() {
        PSubrepLayoutItemCB cb = new PSubrepLayoutItemCB();
        cb.xsetupForDreamCruise((PSubrepLayoutItemCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<PSubrepLayoutItemCB> columnQuery(final SpecifyQuery<PSubrepLayoutItemCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected PSubrepLayoutItemCB xcreateColumnQueryCB() {
        PSubrepLayoutItemCB cb = new PSubrepLayoutItemCB();
        cb.xsetupForColumnQuery((PSubrepLayoutItemCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<PSubrepLayoutItemCB> orCBLambda) {
        xorSQ((PSubrepLayoutItemCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<PSubrepLayoutItemCB> andCBLambda) {
        xorSQAP((PSubrepLayoutItemCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final PSubrepLayoutItemCB cb;
        if (mainCB != null) {
            cb = (PSubrepLayoutItemCB)mainCB;
        } else {
            cb = new PSubrepLayoutItemCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return PSubrepLayoutItemCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return PSubrepLayoutItemCQ.class.getName(); }
