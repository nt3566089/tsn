...
/**
 * The base condition-bean of H_MOVE_B.
 * @author DBFlute(AutoGenerator)
 */
public class BsHMoveBCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected HMoveBCQ _conditionQuery;
     ...
     */
    public HMoveBCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public HMoveBCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected HMoveBCQ doGetConditionQuery() {
    ...
    protected HMoveBCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected HMoveBCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        HMoveBCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected HMoveBCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new HMoveBCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<HMoveBCB> unionCBLambda) {
        final HMoveBCB cb = new HMoveBCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HMoveBCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<HMoveBCB> unionCBLambda) {
        final HMoveBCB cb = new HMoveBCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HMoveBCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">hMoveBBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">hMoveB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hMoveB</span>.<span style="color: #CC4747">getHMoveH()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hMoveB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hMoveB</span>.<span style="color: #CC4747">getHStock()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hMoveB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hMoveB</span>.<span style="color: #CC4747">getBClassDtlByInoutType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<HMoveBCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<HMoveBCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "H_MOVE_B"; }
        /**
         ...
         */
        public HpSDRFunction<HMoveBCB, HMoveBCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HMoveBCB> sq, HMoveBCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public HMoveBCB dreamCruiseCB() {
        HMoveBCB cb = new HMoveBCB();
        cb.xsetupForDreamCruise((HMoveBCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<HMoveBCB> columnQuery(final SpecifyQuery<HMoveBCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected HMoveBCB xcreateColumnQueryCB() {
        HMoveBCB cb = new HMoveBCB();
        cb.xsetupForColumnQuery((HMoveBCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<HMoveBCB> orCBLambda) {
        xorSQ((HMoveBCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<HMoveBCB> andCBLambda) {
        xorSQAP((HMoveBCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return HMoveBCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return HMoveBCQ.class.getName(); }
