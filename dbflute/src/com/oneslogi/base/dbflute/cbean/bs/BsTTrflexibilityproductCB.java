...
/**
 * The base condition-bean of T_TRFLEXIBILITYPRODUCT.
 * @author DBFlute(AutoGenerator)
 */
public class BsTTrflexibilityproductCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TTrflexibilityproductCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrflexibilityproductCB() {
     ...
     * @return this. (NotNull)
     */
    public TTrflexibilityproductCB acceptPK(Long trflexibilityproductId) {
        assertObjectNotNull("trflexibilityproductId", trflexibilityproductId);
        BsTTrflexibilityproductCB cb = this;
        cb.query().setTrflexibilityproductId_Equal(trflexibilityproductId);
        return (TTrflexibilityproductCB)this;
    }
     ...
     * @param trflexibilityproductId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long trflexibilityproductId) {
        assertObjectNotNull("trflexibilityproductId", trflexibilityproductId);
        BsTTrflexibilityproductCB cb = this;
        cb.query().setTrflexibilityproductId_Equal(trflexibilityproductId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_TrflexibilityproductId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TrflexibilityproductId_Desc();
        return this;
    }
     ...
     */
    public TTrflexibilityproductCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TTrflexibilityproductCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TTrflexibilityproductCQ doGetConditionQuery() {
    ...
    protected TTrflexibilityproductCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TTrflexibilityproductCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TTrflexibilityproductCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TTrflexibilityproductCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TTrflexibilityproductCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TTrflexibilityproductCB> unionCBLambda) {
        final TTrflexibilityproductCB cb = new TTrflexibilityproductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TTrflexibilityproductCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TTrflexibilityproductCB> unionCBLambda) {
        final TTrflexibilityproductCB cb = new TTrflexibilityproductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TTrflexibilityproductCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TTrflexibilityproductCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TTrflexibilityproductCQ> qyCall
         ...
         */
        public SpecifiedColumn columnTrflexibilityproductId() { return doColumn("TRFLEXIBILITYPRODUCT_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnRcvmakeflg() { return doColumn("RCVMAKEFLG"); }
        /**
         * REFLINENO: {NotNull, bigint(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnReflineno() { return doColumn("REFLINENO"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCaseinfoflg() { return doColumn("CASEINFOFLG"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnOperationnum() { return doColumn("OPERATIONNUM"); }
        /**
         * RCVKEY: {decimal(16, 6)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCardboardno() { return doColumn("CARDBOARDNO"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnTrflexibilityproductId(); // PK
        }
        @Override
        protected String getTableDbName() { return "T_TRFLEXIBILITYPRODUCT"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<TTrflexibilityproductCB, TTrflexibilityproductCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TTrflexibilityproductCB> sq, TTrflexibilityproductCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TTrflexibilityproductCB dreamCruiseCB() {
        TTrflexibilityproductCB cb = new TTrflexibilityproductCB();
        cb.xsetupForDreamCruise((TTrflexibilityproductCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TTrflexibilityproductCB> columnQuery(final SpecifyQuery<TTrflexibilityproductCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TTrflexibilityproductCB xcreateColumnQueryCB() {
        TTrflexibilityproductCB cb = new TTrflexibilityproductCB();
        cb.xsetupForColumnQuery((TTrflexibilityproductCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TTrflexibilityproductCB> orCBLambda) {
        xorSQ((TTrflexibilityproductCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TTrflexibilityproductCB> andCBLambda) {
        xorSQAP((TTrflexibilityproductCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TTrflexibilityproductCB cb;
        if (mainCB != null) {
            cb = (TTrflexibilityproductCB)mainCB;
        } else {
            cb = new TTrflexibilityproductCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TTrflexibilityproductCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TTrflexibilityproductCQ.class.getName(); }
