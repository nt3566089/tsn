...
/**
 * The base condition-bean of W_SHIPPING_INTERRUPT.
 * @author DBFlute(AutoGenerator)
 */
public class BsWShippingInterruptCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WShippingInterruptCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWShippingInterruptCB() {
     ...
     * @return this. (NotNull)
     */
    public WShippingInterruptCB acceptPK(Long shippingInstHId) {
        assertObjectNotNull("shippingInstHId", shippingInstHId);
        BsWShippingInterruptCB cb = this;
        cb.query().setShippingInstHId_Equal(shippingInstHId);
        return (WShippingInterruptCB)this;
    }
     ...
     */
    public WShippingInterruptCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WShippingInterruptCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WShippingInterruptCQ doGetConditionQuery() {
    ...
    protected WShippingInterruptCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WShippingInterruptCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WShippingInterruptCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WShippingInterruptCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WShippingInterruptCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WShippingInterruptCB> unionCBLambda) {
        final WShippingInterruptCB cb = new WShippingInterruptCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WShippingInterruptCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WShippingInterruptCB> unionCBLambda) {
        final WShippingInterruptCB cb = new WShippingInterruptCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WShippingInterruptCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">wShippingInterruptBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">wShippingInterrupt</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wShippingInterrupt</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wShippingInterrupt</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wShippingInterrupt</span>.<span style="color: #CC4747">getMBox()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wShippingInterrupt</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wShippingInterrupt</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wShippingInterrupt</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wShippingInterrupt</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WShippingInterruptCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WShippingInterruptCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "W_SHIPPING_INTERRUPT"; }
        /**
         ...
         */
        public HpSDRFunction<WShippingInterruptCB, WShippingInterruptCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WShippingInterruptCB> sq, WShippingInterruptCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WShippingInterruptCB dreamCruiseCB() {
        WShippingInterruptCB cb = new WShippingInterruptCB();
        cb.xsetupForDreamCruise((WShippingInterruptCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WShippingInterruptCB> columnQuery(final SpecifyQuery<WShippingInterruptCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WShippingInterruptCB xcreateColumnQueryCB() {
        WShippingInterruptCB cb = new WShippingInterruptCB();
        cb.xsetupForColumnQuery((WShippingInterruptCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WShippingInterruptCB> orCBLambda) {
        xorSQ((WShippingInterruptCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WShippingInterruptCB> andCBLambda) {
        xorSQAP((WShippingInterruptCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WShippingInterruptCB cb;
        if (mainCB != null) {
            cb = (WShippingInterruptCB)mainCB;
        } else {
            cb = new WShippingInterruptCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WShippingInterruptCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WShippingInterruptCQ.class.getName(); }
