...
/**
 * The base condition-bean of E_MH_SHIPPING.
 * @author DBFlute(AutoGenerator)
 */
public class BsEMhShippingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EMhShippingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEMhShippingCB() {
     ...
     * @return this. (NotNull)
     */
    public EMhShippingCB acceptPK(Long mhShippingId) {
        assertObjectNotNull("mhShippingId", mhShippingId);
        BsEMhShippingCB cb = this;
        cb.query().setMhShippingId_Equal(mhShippingId);
        return (EMhShippingCB)this;
    }
     ...
     * @param mhShippingId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long mhShippingId) {
        assertObjectNotNull("mhShippingId", mhShippingId);
        BsEMhShippingCB cb = this;
        cb.query().setMhShippingId_Equal(mhShippingId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_MhShippingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_MhShippingId_Desc();
        return this;
    }
     ...
     */
    public EMhShippingCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EMhShippingCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EMhShippingCQ doGetConditionQuery() {
    ...
    protected EMhShippingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EMhShippingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EMhShippingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EMhShippingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EMhShippingCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EMhShippingCB> unionCBLambda) {
        final EMhShippingCB cb = new EMhShippingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EMhShippingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EMhShippingCB> unionCBLambda) {
        final EMhShippingCB cb = new EMhShippingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EMhShippingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EMhShippingCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EMhShippingCQ> qyCall
         ...
         */
        public SpecifiedColumn columnMhShippingId() { return doColumn("MH_SHIPPING_ID"); }
        /**
         * DPCD: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        ...
        protected void doSpecifyRequiredColumn() {
            columnMhShippingId(); // PK
        }
        @Override
        protected String getTableDbName() { return "E_MH_SHIPPING"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EMhShippingCB, EMhShippingCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EMhShippingCB> sq, EMhShippingCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EMhShippingCB dreamCruiseCB() {
        EMhShippingCB cb = new EMhShippingCB();
        cb.xsetupForDreamCruise((EMhShippingCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EMhShippingCB> columnQuery(final SpecifyQuery<EMhShippingCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EMhShippingCB xcreateColumnQueryCB() {
        EMhShippingCB cb = new EMhShippingCB();
        cb.xsetupForColumnQuery((EMhShippingCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EMhShippingCB> orCBLambda) {
        xorSQ((EMhShippingCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EMhShippingCB> andCBLambda) {
        xorSQAP((EMhShippingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EMhShippingCB cb;
        if (mainCB != null) {
            cb = (EMhShippingCB)mainCB;
        } else {
            cb = new EMhShippingCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EMhShippingCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EMhShippingCQ.class.getName(); }
