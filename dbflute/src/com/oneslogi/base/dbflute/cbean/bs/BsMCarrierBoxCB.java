...
/**
 * The base condition-bean of M_CARRIER_BOX.
 * @author DBFlute(AutoGenerator)
 */
public class BsMCarrierBoxCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MCarrierBoxCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMCarrierBoxCB() {
     ...
     * @return this. (NotNull)
     */
    public MCarrierBoxCB acceptPK(Long carrierBoxId) {
        assertObjectNotNull("carrierBoxId", carrierBoxId);
        BsMCarrierBoxCB cb = this;
        cb.query().setCarrierBoxId_Equal(carrierBoxId);
        return (MCarrierBoxCB)this;
    }
     ...
     * @param carrierBoxId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long carrierBoxId) {
        assertObjectNotNull("carrierBoxId", carrierBoxId);
        BsMCarrierBoxCB cb = this;
        cb.query().setCarrierBoxId_Equal(carrierBoxId);
    }
     ...
     * @return this. (NotNull)
     */
    public MCarrierBoxCB acceptUniqueOf(Long carrierId, Long boxId) {
        assertObjectNotNull("carrierId", carrierId);assertObjectNotNull("boxId", boxId);
        BsMCarrierBoxCB cb = this;
        cb.query().setCarrierId_Equal(carrierId);cb.query().setBoxId_Equal(boxId);
        return (MCarrierBoxCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_CarrierBoxId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_CarrierBoxId_Desc();
        return this;
    }
     ...
     */
    public MCarrierBoxCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MCarrierBoxCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MCarrierBoxCQ doGetConditionQuery() {
    ...
    protected MCarrierBoxCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MCarrierBoxCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MCarrierBoxCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MCarrierBoxCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MCarrierBoxCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MCarrierBoxCB> unionCBLambda) {
        final MCarrierBoxCB cb = new MCarrierBoxCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCarrierBoxCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MCarrierBoxCB> unionCBLambda) {
        final MCarrierBoxCB cb = new MCarrierBoxCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MCarrierBoxCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mCarrierBox</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mCarrierBox</span>.<span style="color: #CC4747">getMBox()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MCarrierBoxCQ> {
         ...
         */
        public SpecifiedColumn columnCarrierBoxId() { return doColumn("CARRIER_BOX_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBoxSizeCd() { return doColumn("BOX_SIZE_CD"); }
        /**
         ...
         */
        public HpSDRFunction<MCarrierBoxCB, MCarrierBoxCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MCarrierBoxCB> sq, MCarrierBoxCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MCarrierBoxCB dreamCruiseCB() {
        MCarrierBoxCB cb = new MCarrierBoxCB();
        cb.xsetupForDreamCruise((MCarrierBoxCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MCarrierBoxCB> columnQuery(final SpecifyQuery<MCarrierBoxCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MCarrierBoxCB xcreateColumnQueryCB() {
        MCarrierBoxCB cb = new MCarrierBoxCB();
        cb.xsetupForColumnQuery((MCarrierBoxCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MCarrierBoxCB> orCBLambda) {
        xorSQ((MCarrierBoxCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MCarrierBoxCB> andCBLambda) {
        xorSQAP((MCarrierBoxCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MCarrierBoxCB cb;
        if (mainCB != null) {
            cb = (MCarrierBoxCB)mainCB;
        } else {
            cb = new MCarrierBoxCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MCarrierBoxCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MCarrierBoxCQ.class.getName(); }
