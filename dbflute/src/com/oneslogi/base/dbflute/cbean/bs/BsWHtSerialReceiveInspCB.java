...
/**
 * The base condition-bean of W_HT_SERIAL_RECEIVE_INSP.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtSerialReceiveInspCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtSerialReceiveInspCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtSerialReceiveInspCB() {
     ...
     * @return this. (NotNull)
     */
    public WHtSerialReceiveInspCB acceptPK(Long htSerialReceiveInspId) {
        assertObjectNotNull("htSerialReceiveInspId", htSerialReceiveInspId);
        BsWHtSerialReceiveInspCB cb = this;
        cb.query().setHtSerialReceiveInspId_Equal(htSerialReceiveInspId);
        return (WHtSerialReceiveInspCB)this;
    }
     ...
     * @param htSerialReceiveInspId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htSerialReceiveInspId) {
        assertObjectNotNull("htSerialReceiveInspId", htSerialReceiveInspId);
        BsWHtSerialReceiveInspCB cb = this;
        cb.query().setHtSerialReceiveInspId_Equal(htSerialReceiveInspId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtSerialReceiveInspId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtSerialReceiveInspId_Desc();
        return this;
    }
     ...
     */
    public WHtSerialReceiveInspCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtSerialReceiveInspCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtSerialReceiveInspCQ doGetConditionQuery() {
    ...
    protected WHtSerialReceiveInspCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtSerialReceiveInspCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtSerialReceiveInspCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtSerialReceiveInspCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtSerialReceiveInspCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtSerialReceiveInspCB> unionCBLambda) {
        final WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtSerialReceiveInspCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtSerialReceiveInspCB> unionCBLambda) {
        final WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtSerialReceiveInspCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">wHtSerialReceiveInspBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">wHtSerialReceiveInsp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtSerialReceiveInsp</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtSerialReceiveInsp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtSerialReceiveInsp</span>.<span style="color: #CC4747">getMCustomer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtSerialReceiveInsp</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtSerialReceiveInsp</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtSerialReceiveInspCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WHtSerialReceiveInspCQ> qyCall
         ...
         */
        public SpecifiedColumn columnHtSerialReceiveInspId() { return doColumn("HT_SERIAL_RECEIVE_INSP_ID"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnHtSerialReceiveInspId(); // PK
        ...
        @Override
        protected String getTableDbName() { return "W_HT_SERIAL_RECEIVE_INSP"; }
        /**
         ...
         */
        public HpSDRFunction<WHtSerialReceiveInspCB, WHtSerialReceiveInspCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtSerialReceiveInspCB> sq, WHtSerialReceiveInspCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtSerialReceiveInspCB dreamCruiseCB() {
        WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB();
        cb.xsetupForDreamCruise((WHtSerialReceiveInspCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtSerialReceiveInspCB> columnQuery(final SpecifyQuery<WHtSerialReceiveInspCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtSerialReceiveInspCB xcreateColumnQueryCB() {
        WHtSerialReceiveInspCB cb = new WHtSerialReceiveInspCB();
        cb.xsetupForColumnQuery((WHtSerialReceiveInspCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtSerialReceiveInspCB> orCBLambda) {
        xorSQ((WHtSerialReceiveInspCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtSerialReceiveInspCB> andCBLambda) {
        xorSQAP((WHtSerialReceiveInspCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtSerialReceiveInspCB cb;
        if (mainCB != null) {
            cb = (WHtSerialReceiveInspCB)mainCB;
        } else {
            cb = new WHtSerialReceiveInspCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtSerialReceiveInspCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtSerialReceiveInspCQ.class.getName(); }
