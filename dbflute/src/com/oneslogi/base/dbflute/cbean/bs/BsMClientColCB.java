...
/**
 * The base condition-bean of M_CLIENT_COL.
 * @author DBFlute(AutoGenerator)
 */
public class BsMClientColCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MClientColCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMClientColCB() {
     ...
     * @return this. (NotNull)
     */
    public MClientColCB acceptPK(Long clientColId) {
        assertObjectNotNull("clientColId", clientColId);
        BsMClientColCB cb = this;
        cb.query().setClientColId_Equal(clientColId);
        return (MClientColCB)this;
    }
     ...
     * @param clientColId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long clientColId) {
        assertObjectNotNull("clientColId", clientColId);
        BsMClientColCB cb = this;
        cb.query().setClientColId_Equal(clientColId);
    }
     ...
     * @return this. (NotNull)
     */
    public MClientColCB acceptUniqueOf(Long clientId, Long colId, Long dictId) {
        assertObjectNotNull("clientId", clientId);assertObjectNotNull("colId", colId);assertObjectNotNull("dictId", dictId);
        BsMClientColCB cb = this;
        cb.query().setClientId_Equal(clientId);cb.query().setColId_Equal(colId);cb.query().setDictId_Equal(dictId);
        return (MClientColCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ClientColId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ClientColId_Desc();
        return this;
    }
     ...
     */
    public MClientColCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MClientColCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MClientColCQ doGetConditionQuery() {
    ...
    protected MClientColCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MClientColCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MClientColCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MClientColCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MClientColCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MClientColCB> unionCBLambda) {
        final MClientColCB cb = new MClientColCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientColCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MClientColCB> unionCBLambda) {
        final MClientColCB cb = new MClientColCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MClientColCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">mClientColBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">mClientCol</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCol</span>.<span style="color: #CC4747">getBCol()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientCol</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCol</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mClientCol</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mClientCol</span>.<span style="color: #CC4747">getVDict()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MClientColCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<MClientColCQ> qyCall
         ...
         */
        public SpecifiedColumn columnClientColId() { return doColumn("CLIENT_COL_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "M_CLIENT_COL"; }
        /**
         ...
         */
        public HpSDRFunction<MClientColCB, MClientColCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MClientColCB> sq, MClientColCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MClientColCB dreamCruiseCB() {
        MClientColCB cb = new MClientColCB();
        cb.xsetupForDreamCruise((MClientColCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MClientColCB> columnQuery(final SpecifyQuery<MClientColCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MClientColCB xcreateColumnQueryCB() {
        MClientColCB cb = new MClientColCB();
        cb.xsetupForColumnQuery((MClientColCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MClientColCB> orCBLambda) {
        xorSQ((MClientColCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MClientColCB> andCBLambda) {
        xorSQAP((MClientColCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MClientColCB cb;
        if (mainCB != null) {
            cb = (MClientColCB)mainCB;
        } else {
            cb = new MClientColCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MClientColCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MClientColCQ.class.getName(); }
