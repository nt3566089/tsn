...
/**
 * The base condition-bean of H_SHIPPING_H.
 * @author DBFlute(AutoGenerator)
 */
public class BsHShippingHCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected HShippingHCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsHShippingHCB() {
     ...
     */
    public HShippingHCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public HShippingHCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected HShippingHCQ doGetConditionQuery() {
    ...
    protected HShippingHCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected HShippingHCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        HShippingHCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected HShippingHCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new HShippingHCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<HShippingHCB> unionCBLambda) {
        final HShippingHCB cb = new HShippingHCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HShippingHCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<HShippingHCB> unionCBLambda) {
        final HShippingHCB cb = new HShippingHCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final HShippingHCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">hShippingHBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">hShippingH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hShippingH</span>.<span style="color: #CC4747">getMProcessType()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hShippingH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hShippingH</span>.<span style="color: #CC4747">getBClassDtlByDelivTz()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">hShippingH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">hShippingH</span>.<span style="color: #CC4747">getBClassDtlByEmergencyFlg()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<HShippingHCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<HShippingHCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "H_SHIPPING_H"; }
        /**
         ...
         * {select max(FOO) from H_PACKING_H where ...) as FOO_MAX} <br>
         ...
         * }, HPackingH.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<HPackingHCB, HShippingHCQ> derivedHPackingHList() {
            assertDerived("hPackingHList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HPackingHCB> sq, HShippingHCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveHPackingHList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<HShippingBCB, HShippingHCQ> derivedHShippingBList() {
            assertDerived("hShippingBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HShippingBCB> sq, HShippingHCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<HShippingHCB, HShippingHCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<HShippingHCB> sq, HShippingHCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public HShippingHCB dreamCruiseCB() {
        HShippingHCB cb = new HShippingHCB();
        cb.xsetupForDreamCruise((HShippingHCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<HShippingHCB> columnQuery(final SpecifyQuery<HShippingHCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected HShippingHCB xcreateColumnQueryCB() {
        HShippingHCB cb = new HShippingHCB();
        cb.xsetupForColumnQuery((HShippingHCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<HShippingHCB> orCBLambda) {
        xorSQ((HShippingHCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<HShippingHCB> andCBLambda) {
        xorSQAP((HShippingHCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final HShippingHCB cb;
        if (mainCB != null) {
            cb = (HShippingHCB)mainCB;
        } else {
            cb = new HShippingHCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return HShippingHCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return HShippingHCQ.class.getName(); }
