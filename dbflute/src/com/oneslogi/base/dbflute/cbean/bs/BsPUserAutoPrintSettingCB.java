...
/**
 * The base condition-bean of P_USER_AUTO_PRINT_SETTING.
 * @author DBFlute(AutoGenerator)
 */
public class BsPUserAutoPrintSettingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected PUserAutoPrintSettingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsPUserAutoPrintSettingCB() {
     ...
     * @return this. (NotNull)
     */
    public PUserAutoPrintSettingCB acceptPK(Long userAutoPrintSettingId) {
        assertObjectNotNull("userAutoPrintSettingId", userAutoPrintSettingId);
        BsPUserAutoPrintSettingCB cb = this;
        cb.query().setUserAutoPrintSettingId_Equal(userAutoPrintSettingId);
        return (PUserAutoPrintSettingCB)this;
    }
     ...
     * @param userAutoPrintSettingId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long userAutoPrintSettingId) {
        assertObjectNotNull("userAutoPrintSettingId", userAutoPrintSettingId);
        BsPUserAutoPrintSettingCB cb = this;
        cb.query().setUserAutoPrintSettingId_Equal(userAutoPrintSettingId);
    }
     ...
     * @return this. (NotNull)
     */
    public PUserAutoPrintSettingCB acceptUniqueOf(Long userId, Long reportLayoutId) {
        assertObjectNotNull("userId", userId);assertObjectNotNull("reportLayoutId", reportLayoutId);
        BsPUserAutoPrintSettingCB cb = this;
        cb.query().setUserId_Equal(userId);cb.query().setReportLayoutId_Equal(reportLayoutId);
        return (PUserAutoPrintSettingCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_UserAutoPrintSettingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_UserAutoPrintSettingId_Desc();
        return this;
    }
     ...
     */
    public PUserAutoPrintSettingCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public PUserAutoPrintSettingCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected PUserAutoPrintSettingCQ doGetConditionQuery() {
    ...
    protected PUserAutoPrintSettingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected PUserAutoPrintSettingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        PUserAutoPrintSettingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected PUserAutoPrintSettingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new PUserAutoPrintSettingCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<PUserAutoPrintSettingCB> unionCBLambda) {
        final PUserAutoPrintSettingCB cb = new PUserAutoPrintSettingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PUserAutoPrintSettingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<PUserAutoPrintSettingCB> unionCBLambda) {
        final PUserAutoPrintSettingCB cb = new PUserAutoPrintSettingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PUserAutoPrintSettingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">pUserAutoPrintSettingBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">pUserAutoPrintSetting</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">pUserAutoPrintSetting</span>.<span style="color: #CC4747">getPReportLayoutByReportLayoutId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">pUserAutoPrintSetting</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">pUserAutoPrintSetting</span>.<span style="color: #CC4747">getPPrinterGroupByPrinterGroupId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">pUserAutoPrintSetting</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">pUserAutoPrintSetting</span>.<span style="color: #CC4747">getPPrinterByPrinterId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">pUserAutoPrintSetting</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">pUserAutoPrintSetting</span>.<span style="color: #CC4747">getPPrinterAttributeByPrinterAttributeId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<PUserAutoPrintSettingCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<PUserAutoPrintSettingCQ> qyCall
         ...
         */
        public SpecifiedColumn columnUserAutoPrintSettingId() { return doColumn("USER_AUTO_PRINT_SETTING_ID"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnUserAutoPrintSettingId(); // PK
        ...
        @Override
        protected String getTableDbName() { return "P_USER_AUTO_PRINT_SETTING"; }
        /**
         ...
         */
        public HpSDRFunction<PUserAutoPrintSettingCB, PUserAutoPrintSettingCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PUserAutoPrintSettingCB> sq, PUserAutoPrintSettingCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public PUserAutoPrintSettingCB dreamCruiseCB() {
        PUserAutoPrintSettingCB cb = new PUserAutoPrintSettingCB();
        cb.xsetupForDreamCruise((PUserAutoPrintSettingCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<PUserAutoPrintSettingCB> columnQuery(final SpecifyQuery<PUserAutoPrintSettingCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected PUserAutoPrintSettingCB xcreateColumnQueryCB() {
        PUserAutoPrintSettingCB cb = new PUserAutoPrintSettingCB();
        cb.xsetupForColumnQuery((PUserAutoPrintSettingCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<PUserAutoPrintSettingCB> orCBLambda) {
        xorSQ((PUserAutoPrintSettingCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<PUserAutoPrintSettingCB> andCBLambda) {
        xorSQAP((PUserAutoPrintSettingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final PUserAutoPrintSettingCB cb;
        if (mainCB != null) {
            cb = (PUserAutoPrintSettingCB)mainCB;
        } else {
            cb = new PUserAutoPrintSettingCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return PUserAutoPrintSettingCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return PUserAutoPrintSettingCQ.class.getName(); }
