...
/**
 * The base condition-bean of E_TRACKING_INFO_IMPORT.
 * @author DBFlute(AutoGenerator)
 */
public class BsETrackingInfoImportCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ETrackingInfoImportCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsETrackingInfoImportCB() {
     ...
     * @return this. (NotNull)
     */
    public ETrackingInfoImportCB acceptPK(Long trackingInfoImportId) {
        assertObjectNotNull("trackingInfoImportId", trackingInfoImportId);
        BsETrackingInfoImportCB cb = this;
        cb.query().setTrackingInfoImportId_Equal(trackingInfoImportId);
        return (ETrackingInfoImportCB)this;
    }
     ...
     * @param trackingInfoImportId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long trackingInfoImportId) {
        assertObjectNotNull("trackingInfoImportId", trackingInfoImportId);
        BsETrackingInfoImportCB cb = this;
        cb.query().setTrackingInfoImportId_Equal(trackingInfoImportId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_TrackingInfoImportId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TrackingInfoImportId_Desc();
        return this;
    }
     ...
     */
    public ETrackingInfoImportCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ETrackingInfoImportCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ETrackingInfoImportCQ doGetConditionQuery() {
    ...
    protected ETrackingInfoImportCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ETrackingInfoImportCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ETrackingInfoImportCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ETrackingInfoImportCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ETrackingInfoImportCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ETrackingInfoImportCB> unionCBLambda) {
        final ETrackingInfoImportCB cb = new ETrackingInfoImportCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETrackingInfoImportCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ETrackingInfoImportCB> unionCBLambda) {
        final ETrackingInfoImportCB cb = new ETrackingInfoImportCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETrackingInfoImportCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ETrackingInfoImportCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ETrackingInfoImportCQ> qyCall
         ...
         */
        public SpecifiedColumn columnTrackingInfoImportId() { return doColumn("TRACKING_INFO_IMPORT_ID"); }
        /**
         * SYMBOLPOSKEY: {NotNull, bigint(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSymbolposkey() { return doColumn("SYMBOLPOSKEY"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCasecreatetypeNm() { return doColumn("CASECREATETYPE_NM"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAdddatetime() { return doColumn("ADDDATETIME"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCaseinnumbowl() { return doColumn("CASEINNUMBOWL"); }
        /**
         * SHIPNUMBOWL: {bigint(19)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShipnumbowl() { return doColumn("SHIPNUMBOWL"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnTokuhanNm() { return doColumn("TOKUHAN_NM"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnTrackingInfoImportId(); // PK
        }
        @Override
        protected String getTableDbName() { return "E_TRACKING_INFO_IMPORT"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ETrackingInfoImportCB, ETrackingInfoImportCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ETrackingInfoImportCB> sq, ETrackingInfoImportCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ETrackingInfoImportCB dreamCruiseCB() {
        ETrackingInfoImportCB cb = new ETrackingInfoImportCB();
        cb.xsetupForDreamCruise((ETrackingInfoImportCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ETrackingInfoImportCB> columnQuery(final SpecifyQuery<ETrackingInfoImportCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ETrackingInfoImportCB xcreateColumnQueryCB() {
        ETrackingInfoImportCB cb = new ETrackingInfoImportCB();
        cb.xsetupForColumnQuery((ETrackingInfoImportCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ETrackingInfoImportCB> orCBLambda) {
        xorSQ((ETrackingInfoImportCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ETrackingInfoImportCB> andCBLambda) {
        xorSQAP((ETrackingInfoImportCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ETrackingInfoImportCB cb;
        if (mainCB != null) {
            cb = (ETrackingInfoImportCB)mainCB;
        } else {
            cb = new ETrackingInfoImportCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ETrackingInfoImportCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ETrackingInfoImportCQ.class.getName(); }
