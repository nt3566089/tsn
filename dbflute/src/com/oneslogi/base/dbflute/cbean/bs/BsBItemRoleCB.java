...
/**
 * The base condition-bean of B_ITEM_ROLE.
 * @author DBFlute(AutoGenerator)
 */
public class BsBItemRoleCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BItemRoleCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsBItemRoleCB() {
     ...
     * @return this. (NotNull)
     */
    public BItemRoleCB acceptPK(Long itemRoleId) {
        assertObjectNotNull("itemRoleId", itemRoleId);
        BsBItemRoleCB cb = this;
        cb.query().setItemRoleId_Equal(itemRoleId);
        return (BItemRoleCB)this;
    }
     ...
     * @param itemRoleId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long itemRoleId) {
        assertObjectNotNull("itemRoleId", itemRoleId);
        BsBItemRoleCB cb = this;
        cb.query().setItemRoleId_Equal(itemRoleId);
    }
     ...
     * @return this. (NotNull)
     */
    public BItemRoleCB acceptUniqueOf(Long roleId, Long itemId) {
        assertObjectNotNull("roleId", roleId);assertObjectNotNull("itemId", itemId);
        BsBItemRoleCB cb = this;
        cb.query().setRoleId_Equal(roleId);cb.query().setItemId_Equal(itemId);
        return (BItemRoleCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ItemRoleId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ItemRoleId_Desc();
        return this;
    }
     ...
     */
    public BItemRoleCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public BItemRoleCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected BItemRoleCQ doGetConditionQuery() {
    ...
    protected BItemRoleCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected BItemRoleCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        BItemRoleCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected BItemRoleCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new BItemRoleCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<BItemRoleCB> unionCBLambda) {
        final BItemRoleCB cb = new BItemRoleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BItemRoleCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<BItemRoleCB> unionCBLambda) {
        final BItemRoleCB cb = new BItemRoleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BItemRoleCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bItemRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bItemRole</span>.<span style="color: #CC4747">getBItem()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bItemRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bItemRole</span>.<span style="color: #CC4747">getBClassDtlByVisible()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bItemRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bItemRole</span>.<span style="color: #CC4747">getBClassDtlByEditable()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<BItemRoleCQ> {
         ...
         */
        public SpecifiedColumn columnItemRoleId() { return doColumn("ITEM_ROLE_ID"); }
        /**
         ...
         */
        public HpSDRFunction<BItemRoleCB, BItemRoleCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<BItemRoleCB> sq, BItemRoleCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public BItemRoleCB dreamCruiseCB() {
        BItemRoleCB cb = new BItemRoleCB();
        cb.xsetupForDreamCruise((BItemRoleCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<BItemRoleCB> columnQuery(final SpecifyQuery<BItemRoleCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected BItemRoleCB xcreateColumnQueryCB() {
        BItemRoleCB cb = new BItemRoleCB();
        cb.xsetupForColumnQuery((BItemRoleCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<BItemRoleCB> orCBLambda) {
        xorSQ((BItemRoleCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<BItemRoleCB> andCBLambda) {
        xorSQAP((BItemRoleCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final BItemRoleCB cb;
        if (mainCB != null) {
            cb = (BItemRoleCB)mainCB;
        } else {
            cb = new BItemRoleCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return BItemRoleCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return BItemRoleCQ.class.getName(); }
