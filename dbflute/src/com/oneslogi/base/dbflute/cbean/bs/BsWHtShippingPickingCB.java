...
/**
 * The base condition-bean of W_HT_SHIPPING_PICKING.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtShippingPickingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtShippingPickingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtShippingPickingCB() {
     ...
     * @return this. (NotNull)
     */
    public WHtShippingPickingCB acceptPK(Long htShippingPickingId) {
        assertObjectNotNull("htShippingPickingId", htShippingPickingId);
        BsWHtShippingPickingCB cb = this;
        cb.query().setHtShippingPickingId_Equal(htShippingPickingId);
        return (WHtShippingPickingCB)this;
    }
     ...
     * @param htShippingPickingId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htShippingPickingId) {
        assertObjectNotNull("htShippingPickingId", htShippingPickingId);
        BsWHtShippingPickingCB cb = this;
        cb.query().setHtShippingPickingId_Equal(htShippingPickingId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtShippingPickingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtShippingPickingId_Desc();
        return this;
    }
     ...
     */
    public WHtShippingPickingCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtShippingPickingCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtShippingPickingCQ doGetConditionQuery() {
    ...
    protected WHtShippingPickingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtShippingPickingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtShippingPickingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtShippingPickingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtShippingPickingCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtShippingPickingCB> unionCBLambda) {
        final WHtShippingPickingCB cb = new WHtShippingPickingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtShippingPickingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtShippingPickingCB> unionCBLambda) {
        final WHtShippingPickingCB cb = new WHtShippingPickingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtShippingPickingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">wHtShippingPicking</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtShippingPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtShippingPicking</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtShippingPicking</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtShippingPicking</span>.<span style="color: #CC4747">getTLot()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtShippingPickingCQ> {
         ...
         */
        public SpecifiedColumn columnHtShippingPickingId() { return doColumn("HT_SHIPPING_PICKING_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "W_HT_SHIPPING_PICKING"; }
        /**
         ...
         */
        public HpSDRFunction<WHtShippingPickingCB, WHtShippingPickingCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtShippingPickingCB> sq, WHtShippingPickingCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtShippingPickingCB dreamCruiseCB() {
        WHtShippingPickingCB cb = new WHtShippingPickingCB();
        cb.xsetupForDreamCruise((WHtShippingPickingCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtShippingPickingCB> columnQuery(final SpecifyQuery<WHtShippingPickingCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtShippingPickingCB xcreateColumnQueryCB() {
        WHtShippingPickingCB cb = new WHtShippingPickingCB();
        cb.xsetupForColumnQuery((WHtShippingPickingCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtShippingPickingCB> orCBLambda) {
        xorSQ((WHtShippingPickingCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtShippingPickingCB> andCBLambda) {
        xorSQAP((WHtShippingPickingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtShippingPickingCB cb;
        if (mainCB != null) {
            cb = (WHtShippingPickingCB)mainCB;
        } else {
            cb = new WHtShippingPickingCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtShippingPickingCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtShippingPickingCQ.class.getName(); }
