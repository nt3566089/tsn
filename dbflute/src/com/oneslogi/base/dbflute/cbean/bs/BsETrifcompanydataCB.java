...
/**
 * The base condition-bean of E_TRIFCOMPANYDATA.
 * @author DBFlute(AutoGenerator)
 */
public class BsETrifcompanydataCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ETrifcompanydataCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsETrifcompanydataCB() {
     ...
     * @return this. (NotNull)
     */
    public ETrifcompanydataCB acceptPK(java.math.BigDecimal ifdatakey) {
        assertObjectNotNull("ifdatakey", ifdatakey);
        BsETrifcompanydataCB cb = this;
        cb.query().setIfdatakey_Equal(ifdatakey);
        return (ETrifcompanydataCB)this;
    }
     ...
     * @param ifdatakey : PK, NotNull, decimal(16, 6). (NotNull)
     */
    public void acceptPrimaryKey(java.math.BigDecimal ifdatakey) {
        assertObjectNotNull("ifdatakey", ifdatakey);
        BsETrifcompanydataCB cb = this;
        cb.query().setIfdatakey_Equal(ifdatakey);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_Ifdatakey_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_Ifdatakey_Desc();
        return this;
    }
     ...
     */
    public ETrifcompanydataCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ETrifcompanydataCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ETrifcompanydataCQ doGetConditionQuery() {
    ...
    protected ETrifcompanydataCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ETrifcompanydataCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ETrifcompanydataCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ETrifcompanydataCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ETrifcompanydataCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ETrifcompanydataCB> unionCBLambda) {
        final ETrifcompanydataCB cb = new ETrifcompanydataCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETrifcompanydataCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ETrifcompanydataCB> unionCBLambda) {
        final ETrifcompanydataCB cb = new ETrifcompanydataCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETrifcompanydataCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ETrifcompanydataCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ETrifcompanydataCQ> qyCall
         ...
         */
        public SpecifiedColumn columnIfdatakey() { return doColumn("IFDATAKEY"); }
        /**
         * SEGNAME: {NotNull, varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnSegname() { return doColumn("SEGNAME"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "E_TRIFCOMPANYDATA"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ETrifcompanydataCB, ETrifcompanydataCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ETrifcompanydataCB> sq, ETrifcompanydataCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ETrifcompanydataCB dreamCruiseCB() {
        ETrifcompanydataCB cb = new ETrifcompanydataCB();
        cb.xsetupForDreamCruise((ETrifcompanydataCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ETrifcompanydataCB> columnQuery(final SpecifyQuery<ETrifcompanydataCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ETrifcompanydataCB xcreateColumnQueryCB() {
        ETrifcompanydataCB cb = new ETrifcompanydataCB();
        cb.xsetupForColumnQuery((ETrifcompanydataCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ETrifcompanydataCB> orCBLambda) {
        xorSQ((ETrifcompanydataCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ETrifcompanydataCB> andCBLambda) {
        xorSQAP((ETrifcompanydataCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ETrifcompanydataCB cb;
        if (mainCB != null) {
            cb = (ETrifcompanydataCB)mainCB;
        } else {
            cb = new ETrifcompanydataCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ETrifcompanydataCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ETrifcompanydataCQ.class.getName(); }
