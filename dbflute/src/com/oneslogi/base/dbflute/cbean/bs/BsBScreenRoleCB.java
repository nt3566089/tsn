...
/**
 * The base condition-bean of B_SCREEN_ROLE.
 * @author DBFlute(AutoGenerator)
 */
public class BsBScreenRoleCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BScreenRoleCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsBScreenRoleCB() {
     ...
     * @return this. (NotNull)
     */
    public BScreenRoleCB acceptPK(Long screenRoleId) {
        assertObjectNotNull("screenRoleId", screenRoleId);
        BsBScreenRoleCB cb = this;
        cb.query().setScreenRoleId_Equal(screenRoleId);
        return (BScreenRoleCB)this;
    }
     ...
     * @param screenRoleId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long screenRoleId) {
        assertObjectNotNull("screenRoleId", screenRoleId);
        BsBScreenRoleCB cb = this;
        cb.query().setScreenRoleId_Equal(screenRoleId);
    }
     ...
     * @return this. (NotNull)
     */
    public BScreenRoleCB acceptUniqueOf(Long roleId, Long screenId) {
        assertObjectNotNull("roleId", roleId);assertObjectNotNull("screenId", screenId);
        BsBScreenRoleCB cb = this;
        cb.query().setRoleId_Equal(roleId);cb.query().setScreenId_Equal(screenId);
        return (BScreenRoleCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ScreenRoleId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ScreenRoleId_Desc();
        return this;
    }
     ...
     */
    public BScreenRoleCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public BScreenRoleCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected BScreenRoleCQ doGetConditionQuery() {
    ...
    protected BScreenRoleCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected BScreenRoleCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        BScreenRoleCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected BScreenRoleCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new BScreenRoleCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<BScreenRoleCB> unionCBLambda) {
        final BScreenRoleCB cb = new BScreenRoleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BScreenRoleCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<BScreenRoleCB> unionCBLambda) {
        final BScreenRoleCB cb = new BScreenRoleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BScreenRoleCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">bScreenRoleBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">bScreenRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bScreenRole</span>.<span style="color: #CC4747">getBRole()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bScreenRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bScreenRole</span>.<span style="color: #CC4747">getBScreen()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">bScreenRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">bScreenRole</span>.<span style="color: #CC4747">getBClassDtlByVisible()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<BScreenRoleCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<BScreenRoleCQ> qyCall
         ...
         */
        public SpecifiedColumn columnScreenRoleId() { return doColumn("SCREEN_ROLE_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "B_SCREEN_ROLE"; }
        /**
         ...
         */
        public HpSDRFunction<BScreenRoleCB, BScreenRoleCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<BScreenRoleCB> sq, BScreenRoleCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public BScreenRoleCB dreamCruiseCB() {
        BScreenRoleCB cb = new BScreenRoleCB();
        cb.xsetupForDreamCruise((BScreenRoleCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<BScreenRoleCB> columnQuery(final SpecifyQuery<BScreenRoleCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected BScreenRoleCB xcreateColumnQueryCB() {
        BScreenRoleCB cb = new BScreenRoleCB();
        cb.xsetupForColumnQuery((BScreenRoleCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<BScreenRoleCB> orCBLambda) {
        xorSQ((BScreenRoleCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<BScreenRoleCB> andCBLambda) {
        xorSQAP((BScreenRoleCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final BScreenRoleCB cb;
        if (mainCB != null) {
            cb = (BScreenRoleCB)mainCB;
        } else {
            cb = new BScreenRoleCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return BScreenRoleCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return BScreenRoleCQ.class.getName(); }
