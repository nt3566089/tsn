...
/**
 * The base condition-bean of T_ALLOC_LOT.
 * @author DBFlute(AutoGenerator)
 */
public class BsTAllocLotCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TAllocLotCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTAllocLotCB() {
     ...
     * @return this. (NotNull)
     */
    public TAllocLotCB acceptPK(Long allocInstBId) {
        assertObjectNotNull("allocInstBId", allocInstBId);
        BsTAllocLotCB cb = this;
        cb.query().setAllocInstBId_Equal(allocInstBId);
        return (TAllocLotCB)this;
    }
     ...
     */
    public TAllocLotCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TAllocLotCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TAllocLotCQ doGetConditionQuery() {
    ...
    protected TAllocLotCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TAllocLotCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TAllocLotCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TAllocLotCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TAllocLotCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TAllocLotCB> unionCBLambda) {
        final TAllocLotCB cb = new TAllocLotCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TAllocLotCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TAllocLotCB> unionCBLambda) {
        final TAllocLotCB cb = new TAllocLotCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TAllocLotCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tAllocLotBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tAllocLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tAllocLot</span>.<span style="color: #CC4747">getTLot()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tAllocLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tAllocLot</span>.<span style="color: #CC4747">getMProduct()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tAllocLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tAllocLot</span>.<span style="color: #CC4747">getTAllocInstB()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tAllocLot</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tAllocLot</span>.<span style="color: #CC4747">getMCustomer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TAllocLotCQ> {
        ...
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TAllocLotCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "T_ALLOC_LOT"; }
        /**
         ...
         */
        public HpSDRFunction<TAllocLotCB, TAllocLotCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TAllocLotCB> sq, TAllocLotCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TAllocLotCB dreamCruiseCB() {
        TAllocLotCB cb = new TAllocLotCB();
        cb.xsetupForDreamCruise((TAllocLotCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TAllocLotCB> columnQuery(final SpecifyQuery<TAllocLotCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TAllocLotCB xcreateColumnQueryCB() {
        TAllocLotCB cb = new TAllocLotCB();
        cb.xsetupForColumnQuery((TAllocLotCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TAllocLotCB> orCBLambda) {
        xorSQ((TAllocLotCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TAllocLotCB> andCBLambda) {
        xorSQAP((TAllocLotCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TAllocLotCB cb;
        if (mainCB != null) {
            cb = (TAllocLotCB)mainCB;
        } else {
            cb = new TAllocLotCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TAllocLotCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TAllocLotCQ.class.getName(); }
