...
/**
 * The base condition-bean of T_INVENTORY_H.
 * @author DBFlute(AutoGenerator)
 */
public class BsTInventoryHCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TInventoryHCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTInventoryHCB() {
     ...
     * @return this. (NotNull)
     */
    public TInventoryHCB acceptPK(Long inventoryHId) {
        assertObjectNotNull("inventoryHId", inventoryHId);
        BsTInventoryHCB cb = this;
        cb.query().setInventoryHId_Equal(inventoryHId);
        return (TInventoryHCB)this;
    }
     ...
     * @param inventoryHId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long inventoryHId) {
        assertObjectNotNull("inventoryHId", inventoryHId);
        BsTInventoryHCB cb = this;
        cb.query().setInventoryHId_Equal(inventoryHId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_InventoryHId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_InventoryHId_Desc();
        return this;
    }
     ...
     */
    public TInventoryHCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TInventoryHCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TInventoryHCQ doGetConditionQuery() {
    ...
    protected TInventoryHCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TInventoryHCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TInventoryHCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TInventoryHCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TInventoryHCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TInventoryHCB> unionCBLambda) {
        final TInventoryHCB cb = new TInventoryHCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TInventoryHCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TInventoryHCB> unionCBLambda) {
        final TInventoryHCB cb = new TInventoryHCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TInventoryHCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">tInventoryHBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">tInventoryH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tInventoryH</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tInventoryH</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tInventoryH</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TInventoryHCQ> {
        protected MCenterCB.HpSpecification _mCenter;
        protected MClientCB.HpSpecification _mClient;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TInventoryHCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnBatchNum() { return doColumn("BATCH_NUM"); }
        /**
         * INVENTORY_DT: {IX, NotNull, varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnInventoryDt() { return doColumn("INVENTORY_DT"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "T_INVENTORY_H"; }
        /**
         ...
         */
        public HpSDRFunction<TInventoryBCB, TInventoryHCQ> derivedTInventoryBList() {
            assertDerived("tInventoryBList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryBCB> sq, TInventoryHCQ cq, String al, DerivedReferrerOption op)
         ...
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TInventoryInstCB, TInventoryHCQ> derivedTInventoryInstList() {
            assertDerived("tInventoryInstList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryInstCB> sq, TInventoryHCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<TInventoryHCB, TInventoryHCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TInventoryHCB> sq, TInventoryHCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TInventoryHCB dreamCruiseCB() {
        TInventoryHCB cb = new TInventoryHCB();
        cb.xsetupForDreamCruise((TInventoryHCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TInventoryHCB> columnQuery(final SpecifyQuery<TInventoryHCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TInventoryHCB xcreateColumnQueryCB() {
        TInventoryHCB cb = new TInventoryHCB();
        cb.xsetupForColumnQuery((TInventoryHCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TInventoryHCB> orCBLambda) {
        xorSQ((TInventoryHCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TInventoryHCB> andCBLambda) {
        xorSQAP((TInventoryHCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TInventoryHCB cb;
        if (mainCB != null) {
            cb = (TInventoryHCB)mainCB;
        } else {
            cb = new TInventoryHCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TInventoryHCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TInventoryHCQ.class.getName(); }
