...
/**
 * The base condition-bean of E_ZIP.
 * @author DBFlute(AutoGenerator)
 */
public class BsEZipCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EZipCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public EZipCB acceptPK(Long zipId) {
     ...
     * @return this. (NotNull)
     */
    public EZipCB acceptUniqueOf(String receiveCd, Long receiveRowId) {
    ...
    public EZipCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EZipCQ doGetConditionQuery() {
    ...
    protected EZipCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EZipCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EZipCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EZipCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EZipCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EZipCB> unionCBLambda) {
        final EZipCB cb = new EZipCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EZipCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EZipCB> unionCBLambda) {
        final EZipCB cb = new EZipCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EZipCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EZipCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EZipCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnZipCd5() { return doColumn("ZIP_CD5"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "E_ZIP"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EZipCB, EZipCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EZipCB> sq, EZipCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EZipCB dreamCruiseCB() {
        EZipCB cb = new EZipCB();
        cb.xsetupForDreamCruise((EZipCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EZipCB> columnQuery(final SpecifyQuery<EZipCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EZipCB xcreateColumnQueryCB() {
        EZipCB cb = new EZipCB();
        cb.xsetupForColumnQuery((EZipCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EZipCB> orCBLambda) {
        xorSQ((EZipCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EZipCB> andCBLambda) {
        xorSQAP((EZipCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EZipCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EZipCQ.class.getName(); }
