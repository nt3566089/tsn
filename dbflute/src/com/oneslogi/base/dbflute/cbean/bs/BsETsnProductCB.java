...
/**
 * The base condition-bean of E_TSN_PRODUCT.
 * @author DBFlute(AutoGenerator)
 */
public class BsETsnProductCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ETsnProductCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsETsnProductCB() {
     ...
     * @return this. (NotNull)
     */
    public ETsnProductCB acceptPK(Long tsnProductId) {
        assertObjectNotNull("tsnProductId", tsnProductId);
        BsETsnProductCB cb = this;
        cb.query().setTsnProductId_Equal(tsnProductId);
        return (ETsnProductCB)this;
    }
     ...
     */
    public ETsnProductCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public ETsnProductCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ETsnProductCQ doGetConditionQuery() {
    ...
    protected ETsnProductCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ETsnProductCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ETsnProductCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ETsnProductCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ETsnProductCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ETsnProductCB> unionCBLambda) {
        final ETsnProductCB cb = new ETsnProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETsnProductCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ETsnProductCB> unionCBLambda) {
        final ETsnProductCB cb = new ETsnProductCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ETsnProductCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ETsnProductCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ETsnProductCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "E_TSN_PRODUCT"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<ETsnProductCB, ETsnProductCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ETsnProductCB> sq, ETsnProductCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ETsnProductCB dreamCruiseCB() {
        ETsnProductCB cb = new ETsnProductCB();
        cb.xsetupForDreamCruise((ETsnProductCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ETsnProductCB> columnQuery(final SpecifyQuery<ETsnProductCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ETsnProductCB xcreateColumnQueryCB() {
        ETsnProductCB cb = new ETsnProductCB();
        cb.xsetupForColumnQuery((ETsnProductCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ETsnProductCB> orCBLambda) {
        xorSQ((ETsnProductCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ETsnProductCB> andCBLambda) {
        xorSQAP((ETsnProductCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ETsnProductCB cb;
        if (mainCB != null) {
            cb = (ETsnProductCB)mainCB;
        } else {
            cb = new ETsnProductCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ETsnProductCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ETsnProductCQ.class.getName(); }
