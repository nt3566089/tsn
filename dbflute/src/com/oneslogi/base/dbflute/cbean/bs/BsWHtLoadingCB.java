...
/**
 * The base condition-bean of W_HT_LOADING.
 * @author DBFlute(AutoGenerator)
 */
public class BsWHtLoadingCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected WHtLoadingCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtLoadingCB() {
     ...
     * @return this. (NotNull)
     */
    public WHtLoadingCB acceptPK(Long htLoadingId) {
        assertObjectNotNull("htLoadingId", htLoadingId);
        BsWHtLoadingCB cb = this;
        cb.query().setHtLoadingId_Equal(htLoadingId);
        return (WHtLoadingCB)this;
    }
     ...
     * @param htLoadingId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long htLoadingId) {
        assertObjectNotNull("htLoadingId", htLoadingId);
        BsWHtLoadingCB cb = this;
        cb.query().setHtLoadingId_Equal(htLoadingId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_HtLoadingId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_HtLoadingId_Desc();
        return this;
    }
     ...
     */
    public WHtLoadingCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public WHtLoadingCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected WHtLoadingCQ doGetConditionQuery() {
    ...
    protected WHtLoadingCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected WHtLoadingCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        WHtLoadingCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected WHtLoadingCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new WHtLoadingCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<WHtLoadingCB> unionCBLambda) {
        final WHtLoadingCB cb = new WHtLoadingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtLoadingCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<WHtLoadingCB> unionCBLambda) {
        final WHtLoadingCB cb = new WHtLoadingCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final WHtLoadingCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">wHtLoading</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">wHtLoading</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<WHtLoadingCQ> {
         ...
         */
        public SpecifiedColumn columnHtLoadingId() { return doColumn("HT_LOADING_ID"); }
        /**
         ...
         */
        public HpSDRFunction<WHtLoadingCB, WHtLoadingCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WHtLoadingCB> sq, WHtLoadingCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public WHtLoadingCB dreamCruiseCB() {
        WHtLoadingCB cb = new WHtLoadingCB();
        cb.xsetupForDreamCruise((WHtLoadingCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<WHtLoadingCB> columnQuery(final SpecifyQuery<WHtLoadingCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected WHtLoadingCB xcreateColumnQueryCB() {
        WHtLoadingCB cb = new WHtLoadingCB();
        cb.xsetupForColumnQuery((WHtLoadingCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<WHtLoadingCB> orCBLambda) {
        xorSQ((WHtLoadingCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<WHtLoadingCB> andCBLambda) {
        xorSQAP((WHtLoadingCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WHtLoadingCB cb;
        if (mainCB != null) {
            cb = (WHtLoadingCB)mainCB;
        } else {
            cb = new WHtLoadingCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return WHtLoadingCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return WHtLoadingCQ.class.getName(); }
