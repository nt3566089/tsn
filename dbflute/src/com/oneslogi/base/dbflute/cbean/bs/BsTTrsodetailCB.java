...
/**
 * The base condition-bean of T_TRSODETAIL.
 * @author DBFlute(AutoGenerator)
 */
public class BsTTrsodetailCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TTrsodetailCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrsodetailCB() {
     ...
     * @return this. (NotNull)
     */
    public TTrsodetailCB acceptPK(Long sodetailid) {
        assertObjectNotNull("sodetailid", sodetailid);
        BsTTrsodetailCB cb = this;
        cb.query().setSodetailid_Equal(sodetailid);
        return (TTrsodetailCB)this;
    }
     ...
     * @param sodetailid : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long sodetailid) {
        assertObjectNotNull("sodetailid", sodetailid);
        BsTTrsodetailCB cb = this;
        cb.query().setSodetailid_Equal(sodetailid);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_Sodetailid_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_Sodetailid_Desc();
        return this;
    }
     ...
     */
    public TTrsodetailCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TTrsodetailCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TTrsodetailCQ doGetConditionQuery() {
    ...
    protected TTrsodetailCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TTrsodetailCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TTrsodetailCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TTrsodetailCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TTrsodetailCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TTrsodetailCB> unionCBLambda) {
        final TTrsodetailCB cb = new TTrsodetailCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TTrsodetailCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TTrsodetailCB> unionCBLambda) {
        final TTrsodetailCB cb = new TTrsodetailCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TTrsodetailCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<TTrsodetailCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<TTrsodetailCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnXdockqty1() { return doColumn("XDOCKQTY1"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPrice1() { return doColumn("PRICE1"); }
        /**
         * PRICE2: {NotNull, decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPrice2() { return doColumn("PRICE2"); }
        /**
         * PRICE3: {NotNull, decimal(16, 6), default=[(0)]}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPrice3() { return doColumn("PRICE3"); }
        /**
         * NOTES: {varchar(30)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnPickqtyerrorflg() { return doColumn("PICKQTYERRORFLG"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "T_TRSODETAIL"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<TTrsodetailCB, TTrsodetailCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TTrsodetailCB> sq, TTrsodetailCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TTrsodetailCB dreamCruiseCB() {
        TTrsodetailCB cb = new TTrsodetailCB();
        cb.xsetupForDreamCruise((TTrsodetailCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TTrsodetailCB> columnQuery(final SpecifyQuery<TTrsodetailCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TTrsodetailCB xcreateColumnQueryCB() {
        TTrsodetailCB cb = new TTrsodetailCB();
        cb.xsetupForColumnQuery((TTrsodetailCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TTrsodetailCB> orCBLambda) {
        xorSQ((TTrsodetailCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TTrsodetailCB> andCBLambda) {
        xorSQAP((TTrsodetailCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TTrsodetailCB cb;
        if (mainCB != null) {
            cb = (TTrsodetailCB)mainCB;
        } else {
            cb = new TTrsodetailCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TTrsodetailCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TTrsodetailCQ.class.getName(); }
