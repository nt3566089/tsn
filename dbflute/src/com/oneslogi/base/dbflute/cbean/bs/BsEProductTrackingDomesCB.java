...
/**
 * The base condition-bean of E_PRODUCT_TRACKING_DOMES.
 * @author DBFlute(AutoGenerator)
 */
public class BsEProductTrackingDomesCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EProductTrackingDomesCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEProductTrackingDomesCB() {
     ...
     * @return this. (NotNull)
     */
    public EProductTrackingDomesCB acceptPK(Long productTrackingDomesId) {
        assertObjectNotNull("productTrackingDomesId", productTrackingDomesId);
        BsEProductTrackingDomesCB cb = this;
        cb.query().setProductTrackingDomesId_Equal(productTrackingDomesId);
        return (EProductTrackingDomesCB)this;
    }
     ...
     * @param productTrackingDomesId : PK, ID, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long productTrackingDomesId) {
        assertObjectNotNull("productTrackingDomesId", productTrackingDomesId);
        BsEProductTrackingDomesCB cb = this;
        cb.query().setProductTrackingDomesId_Equal(productTrackingDomesId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ProductTrackingDomesId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ProductTrackingDomesId_Desc();
        return this;
    }
     ...
     */
    public EProductTrackingDomesCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public EProductTrackingDomesCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected EProductTrackingDomesCQ doGetConditionQuery() {
    ...
    protected EProductTrackingDomesCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EProductTrackingDomesCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EProductTrackingDomesCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EProductTrackingDomesCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EProductTrackingDomesCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<EProductTrackingDomesCB> unionCBLambda) {
        final EProductTrackingDomesCB cb = new EProductTrackingDomesCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EProductTrackingDomesCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<EProductTrackingDomesCB> unionCBLambda) {
        final EProductTrackingDomesCB cb = new EProductTrackingDomesCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final EProductTrackingDomesCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EProductTrackingDomesCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EProductTrackingDomesCQ> qyCall
         ...
         */
        public SpecifiedColumn columnProductTrackingDomesId() { return doColumn("PRODUCT_TRACKING_DOMES_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMachinemo() { return doColumn("MACHINEMO"); }
        /**
        ...
        protected void doSpecifyRequiredColumn() {
            columnProductTrackingDomesId(); // PK
        }
        @Override
        protected String getTableDbName() { return "E_PRODUCT_TRACKING_DOMES"; }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<EProductTrackingDomesCB, EProductTrackingDomesCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<EProductTrackingDomesCB> sq, EProductTrackingDomesCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public EProductTrackingDomesCB dreamCruiseCB() {
        EProductTrackingDomesCB cb = new EProductTrackingDomesCB();
        cb.xsetupForDreamCruise((EProductTrackingDomesCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<EProductTrackingDomesCB> columnQuery(final SpecifyQuery<EProductTrackingDomesCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected EProductTrackingDomesCB xcreateColumnQueryCB() {
        EProductTrackingDomesCB cb = new EProductTrackingDomesCB();
        cb.xsetupForColumnQuery((EProductTrackingDomesCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<EProductTrackingDomesCB> orCBLambda) {
        xorSQ((EProductTrackingDomesCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EProductTrackingDomesCB> andCBLambda) {
        xorSQAP((EProductTrackingDomesCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EProductTrackingDomesCB cb;
        if (mainCB != null) {
            cb = (EProductTrackingDomesCB)mainCB;
        } else {
            cb = new EProductTrackingDomesCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return EProductTrackingDomesCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return EProductTrackingDomesCQ.class.getName(); }
