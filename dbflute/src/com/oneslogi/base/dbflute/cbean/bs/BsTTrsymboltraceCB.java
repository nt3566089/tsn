...
/**
 * The base condition-bean of T_TRSYMBOLTRACE.
 * @author DBFlute(AutoGenerator)
 */
public class BsTTrsymboltraceCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected TTrsymboltraceCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrsymboltraceCB() {
     ...
     * @return this. (NotNull)
     */
    public TTrsymboltraceCB acceptPK(Long trsymboltraceId) {
        assertObjectNotNull("trsymboltraceId", trsymboltraceId);
        BsTTrsymboltraceCB cb = this;
        cb.query().setTrsymboltraceId_Equal(trsymboltraceId);
        return (TTrsymboltraceCB)this;
    }
     ...
     * @param trsymboltraceId : PK, ID, IX, NotNull, bigint identity(19). (NotNull)
     */
    public void acceptPrimaryKey(Long trsymboltraceId) {
        assertObjectNotNull("trsymboltraceId", trsymboltraceId);
        BsTTrsymboltraceCB cb = this;
        cb.query().setTrsymboltraceId_Equal(trsymboltraceId);
    }
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_TrsymboltraceId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_TrsymboltraceId_Desc();
        return this;
    }
     ...
     */
    public TTrsymboltraceCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public TTrsymboltraceCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected TTrsymboltraceCQ doGetConditionQuery() {
    ...
    protected TTrsymboltraceCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected TTrsymboltraceCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        TTrsymboltraceCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected TTrsymboltraceCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new TTrsymboltraceCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<TTrsymboltraceCB> unionCBLambda) {
        final TTrsymboltraceCB cb = new TTrsymboltraceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TTrsymboltraceCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<TTrsymboltraceCB> unionCBLambda) {
        final TTrsymboltraceCB cb = new TTrsymboltraceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final TTrsymboltraceCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">tTrsymboltrace</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">tTrsymboltrace</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<TTrsymboltraceCQ> {
         ...
         */
        public SpecifiedColumn columnTrsymboltraceId() { return doColumn("TRSYMBOLTRACE_ID"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMosjtsendflg() { return doColumn("MOSJTSENDFLG"); }
        /**
         * SHIPDATE: {varchar(8)}
         * @return The information object of specified column. (NotNull)
         */
         ...
         */
        public HpSDRFunction<TTrsymboltraceCB, TTrsymboltraceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TTrsymboltraceCB> sq, TTrsymboltraceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public TTrsymboltraceCB dreamCruiseCB() {
        TTrsymboltraceCB cb = new TTrsymboltraceCB();
        cb.xsetupForDreamCruise((TTrsymboltraceCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<TTrsymboltraceCB> columnQuery(final SpecifyQuery<TTrsymboltraceCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected TTrsymboltraceCB xcreateColumnQueryCB() {
        TTrsymboltraceCB cb = new TTrsymboltraceCB();
        cb.xsetupForColumnQuery((TTrsymboltraceCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<TTrsymboltraceCB> orCBLambda) {
        xorSQ((TTrsymboltraceCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<TTrsymboltraceCB> andCBLambda) {
        xorSQAP((TTrsymboltraceCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final TTrsymboltraceCB cb;
        if (mainCB != null) {
            cb = (TTrsymboltraceCB)mainCB;
        } else {
            cb = new TTrsymboltraceCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return TTrsymboltraceCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return TTrsymboltraceCQ.class.getName(); }
