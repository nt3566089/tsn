...
/**
 * The base condition-bean of M_USER_LOGIN.
 * @author DBFlute(AutoGenerator)
 */
public class BsMUserLoginCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected MUserLoginCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsMUserLoginCB() {
     ...
     * @return this. (NotNull)
     */
    public MUserLoginCB acceptPK(Long userId) {
        assertObjectNotNull("userId", userId);
        BsMUserLoginCB cb = this;
        cb.query().setUserId_Equal(userId);
        return (MUserLoginCB)this;
    }
     ...
     */
    public MUserLoginCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public MUserLoginCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MUserLoginCQ doGetConditionQuery() {
    ...
    protected MUserLoginCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected MUserLoginCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        MUserLoginCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected MUserLoginCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new MUserLoginCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<MUserLoginCB> unionCBLambda) {
        final MUserLoginCB cb = new MUserLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MUserLoginCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<MUserLoginCB> unionCBLambda) {
        final MUserLoginCB cb = new MUserLoginCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final MUserLoginCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     *     ... = <span style="color: #553000">mUserLogin</span>.<span style="color: #CC4747">getMCenter()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">mUserLogin</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">mUserLogin</span>.<span style="color: #CC4747">getMClient()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<MUserLoginCQ> {
        ...
        /**
         * USER_ID: {PK, ID, NotNull, bigint identity(19), FK to B_USER}
        ...
        @Override
        protected String getTableDbName() { return "M_USER_LOGIN"; }
        /**
         ...
         */
        public HpSDRFunction<MUserLoginCB, MUserLoginCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MUserLoginCB> sq, MUserLoginCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public MUserLoginCB dreamCruiseCB() {
        MUserLoginCB cb = new MUserLoginCB();
        cb.xsetupForDreamCruise((MUserLoginCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<MUserLoginCB> columnQuery(final SpecifyQuery<MUserLoginCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected MUserLoginCB xcreateColumnQueryCB() {
        MUserLoginCB cb = new MUserLoginCB();
        cb.xsetupForColumnQuery((MUserLoginCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<MUserLoginCB> orCBLambda) {
        xorSQ((MUserLoginCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<MUserLoginCB> andCBLambda) {
        xorSQAP((MUserLoginCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final MUserLoginCB cb;
        if (mainCB != null) {
            cb = (MUserLoginCB)mainCB;
        } else {
            cb = new MUserLoginCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MUserLoginCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MUserLoginCQ.class.getName(); }
