...
/**
 * The referrer loader of M_USER_TERM as TABLE. <br>
 * <pre>
 * [primary key]
 *     COMMON_AUTH_ID
 *
 ...
 */
public class LoaderOfMUserTerm {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<MUserTerm> _selectedList;
    protected BehaviorSelector _selector;
    protected MUserTermBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfMUserTerm ready(List<MUserTerm> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected MUserTermBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(MUserTermBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<MUserTerm> getSelectedList() { return _selectedList; }
