...
/**
 * The referrer loader of E_TSN_PRODUCT as TABLE. <br>
 * <pre>
 * [primary key]
 *     TSN_PRODUCT_ID
 *
 ...
 */
public class LoaderOfETsnProduct {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ETsnProduct> _selectedList;
    protected BehaviorSelector _selector;
    protected ETsnProductBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfETsnProduct ready(List<ETsnProduct> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ETsnProductBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ETsnProductBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ETsnProduct> getSelectedList() { return _selectedList; }
