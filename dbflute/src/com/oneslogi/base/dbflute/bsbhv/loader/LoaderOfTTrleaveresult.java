...
/**
 * The referrer loader of T_TRLEAVERESULT as TABLE. <br>
 * <pre>
 * [primary key]
 *     TRLEAVERESULT_ID
 *
 ...
 */
public class LoaderOfTTrleaveresult {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<TTrleaveresult> _selectedList;
    protected BehaviorSelector _selector;
    protected TTrleaveresultBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfTTrleaveresult ready(List<TTrleaveresult> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected TTrleaveresultBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(TTrleaveresultBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<TTrleaveresult> getSelectedList() { return _selectedList; }
