...
/**
 * The referrer loader of T_CORDDTASR as TABLE. <br>
 * <pre>
 * [primary key]
 *     ORDER_SORT_ID
 *
 ...
 */
public class LoaderOfTCorddtasr {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<TCorddtasr> _selectedList;
    protected BehaviorSelector _selector;
    protected TCorddtasrBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfTCorddtasr ready(List<TCorddtasr> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected TCorddtasrBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(TCorddtasrBhv.class); return _myBhv; } }
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<TCorddtasr> getSelectedList() { return _selectedList; }
