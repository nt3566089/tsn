...
/**
 * The base class for typed parameter-bean of SqlOrderPickingDataList. <br>
 * This is related to "<span style="color: #AD4747">selectSqlOrderPickingDataList</span>" on MProductBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlOrderPickingDataListPmb extends SimplePagingBean implements EntityHandlingPmb<MProductBhv, SqlOrderPickingDataList>, AutoPagingHandlingPmb<MProductBhv, SqlOrderPickingDataList>, FetchBean {
    ...
    /** The parameter of shippingPackingNo. */
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlOrderPickingDataList. <br>
     * This is related to "<span style="color: #AD4747">selectSqlOrderPickingDataList</span>" on MProductBhv.
     */
    public BsSqlOrderPickingDataListPmb() {
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlOrderPickingDataList"; }
    ...
    protected String xbuildColumnString() {
        ...
        sb.append(dm).append(_shippingPackingNo);
    ...
    /**
     * [get] shippingPackingNo <br>
     * @return The value of shippingPackingNo. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public String getShippingPackingNo() {
        return filterStringParameter(_shippingPackingNo);
    }

    /**
     * [set] shippingPackingNo <br>
     * @param shippingPackingNo The value of shippingPackingNo. (NullAllowed)
     */
