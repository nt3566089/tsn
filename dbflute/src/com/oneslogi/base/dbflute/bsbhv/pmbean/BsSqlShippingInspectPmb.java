...
/**
 * The base class for typed parameter-bean of SqlShippingInspect. <br>
 * This is related to "<span style="color: #AD4747">selectSqlShippingInspect</span>" on MProductBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlShippingInspectPmb extends SimplePagingBean implements EntityHandlingPmb<MProductBhv, SqlShippingInspect>, AutoPagingHandlingPmb<MProductBhv, SqlShippingInspect>, FetchBean {
    ...
    /** The parameter of pickingWorkNo. */
    protected String _pickingWorkNo;

    /** The parameter of packingNo. */
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlShippingInspect. <br>
     * This is related to "<span style="color: #AD4747">selectSqlShippingInspect</span>" on MProductBhv.
     */
    public BsSqlShippingInspectPmb() {
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlShippingInspect"; }
    ...
    protected String xbuildColumnString() {
        ...
        sb.append(dm).append(_packingNo);
    ...
    /**
     * [get] packingNo <br>
     * @return The value of packingNo. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public String getPackingNo() {
        return filterStringParameter(_packingNo);
    }

    /**
     * [set] packingNo <br>
     * @param packingNo The value of packingNo. (NullAllowed)
     */
