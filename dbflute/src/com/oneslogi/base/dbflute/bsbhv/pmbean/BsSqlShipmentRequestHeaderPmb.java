...
/**
 * The base class for typed parameter-bean of SqlShipmentRequestHeader. <br>
 * This is related to "<span style="color: #AD4747">selectSqlShipmentRequestHeader</span>" on TShippingInstHBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlShipmentRequestHeaderPmb extends SimplePagingBean implements EntityHandlingPmb<TShippingInstHBhv, SqlShipmentRequestHeader>, AutoPagingHandlingPmb<TShippingInstHBhv, SqlShipmentRequestHeader>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlShipmentRequestHeader. <br>
     * This is related to "<span style="color: #AD4747">selectSqlShipmentRequestHeader</span>" on TShippingInstHBhv.
     */
    public BsSqlShipmentRequestHeaderPmb() {
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlShipmentRequestHeader"; }
