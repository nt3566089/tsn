...
/**
 * The base class for typed parameter-bean of SqlTTrsymbolInventoryInputProductSortingPlace. <br>
 * This is related to "<span style="color: #AD4747">selectSqlTTrsymbolInventoryInputProductSortingPlace</span>" on TTrsymbolBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlTTrsymbolInventoryInputProductSortingPlacePmb extends SimplePagingBean implements EntityHandlingPmb<TTrsymbolBhv, SqlTTrsymbolInventoryInputProductSortingPlace>, AutoPagingHandlingPmb<TTrsymbolBhv, SqlTTrsymbolInventoryInputProductSortingPlace>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlTTrsymbolInventoryInputProductSortingPlace. <br>
     * This is related to "<span style="color: #AD4747">selectSqlTTrsymbolInventoryInputProductSortingPlace</span>" on TTrsymbolBhv.
     */
    public BsSqlTTrsymbolInventoryInputProductSortingPlacePmb() {
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlTTrsymbolInventoryInputProductSortingPlace"; }
    ...
    /**
     * [get] caseCd <br>
     * @return The value of caseCd. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    ...
    /**
     * [set] caseCd <br>
     * @param caseCd The value of caseCd. (NullAllowed)
     */
