...
/**
 * The base class for typed parameter-bean of SqlMLocationMasterList. <br>
 * This is related to "<span style="color: #AD4747">selectSqlMLocationMasterList</span>" on MLocationBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlMLocationMasterListPmb extends SimplePagingBean implements EntityHandlingPmb<MLocationBhv, SqlMLocationMasterList>, AutoPagingHandlingPmb<MLocationBhv, SqlMLocationMasterList>, FetchBean {
    ...
    /** The parameter of allcNgFlg. */
    protected String _allcNgFlg;
    ...
    /** The parameter of zone:likePrefix. */
    protected String _zone;

    /** The option of like-search for zone. */
    protected LikeSearchOption _zoneInternalLikeSearchOption;
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlMLocationMasterList. <br>
     * This is related to "<span style="color: #AD4747">selectSqlMLocationMasterList</span>" on MLocationBhv.
     */
    public BsSqlMLocationMasterListPmb() {
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlMLocationMasterList"; }
    ...
    protected String xbuildColumnString() {
        ...
        sb.append(dm).append(_allcNgFlg);
        sb.append(dm).append(_locationCd);
        sb.append(dm).append(_zone);
    ...
    /**
     * [get] allcNgFlg <br>
     * @return The value of allcNgFlg. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public String getAllcNgFlg() {
        return filterStringParameter(_allcNgFlg);
    }

    /**
     * [set] allcNgFlg <br>
     * @param allcNgFlg The value of allcNgFlg. (NullAllowed)
     */
    public void setAllcNgFlg(String allcNgFlg) {
        _allcNgFlg = allcNgFlg;
    }
    ...
    /**
     * [get] zone:likePrefix <br>
     * @return The value of zone. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public String getZone() {
        return filterStringParameter(_zone);
    }

    /**
     * [set as prefixSearch] zone:likePrefix <br>
     * @param zone The value of zone. (NullAllowed)
     */
    public void setZone_PrefixSearch(String zone) {
        _zone = zone;
        _zoneInternalLikeSearchOption = new LikeSearchOption().likePrefix();
    }

    /**
     * Get the internal option of likeSearch for zone. {Internal Method: Don't invoke this}
     * @return The internal option of likeSearch for zone. (NullAllowed)
     */
    public LikeSearchOption getZoneInternalLikeSearchOption() {
        return _zoneInternalLikeSearchOption;
    }
