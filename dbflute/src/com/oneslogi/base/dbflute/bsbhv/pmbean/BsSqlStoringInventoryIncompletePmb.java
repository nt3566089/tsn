...
/**
 * The base class for typed parameter-bean of SqlStoringInventoryIncomplete. <br>
 * This is related to "<span style="color: #AD4747">selectSqlStoringInventoryIncomplete</span>" on MLocationBhv.
 * @author DBFlute(AutoGenerator)
 */
public class BsSqlStoringInventoryIncompletePmb extends SimplePagingBean implements EntityHandlingPmb<MLocationBhv, SqlStoringInventoryIncomplete>, AutoPagingHandlingPmb<MLocationBhv, SqlStoringInventoryIncomplete>, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlStoringInventoryIncomplete. <br>
     * This is related to "<span style="color: #AD4747">selectSqlStoringInventoryIncomplete</span>" on MLocationBhv.
     */
    public BsSqlStoringInventoryIncompletePmb() {
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlStoringInventoryIncomplete"; }

    /**
     * Get the type of an entity for result. (implementation)
     * @return The type instance of an entity, customize entity. (NotNull)
     */
    public Class<SqlStoringInventoryIncomplete> getEntityType() { return SqlStoringInventoryIncomplete.class; }
