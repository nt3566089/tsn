...
/**
 * The base class for typed parameter-bean of SqlgetStockList. <br>
...
public class BsSqlgetStockListPmb extends SimplePagingBean implements EntityHandlingPmb<TStockBhv, SqlgetStockList>, AutoPagingHandlingPmb<TStockBhv, SqlgetStockList>, FetchBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of lineBlock:likePrefix. */
    protected String _lineBlock;

    /** The option of like-search for lineBlock. */
    protected LikeSearchOption _lineBlockInternalLikeSearchOption;
    ...
    //                                                                         ===========
    /**
     * Constructor for the typed parameter-bean of SqlgetStockList. <br>
     * This is related to "<span style="color: #AD4747">selectSqlgetStockList</span>" on TStockBhv.
     */
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "selectSqlgetStockList"; }
    ...
    /**
     * [set as prefixSearch] lineBlock:likePrefix <br>
    ...
    public void setLineBlock_PrefixSearch(String lineBlock) {
        ...
        _lineBlockInternalLikeSearchOption = new LikeSearchOption().likePrefix();
    }

    /**
     * Get the internal option of likeSearch for lineBlock. {Internal Method: Don't invoke this}
     * @return The internal option of likeSearch for lineBlock. (NullAllowed)
     */
    public LikeSearchOption getLineBlockInternalLikeSearchOption() {
        return _lineBlockInternalLikeSearchOption;
    }
