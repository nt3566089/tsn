...
/**
 * The DTO mapper of SqlDualProductList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlDualProductListDtoMapper implements DtoMapper<SqlDualProductList, SqlDualProductListDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlDualProductListDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlDualProductListDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlDualProductListDto mappingToDto(SqlDualProductList entity) {
        if (entity == null) {
            return null;
        }
        SqlDualProductListDto dto = new SqlDualProductListDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlDualProductListDto> mappingToDtoList(List<SqlDualProductList> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlDualProductListDto> dtoList = new ArrayList<SqlDualProductListDto>();
        for (SqlDualProductList entity : entityList) {
            SqlDualProductListDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlDualProductList mappingToEntity(SqlDualProductListDto dto) {
        if (dto == null) {
            return null;
        }
        SqlDualProductList entity = new SqlDualProductList();
     ...
     */
    protected boolean needsMapping(SqlDualProductListDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlDualProductList> mappingToEntityList(List<SqlDualProductListDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlDualProductList> entityList = new ArrayList<SqlDualProductList>();
        for (SqlDualProductListDto dto : dtoList) {
            SqlDualProductList entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlDualProductListDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlDualProductListDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlDualProductListDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlDualProductListDtoMapper reverseReference() {
