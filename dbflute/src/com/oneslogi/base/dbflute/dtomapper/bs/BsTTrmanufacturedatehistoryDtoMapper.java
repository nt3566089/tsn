...
/**
 * The DTO mapper of T_TRMANUFACTUREDATEHISTORY as TABLE. <br>
 * 製造年月日履歴
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsTTrmanufacturedatehistoryDtoMapper implements DtoMapper<TTrmanufacturedatehistory, TTrmanufacturedatehistoryDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrmanufacturedatehistoryDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrmanufacturedatehistoryDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrmanufacturedatehistoryDto mappingToDto(TTrmanufacturedatehistory entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TTrmanufacturedatehistoryDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrmanufacturedatehistoryDto dto = new TTrmanufacturedatehistoryDto();
        dto.setTrmanufacturedatehistoryId(entity.getTrmanufacturedatehistoryId());
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTTrmanufacturedatehistoryList().add(dto);
                }
            } else {
                ...
                mapper.suppressTTrmanufacturedatehistoryList();
     ...
     * {@inheritDoc}
     */
    public List<TTrmanufacturedatehistoryDto> mappingToDtoList(List<TTrmanufacturedatehistory> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrmanufacturedatehistoryDto> dtoList = new ArrayList<TTrmanufacturedatehistoryDto>();
        for (TTrmanufacturedatehistory entity : entityList) {
            TTrmanufacturedatehistoryDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrmanufacturedatehistory mappingToEntity(TTrmanufacturedatehistoryDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TTrmanufacturedatehistory)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrmanufacturedatehistory entity = new TTrmanufacturedatehistory();
        if (needsMapping(dto, dto.getTrmanufacturedatehistoryId(), "trmanufacturedatehistoryId")) {
            entity.setTrmanufacturedatehistoryId(dto.getTrmanufacturedatehistoryId());
        }
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTTrmanufacturedatehistoryList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TTrmanufacturedatehistoryDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrmanufacturedatehistory> mappingToEntityList(List<TTrmanufacturedatehistoryDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrmanufacturedatehistory> entityList = new ArrayList<TTrmanufacturedatehistory>();
        for (TTrmanufacturedatehistoryDto dto : dtoList) {
            TTrmanufacturedatehistory entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrmanufacturedatehistoryDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrmanufacturedatehistoryDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrmanufacturedatehistoryDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrmanufacturedatehistoryDtoMapper reverseReference() {
