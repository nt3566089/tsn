...
/**
 * The DTO mapper of SqlShippingTagDataOutput. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlShippingTagDataOutputDtoMapper implements DtoMapper<SqlShippingTagDataOutput, SqlShippingTagDataOutputDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlShippingTagDataOutputDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlShippingTagDataOutputDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlShippingTagDataOutputDto mappingToDto(SqlShippingTagDataOutput entity) {
        if (entity == null) {
            return null;
        }
        SqlShippingTagDataOutputDto dto = new SqlShippingTagDataOutputDto();
        ...
        dto.setSumPickinghCount(entity.getSumPickinghCount());
     ...
     * {@inheritDoc}
     */
    public List<SqlShippingTagDataOutputDto> mappingToDtoList(List<SqlShippingTagDataOutput> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlShippingTagDataOutputDto> dtoList = new ArrayList<SqlShippingTagDataOutputDto>();
        for (SqlShippingTagDataOutput entity : entityList) {
            SqlShippingTagDataOutputDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlShippingTagDataOutput mappingToEntity(SqlShippingTagDataOutputDto dto) {
        if (dto == null) {
            return null;
        }
        SqlShippingTagDataOutput entity = new SqlShippingTagDataOutput();
        ...
        if (needsMapping(dto, dto.getSumPickinghCount(), "sumPickinghCount")) {
            entity.setSumPickinghCount(dto.getSumPickinghCount());
        }
     ...
     */
    protected boolean needsMapping(SqlShippingTagDataOutputDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlShippingTagDataOutput> mappingToEntityList(List<SqlShippingTagDataOutputDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlShippingTagDataOutput> entityList = new ArrayList<SqlShippingTagDataOutput>();
        for (SqlShippingTagDataOutputDto dto : dtoList) {
            SqlShippingTagDataOutput entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlShippingTagDataOutputDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlShippingTagDataOutputDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlShippingTagDataOutputDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlShippingTagDataOutputDtoMapper reverseReference() {
