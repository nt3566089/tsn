...
/**
 * The DTO mapper of SqlSortingPlaceMasterEditSrw. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlSortingPlaceMasterEditSrwDtoMapper implements DtoMapper<SqlSortingPlaceMasterEditSrw, SqlSortingPlaceMasterEditSrwDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlSortingPlaceMasterEditSrwDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlSortingPlaceMasterEditSrwDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlSortingPlaceMasterEditSrwDto mappingToDto(SqlSortingPlaceMasterEditSrw entity) {
        if (entity == null) {
            return null;
        }
        SqlSortingPlaceMasterEditSrwDto dto = new SqlSortingPlaceMasterEditSrwDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlSortingPlaceMasterEditSrwDto> mappingToDtoList(List<SqlSortingPlaceMasterEditSrw> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlSortingPlaceMasterEditSrwDto> dtoList = new ArrayList<SqlSortingPlaceMasterEditSrwDto>();
        for (SqlSortingPlaceMasterEditSrw entity : entityList) {
            SqlSortingPlaceMasterEditSrwDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlSortingPlaceMasterEditSrw mappingToEntity(SqlSortingPlaceMasterEditSrwDto dto) {
        if (dto == null) {
            return null;
        }
        SqlSortingPlaceMasterEditSrw entity = new SqlSortingPlaceMasterEditSrw();
     ...
     */
    protected boolean needsMapping(SqlSortingPlaceMasterEditSrwDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlSortingPlaceMasterEditSrw> mappingToEntityList(List<SqlSortingPlaceMasterEditSrwDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlSortingPlaceMasterEditSrw> entityList = new ArrayList<SqlSortingPlaceMasterEditSrw>();
        for (SqlSortingPlaceMasterEditSrwDto dto : dtoList) {
            SqlSortingPlaceMasterEditSrw entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlSortingPlaceMasterEditSrwDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlSortingPlaceMasterEditSrwDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlSortingPlaceMasterEditSrwDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlSortingPlaceMasterEditSrwDtoMapper reverseReference() {
