...
/**
 * The DTO mapper of T_CORDDTASR as TABLE. <br>
 * さしずデータ(仕分中）
 * <pre>
 * [primary-key]
 *     ORDER_SORT_ID
 ...
 */
public abstract class BsTCorddtasrDtoMapper implements DtoMapper<TCorddtasr, TCorddtasrDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTCorddtasrDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTCorddtasrDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TCorddtasrDto mappingToDto(TCorddtasr entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TCorddtasrDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TCorddtasrDto dto = new TCorddtasrDto();
        dto.setOrderSortId(entity.getOrderSortId());
        ...
        if (!_suppressTCordhdr && entity.getTCordhdr() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTCorddtasrList().add(dto);
                }
            } else {
     ...
     * {@inheritDoc}
     */
    public List<TCorddtasrDto> mappingToDtoList(List<TCorddtasr> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TCorddtasrDto> dtoList = new ArrayList<TCorddtasrDto>();
        for (TCorddtasr entity : entityList) {
            TCorddtasrDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TCorddtasr mappingToEntity(TCorddtasrDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TCorddtasr)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TCorddtasr entity = new TCorddtasr();
        if (needsMapping(dto, dto.getOrderSortId(), "orderSortId")) {
            entity.setOrderSortId(dto.getOrderSortId());
        }
        ...
        if (!_suppressTCordhdr && dto.getTCordhdr() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTCorddtasrList().add(entity);
                }
            } else {
                TCordhdrDtoMapper mapper = new TCordhdrDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TCorddtasrDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TCorddtasr> mappingToEntityList(List<TCorddtasrDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TCorddtasr> entityList = new ArrayList<TCorddtasr>();
        for (TCorddtasrDto dto : dtoList) {
            TCorddtasr entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TCorddtasrDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TCorddtasrDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TCorddtasrDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TCorddtasrDtoMapper reverseReference() {
