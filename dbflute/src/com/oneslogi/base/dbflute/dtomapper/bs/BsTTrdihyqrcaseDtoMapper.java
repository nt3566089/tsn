...
/**
 * The DTO mapper of T_TRDIHYQRCASE as TABLE. <br>
 * 代表ＱＲコードケース情報
 * <pre>
 * [primary-key]
 *     TRDIHYQRCASE_ID
 ...
 */
public abstract class BsTTrdihyqrcaseDtoMapper implements DtoMapper<TTrdihyqrcase, TTrdihyqrcaseDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrdihyqrcaseDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrdihyqrcaseDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrdihyqrcaseDto mappingToDto(TTrdihyqrcase entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrdihyqrcaseDto dto = new TTrdihyqrcaseDto();
        dto.setTrdihyqrcaseId(entity.getTrdihyqrcaseId());
        dto.setQrcasekey(entity.getQrcasekey());
        dto.setQrdata(entity.getQrdata());
        dto.setTransportcd(entity.getTransportcd());
        dto.setProductCd(entity.getProductCd());
        dto.setDihyqrheader(entity.getDihyqrheader());
        dto.setDihyqrdetail(entity.getDihyqrdetail());
        dto.setFlgunitbowl(entity.getFlgunitbowl());
     ...
     * {@inheritDoc}
     */
    public List<TTrdihyqrcaseDto> mappingToDtoList(List<TTrdihyqrcase> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrdihyqrcaseDto> dtoList = new ArrayList<TTrdihyqrcaseDto>();
        for (TTrdihyqrcase entity : entityList) {
            TTrdihyqrcaseDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrdihyqrcase mappingToEntity(TTrdihyqrcaseDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrdihyqrcase entity = new TTrdihyqrcase();
        if (needsMapping(dto, dto.getTrdihyqrcaseId(), "trdihyqrcaseId")) {
            entity.setTrdihyqrcaseId(dto.getTrdihyqrcaseId());
        }
        if (needsMapping(dto, dto.getQrcasekey(), "qrcasekey")) {
            entity.setQrcasekey(dto.getQrcasekey());
        }
        ...
        if (needsMapping(dto, dto.getDihyqrheader(), "dihyqrheader")) {
            entity.setDihyqrheader(dto.getDihyqrheader());
        }
        if (needsMapping(dto, dto.getDihyqrdetail(), "dihyqrdetail")) {
            entity.setDihyqrdetail(dto.getDihyqrdetail());
        }
        if (needsMapping(dto, dto.getFlgunitbowl(), "flgunitbowl")) {
            entity.setFlgunitbowl(dto.getFlgunitbowl());
        }
     ...
     */
    protected boolean needsMapping(TTrdihyqrcaseDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrdihyqrcase> mappingToEntityList(List<TTrdihyqrcaseDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrdihyqrcase> entityList = new ArrayList<TTrdihyqrcase>();
        for (TTrdihyqrcaseDto dto : dtoList) {
            TTrdihyqrcase entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrdihyqrcaseDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrdihyqrcaseDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrdihyqrcaseDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrdihyqrcaseDtoMapper reverseReference() {
