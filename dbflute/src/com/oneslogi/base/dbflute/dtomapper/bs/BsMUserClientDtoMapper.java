...
/**
 * The DTO mapper of M_USER_CLIENT as TABLE. <br>
 * ユーザ荷主マスタ
 * <pre>
 * [primary-key]
 *     USER_CLIENT_ID
 ...
 */
public abstract class BsMUserClientDtoMapper implements DtoMapper<MUserClient, MUserClientDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMUserClientDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMUserClientDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MUserClientDto mappingToDto(MUserClient entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MUserClientDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserClientDto dto = new MUserClientDto();
        dto.setUserClientId(entity.getUserClientId());
        ...
        if (!_suppressBUser && entity.getBUser() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getMUserClientList().add(dto);
                }
            } else {
                ...
                mapper.suppressMUserClientList();
     ...
     * {@inheritDoc}
     */
    public List<MUserClientDto> mappingToDtoList(List<MUserClient> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MUserClientDto> dtoList = new ArrayList<MUserClientDto>();
        for (MUserClient entity : entityList) {
            MUserClientDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MUserClient mappingToEntity(MUserClientDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MUserClient)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserClient entity = new MUserClient();
        if (needsMapping(dto, dto.getUserClientId(), "userClientId")) {
            entity.setUserClientId(dto.getUserClientId());
        }
        ...
        if (!_suppressBUser && dto.getBUser() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getMUserClientList().add(entity);
                }
            } else {
                BUserDtoMapper mapper = new BUserDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(MUserClientDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MUserClient> mappingToEntityList(List<MUserClientDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MUserClient> entityList = new ArrayList<MUserClient>();
        for (MUserClientDto dto : dtoList) {
            MUserClient entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MUserClientDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MUserClientDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MUserClientDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MUserClientDtoMapper reverseReference() {
