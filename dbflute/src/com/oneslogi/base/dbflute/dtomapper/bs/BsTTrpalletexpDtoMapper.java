...
/**
 * The DTO mapper of T_TRPALLETEXP as TABLE. <br>
 * パレットはり紙拡張情報
 * <pre>
 * [primary-key]
 *     TRPALLETEXP_ID
 ...
 */
public abstract class BsTTrpalletexpDtoMapper implements DtoMapper<TTrpalletexp, TTrpalletexpDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrpalletexpDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrpalletexpDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrpalletexpDto mappingToDto(TTrpalletexp entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrpalletexpDto dto = new TTrpalletexpDto();
        dto.setTrpalletexpId(entity.getTrpalletexpId());
     ...
     * {@inheritDoc}
     */
    public List<TTrpalletexpDto> mappingToDtoList(List<TTrpalletexp> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrpalletexpDto> dtoList = new ArrayList<TTrpalletexpDto>();
        for (TTrpalletexp entity : entityList) {
            TTrpalletexpDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrpalletexp mappingToEntity(TTrpalletexpDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrpalletexp entity = new TTrpalletexp();
        if (needsMapping(dto, dto.getTrpalletexpId(), "trpalletexpId")) {
            entity.setTrpalletexpId(dto.getTrpalletexpId());
        }
     ...
     */
    protected boolean needsMapping(TTrpalletexpDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrpalletexp> mappingToEntityList(List<TTrpalletexpDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrpalletexp> entityList = new ArrayList<TTrpalletexp>();
        for (TTrpalletexpDto dto : dtoList) {
            TTrpalletexp entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrpalletexpDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrpalletexpDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrpalletexpDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrpalletexpDtoMapper reverseReference() {
