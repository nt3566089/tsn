...
/**
 * The DTO mapper of M_MFMONTHCHG as TABLE. <br>
 * 月替り・デ変情報マスタ
 * <pre>
 * [primary-key]
 *     MFMONTHCHG_ID
 ...
 */
public abstract class BsMMfmonthchgDtoMapper implements DtoMapper<MMfmonthchg, MMfmonthchgDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMMfmonthchgDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMMfmonthchgDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MMfmonthchgDto mappingToDto(MMfmonthchg entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MMfmonthchgDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MMfmonthchgDto dto = new MMfmonthchgDto();
        ...
        dto.setPicklisttype(entity.getPicklisttype());
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getMMfmonthchgList().add(dto);
                }
            } else {
                ...
                mapper.suppressMMfmonthchgList();
     ...
     * {@inheritDoc}
     */
    public List<MMfmonthchgDto> mappingToDtoList(List<MMfmonthchg> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MMfmonthchgDto> dtoList = new ArrayList<MMfmonthchgDto>();
        for (MMfmonthchg entity : entityList) {
            MMfmonthchgDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MMfmonthchg mappingToEntity(MMfmonthchgDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MMfmonthchg)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MMfmonthchg entity = new MMfmonthchg();
        ...
        if (needsMapping(dto, dto.getPicklisttype(), "picklisttype")) {
            entity.setPicklisttype(dto.getPicklisttype());
        }
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getMMfmonthchgList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(MMfmonthchgDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MMfmonthchg> mappingToEntityList(List<MMfmonthchgDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MMfmonthchg> entityList = new ArrayList<MMfmonthchg>();
        for (MMfmonthchgDto dto : dtoList) {
            MMfmonthchg entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MMfmonthchgDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MMfmonthchgDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MMfmonthchgDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MMfmonthchgDtoMapper reverseReference() {
