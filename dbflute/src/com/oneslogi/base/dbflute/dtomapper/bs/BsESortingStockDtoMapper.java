...
/**
 * The DTO mapper of E_SORTING_STOCK as TABLE. <br>
 * 仕分在庫実績受信テーブル
 * <pre>
 * [primary-key]
 *     SORTING_STOCK_ID
 ...
 */
public abstract class BsESortingStockDtoMapper implements DtoMapper<ESortingStock, ESortingStockDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsESortingStockDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsESortingStockDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ESortingStockDto mappingToDto(ESortingStock entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ESortingStockDto dto = new ESortingStockDto();
        dto.setSortingStockId(entity.getSortingStockId());
     ...
     * {@inheritDoc}
     */
    public List<ESortingStockDto> mappingToDtoList(List<ESortingStock> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ESortingStockDto> dtoList = new ArrayList<ESortingStockDto>();
        for (ESortingStock entity : entityList) {
            ESortingStockDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ESortingStock mappingToEntity(ESortingStockDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ESortingStock entity = new ESortingStock();
        if (needsMapping(dto, dto.getSortingStockId(), "sortingStockId")) {
            entity.setSortingStockId(dto.getSortingStockId());
        }
     ...
     */
    protected boolean needsMapping(ESortingStockDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ESortingStock> mappingToEntityList(List<ESortingStockDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ESortingStock> entityList = new ArrayList<ESortingStock>();
        for (ESortingStockDto dto : dtoList) {
            ESortingStock entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ESortingStockDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ESortingStockDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ESortingStockDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ESortingStockDtoMapper reverseReference() {
