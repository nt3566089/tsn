...
/**
 * The DTO mapper of E_TRIFTRANPLAN as TABLE. <br>
 * IF輸送受払計画中間
 * <pre>
 * [primary-key]
 *     UJTYPE, RECNO
 ...
 */
public abstract class BsETriftranplanDtoMapper implements DtoMapper<ETriftranplan, ETriftranplanDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsETriftranplanDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsETriftranplanDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ETriftranplanDto mappingToDto(ETriftranplan entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETriftranplanDto dto = new ETriftranplanDto();
        dto.setUjtype(entity.getUjtype());
     ...
     * {@inheritDoc}
     */
    public List<ETriftranplanDto> mappingToDtoList(List<ETriftranplan> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ETriftranplanDto> dtoList = new ArrayList<ETriftranplanDto>();
        for (ETriftranplan entity : entityList) {
            ETriftranplanDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ETriftranplan mappingToEntity(ETriftranplanDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETriftranplan entity = new ETriftranplan();
        if (needsMapping(dto, dto.getUjtype(), "ujtype")) {
            entity.setUjtype(dto.getUjtype());
        }
     ...
     */
    protected boolean needsMapping(ETriftranplanDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ETriftranplan> mappingToEntityList(List<ETriftranplanDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ETriftranplan> entityList = new ArrayList<ETriftranplan>();
        for (ETriftranplanDto dto : dtoList) {
            ETriftranplan entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ETriftranplanDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ETriftranplanDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ETriftranplanDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ETriftranplanDtoMapper reverseReference() {
