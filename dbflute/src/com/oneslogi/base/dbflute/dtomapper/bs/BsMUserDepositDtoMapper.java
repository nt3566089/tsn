...
/**
 * The DTO mapper of M_USER_DEPOSIT as TABLE. <br>
 * ユーザ預託マスタ
 * <pre>
 * [primary-key]
 *     USER_DEPOSIT_ID
 ...
 */
public abstract class BsMUserDepositDtoMapper implements DtoMapper<MUserDeposit, MUserDepositDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMUserDepositDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMUserDepositDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MUserDepositDto mappingToDto(MUserDeposit entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MUserDepositDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserDepositDto dto = new MUserDepositDto();
        dto.setUserDepositId(entity.getUserDepositId());
        ...
        if (!_suppressMCustomer && entity.getMCustomer() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getMUserDepositList().add(dto);
                }
            } else {
                ...
                mapper.suppressMUserDepositList();
     ...
     * {@inheritDoc}
     */
    public List<MUserDepositDto> mappingToDtoList(List<MUserDeposit> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MUserDepositDto> dtoList = new ArrayList<MUserDepositDto>();
        for (MUserDeposit entity : entityList) {
            MUserDepositDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MUserDeposit mappingToEntity(MUserDepositDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MUserDeposit)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserDeposit entity = new MUserDeposit();
        if (needsMapping(dto, dto.getUserDepositId(), "userDepositId")) {
            entity.setUserDepositId(dto.getUserDepositId());
        }
        ...
        if (!_suppressMCustomer && dto.getMCustomer() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getMUserDepositList().add(entity);
                }
            } else {
                MCustomerDtoMapper mapper = new MCustomerDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(MUserDepositDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MUserDeposit> mappingToEntityList(List<MUserDepositDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MUserDeposit> entityList = new ArrayList<MUserDeposit>();
        for (MUserDepositDto dto : dtoList) {
            MUserDeposit entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MUserDepositDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MUserDepositDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MUserDepositDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MUserDepositDtoMapper reverseReference() {
