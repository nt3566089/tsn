...
/**
 * The DTO mapper of E_CUSTOMER as TABLE. <br>
 * 取引先マスタ受信
 * <pre>
 * [primary-key]
 *     CUSTOMER_ID
 ...
 */
public abstract class BsECustomerDtoMapper implements DtoMapper<ECustomer, ECustomerDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsECustomerDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsECustomerDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ECustomerDto mappingToDto(ECustomer entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ECustomerDto dto = new ECustomerDto();
     ...
     * {@inheritDoc}
     */
    public List<ECustomerDto> mappingToDtoList(List<ECustomer> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ECustomerDto> dtoList = new ArrayList<ECustomerDto>();
        for (ECustomer entity : entityList) {
            ECustomerDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ECustomer mappingToEntity(ECustomerDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
     ...
     */
    protected boolean needsMapping(ECustomerDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ECustomer> mappingToEntityList(List<ECustomerDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ECustomer> entityList = new ArrayList<ECustomer>();
        for (ECustomerDto dto : dtoList) {
            ECustomer entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ECustomerDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ECustomerDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ECustomerDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ECustomerDtoMapper reverseReference() {
