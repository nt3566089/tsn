...
/**
 * The DTO mapper of W_CDRCATT_INST_INPUT as TABLE. <br>
 * 方面属性一括取込ワーク
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsWCdrcattInstInputDtoMapper implements DtoMapper<WCdrcattInstInput, WCdrcattInstInputDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWCdrcattInstInputDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWCdrcattInstInputDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WCdrcattInstInputDto mappingToDto(WCdrcattInstInput entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WCdrcattInstInputDto dto = new WCdrcattInstInputDto();
        dto.setCdrcattInstInputId(entity.getCdrcattInstInputId());
     ...
     * {@inheritDoc}
     */
    public List<WCdrcattInstInputDto> mappingToDtoList(List<WCdrcattInstInput> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WCdrcattInstInputDto> dtoList = new ArrayList<WCdrcattInstInputDto>();
        for (WCdrcattInstInput entity : entityList) {
            WCdrcattInstInputDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WCdrcattInstInput mappingToEntity(WCdrcattInstInputDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WCdrcattInstInput entity = new WCdrcattInstInput();
        if (needsMapping(dto, dto.getCdrcattInstInputId(), "cdrcattInstInputId")) {
            entity.setCdrcattInstInputId(dto.getCdrcattInstInputId());
        }
     ...
     */
    protected boolean needsMapping(WCdrcattInstInputDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WCdrcattInstInput> mappingToEntityList(List<WCdrcattInstInputDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WCdrcattInstInput> entityList = new ArrayList<WCdrcattInstInput>();
        for (WCdrcattInstInputDto dto : dtoList) {
            WCdrcattInstInput entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WCdrcattInstInputDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WCdrcattInstInputDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WCdrcattInstInputDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WCdrcattInstInputDtoMapper reverseReference() {
