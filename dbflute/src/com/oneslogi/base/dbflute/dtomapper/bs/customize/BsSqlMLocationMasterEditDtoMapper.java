...
/**
 * The DTO mapper of SqlMLocationMasterEdit. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlMLocationMasterEditDtoMapper implements DtoMapper<SqlMLocationMasterEdit, SqlMLocationMasterEditDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlMLocationMasterEditDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlMLocationMasterEditDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlMLocationMasterEditDto mappingToDto(SqlMLocationMasterEdit entity) {
        if (entity == null) {
            return null;
        }
        SqlMLocationMasterEditDto dto = new SqlMLocationMasterEditDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlMLocationMasterEditDto> mappingToDtoList(List<SqlMLocationMasterEdit> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlMLocationMasterEditDto> dtoList = new ArrayList<SqlMLocationMasterEditDto>();
        for (SqlMLocationMasterEdit entity : entityList) {
            SqlMLocationMasterEditDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlMLocationMasterEdit mappingToEntity(SqlMLocationMasterEditDto dto) {
        if (dto == null) {
            return null;
        }
        SqlMLocationMasterEdit entity = new SqlMLocationMasterEdit();
     ...
     */
    protected boolean needsMapping(SqlMLocationMasterEditDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlMLocationMasterEdit> mappingToEntityList(List<SqlMLocationMasterEditDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlMLocationMasterEdit> entityList = new ArrayList<SqlMLocationMasterEdit>();
        for (SqlMLocationMasterEditDto dto : dtoList) {
            SqlMLocationMasterEdit entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlMLocationMasterEditDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlMLocationMasterEditDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlMLocationMasterEditDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlMLocationMasterEditDtoMapper reverseReference() {
