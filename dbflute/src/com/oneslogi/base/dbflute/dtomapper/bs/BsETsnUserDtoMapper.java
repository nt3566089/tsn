...
/**
 * The DTO mapper of E_TSN_USER as TABLE. <br>
 * TSNユーザマスタ
 * <pre>
 * [primary-key]
 *     TSN_USER_ID
 ...
 */
public abstract class BsETsnUserDtoMapper implements DtoMapper<ETsnUser, ETsnUserDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsETsnUserDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsETsnUserDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ETsnUserDto mappingToDto(ETsnUser entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETsnUserDto dto = new ETsnUserDto();
        dto.setTsnUserId(entity.getTsnUserId());
     ...
     * {@inheritDoc}
     */
    public List<ETsnUserDto> mappingToDtoList(List<ETsnUser> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ETsnUserDto> dtoList = new ArrayList<ETsnUserDto>();
        for (ETsnUser entity : entityList) {
            ETsnUserDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ETsnUser mappingToEntity(ETsnUserDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETsnUser entity = new ETsnUser();
        if (needsMapping(dto, dto.getTsnUserId(), "tsnUserId")) {
            entity.setTsnUserId(dto.getTsnUserId());
        }
     ...
     */
    protected boolean needsMapping(ETsnUserDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ETsnUser> mappingToEntityList(List<ETsnUserDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ETsnUser> entityList = new ArrayList<ETsnUser>();
        for (ETsnUserDto dto : dtoList) {
            ETsnUser entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ETsnUserDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ETsnUserDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ETsnUserDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ETsnUserDtoMapper reverseReference() {
