...
/**
 * The DTO mapper of B_CLASS_DTL as TABLE. <br>
 * 区分値明細マスタ
 * <pre>
 * [primary-key]
 *     CLASS_DTL_ID
 ...
 */
public abstract class BsBClassDtlDtoMapper implements DtoMapper<BClassDtl, BClassDtlDto>, Serializable {
    ...
    protected boolean _suppressBClassDtlSubAsOne;
    protected boolean _suppressBClassGrpDtlList;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsBClassDtlDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsBClassDtlDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public BClassDtlDto mappingToDto(BClassDtl entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (BClassDtlDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        BClassDtlDto dto = new BClassDtlDto();
        ...
        if (!_suppressBClass && entity.getBClass() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getBClassDtlList().add(dto);
                }
            } else {
        ...
        if (!_suppressBClassDtlSubAsOne && entity.getBClassDtlSubAsOne() != null) {
            BClassDtlSub relationEntity = entity.getBClassDtlSubAsOne();
            Entity relationKey = createInstanceKeyEntity(relationEntity);
            Object cachedDto = instanceCache ? _relationDtoMap.get(relationKey) : null;
            if (cachedDto != null) {
                BClassDtlSubDto relationDto = (BClassDtlSubDto)cachedDto;
                dto.setBClassDtlSubAsOne(relationDto);
                if (reverseReference) {
                    relationDto.setBClassDtl(dto);
                }
            } else {
                BClassDtlSubDtoMapper mapper = new BClassDtlSubDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
                mapper.setReverseReference(reverseReference);
                if (!instanceCache) { mapper.disableInstanceCache(); }
                mapper.suppressBClassDtl();
                BClassDtlSubDto relationDto = mapper.mappingToDto(relationEntity);
                dto.setBClassDtlSubAsOne(relationDto);
                if (reverseReference) {
                    relationDto.setBClassDtl(dto);
                }
                if (instanceCache && relationEntity.hasPrimaryKeyValue()) {
                    _relationDtoMap.put(relationKey, dto.getBClassDtlSubAsOne());
                }
            }
        };
     ...
     * {@inheritDoc}
     */
    public List<BClassDtlDto> mappingToDtoList(List<BClassDtl> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<BClassDtlDto> dtoList = new ArrayList<BClassDtlDto>();
        for (BClassDtl entity : entityList) {
            BClassDtlDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public BClassDtl mappingToEntity(BClassDtlDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (BClassDtl)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ...
        if (!_suppressBClass && dto.getBClass() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getBClassDtlList().add(entity);
                }
            } else {
                BClassDtoMapper mapper = new BClassDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
        ...
        if (!_suppressBClassDtlSubAsOne && dto.getBClassDtlSubAsOne() != null) {
            BClassDtlSubDto relationDto = dto.getBClassDtlSubAsOne();
            Object relationKey = createInstanceKeyDto(relationDto, relationDto.instanceHash());
            Entity cachedEntity = instanceCache ? _relationEntityMap.get(relationKey) : null;
            if (cachedEntity != null) {
                BClassDtlSub relationEntity = (BClassDtlSub)cachedEntity;
                entity.setBClassDtlSubAsOne(relationEntity);
                if (reverseReference) {
                    relationEntity.setBClassDtl(entity);
                }
            } else {
                BClassDtlSubDtoMapper mapper = new BClassDtlSubDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
                ...
                if (!instanceCache) { mapper.disableInstanceCache(); }
                mapper.suppressBClassDtl();
                BClassDtlSub relationEntity = mapper.mappingToEntity(relationDto);
                entity.setBClassDtlSubAsOne(relationEntity);
                if (reverseReference) {
                    relationEntity.setBClassDtl(entity);
                }
                if (instanceCache && entity.getBClassDtlSubAsOne().hasPrimaryKeyValue()) {
                    _relationEntityMap.put(relationKey, entity.getBClassDtlSubAsOne());
                }
            }
        };
     ...
     */
    protected boolean needsMapping(BClassDtlDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<BClassDtl> mappingToEntityList(List<BClassDtlDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<BClassDtl> entityList = new ArrayList<BClassDtl>();
        for (BClassDtlDto dto : dtoList) {
            BClassDtl entity = mappingToEntity(dto);
            if (entity != null) {
    ...
    public void suppressBClassDtlSubAsOne() {
        _suppressBClassDtlSubAsOne = true;
    }
    ...
    protected void doSuppressClear() { // internal
        ...
        _suppressBClassDtlSubAsOne = false;
     ...
     * @return this. (NotNull)
     */
    public BClassDtlDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (BClassDtlDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public BClassDtlDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public BClassDtlDtoMapper reverseReference() {
