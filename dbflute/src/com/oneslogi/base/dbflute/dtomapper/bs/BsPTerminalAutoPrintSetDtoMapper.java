...
/**
 * The DTO mapper of P_TERMINAL_AUTO_PRINT_SET as TABLE. <br>
 * 端末別自動印刷設定マスタ
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsPTerminalAutoPrintSetDtoMapper implements DtoMapper<PTerminalAutoPrintSet, PTerminalAutoPrintSetDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsPTerminalAutoPrintSetDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsPTerminalAutoPrintSetDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public PTerminalAutoPrintSetDto mappingToDto(PTerminalAutoPrintSet entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (PTerminalAutoPrintSetDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        PTerminalAutoPrintSetDto dto = new PTerminalAutoPrintSetDto();
        dto.setTerminalAutoPrintSetId(entity.getTerminalAutoPrintSetId());
        dto.setTerminalAssignCd(entity.getTerminalAssignCd());
        ...
        if (!_suppressPReportLayoutByReportLayoutId && entity.getPReportLayoutByReportLayoutId() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getPTerminalAutoPrintSetByReportLayoutIdList().add(dto);
                }
            } else {
                ...
                mapper.suppressPTerminalAutoPrintSetByReportLayoutIdList();
        ...
        if (!_suppressPPrinterGroupByPrinterGroupId && entity.getPPrinterGroupByPrinterGroupId() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getPTerminalAutoPrintSetByPrinterGroupIdList().add(dto);
                }
            } else {
                ...
                mapper.setReverseReference(reverseReference);
                if (!instanceCache) { mapper.disableInstanceCache(); }
                mapper.suppressPTerminalAutoPrintSetByPrinterGroupIdList();
        ...
        if (!_suppressPPrinterByPrinterId && entity.getPPrinterByPrinterId() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getPTerminalAutoPrintSetByPrinterIdList().add(dto);
                }
            } else {
                ...
                mapper.setReverseReference(reverseReference);
                if (!instanceCache) { mapper.disableInstanceCache(); }
                mapper.suppressPTerminalAutoPrintSetByPrinterIdList();
        ...
        if (!_suppressPPrinterAttributeByPrinterAttributeId && entity.getPPrinterAttributeByPrinterAttributeId() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getPTerminalAutoPrintSetByPrinterAttributeIdList().add(dto);
                }
            } else {
                ...
                mapper.setReverseReference(reverseReference);
                if (!instanceCache) { mapper.disableInstanceCache(); }
                mapper.suppressPTerminalAutoPrintSetByPrinterAttributeIdList();
     ...
     * {@inheritDoc}
     */
    public List<PTerminalAutoPrintSetDto> mappingToDtoList(List<PTerminalAutoPrintSet> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<PTerminalAutoPrintSetDto> dtoList = new ArrayList<PTerminalAutoPrintSetDto>();
        for (PTerminalAutoPrintSet entity : entityList) {
            PTerminalAutoPrintSetDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public PTerminalAutoPrintSet mappingToEntity(PTerminalAutoPrintSetDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (PTerminalAutoPrintSet)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        PTerminalAutoPrintSet entity = new PTerminalAutoPrintSet();
        if (needsMapping(dto, dto.getTerminalAutoPrintSetId(), "terminalAutoPrintSetId")) {
            entity.setTerminalAutoPrintSetId(dto.getTerminalAutoPrintSetId());
        }
        if (needsMapping(dto, dto.getTerminalAssignCd(), "terminalAssignCd")) {
            entity.setTerminalAssignCd(dto.getTerminalAssignCd());
        }
        ...
        if (!_suppressPReportLayoutByReportLayoutId && dto.getPReportLayoutByReportLayoutId() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getPTerminalAutoPrintSetByReportLayoutIdList().add(entity);
                }
            } else {
                PReportLayoutDtoMapper mapper = new PReportLayoutDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
        ...
        if (!_suppressPPrinterGroupByPrinterGroupId && dto.getPPrinterGroupByPrinterGroupId() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getPTerminalAutoPrintSetByPrinterGroupIdList().add(entity);
                }
            } else {
                PPrinterGroupDtoMapper mapper = new PPrinterGroupDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
        ...
        if (!_suppressPPrinterByPrinterId && dto.getPPrinterByPrinterId() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getPTerminalAutoPrintSetByPrinterIdList().add(entity);
                }
            } else {
                PPrinterDtoMapper mapper = new PPrinterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
        ...
        if (!_suppressPPrinterAttributeByPrinterAttributeId && dto.getPPrinterAttributeByPrinterAttributeId() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getPTerminalAutoPrintSetByPrinterAttributeIdList().add(entity);
                }
            } else {
                PPrinterAttributeDtoMapper mapper = new PPrinterAttributeDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(PTerminalAutoPrintSetDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<PTerminalAutoPrintSet> mappingToEntityList(List<PTerminalAutoPrintSetDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<PTerminalAutoPrintSet> entityList = new ArrayList<PTerminalAutoPrintSet>();
        for (PTerminalAutoPrintSetDto dto : dtoList) {
            PTerminalAutoPrintSet entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public PTerminalAutoPrintSetDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (PTerminalAutoPrintSetDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public PTerminalAutoPrintSetDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public PTerminalAutoPrintSetDtoMapper reverseReference() {
