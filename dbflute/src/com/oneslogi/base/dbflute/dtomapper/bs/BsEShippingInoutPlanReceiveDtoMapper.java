...
/**
 * The DTO mapper of E_SHIPPING_INOUT_PLAN_RECEIVE as TABLE. <br>
 * 輸送受払計画受信テーブル(受入)(国産)
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEShippingInoutPlanReceiveDtoMapper implements DtoMapper<EShippingInoutPlanReceive, EShippingInoutPlanReceiveDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEShippingInoutPlanReceiveDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEShippingInoutPlanReceiveDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EShippingInoutPlanReceiveDto mappingToDto(EShippingInoutPlanReceive entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EShippingInoutPlanReceiveDto dto = new EShippingInoutPlanReceiveDto();
        dto.setShippingInoutPlanReceiveId(entity.getShippingInoutPlanReceiveId());
     ...
     * {@inheritDoc}
     */
    public List<EShippingInoutPlanReceiveDto> mappingToDtoList(List<EShippingInoutPlanReceive> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EShippingInoutPlanReceiveDto> dtoList = new ArrayList<EShippingInoutPlanReceiveDto>();
        for (EShippingInoutPlanReceive entity : entityList) {
            EShippingInoutPlanReceiveDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EShippingInoutPlanReceive mappingToEntity(EShippingInoutPlanReceiveDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EShippingInoutPlanReceive entity = new EShippingInoutPlanReceive();
        if (needsMapping(dto, dto.getShippingInoutPlanReceiveId(), "shippingInoutPlanReceiveId")) {
            entity.setShippingInoutPlanReceiveId(dto.getShippingInoutPlanReceiveId());
        }
     ...
     */
    protected boolean needsMapping(EShippingInoutPlanReceiveDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EShippingInoutPlanReceive> mappingToEntityList(List<EShippingInoutPlanReceiveDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EShippingInoutPlanReceive> entityList = new ArrayList<EShippingInoutPlanReceive>();
        for (EShippingInoutPlanReceiveDto dto : dtoList) {
            EShippingInoutPlanReceive entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EShippingInoutPlanReceiveDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EShippingInoutPlanReceiveDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EShippingInoutPlanReceiveDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EShippingInoutPlanReceiveDtoMapper reverseReference() {
