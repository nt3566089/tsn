...
/**
 * The DTO mapper of T_LAST_LOT as TABLE. <br>
 * 最終ロット管理
 * <pre>
 * [primary-key]
 *     LAST_LOT_ID
 ...
 */
public abstract class BsTLastLotDtoMapper implements DtoMapper<TLastLot, TLastLotDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTLastLotDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTLastLotDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TLastLotDto mappingToDto(TLastLot entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TLastLotDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TLastLotDto dto = new TLastLotDto();
        dto.setLastLotId(entity.getLastLotId());
     ...
     * {@inheritDoc}
     */
    public List<TLastLotDto> mappingToDtoList(List<TLastLot> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TLastLotDto> dtoList = new ArrayList<TLastLotDto>();
        for (TLastLot entity : entityList) {
            TLastLotDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TLastLot mappingToEntity(TLastLotDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TLastLot)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TLastLot entity = new TLastLot();
        if (needsMapping(dto, dto.getLastLotId(), "lastLotId")) {
            entity.setLastLotId(dto.getLastLotId());
        }
     ...
     */
    protected boolean needsMapping(TLastLotDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TLastLot> mappingToEntityList(List<TLastLotDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TLastLot> entityList = new ArrayList<TLastLot>();
        for (TLastLotDto dto : dtoList) {
            TLastLot entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TLastLotDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TLastLotDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TLastLotDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TLastLotDtoMapper reverseReference() {
