...
/**
 * The DTO mapper of T_INVENTORY_H as TABLE. <br>
 * 棚卸ヘッダ
 * <pre>
 * [primary-key]
 *     INVENTORY_H_ID
 ...
 */
public abstract class BsTInventoryHDtoMapper implements DtoMapper<TInventoryH, TInventoryHDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTInventoryHDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTInventoryHDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TInventoryHDto mappingToDto(TInventoryH entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TInventoryHDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TInventoryHDto dto = new TInventoryHDto();
        dto.setInventoryHId(entity.getInventoryHId());
        dto.setClientId(entity.getClientId());
        dto.setCenterId(entity.getCenterId());
        dto.setBatchNum(entity.getBatchNum());
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTInventoryHList().add(dto);
                }
            } else {
                ...
                mapper.suppressTInventoryHList();
        ...
        if (!_suppressTInventoryBList && !entity.getTInventoryBList().isEmpty()) {
            ...
            if (reverseReference) {
                for (TInventoryBDto relationDto : relationDtoList) {
                    relationDto.setTInventoryH(dto);
                }
            }
        };
     ...
     * {@inheritDoc}
     */
    public List<TInventoryHDto> mappingToDtoList(List<TInventoryH> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TInventoryHDto> dtoList = new ArrayList<TInventoryHDto>();
        for (TInventoryH entity : entityList) {
            TInventoryHDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TInventoryH mappingToEntity(TInventoryHDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TInventoryH)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TInventoryH entity = new TInventoryH();
        ...
        if (needsMapping(dto, dto.getBatchNum(), "batchNum")) {
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTInventoryHList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
        ...
        if (!_suppressTInventoryBList && !dto.getTInventoryBList().isEmpty()) {
            ...
            if (reverseReference) {
                for (TInventoryB relationEntity : relationEntityList) {
                    relationEntity.setTInventoryH(entity);
                }
            }
        };
     ...
     */
    protected boolean needsMapping(TInventoryHDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TInventoryH> mappingToEntityList(List<TInventoryHDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TInventoryH> entityList = new ArrayList<TInventoryH>();
        for (TInventoryHDto dto : dtoList) {
            TInventoryH entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TInventoryHDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TInventoryHDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TInventoryHDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TInventoryHDtoMapper reverseReference() {
