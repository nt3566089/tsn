...
/**
 * The DTO mapper of E_NOTIFICATION_IMPORT as TABLE. <br>
 * 受入通知情報受信テーブル（輸入）
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsENotificationImportDtoMapper implements DtoMapper<ENotificationImport, ENotificationImportDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsENotificationImportDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsENotificationImportDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ENotificationImportDto mappingToDto(ENotificationImport entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ENotificationImportDto dto = new ENotificationImportDto();
        dto.setNotificationImportId(entity.getNotificationImportId());
     ...
     * {@inheritDoc}
     */
    public List<ENotificationImportDto> mappingToDtoList(List<ENotificationImport> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ENotificationImportDto> dtoList = new ArrayList<ENotificationImportDto>();
        for (ENotificationImport entity : entityList) {
            ENotificationImportDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ENotificationImport mappingToEntity(ENotificationImportDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ENotificationImport entity = new ENotificationImport();
        if (needsMapping(dto, dto.getNotificationImportId(), "notificationImportId")) {
            entity.setNotificationImportId(dto.getNotificationImportId());
        }
     ...
     */
    protected boolean needsMapping(ENotificationImportDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ENotificationImport> mappingToEntityList(List<ENotificationImportDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ENotificationImport> entityList = new ArrayList<ENotificationImport>();
        for (ENotificationImportDto dto : dtoList) {
            ENotificationImport entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ENotificationImportDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ENotificationImportDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ENotificationImportDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ENotificationImportDtoMapper reverseReference() {
