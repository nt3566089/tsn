...
/**
 * The DTO mapper of E_TSN_MFCOMPANY as TABLE. <br>
 * TSN組織マスタ
 * <pre>
 * [primary-key]
 *     TSN_MFCOMPANY_ID
 ...
 */
public abstract class BsETsnMfcompanyDtoMapper implements DtoMapper<ETsnMfcompany, ETsnMfcompanyDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsETsnMfcompanyDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsETsnMfcompanyDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ETsnMfcompanyDto mappingToDto(ETsnMfcompany entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETsnMfcompanyDto dto = new ETsnMfcompanyDto();
        dto.setTsnMfcompanyId(entity.getTsnMfcompanyId());
     ...
     * {@inheritDoc}
     */
    public List<ETsnMfcompanyDto> mappingToDtoList(List<ETsnMfcompany> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ETsnMfcompanyDto> dtoList = new ArrayList<ETsnMfcompanyDto>();
        for (ETsnMfcompany entity : entityList) {
            ETsnMfcompanyDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ETsnMfcompany mappingToEntity(ETsnMfcompanyDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETsnMfcompany entity = new ETsnMfcompany();
        if (needsMapping(dto, dto.getTsnMfcompanyId(), "tsnMfcompanyId")) {
            entity.setTsnMfcompanyId(dto.getTsnMfcompanyId());
        }
     ...
     */
    protected boolean needsMapping(ETsnMfcompanyDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ETsnMfcompany> mappingToEntityList(List<ETsnMfcompanyDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ETsnMfcompany> entityList = new ArrayList<ETsnMfcompany>();
        for (ETsnMfcompanyDto dto : dtoList) {
            ETsnMfcompany entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ETsnMfcompanyDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ETsnMfcompanyDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ETsnMfcompanyDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ETsnMfcompanyDtoMapper reverseReference() {
