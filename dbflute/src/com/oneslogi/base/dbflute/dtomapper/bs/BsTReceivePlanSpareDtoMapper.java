...
/**
 * The DTO mapper of T_RECEIVE_PLAN_SPARE as TABLE. <br>
 * 入荷予定予備
 * <pre>
 * [primary-key]
 *     RECEIVE_PLAN_B_ID
 ...
 */
public abstract class BsTReceivePlanSpareDtoMapper implements DtoMapper<TReceivePlanSpare, TReceivePlanSpareDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTReceivePlanSpareDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTReceivePlanSpareDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TReceivePlanSpareDto mappingToDto(TReceivePlanSpare entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TReceivePlanSpareDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TReceivePlanSpareDto dto = new TReceivePlanSpareDto();
        ...
        if (!_suppressTReceivePlanB && entity.getTReceivePlanB() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.setTReceivePlanSpareAsOne(dto);
                }
            } else {
                ...
                mapper.suppressTReceivePlanSpareAsOne();
     ...
     * {@inheritDoc}
     */
    public List<TReceivePlanSpareDto> mappingToDtoList(List<TReceivePlanSpare> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TReceivePlanSpareDto> dtoList = new ArrayList<TReceivePlanSpareDto>();
        for (TReceivePlanSpare entity : entityList) {
            TReceivePlanSpareDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TReceivePlanSpare mappingToEntity(TReceivePlanSpareDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TReceivePlanSpare)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TReceivePlanSpare entity = new TReceivePlanSpare();
        ...
        if (!_suppressTReceivePlanB && dto.getTReceivePlanB() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.setTReceivePlanSpareAsOne(entity);
                }
            } else {
                TReceivePlanBDtoMapper mapper = new TReceivePlanBDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TReceivePlanSpareDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TReceivePlanSpare> mappingToEntityList(List<TReceivePlanSpareDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TReceivePlanSpare> entityList = new ArrayList<TReceivePlanSpare>();
        for (TReceivePlanSpareDto dto : dtoList) {
            TReceivePlanSpare entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TReceivePlanSpareDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TReceivePlanSpareDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TReceivePlanSpareDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TReceivePlanSpareDtoMapper reverseReference() {
