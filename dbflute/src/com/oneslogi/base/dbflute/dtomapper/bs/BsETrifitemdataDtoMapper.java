...
/**
 * The DTO mapper of E_TRIFITEMDATA as TABLE. <br>
 * IF銘柄
 * <pre>
 * [primary-key]
 *     IFDATAKEY
 ...
 */
public abstract class BsETrifitemdataDtoMapper implements DtoMapper<ETrifitemdata, ETrifitemdataDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsETrifitemdataDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsETrifitemdataDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ETrifitemdataDto mappingToDto(ETrifitemdata entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETrifitemdataDto dto = new ETrifitemdataDto();
     ...
     * {@inheritDoc}
     */
    public List<ETrifitemdataDto> mappingToDtoList(List<ETrifitemdata> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ETrifitemdataDto> dtoList = new ArrayList<ETrifitemdataDto>();
        for (ETrifitemdata entity : entityList) {
            ETrifitemdataDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ETrifitemdata mappingToEntity(ETrifitemdataDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ETrifitemdata entity = new ETrifitemdata();
     ...
     */
    protected boolean needsMapping(ETrifitemdataDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ETrifitemdata> mappingToEntityList(List<ETrifitemdataDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ETrifitemdata> entityList = new ArrayList<ETrifitemdata>();
        for (ETrifitemdataDto dto : dtoList) {
            ETrifitemdata entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ETrifitemdataDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ETrifitemdataDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ETrifitemdataDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ETrifitemdataDtoMapper reverseReference() {
