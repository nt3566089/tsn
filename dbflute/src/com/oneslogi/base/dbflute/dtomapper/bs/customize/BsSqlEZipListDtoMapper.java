...
/**
 * The DTO mapper of SqlEZipList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlEZipListDtoMapper implements DtoMapper<SqlEZipList, SqlEZipListDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlEZipListDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlEZipListDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlEZipListDto mappingToDto(SqlEZipList entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        SqlEZipListDto dto = new SqlEZipListDto();
        ...
        dto.setMzipId(entity.getMzipId());
     ...
     * {@inheritDoc}
     */
    public List<SqlEZipListDto> mappingToDtoList(List<SqlEZipList> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlEZipListDto> dtoList = new ArrayList<SqlEZipListDto>();
        for (SqlEZipList entity : entityList) {
            SqlEZipListDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlEZipList mappingToEntity(SqlEZipListDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        SqlEZipList entity = new SqlEZipList();
        ...
        if (needsMapping(dto, dto.getMzipId(), "mzipId")) {
            entity.setMzipId(dto.getMzipId());
        }
     ...
     */
    protected boolean needsMapping(SqlEZipListDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlEZipList> mappingToEntityList(List<SqlEZipListDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlEZipList> entityList = new ArrayList<SqlEZipList>();
        for (SqlEZipListDto dto : dtoList) {
            SqlEZipList entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlEZipListDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlEZipListDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlEZipListDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlEZipListDtoMapper reverseReference() {
