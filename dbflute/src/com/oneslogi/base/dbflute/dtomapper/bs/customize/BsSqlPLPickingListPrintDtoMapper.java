...
/**
 * The DTO mapper of SqlPLPickingListPrint. <br>
 * <pre>
 * [primary-key]
 *     PRODUCT_ID
 *
 ...
 */
public abstract class BsSqlPLPickingListPrintDtoMapper implements DtoMapper<SqlPLPickingListPrint, SqlPLPickingListPrintDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlPLPickingListPrintDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlPLPickingListPrintDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlPLPickingListPrintDto mappingToDto(SqlPLPickingListPrint entity) {
        if (entity == null) {
            return null;
        }
        SqlPLPickingListPrintDto dto = new SqlPLPickingListPrintDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlPLPickingListPrintDto> mappingToDtoList(List<SqlPLPickingListPrint> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlPLPickingListPrintDto> dtoList = new ArrayList<SqlPLPickingListPrintDto>();
        for (SqlPLPickingListPrint entity : entityList) {
            SqlPLPickingListPrintDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlPLPickingListPrint mappingToEntity(SqlPLPickingListPrintDto dto) {
        if (dto == null) {
            return null;
        }
        SqlPLPickingListPrint entity = new SqlPLPickingListPrint();
     ...
     */
    protected boolean needsMapping(SqlPLPickingListPrintDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlPLPickingListPrint> mappingToEntityList(List<SqlPLPickingListPrintDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlPLPickingListPrint> entityList = new ArrayList<SqlPLPickingListPrint>();
        for (SqlPLPickingListPrintDto dto : dtoList) {
            SqlPLPickingListPrint entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlPLPickingListPrintDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlPLPickingListPrintDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlPLPickingListPrintDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlPLPickingListPrintDtoMapper reverseReference() {
