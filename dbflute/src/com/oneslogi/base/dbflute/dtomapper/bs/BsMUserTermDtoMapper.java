...
/**
 * The DTO mapper of M_USER_TERM as TABLE. <br>
 * ユーザマスタ適用期間
 * <pre>
 * [primary-key]
 *     COMMON_AUTH_ID
 ...
 */
public abstract class BsMUserTermDtoMapper implements DtoMapper<MUserTerm, MUserTermDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMUserTermDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMUserTermDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MUserTermDto mappingToDto(MUserTerm entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserTermDto dto = new MUserTermDto();
     ...
     * {@inheritDoc}
     */
    public List<MUserTermDto> mappingToDtoList(List<MUserTerm> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MUserTermDto> dtoList = new ArrayList<MUserTermDto>();
        for (MUserTerm entity : entityList) {
            MUserTermDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MUserTerm mappingToEntity(MUserTermDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserTerm entity = new MUserTerm();
     ...
     */
    protected boolean needsMapping(MUserTermDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MUserTerm> mappingToEntityList(List<MUserTermDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MUserTerm> entityList = new ArrayList<MUserTerm>();
        for (MUserTermDto dto : dtoList) {
            MUserTerm entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MUserTermDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MUserTermDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MUserTermDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MUserTermDtoMapper reverseReference() {
