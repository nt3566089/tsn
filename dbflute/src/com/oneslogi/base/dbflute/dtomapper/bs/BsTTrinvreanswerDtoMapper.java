...
/**
 * The DTO mapper of T_TRINVREANSWER as TABLE. <br>
 * 在庫照会回答情報
 * <pre>
 * [primary-key]
 *     TRINVREANSWER_ID
 ...
 */
public abstract class BsTTrinvreanswerDtoMapper implements DtoMapper<TTrinvreanswer, TTrinvreanswerDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrinvreanswerDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrinvreanswerDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrinvreanswerDto mappingToDto(TTrinvreanswer entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TTrinvreanswerDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrinvreanswerDto dto = new TTrinvreanswerDto();
        dto.setTrinvreanswerId(entity.getTrinvreanswerId());
        dto.setInvinqkey(entity.getInvinqkey());
        dto.setAnswerlineno(entity.getAnswerlineno());
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTTrinvreanswerList().add(dto);
                }
            } else {
                ...
                mapper.suppressTTrinvreanswerList();
     ...
     * {@inheritDoc}
     */
    public List<TTrinvreanswerDto> mappingToDtoList(List<TTrinvreanswer> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrinvreanswerDto> dtoList = new ArrayList<TTrinvreanswerDto>();
        for (TTrinvreanswer entity : entityList) {
            TTrinvreanswerDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrinvreanswer mappingToEntity(TTrinvreanswerDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TTrinvreanswer)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrinvreanswer entity = new TTrinvreanswer();
        if (needsMapping(dto, dto.getTrinvreanswerId(), "trinvreanswerId")) {
            entity.setTrinvreanswerId(dto.getTrinvreanswerId());
        }
        if (needsMapping(dto, dto.getInvinqkey(), "invinqkey")) {
            entity.setInvinqkey(dto.getInvinqkey());
        }
        if (needsMapping(dto, dto.getAnswerlineno(), "answerlineno")) {
            entity.setAnswerlineno(dto.getAnswerlineno());
        }
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTTrinvreanswerList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TTrinvreanswerDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrinvreanswer> mappingToEntityList(List<TTrinvreanswerDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrinvreanswer> entityList = new ArrayList<TTrinvreanswer>();
        for (TTrinvreanswerDto dto : dtoList) {
            TTrinvreanswer entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrinvreanswerDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrinvreanswerDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrinvreanswerDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrinvreanswerDtoMapper reverseReference() {
