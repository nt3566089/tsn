...
/**
 * The DTO mapper of M_MFRCVITEM as TABLE. <br>
 * 入庫銘柄組替マスタ
 * <pre>
 * [primary-key]
 *     RCVITEM_ID
 ...
 */
public abstract class BsMMfrcvitemDtoMapper implements DtoMapper<MMfrcvitem, MMfrcvitemDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMMfrcvitemDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMMfrcvitemDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MMfrcvitemDto mappingToDto(MMfrcvitem entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MMfrcvitemDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MMfrcvitemDto dto = new MMfrcvitemDto();
        dto.setRcvitemId(entity.getRcvitemId());
        dto.setClientId(entity.getClientId());
        dto.setRcvitemkey(entity.getRcvitemkey());
        dto.setItemcdFrom(entity.getItemcdFrom());
        dto.setDesigncdFrom(entity.getDesigncdFrom());
        dto.setItemcdTo(entity.getItemcdTo());
        dto.setDesigncdTo(entity.getDesigncdTo());
        ...
        dto.setItemNmFrom(entity.getItemNmFrom());
        dto.setItemNmTo(entity.getItemNmTo());
        ...
        if (!_suppressMClient && entity.getMClient() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getMMfrcvitemList().add(dto);
                }
            } else {
     ...
     * {@inheritDoc}
     */
    public List<MMfrcvitemDto> mappingToDtoList(List<MMfrcvitem> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MMfrcvitemDto> dtoList = new ArrayList<MMfrcvitemDto>();
        for (MMfrcvitem entity : entityList) {
            MMfrcvitemDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MMfrcvitem mappingToEntity(MMfrcvitemDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MMfrcvitem)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MMfrcvitem entity = new MMfrcvitem();
        if (needsMapping(dto, dto.getRcvitemId(), "rcvitemId")) {
            entity.setRcvitemId(dto.getRcvitemId());
        }
        if (needsMapping(dto, dto.getClientId(), "clientId")) {
            entity.setClientId(dto.getClientId());
        }
        if (needsMapping(dto, dto.getRcvitemkey(), "rcvitemkey")) {
            entity.setRcvitemkey(dto.getRcvitemkey());
        }
        if (needsMapping(dto, dto.getItemcdFrom(), "itemcdFrom")) {
            entity.setItemcdFrom(dto.getItemcdFrom());
        }
        if (needsMapping(dto, dto.getDesigncdFrom(), "designcdFrom")) {
            entity.setDesigncdFrom(dto.getDesigncdFrom());
        }
        if (needsMapping(dto, dto.getItemcdTo(), "itemcdTo")) {
            entity.setItemcdTo(dto.getItemcdTo());
        }
        if (needsMapping(dto, dto.getDesigncdTo(), "designcdTo")) {
            entity.setDesigncdTo(dto.getDesigncdTo());
        }
        ...
        if (needsMapping(dto, dto.getItemNmFrom(), "itemNmFrom")) {
            entity.setItemNmFrom(dto.getItemNmFrom());
        }
        if (needsMapping(dto, dto.getItemNmTo(), "itemNmTo")) {
            entity.setItemNmTo(dto.getItemNmTo());
        }
        ...
        if (!_suppressMClient && dto.getMClient() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getMMfrcvitemList().add(entity);
                }
            } else {
                MClientDtoMapper mapper = new MClientDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(MMfrcvitemDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MMfrcvitem> mappingToEntityList(List<MMfrcvitemDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MMfrcvitem> entityList = new ArrayList<MMfrcvitem>();
        for (MMfrcvitemDto dto : dtoList) {
            MMfrcvitem entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MMfrcvitemDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MMfrcvitemDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MMfrcvitemDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MMfrcvitemDtoMapper reverseReference() {
