...
/**
 * The DTO mapper of SqlInventoryBInvCreate. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlInventoryBInvCreateDtoMapper implements DtoMapper<SqlInventoryBInvCreate, SqlInventoryBInvCreateDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlInventoryBInvCreateDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlInventoryBInvCreateDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlInventoryBInvCreateDto mappingToDto(SqlInventoryBInvCreate entity) {
        if (entity == null) {
            return null;
        }
        SqlInventoryBInvCreateDto dto = new SqlInventoryBInvCreateDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlInventoryBInvCreateDto> mappingToDtoList(List<SqlInventoryBInvCreate> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlInventoryBInvCreateDto> dtoList = new ArrayList<SqlInventoryBInvCreateDto>();
        for (SqlInventoryBInvCreate entity : entityList) {
            SqlInventoryBInvCreateDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlInventoryBInvCreate mappingToEntity(SqlInventoryBInvCreateDto dto) {
        if (dto == null) {
            return null;
        }
        SqlInventoryBInvCreate entity = new SqlInventoryBInvCreate();
     ...
     */
    protected boolean needsMapping(SqlInventoryBInvCreateDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlInventoryBInvCreate> mappingToEntityList(List<SqlInventoryBInvCreateDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlInventoryBInvCreate> entityList = new ArrayList<SqlInventoryBInvCreate>();
        for (SqlInventoryBInvCreateDto dto : dtoList) {
            SqlInventoryBInvCreate entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlInventoryBInvCreateDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlInventoryBInvCreateDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlInventoryBInvCreateDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlInventoryBInvCreateDtoMapper reverseReference() {
