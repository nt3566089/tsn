...
/**
 * The DTO mapper of E_SHIP_INOUT_PLAN_SHIP as TABLE. <br>
 * 輸送受払計画受信テーブル(輸送)(国産)
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEShipInoutPlanShipDtoMapper implements DtoMapper<EShipInoutPlanShip, EShipInoutPlanShipDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEShipInoutPlanShipDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEShipInoutPlanShipDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EShipInoutPlanShipDto mappingToDto(EShipInoutPlanShip entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EShipInoutPlanShipDto dto = new EShipInoutPlanShipDto();
        dto.setShipInoutPlanShipId(entity.getShipInoutPlanShipId());
     ...
     * {@inheritDoc}
     */
    public List<EShipInoutPlanShipDto> mappingToDtoList(List<EShipInoutPlanShip> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EShipInoutPlanShipDto> dtoList = new ArrayList<EShipInoutPlanShipDto>();
        for (EShipInoutPlanShip entity : entityList) {
            EShipInoutPlanShipDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EShipInoutPlanShip mappingToEntity(EShipInoutPlanShipDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EShipInoutPlanShip entity = new EShipInoutPlanShip();
        if (needsMapping(dto, dto.getShipInoutPlanShipId(), "shipInoutPlanShipId")) {
            entity.setShipInoutPlanShipId(dto.getShipInoutPlanShipId());
        }
     ...
     */
    protected boolean needsMapping(EShipInoutPlanShipDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EShipInoutPlanShip> mappingToEntityList(List<EShipInoutPlanShipDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EShipInoutPlanShip> entityList = new ArrayList<EShipInoutPlanShip>();
        for (EShipInoutPlanShipDto dto : dtoList) {
            EShipInoutPlanShip entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EShipInoutPlanShipDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EShipInoutPlanShipDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EShipInoutPlanShipDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EShipInoutPlanShipDtoMapper reverseReference() {
