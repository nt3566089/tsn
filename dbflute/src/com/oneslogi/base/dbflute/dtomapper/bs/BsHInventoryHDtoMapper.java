...
/**
 * The DTO mapper of H_INVENTORY_H as TABLE. <br>
 * 棚卸ヘッダ履歴
 * <pre>
 * [primary-key]
 *     INVENTORY_H_ID
 ...
 */
public abstract class BsHInventoryHDtoMapper implements DtoMapper<HInventoryH, HInventoryHDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsHInventoryHDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsHInventoryHDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public HInventoryHDto mappingToDto(HInventoryH entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (HInventoryHDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        HInventoryHDto dto = new HInventoryHDto();
        ...
        if (!_suppressHInventoryBList && !entity.getHInventoryBList().isEmpty()) {
            ...
            if (reverseReference) {
                for (HInventoryBDto relationDto : relationDtoList) {
                    relationDto.setHInventoryH(dto);
                }
            }
        };
        return dto;
     ...
     * {@inheritDoc}
     */
    public List<HInventoryHDto> mappingToDtoList(List<HInventoryH> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<HInventoryHDto> dtoList = new ArrayList<HInventoryHDto>();
        for (HInventoryH entity : entityList) {
            HInventoryHDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public HInventoryH mappingToEntity(HInventoryHDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (HInventoryH)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        HInventoryH entity = new HInventoryH();
        ...
        if (!_suppressHInventoryBList && !dto.getHInventoryBList().isEmpty()) {
            ...
            if (reverseReference) {
                for (HInventoryB relationEntity : relationEntityList) {
                    relationEntity.setHInventoryH(entity);
                }
            }
        };
        return entity;
     ...
     */
    protected boolean needsMapping(HInventoryHDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<HInventoryH> mappingToEntityList(List<HInventoryHDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<HInventoryH> entityList = new ArrayList<HInventoryH>();
        for (HInventoryHDto dto : dtoList) {
            HInventoryH entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public HInventoryHDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (HInventoryHDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public HInventoryHDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public HInventoryHDtoMapper reverseReference() {
