...
/**
 * The DTO mapper of SqlTCcopamPrintData. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlTCcopamPrintDataDtoMapper implements DtoMapper<SqlTCcopamPrintData, SqlTCcopamPrintDataDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlTCcopamPrintDataDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlTCcopamPrintDataDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlTCcopamPrintDataDto mappingToDto(SqlTCcopamPrintData entity) {
        if (entity == null) {
            return null;
        }
        SqlTCcopamPrintDataDto dto = new SqlTCcopamPrintDataDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlTCcopamPrintDataDto> mappingToDtoList(List<SqlTCcopamPrintData> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlTCcopamPrintDataDto> dtoList = new ArrayList<SqlTCcopamPrintDataDto>();
        for (SqlTCcopamPrintData entity : entityList) {
            SqlTCcopamPrintDataDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlTCcopamPrintData mappingToEntity(SqlTCcopamPrintDataDto dto) {
        if (dto == null) {
            return null;
        }
        SqlTCcopamPrintData entity = new SqlTCcopamPrintData();
     ...
     */
    protected boolean needsMapping(SqlTCcopamPrintDataDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlTCcopamPrintData> mappingToEntityList(List<SqlTCcopamPrintDataDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlTCcopamPrintData> entityList = new ArrayList<SqlTCcopamPrintData>();
        for (SqlTCcopamPrintDataDto dto : dtoList) {
            SqlTCcopamPrintData entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlTCcopamPrintDataDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlTCcopamPrintDataDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlTCcopamPrintDataDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlTCcopamPrintDataDtoMapper reverseReference() {
