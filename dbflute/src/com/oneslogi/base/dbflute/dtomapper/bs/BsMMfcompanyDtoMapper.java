...
/**
 * The DTO mapper of M_MFCOMPANY as TABLE. <br>
 * 組織マスタ
 * <pre>
 * [primary-key]
 *     COMPANY_ID
 ...
 */
public abstract class BsMMfcompanyDtoMapper implements DtoMapper<MMfcompany, MMfcompanyDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMMfcompanyDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMMfcompanyDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MMfcompanyDto mappingToDto(MMfcompany entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MMfcompanyDto dto = new MMfcompanyDto();
        ...
        dto.setWarehouseFuncKbn(entity.getWarehouseFuncKbn());
     ...
     * {@inheritDoc}
     */
    public List<MMfcompanyDto> mappingToDtoList(List<MMfcompany> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MMfcompanyDto> dtoList = new ArrayList<MMfcompanyDto>();
        for (MMfcompany entity : entityList) {
            MMfcompanyDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MMfcompany mappingToEntity(MMfcompanyDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MMfcompany entity = new MMfcompany();
        if (needsMapping(dto, dto.getCompanyId(), "companyId")) {
        ...
        if (needsMapping(dto, dto.getWarehouseFuncKbn(), "warehouseFuncKbn")) {
            entity.setWarehouseFuncKbn(dto.getWarehouseFuncKbn());
        }
     ...
     */
    protected boolean needsMapping(MMfcompanyDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MMfcompany> mappingToEntityList(List<MMfcompanyDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MMfcompany> entityList = new ArrayList<MMfcompany>();
        for (MMfcompanyDto dto : dtoList) {
            MMfcompany entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MMfcompanyDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MMfcompanyDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MMfcompanyDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MMfcompanyDtoMapper reverseReference() {
