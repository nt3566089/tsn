...
/**
 * The DTO mapper of W_WKPALLETIZE as TABLE. <br>
 * パレタイズ検品ワーク
 * <pre>
 * [primary-key]
 *     SEQNO, SYMBOLNO
 ...
 */
public abstract class BsWWkpalletizeDtoMapper implements DtoMapper<WWkpalletize, WWkpalletizeDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWWkpalletizeDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWWkpalletizeDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WWkpalletizeDto mappingToDto(WWkpalletize entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WWkpalletizeDto dto = new WWkpalletizeDto();
     ...
     * {@inheritDoc}
     */
    public List<WWkpalletizeDto> mappingToDtoList(List<WWkpalletize> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WWkpalletizeDto> dtoList = new ArrayList<WWkpalletizeDto>();
        for (WWkpalletize entity : entityList) {
            WWkpalletizeDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WWkpalletize mappingToEntity(WWkpalletizeDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WWkpalletize entity = new WWkpalletize();
     ...
     */
    protected boolean needsMapping(WWkpalletizeDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WWkpalletize> mappingToEntityList(List<WWkpalletizeDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WWkpalletize> entityList = new ArrayList<WWkpalletize>();
        for (WWkpalletizeDto dto : dtoList) {
            WWkpalletize entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WWkpalletizeDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WWkpalletizeDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WWkpalletizeDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WWkpalletizeDtoMapper reverseReference() {
