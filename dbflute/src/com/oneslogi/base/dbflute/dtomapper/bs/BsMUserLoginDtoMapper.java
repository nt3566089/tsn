...
/**
 * The DTO mapper of M_USER_LOGIN as TABLE. <br>
 * ユーザログインマスタ
 * <pre>
 * [primary-key]
 *     USER_ID
 ...
 */
public abstract class BsMUserLoginDtoMapper implements DtoMapper<MUserLogin, MUserLoginDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMUserLoginDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMUserLoginDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MUserLoginDto mappingToDto(MUserLogin entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MUserLoginDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserLoginDto dto = new MUserLoginDto();
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getMUserLoginList().add(dto);
                }
            } else {
     ...
     * {@inheritDoc}
     */
    public List<MUserLoginDto> mappingToDtoList(List<MUserLogin> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MUserLoginDto> dtoList = new ArrayList<MUserLoginDto>();
        for (MUserLogin entity : entityList) {
            MUserLoginDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MUserLogin mappingToEntity(MUserLoginDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MUserLogin)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MUserLogin entity = new MUserLogin();
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getMUserLoginList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(MUserLoginDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MUserLogin> mappingToEntityList(List<MUserLoginDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MUserLogin> entityList = new ArrayList<MUserLogin>();
        for (MUserLoginDto dto : dtoList) {
            MUserLogin entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MUserLoginDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MUserLoginDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MUserLoginDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MUserLoginDtoMapper reverseReference() {
