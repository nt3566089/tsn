...
/**
 * The DTO mapper of W_WKSOCANCELPICK1 as TABLE. <br>
 * 棚出済リスト情報中間1
 * <pre>
 * [primary-key]
 *     
 ...
 */
public abstract class BsWWksocancelpick1DtoMapper implements DtoMapper<WWksocancelpick1, WWksocancelpick1Dto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWWksocancelpick1DtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWWksocancelpick1DtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WWksocancelpick1Dto mappingToDto(WWksocancelpick1 entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WWksocancelpick1Dto dto = new WWksocancelpick1Dto();
     ...
     * {@inheritDoc}
     */
    public List<WWksocancelpick1Dto> mappingToDtoList(List<WWksocancelpick1> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WWksocancelpick1Dto> dtoList = new ArrayList<WWksocancelpick1Dto>();
        for (WWksocancelpick1 entity : entityList) {
            WWksocancelpick1Dto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WWksocancelpick1 mappingToEntity(WWksocancelpick1Dto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WWksocancelpick1 entity = new WWksocancelpick1();
     ...
     */
    protected boolean needsMapping(WWksocancelpick1Dto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WWksocancelpick1> mappingToEntityList(List<WWksocancelpick1Dto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WWksocancelpick1> entityList = new ArrayList<WWksocancelpick1>();
        for (WWksocancelpick1Dto dto : dtoList) {
            WWksocancelpick1 entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WWksocancelpick1DtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WWksocancelpick1DtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WWksocancelpick1DtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WWksocancelpick1DtoMapper reverseReference() {
