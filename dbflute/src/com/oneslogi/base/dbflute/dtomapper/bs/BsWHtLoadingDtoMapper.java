...
/**
 * The DTO mapper of W_HT_LOADING as TABLE. <br>
 * 積込検品ワーク
 * <pre>
 * [primary-key]
 *     HT_LOADING_ID
 ...
 */
public abstract class BsWHtLoadingDtoMapper implements DtoMapper<WHtLoading, WHtLoadingDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtLoadingDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWHtLoadingDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WHtLoadingDto mappingToDto(WHtLoading entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (WHtLoadingDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtLoadingDto dto = new WHtLoadingDto();
        dto.setHtLoadingId(entity.getHtLoadingId());
     ...
     * {@inheritDoc}
     */
    public List<WHtLoadingDto> mappingToDtoList(List<WHtLoading> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WHtLoadingDto> dtoList = new ArrayList<WHtLoadingDto>();
        for (WHtLoading entity : entityList) {
            WHtLoadingDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WHtLoading mappingToEntity(WHtLoadingDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (WHtLoading)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtLoading entity = new WHtLoading();
        if (needsMapping(dto, dto.getHtLoadingId(), "htLoadingId")) {
            entity.setHtLoadingId(dto.getHtLoadingId());
        }
     ...
     */
    protected boolean needsMapping(WHtLoadingDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WHtLoading> mappingToEntityList(List<WHtLoadingDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WHtLoading> entityList = new ArrayList<WHtLoading>();
        for (WHtLoadingDto dto : dtoList) {
            WHtLoading entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WHtLoadingDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WHtLoadingDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WHtLoadingDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WHtLoadingDtoMapper reverseReference() {
