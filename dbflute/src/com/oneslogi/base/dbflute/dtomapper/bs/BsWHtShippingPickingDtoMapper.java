...
/**
 * The DTO mapper of W_HT_SHIPPING_PICKING as TABLE. <br>
 * 出荷ピッキングワーク
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsWHtShippingPickingDtoMapper implements DtoMapper<WHtShippingPicking, WHtShippingPickingDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsWHtShippingPickingDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsWHtShippingPickingDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public WHtShippingPickingDto mappingToDto(WHtShippingPicking entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (WHtShippingPickingDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtShippingPickingDto dto = new WHtShippingPickingDto();
        dto.setHtShippingPickingId(entity.getHtShippingPickingId());
        ...
        dto.setSkipNum(entity.getSkipNum());
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getWHtShippingPickingList().add(dto);
                }
            } else {
                ...
                mapper.suppressWHtShippingPickingList();
     ...
     * {@inheritDoc}
     */
    public List<WHtShippingPickingDto> mappingToDtoList(List<WHtShippingPicking> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<WHtShippingPickingDto> dtoList = new ArrayList<WHtShippingPickingDto>();
        for (WHtShippingPicking entity : entityList) {
            WHtShippingPickingDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public WHtShippingPicking mappingToEntity(WHtShippingPickingDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (WHtShippingPicking)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        WHtShippingPicking entity = new WHtShippingPicking();
        if (needsMapping(dto, dto.getHtShippingPickingId(), "htShippingPickingId")) {
            entity.setHtShippingPickingId(dto.getHtShippingPickingId());
        }
        ...
        if (needsMapping(dto, dto.getPickingFlg(), "pickingFlg")) {
            entity.setPickingFlg(dto.getPickingFlg());
        }
        if (needsMapping(dto, dto.getSkipNum(), "skipNum")) {
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getWHtShippingPickingList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(WHtShippingPickingDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<WHtShippingPicking> mappingToEntityList(List<WHtShippingPickingDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<WHtShippingPicking> entityList = new ArrayList<WHtShippingPicking>();
        for (WHtShippingPickingDto dto : dtoList) {
            WHtShippingPicking entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public WHtShippingPickingDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (WHtShippingPickingDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public WHtShippingPickingDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public WHtShippingPickingDtoMapper reverseReference() {
