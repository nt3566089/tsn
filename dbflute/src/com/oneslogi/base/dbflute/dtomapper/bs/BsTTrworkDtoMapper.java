...
/**
 * The DTO mapper of T_TRWORK as TABLE. <br>
 * 作業実績(基盤)
 * <pre>
 * [primary-key]
 *     SEQUENCENO
 ...
 */
public abstract class BsTTrworkDtoMapper implements DtoMapper<TTrwork, TTrworkDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrworkDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrworkDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrworkDto mappingToDto(TTrwork entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrworkDto dto = new TTrworkDto();
     ...
     * {@inheritDoc}
     */
    public List<TTrworkDto> mappingToDtoList(List<TTrwork> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrworkDto> dtoList = new ArrayList<TTrworkDto>();
        for (TTrwork entity : entityList) {
            TTrworkDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrwork mappingToEntity(TTrworkDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrwork entity = new TTrwork();
        ...
        if (needsMapping(dto, dto.getErrcd(), "errcd")) {
            entity.setErrcd(dto.getErrcd());
        }
     ...
     */
    protected boolean needsMapping(TTrworkDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrwork> mappingToEntityList(List<TTrworkDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrwork> entityList = new ArrayList<TTrwork>();
        for (TTrworkDto dto : dtoList) {
            TTrwork entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrworkDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrworkDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrworkDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrworkDtoMapper reverseReference() {
