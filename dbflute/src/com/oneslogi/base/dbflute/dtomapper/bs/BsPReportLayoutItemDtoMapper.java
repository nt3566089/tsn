...
/**
 * The DTO mapper of P_REPORT_LAYOUT_ITEM as TABLE. <br>
 * 帳票レイアウト項目マスタ
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsPReportLayoutItemDtoMapper implements DtoMapper<PReportLayoutItem, PReportLayoutItemDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsPReportLayoutItemDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsPReportLayoutItemDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public PReportLayoutItemDto mappingToDto(PReportLayoutItem entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (PReportLayoutItemDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        PReportLayoutItemDto dto = new PReportLayoutItemDto();
        dto.setReportLayoutItemId(entity.getReportLayoutItemId());
     ...
     * {@inheritDoc}
     */
    public List<PReportLayoutItemDto> mappingToDtoList(List<PReportLayoutItem> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<PReportLayoutItemDto> dtoList = new ArrayList<PReportLayoutItemDto>();
        for (PReportLayoutItem entity : entityList) {
            PReportLayoutItemDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public PReportLayoutItem mappingToEntity(PReportLayoutItemDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (PReportLayoutItem)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        PReportLayoutItem entity = new PReportLayoutItem();
        if (needsMapping(dto, dto.getReportLayoutItemId(), "reportLayoutItemId")) {
            entity.setReportLayoutItemId(dto.getReportLayoutItemId());
        }
     ...
     */
    protected boolean needsMapping(PReportLayoutItemDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<PReportLayoutItem> mappingToEntityList(List<PReportLayoutItemDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<PReportLayoutItem> entityList = new ArrayList<PReportLayoutItem>();
        for (PReportLayoutItemDto dto : dtoList) {
            PReportLayoutItem entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public PReportLayoutItemDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (PReportLayoutItemDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public PReportLayoutItemDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public PReportLayoutItemDtoMapper reverseReference() {
