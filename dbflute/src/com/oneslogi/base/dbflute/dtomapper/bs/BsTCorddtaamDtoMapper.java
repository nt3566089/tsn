...
/**
 * The DTO mapper of T_CORDDTAAM as TABLE. <br>
 * さしずデータ（実績）
 * <pre>
 * [primary-key]
 *     ORDER_RECORD_ID
 ...
 */
public abstract class BsTCorddtaamDtoMapper implements DtoMapper<TCorddtaam, TCorddtaamDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTCorddtaamDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTCorddtaamDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TCorddtaamDto mappingToDto(TCorddtaam entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TCorddtaamDto dto = new TCorddtaamDto();
        dto.setOrderRecordId(entity.getOrderRecordId());
     ...
     * {@inheritDoc}
     */
    public List<TCorddtaamDto> mappingToDtoList(List<TCorddtaam> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TCorddtaamDto> dtoList = new ArrayList<TCorddtaamDto>();
        for (TCorddtaam entity : entityList) {
            TCorddtaamDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TCorddtaam mappingToEntity(TCorddtaamDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TCorddtaam entity = new TCorddtaam();
        if (needsMapping(dto, dto.getOrderRecordId(), "orderRecordId")) {
            entity.setOrderRecordId(dto.getOrderRecordId());
        }
     ...
     */
    protected boolean needsMapping(TCorddtaamDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TCorddtaam> mappingToEntityList(List<TCorddtaamDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TCorddtaam> entityList = new ArrayList<TCorddtaam>();
        for (TCorddtaamDto dto : dtoList) {
            TCorddtaam entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TCorddtaamDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TCorddtaamDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TCorddtaamDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TCorddtaamDtoMapper reverseReference() {
