...
/**
 * The DTO mapper of SqlBondedShippingRelationListPrintGetId. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlBondedShippingRelationListPrintGetIdDtoMapper implements DtoMapper<SqlBondedShippingRelationListPrintGetId, SqlBondedShippingRelationListPrintGetIdDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlBondedShippingRelationListPrintGetIdDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlBondedShippingRelationListPrintGetIdDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlBondedShippingRelationListPrintGetIdDto mappingToDto(SqlBondedShippingRelationListPrintGetId entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        SqlBondedShippingRelationListPrintGetIdDto dto = new SqlBondedShippingRelationListPrintGetIdDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlBondedShippingRelationListPrintGetIdDto> mappingToDtoList(List<SqlBondedShippingRelationListPrintGetId> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlBondedShippingRelationListPrintGetIdDto> dtoList = new ArrayList<SqlBondedShippingRelationListPrintGetIdDto>();
        for (SqlBondedShippingRelationListPrintGetId entity : entityList) {
            SqlBondedShippingRelationListPrintGetIdDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlBondedShippingRelationListPrintGetId mappingToEntity(SqlBondedShippingRelationListPrintGetIdDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        SqlBondedShippingRelationListPrintGetId entity = new SqlBondedShippingRelationListPrintGetId();
     ...
     */
    protected boolean needsMapping(SqlBondedShippingRelationListPrintGetIdDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlBondedShippingRelationListPrintGetId> mappingToEntityList(List<SqlBondedShippingRelationListPrintGetIdDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlBondedShippingRelationListPrintGetId> entityList = new ArrayList<SqlBondedShippingRelationListPrintGetId>();
        for (SqlBondedShippingRelationListPrintGetIdDto dto : dtoList) {
            SqlBondedShippingRelationListPrintGetId entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlBondedShippingRelationListPrintGetIdDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlBondedShippingRelationListPrintGetIdDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlBondedShippingRelationListPrintGetIdDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlBondedShippingRelationListPrintGetIdDtoMapper reverseReference() {
