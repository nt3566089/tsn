...
/**
 * The DTO mapper of B_COL_ROLE as TABLE. <br>
 * 列権限マスタ
 * <pre>
 * [primary-key]
 *     COL_ROLE_ID
 ...
 */
public abstract class BsBColRoleDtoMapper implements DtoMapper<BColRole, BColRoleDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsBColRoleDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsBColRoleDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public BColRoleDto mappingToDto(BColRole entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (BColRoleDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        BColRoleDto dto = new BColRoleDto();
        dto.setColRoleId(entity.getColRoleId());
        ...
        if (!_suppressBCol && entity.getBCol() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getBColRoleList().add(dto);
                }
            } else {
     ...
     * {@inheritDoc}
     */
    public List<BColRoleDto> mappingToDtoList(List<BColRole> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<BColRoleDto> dtoList = new ArrayList<BColRoleDto>();
        for (BColRole entity : entityList) {
            BColRoleDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public BColRole mappingToEntity(BColRoleDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (BColRole)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        BColRole entity = new BColRole();
        if (needsMapping(dto, dto.getColRoleId(), "colRoleId")) {
            entity.setColRoleId(dto.getColRoleId());
        }
        ...
        if (!_suppressBCol && dto.getBCol() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getBColRoleList().add(entity);
                }
            } else {
                BColDtoMapper mapper = new BColDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(BColRoleDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<BColRole> mappingToEntityList(List<BColRoleDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<BColRole> entityList = new ArrayList<BColRole>();
        for (BColRoleDto dto : dtoList) {
            BColRole entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public BColRoleDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (BColRoleDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public BColRoleDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public BColRoleDtoMapper reverseReference() {
