...
/**
 * The DTO mapper of SqlSortingPlaceMasterListSrw. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlSortingPlaceMasterListSrwDtoMapper implements DtoMapper<SqlSortingPlaceMasterListSrw, SqlSortingPlaceMasterListSrwDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlSortingPlaceMasterListSrwDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlSortingPlaceMasterListSrwDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlSortingPlaceMasterListSrwDto mappingToDto(SqlSortingPlaceMasterListSrw entity) {
        if (entity == null) {
            return null;
        }
        SqlSortingPlaceMasterListSrwDto dto = new SqlSortingPlaceMasterListSrwDto();
     ...
     * {@inheritDoc}
     */
    public List<SqlSortingPlaceMasterListSrwDto> mappingToDtoList(List<SqlSortingPlaceMasterListSrw> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlSortingPlaceMasterListSrwDto> dtoList = new ArrayList<SqlSortingPlaceMasterListSrwDto>();
        for (SqlSortingPlaceMasterListSrw entity : entityList) {
            SqlSortingPlaceMasterListSrwDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlSortingPlaceMasterListSrw mappingToEntity(SqlSortingPlaceMasterListSrwDto dto) {
        if (dto == null) {
            return null;
        }
        SqlSortingPlaceMasterListSrw entity = new SqlSortingPlaceMasterListSrw();
     ...
     */
    protected boolean needsMapping(SqlSortingPlaceMasterListSrwDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlSortingPlaceMasterListSrw> mappingToEntityList(List<SqlSortingPlaceMasterListSrwDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlSortingPlaceMasterListSrw> entityList = new ArrayList<SqlSortingPlaceMasterListSrw>();
        for (SqlSortingPlaceMasterListSrwDto dto : dtoList) {
            SqlSortingPlaceMasterListSrw entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlSortingPlaceMasterListSrwDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlSortingPlaceMasterListSrwDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlSortingPlaceMasterListSrwDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlSortingPlaceMasterListSrwDtoMapper reverseReference() {
