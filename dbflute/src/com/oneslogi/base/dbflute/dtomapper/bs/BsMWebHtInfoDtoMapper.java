...
/**
 * The DTO mapper of M_WEB_HT_INFO as TABLE. <br>
 * ＷＥＢＳＤ管理マスタ
 * <pre>
 * [primary-key]
 *     WEB_HT_INFO_ID
 ...
 */
public abstract class BsMWebHtInfoDtoMapper implements DtoMapper<MWebHtInfo, MWebHtInfoDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMWebHtInfoDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMWebHtInfoDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MWebHtInfoDto mappingToDto(MWebHtInfo entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MWebHtInfoDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MWebHtInfoDto dto = new MWebHtInfoDto();
        dto.setWebHtInfoId(entity.getWebHtInfoId());
     ...
     * {@inheritDoc}
     */
    public List<MWebHtInfoDto> mappingToDtoList(List<MWebHtInfo> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MWebHtInfoDto> dtoList = new ArrayList<MWebHtInfoDto>();
        for (MWebHtInfo entity : entityList) {
            MWebHtInfoDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MWebHtInfo mappingToEntity(MWebHtInfoDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MWebHtInfo)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MWebHtInfo entity = new MWebHtInfo();
        if (needsMapping(dto, dto.getWebHtInfoId(), "webHtInfoId")) {
            entity.setWebHtInfoId(dto.getWebHtInfoId());
        }
     ...
     */
    protected boolean needsMapping(MWebHtInfoDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MWebHtInfo> mappingToEntityList(List<MWebHtInfoDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MWebHtInfo> entityList = new ArrayList<MWebHtInfo>();
        for (MWebHtInfoDto dto : dtoList) {
            MWebHtInfo entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MWebHtInfoDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MWebHtInfoDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MWebHtInfoDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MWebHtInfoDtoMapper reverseReference() {
