...
/**
 * The DTO mapper of M_TSN_PRODUCT as TABLE. <br>
 * TSN銘柄マスタ
 * <pre>
 * [primary-key]
 *     TSN_PRODUCT_ID
 ...
 */
public abstract class BsMTsnProductDtoMapper implements DtoMapper<MTsnProduct, MTsnProductDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMTsnProductDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMTsnProductDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MTsnProductDto mappingToDto(MTsnProduct entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MTsnProductDto dto = new MTsnProductDto();
     ...
     * {@inheritDoc}
     */
    public List<MTsnProductDto> mappingToDtoList(List<MTsnProduct> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MTsnProductDto> dtoList = new ArrayList<MTsnProductDto>();
        for (MTsnProduct entity : entityList) {
            MTsnProductDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MTsnProduct mappingToEntity(MTsnProductDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MTsnProduct entity = new MTsnProduct();
     ...
     */
    protected boolean needsMapping(MTsnProductDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MTsnProduct> mappingToEntityList(List<MTsnProductDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MTsnProduct> entityList = new ArrayList<MTsnProduct>();
        for (MTsnProductDto dto : dtoList) {
            MTsnProduct entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MTsnProductDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MTsnProductDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MTsnProductDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MTsnProductDtoMapper reverseReference() {
