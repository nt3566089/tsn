...
/**
 * The DTO mapper of E_NOTIFICATION_DOMESTIC as TABLE. <br>
 * 受入通知情報受信テーブル（国産）
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsENotificationDomesticDtoMapper implements DtoMapper<ENotificationDomestic, ENotificationDomesticDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsENotificationDomesticDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsENotificationDomesticDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ENotificationDomesticDto mappingToDto(ENotificationDomestic entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ENotificationDomesticDto dto = new ENotificationDomesticDto();
        dto.setNotificationDomesticId(entity.getNotificationDomesticId());
     ...
     * {@inheritDoc}
     */
    public List<ENotificationDomesticDto> mappingToDtoList(List<ENotificationDomestic> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ENotificationDomesticDto> dtoList = new ArrayList<ENotificationDomesticDto>();
        for (ENotificationDomestic entity : entityList) {
            ENotificationDomesticDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ENotificationDomestic mappingToEntity(ENotificationDomesticDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ENotificationDomestic entity = new ENotificationDomestic();
        if (needsMapping(dto, dto.getNotificationDomesticId(), "notificationDomesticId")) {
            entity.setNotificationDomesticId(dto.getNotificationDomesticId());
        }
     ...
     */
    protected boolean needsMapping(ENotificationDomesticDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ENotificationDomestic> mappingToEntityList(List<ENotificationDomesticDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ENotificationDomestic> entityList = new ArrayList<ENotificationDomestic>();
        for (ENotificationDomesticDto dto : dtoList) {
            ENotificationDomestic entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ENotificationDomesticDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ENotificationDomesticDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ENotificationDomesticDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ENotificationDomesticDtoMapper reverseReference() {
