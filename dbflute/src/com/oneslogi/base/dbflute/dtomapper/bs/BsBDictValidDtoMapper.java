...
/**
 * The DTO mapper of B_DICT_VALID as TABLE. <br>
 * 辞書検証マスタ
 * <pre>
 * [primary-key]
 *     DICT_ID
 ...
 */
public abstract class BsBDictValidDtoMapper implements DtoMapper<BDictValid, BDictValidDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsBDictValidDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsBDictValidDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public BDictValidDto mappingToDto(BDictValid entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (BDictValidDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        BDictValidDto dto = new BDictValidDto();
        ...
        if (!_suppressBDict && entity.getBDict() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.setBDictValidAsOne(dto);
                }
            } else {
                ...
                mapper.suppressBDictValidAsOne();
     ...
     * {@inheritDoc}
     */
    public List<BDictValidDto> mappingToDtoList(List<BDictValid> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<BDictValidDto> dtoList = new ArrayList<BDictValidDto>();
        for (BDictValid entity : entityList) {
            BDictValidDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public BDictValid mappingToEntity(BDictValidDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (BDictValid)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        BDictValid entity = new BDictValid();
        ...
        if (!_suppressBDict && dto.getBDict() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.setBDictValidAsOne(entity);
                }
            } else {
                BDictDtoMapper mapper = new BDictDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(BDictValidDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<BDictValid> mappingToEntityList(List<BDictValidDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<BDictValid> entityList = new ArrayList<BDictValid>();
        for (BDictValidDto dto : dtoList) {
            BDictValid entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public BDictValidDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (BDictValidDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public BDictValidDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public BDictValidDtoMapper reverseReference() {
