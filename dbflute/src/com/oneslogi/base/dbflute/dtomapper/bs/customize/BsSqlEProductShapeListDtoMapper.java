...
/**
 * The DTO mapper of SqlEProductShapeList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlEProductShapeListDtoMapper implements DtoMapper<SqlEProductShapeList, SqlEProductShapeListDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsSqlEProductShapeListDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsSqlEProductShapeListDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public SqlEProductShapeListDto mappingToDto(SqlEProductShapeList entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        SqlEProductShapeListDto dto = new SqlEProductShapeListDto();
        ...
        dto.setMsUnitNum(entity.getMsUnitNum());
     ...
     * {@inheritDoc}
     */
    public List<SqlEProductShapeListDto> mappingToDtoList(List<SqlEProductShapeList> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<SqlEProductShapeListDto> dtoList = new ArrayList<SqlEProductShapeListDto>();
        for (SqlEProductShapeList entity : entityList) {
            SqlEProductShapeListDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public SqlEProductShapeList mappingToEntity(SqlEProductShapeListDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        SqlEProductShapeList entity = new SqlEProductShapeList();
        ...
        if (needsMapping(dto, dto.getMsUnitNum(), "msUnitNum")) {
            entity.setMsUnitNum(dto.getMsUnitNum());
        }
     ...
     */
    protected boolean needsMapping(SqlEProductShapeListDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<SqlEProductShapeList> mappingToEntityList(List<SqlEProductShapeListDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<SqlEProductShapeList> entityList = new ArrayList<SqlEProductShapeList>();
        for (SqlEProductShapeListDto dto : dtoList) {
            SqlEProductShapeList entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public SqlEProductShapeListDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (SqlEProductShapeListDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public SqlEProductShapeListDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public SqlEProductShapeListDtoMapper reverseReference() {
