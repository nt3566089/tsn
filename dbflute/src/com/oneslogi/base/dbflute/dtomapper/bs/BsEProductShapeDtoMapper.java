...
/**
 * The DTO mapper of E_PRODUCT_SHAPE as TABLE. <br>
 * 商品荷姿マスタ受信
 * <pre>
 * [primary-key]
 *     PRODUCT_SHAPE_ID
 ...
 */
public abstract class BsEProductShapeDtoMapper implements DtoMapper<EProductShape, EProductShapeDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsEProductShapeDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsEProductShapeDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public EProductShapeDto mappingToDto(EProductShape entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EProductShapeDto dto = new EProductShapeDto();
     ...
     * {@inheritDoc}
     */
    public List<EProductShapeDto> mappingToDtoList(List<EProductShape> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<EProductShapeDto> dtoList = new ArrayList<EProductShapeDto>();
        for (EProductShape entity : entityList) {
            EProductShapeDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public EProductShape mappingToEntity(EProductShapeDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        EProductShape entity = new EProductShape();
     ...
     */
    protected boolean needsMapping(EProductShapeDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<EProductShape> mappingToEntityList(List<EProductShapeDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<EProductShape> entityList = new ArrayList<EProductShape>();
        for (EProductShapeDto dto : dtoList) {
            EProductShape entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public EProductShapeDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (EProductShapeDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public EProductShapeDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public EProductShapeDtoMapper reverseReference() {
