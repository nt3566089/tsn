...
/**
 * The DTO mapper of H_STOCK_REPORT as TABLE. <br>
 * 在庫日報履歴
 * <pre>
 * [primary-key]
 *     STOCK_REPORT_ID
 ...
 */
public abstract class BsHStockReportDtoMapper implements DtoMapper<HStockReport, HStockReportDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsHStockReportDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsHStockReportDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public HStockReportDto mappingToDto(HStockReport entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (HStockReportDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        HStockReportDto dto = new HStockReportDto();
        dto.setStockReportId(entity.getStockReportId());
        ...
        if (!_suppressHStock && entity.getHStock() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getHStockReportList().add(dto);
                }
            } else {
                ...
                mapper.suppressHStockReportList();
     ...
     * {@inheritDoc}
     */
    public List<HStockReportDto> mappingToDtoList(List<HStockReport> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<HStockReportDto> dtoList = new ArrayList<HStockReportDto>();
        for (HStockReport entity : entityList) {
            HStockReportDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public HStockReport mappingToEntity(HStockReportDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (HStockReport)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        HStockReport entity = new HStockReport();
        if (needsMapping(dto, dto.getStockReportId(), "stockReportId")) {
            entity.setStockReportId(dto.getStockReportId());
        }
        ...
        if (!_suppressHStock && dto.getHStock() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getHStockReportList().add(entity);
                }
            } else {
                HStockDtoMapper mapper = new HStockDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(HStockReportDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<HStockReport> mappingToEntityList(List<HStockReportDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<HStockReport> entityList = new ArrayList<HStockReport>();
        for (HStockReportDto dto : dtoList) {
            HStockReport entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public HStockReportDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (HStockReportDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public HStockReportDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public HStockReportDtoMapper reverseReference() {
