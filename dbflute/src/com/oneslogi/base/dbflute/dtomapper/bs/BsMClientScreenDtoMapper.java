...
/**
 * The DTO mapper of M_CLIENT_SCREEN as TABLE. <br>
 * 荷主画面マスタ
 * <pre>
 * [primary-key]
 *     CLIENT_SCREEN_ID
 ...
 */
public abstract class BsMClientScreenDtoMapper implements DtoMapper<MClientScreen, MClientScreenDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsMClientScreenDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsMClientScreenDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public MClientScreenDto mappingToDto(MClientScreen entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (MClientScreenDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MClientScreenDto dto = new MClientScreenDto();
        dto.setClientScreenId(entity.getClientScreenId());
     ...
     * {@inheritDoc}
     */
    public List<MClientScreenDto> mappingToDtoList(List<MClientScreen> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<MClientScreenDto> dtoList = new ArrayList<MClientScreenDto>();
        for (MClientScreen entity : entityList) {
            MClientScreenDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public MClientScreen mappingToEntity(MClientScreenDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (MClientScreen)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        MClientScreen entity = new MClientScreen();
        if (needsMapping(dto, dto.getClientScreenId(), "clientScreenId")) {
            entity.setClientScreenId(dto.getClientScreenId());
        }
     ...
     */
    protected boolean needsMapping(MClientScreenDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<MClientScreen> mappingToEntityList(List<MClientScreenDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<MClientScreen> entityList = new ArrayList<MClientScreen>();
        for (MClientScreenDto dto : dtoList) {
            MClientScreen entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public MClientScreenDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (MClientScreenDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public MClientScreenDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public MClientScreenDtoMapper reverseReference() {
