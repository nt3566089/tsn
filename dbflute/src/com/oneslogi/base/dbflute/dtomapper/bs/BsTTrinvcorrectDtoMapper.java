...
/**
 * The DTO mapper of T_TRINVCORRECT as TABLE. <br>
 * 在庫調査補正情報
 * <pre>
 * [primary-key]
 *     TRINVCORRECT_ID
 ...
 */
public abstract class BsTTrinvcorrectDtoMapper implements DtoMapper<TTrinvcorrect, TTrinvcorrectDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrinvcorrectDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrinvcorrectDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrinvcorrectDto mappingToDto(TTrinvcorrect entity) {
        if (entity == null) {
            return null;
        }
        ...
        if (cachedLocalDto != null) {
            return (TTrinvcorrectDto)cachedLocalDto;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrinvcorrectDto dto = new TTrinvcorrectDto();
        dto.setTrinvcorrectId(entity.getTrinvcorrectId());
        dto.setCaseinventoryno(entity.getCaseinventoryno());
        dto.setCorrectqty(entity.getCorrectqty());
        ...
        if (!_suppressMCenter && entity.getMCenter() != null) {
            ...
            if (cachedDto != null) {
                ...
                if (reverseReference) {
                    relationDto.getTTrinvcorrectList().add(dto);
                }
            } else {
                ...
                mapper.suppressTTrinvcorrectList();
     ...
     * {@inheritDoc}
     */
    public List<TTrinvcorrectDto> mappingToDtoList(List<TTrinvcorrect> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrinvcorrectDto> dtoList = new ArrayList<TTrinvcorrectDto>();
        for (TTrinvcorrect entity : entityList) {
            TTrinvcorrectDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrinvcorrect mappingToEntity(TTrinvcorrectDto dto) {
        if (dto == null) {
            return null;
        }
        boolean instanceCache = _instanceCache;
        ...
        if (cachedLocalEntity != null) {
            return (TTrinvcorrect)cachedLocalEntity;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrinvcorrect entity = new TTrinvcorrect();
        ...
        if (needsMapping(dto, dto.getCorrectqty(), "correctqty")) {
            entity.setCorrectqty(dto.getCorrectqty());
        }
        ...
        if (!_suppressMCenter && dto.getMCenter() != null) {
            ...
            if (cachedEntity != null) {
                ...
                if (reverseReference) {
                    relationEntity.getTTrinvcorrectList().add(entity);
                }
            } else {
                MCenterDtoMapper mapper = new MCenterDtoMapper(_relationDtoMap, _relationEntityMap);
                mapper.setExceptCommonColumn(exceptCommonColumn);
     ...
     */
    protected boolean needsMapping(TTrinvcorrectDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrinvcorrect> mappingToEntityList(List<TTrinvcorrectDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrinvcorrect> entityList = new ArrayList<TTrinvcorrect>();
        for (TTrinvcorrectDto dto : dtoList) {
            TTrinvcorrect entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrinvcorrectDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrinvcorrectDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrinvcorrectDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrinvcorrectDtoMapper reverseReference() {
