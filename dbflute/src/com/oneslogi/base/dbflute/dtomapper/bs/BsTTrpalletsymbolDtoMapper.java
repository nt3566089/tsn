...
/**
 * The DTO mapper of T_TRPALLETSYMBOL as TABLE. <br>
 * パレット内個体情報
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsTTrpalletsymbolDtoMapper implements DtoMapper<TTrpalletsymbol, TTrpalletsymbolDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsTTrpalletsymbolDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsTTrpalletsymbolDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public TTrpalletsymbolDto mappingToDto(TTrpalletsymbol entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrpalletsymbolDto dto = new TTrpalletsymbolDto();
        ...
        dto.setPalletsymbolprintflg(entity.getPalletsymbolprintflg());
     ...
     * {@inheritDoc}
     */
    public List<TTrpalletsymbolDto> mappingToDtoList(List<TTrpalletsymbol> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<TTrpalletsymbolDto> dtoList = new ArrayList<TTrpalletsymbolDto>();
        for (TTrpalletsymbol entity : entityList) {
            TTrpalletsymbolDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public TTrpalletsymbol mappingToEntity(TTrpalletsymbolDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        TTrpalletsymbol entity = new TTrpalletsymbol();
        ...
        if (needsMapping(dto, dto.getPalletsymbolprintflg(), "palletsymbolprintflg")) {
            entity.setPalletsymbolprintflg(dto.getPalletsymbolprintflg());
        }
     ...
     */
    protected boolean needsMapping(TTrpalletsymbolDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<TTrpalletsymbol> mappingToEntityList(List<TTrpalletsymbolDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<TTrpalletsymbol> entityList = new ArrayList<TTrpalletsymbol>();
        for (TTrpalletsymbolDto dto : dtoList) {
            TTrpalletsymbol entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public TTrpalletsymbolDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (TTrpalletsymbolDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public TTrpalletsymbolDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public TTrpalletsymbolDtoMapper reverseReference() {
