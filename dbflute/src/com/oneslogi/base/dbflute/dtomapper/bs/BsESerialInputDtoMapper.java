...
/**
 * The DTO mapper of E_SERIAL_INPUT as TABLE. <br>
 * シリアルNo.受信
 * <pre>
 * [primary-key]
 *     SERIAL_INPUT_ID
 ...
 */
public abstract class BsESerialInputDtoMapper implements DtoMapper<ESerialInput, ESerialInputDto>, Serializable {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public BsESerialInputDtoMapper() {
        _relationDtoMap = new HashMap<Entity, Object>();
        _relationEntityMap = new HashMap<Object, Entity>();
    }

    public BsESerialInputDtoMapper(Map<Entity, Object> relationDtoMap, Map<Object, Entity> relationEntityMap) {
     ...
     * {@inheritDoc}
     */
    public ESerialInputDto mappingToDto(ESerialInput entity) {
        if (entity == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ESerialInputDto dto = new ESerialInputDto();
     ...
     * {@inheritDoc}
     */
    public List<ESerialInputDto> mappingToDtoList(List<ESerialInput> entityList) {
        if (entityList == null) {
            throw new IllegalArgumentException("The argument 'entityList' should not be null.");
        }
        List<ESerialInputDto> dtoList = new ArrayList<ESerialInputDto>();
        for (ESerialInput entity : entityList) {
            ESerialInputDto dto = mappingToDto(entity);
            if (dto != null) {
                dtoList.add(dto);
            } else {
     ...
     * {@inheritDoc}
     */
    public ESerialInput mappingToEntity(ESerialInputDto dto) {
        if (dto == null) {
            return null;
        }
        boolean exceptCommonColumn = isExceptCommonColumn();
        ESerialInput entity = new ESerialInput();
     ...
     */
    protected boolean needsMapping(ESerialInputDto dto, Object value, String propName) {
     ...
     * {@inheritDoc}
     */
    public List<ESerialInput> mappingToEntityList(List<ESerialInputDto> dtoList) {
        if (dtoList == null) {
            throw new IllegalArgumentException("The argument 'dtoList' should not be null.");
        }
        List<ESerialInput> entityList = new ArrayList<ESerialInput>();
        for (ESerialInputDto dto : dtoList) {
            ESerialInput entity = mappingToEntity(dto);
            if (entity != null) {
     ...
     * @return this. (NotNull)
     */
    public ESerialInputDtoMapper baseOnlyMapping() {
        setBaseOnlyMapping(true);
        return (ESerialInputDtoMapper)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ESerialInputDtoMapper exceptCommonColumn() {
     ...
     * @return this. (NotNull)
     */
    public ESerialInputDtoMapper reverseReference() {
