...
/**
 * The entity of B_CLASS_GRP as TABLE. <br>
 * 区分値グループマスタ
 * <pre>
 * [primary-key]
 *     CLASS_GRP_ID
 ...
 */
public abstract class BsBClassGrp extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_classGrpId == null) { return false; }
    ...
    /**
     * [get] B_CLASS_GRP_DTL by CLASS_GRP_ID, named 'BClassGrpDtlList'.
    ...
    /**
     * [set] B_CLASS_GRP_DTL by CLASS_GRP_ID, named 'BClassGrpDtlList'.
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBClassGrp) {
            BsBClassGrp other = (BsBClassGrp)obj;
            if (!xSV(_classGrpId, other._classGrpId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    @Override
    public BClassGrp clone() {
        return (BClassGrp)super.clone();
    }
