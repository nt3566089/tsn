...
/**
 * The entity of B_COL_ROLE as TABLE. <br>
 * 列権限マスタ
 * <pre>
 * [primary-key]
 *     COL_ROLE_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long colRoleId = entity.getColRoleId();
 ...
 */
public abstract class BsBColRole extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_colRoleId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBColRole) {
            BsBColRole other = (BsBColRole)obj;
            if (!xSV(_colRoleId, other._colRoleId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_colRoleId));
    ...
    @Override
    public BColRole clone() {
        return (BColRole)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] COL_ROLE_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 列権限ID
     * @return The value of the column 'COL_ROLE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getColRoleId() {
        checkSpecifiedProperty("colRoleId");
        return _colRoleId;
    }

    /**
     * [set] COL_ROLE_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 列権限ID
     * @param colRoleId The value of the column 'COL_ROLE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setColRoleId(Long colRoleId) {
        registerModifiedProperty("colRoleId");
        _colRoleId = colRoleId;
    }
