...
/**
 * The DB meta of B_DICT_VALID. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class BDictValidDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final BDictValidDbm _instance = new BDictValidDbm();
    private BDictValidDbm() {}
    public static BDictValidDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((BDictValid)et).getDictId(), (et, vl) -> ((BDictValid)et).setDictId(ctl(vl)), "dictId");
        setupEpg(_epgMap, et -> ((BDictValid)et).getInputLimit(), (et, vl) -> ((BDictValid)et).setInputLimit((String)vl), "inputLimit");
        setupEpg(_epgMap, et -> ((BDictValid)et).getLimitMessageCd(), (et, vl) -> ((BDictValid)et).setLimitMessageCd((String)vl), "limitMessageCd");
        setupEpg(_epgMap, et -> ((BDictValid)et).getMinChars(), (et, vl) -> ((BDictValid)et).setMinChars(ctl(vl)), "minChars");
        setupEpg(_epgMap, et -> ((BDictValid)et).getMaxChars(), (et, vl) -> ((BDictValid)et).setMaxChars(ctl(vl)), "maxChars");
        setupEpg(_epgMap, et -> ((BDictValid)et).getMinNumber(), (et, vl) -> ((BDictValid)et).setMinNumber(ctb(vl)), "minNumber");
        setupEpg(_epgMap, et -> ((BDictValid)et).getMaxNumber(), (et, vl) -> ((BDictValid)et).setMaxNumber(ctb(vl)), "maxNumber");
        setupEpg(_epgMap, et -> ((BDictValid)et).getIntegerLength(), (et, vl) -> ((BDictValid)et).setIntegerLength(ctl(vl)), "integerLength");
        setupEpg(_epgMap, et -> ((BDictValid)et).getDecimalLength(), (et, vl) -> ((BDictValid)et).setDecimalLength(ctl(vl)), "decimalLength");
        setupEpg(_epgMap, et -> ((BDictValid)et).getDelFlg(), (et, vl) -> ((BDictValid)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((BDictValid)et).getVersionNo(), (et, vl) -> ((BDictValid)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((BDictValid)et).getControlNo(), (et, vl) -> ((BDictValid)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((BDictValid)et).getAddDt(), (et, vl) -> ((BDictValid)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((BDictValid)et).getAddUser(), (et, vl) -> ((BDictValid)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((BDictValid)et).getAddProcess(), (et, vl) -> ((BDictValid)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((BDictValid)et).getUpdDt(), (et, vl) -> ((BDictValid)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((BDictValid)et).getUpdUser(), (et, vl) -> ((BDictValid)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((BDictValid)et).getUpdProcess(), (et, vl) -> ((BDictValid)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    protected void xsetupEfpg() {
        setupEfpg(_efpgMap, et -> ((BDictValid)et).getBDict(), (et, vl) -> ((BDictValid)et).setBDict((BDict)vl), "BDict");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "B_DICT_VALID";
    protected final String _tableDispName = "B_DICT_VALID";
    protected final String _tablePropertyName = "BDictValid";
    protected final TableSqlName _tableSqlName = new TableSqlName("B_DICT_VALID", _tableDbName);
    ...
    public ForeignInfo foreignBDict() {
        ...
        return cfi("B_DICT_VALID_FK1", "BDict", this, BDictDbm.getInstance(), mp, 0, null, true, false, false, false, null, null, false, "BDictValidAsOne", false);
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.BDictValid"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.BDictValidCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.BDictValidBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<BDictValid> getEntityType() { return BDictValid.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public BDictValid newEntity() { return new BDictValid(); }
    ...
    { doAcceptPrimaryKeyMap((BDictValid)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((BDictValid)et, mp); }
