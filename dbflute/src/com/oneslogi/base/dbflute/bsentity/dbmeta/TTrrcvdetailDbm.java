...
/**
 * The DB meta of T_TRRCVDETAIL. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class TTrrcvdetailDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final TTrrcvdetailDbm _instance = new TTrrcvdetailDbm();
    private TTrrcvdetailDbm() {}
    public static TTrrcvdetailDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getReceivePlanBId(), (et, vl) -> ((TTrrcvdetail)et).setReceivePlanBId(ctl(vl)), "receivePlanBId");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getReceivePlanHId(), (et, vl) -> ((TTrrcvdetail)et).setReceivePlanHId(ctl(vl)), "receivePlanHId");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getRcvlineno(), (et, vl) -> ((TTrrcvdetail)et).setRcvlineno(ctl(vl)), "rcvlineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getSupplierrcvlineno(), (et, vl) -> ((TTrrcvdetail)et).setSupplierrcvlineno(ctl(vl)), "supplierrcvlineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getXdocflg(), (et, vl) -> ((TTrrcvdetail)et).setXdocflg(ctb(vl)), "xdocflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPokey(), (et, vl) -> ((TTrrcvdetail)et).setPokey(ctb(vl)), "pokey");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPolineno(), (et, vl) -> ((TTrrcvdetail)et).setPolineno(ctl(vl)), "polineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPotype(), (et, vl) -> ((TTrrcvdetail)et).setPotype((String)vl), "potype");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOwnerpolineno(), (et, vl) -> ((TTrrcvdetail)et).setOwnerpolineno(ctl(vl)), "ownerpolineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOriginalpono(), (et, vl) -> ((TTrrcvdetail)et).setOriginalpono((String)vl), "originalpono");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOriginalpolineno(), (et, vl) -> ((TTrrcvdetail)et).setOriginalpolineno(ctl(vl)), "originalpolineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPodate(), (et, vl) -> ((TTrrcvdetail)et).setPodate((String)vl), "podate");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOwnercd(), (et, vl) -> ((TTrrcvdetail)et).setOwnercd((String)vl), "ownercd");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getItemadmin(), (et, vl) -> ((TTrrcvdetail)et).setItemadmin((String)vl), "itemadmin");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getProductCd(), (et, vl) -> ((TTrrcvdetail)et).setProductCd((String)vl), "productCd");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getItemcd(), (et, vl) -> ((TTrrcvdetail)et).setItemcd((String)vl), "itemcd");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getIfitemcd(), (et, vl) -> ((TTrrcvdetail)et).setIfitemcd((String)vl), "ifitemcd");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLot1(), (et, vl) -> ((TTrrcvdetail)et).setLot1((String)vl), "lot1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLot2(), (et, vl) -> ((TTrrcvdetail)et).setLot2((String)vl), "lot2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLot3(), (et, vl) -> ((TTrrcvdetail)et).setLot3((String)vl), "lot3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLot4(), (et, vl) -> ((TTrrcvdetail)et).setLot4((String)vl), "lot4");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLot5(), (et, vl) -> ((TTrrcvdetail)et).setLot5((String)vl), "lot5");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOtherlot1(), (et, vl) -> ((TTrrcvdetail)et).setOtherlot1((String)vl), "otherlot1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOtherlot2(), (et, vl) -> ((TTrrcvdetail)et).setOtherlot2((String)vl), "otherlot2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOtherlot3(), (et, vl) -> ((TTrrcvdetail)et).setOtherlot3((String)vl), "otherlot3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOtherlot4(), (et, vl) -> ((TTrrcvdetail)et).setOtherlot4((String)vl), "otherlot4");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOtherlot5(), (et, vl) -> ((TTrrcvdetail)et).setOtherlot5(ctb(vl)), "otherlot5");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getDamageflg(), (et, vl) -> ((TTrrcvdetail)et).setDamageflg(ctb(vl)), "damageflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getNoshippingflg(), (et, vl) -> ((TTrrcvdetail)et).setNoshippingflg(ctb(vl)), "noshippingflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getForeigncargoflg(), (et, vl) -> ((TTrrcvdetail)et).setForeigncargoflg(ctb(vl)), "foreigncargoflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getCustomsreleaseflg(), (et, vl) -> ((TTrrcvdetail)et).setCustomsreleaseflg(ctb(vl)), "customsreleaseflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getTaxflg(), (et, vl) -> ((TTrrcvdetail)et).setTaxflg(ctb(vl)), "taxflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getExpectqty1(), (et, vl) -> ((TTrrcvdetail)et).setExpectqty1(ctb(vl)), "expectqty1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getExpectqty2(), (et, vl) -> ((TTrrcvdetail)et).setExpectqty2(ctl(vl)), "expectqty2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getExpectqty3(), (et, vl) -> ((TTrrcvdetail)et).setExpectqty3(ctl(vl)), "expectqty3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getReceivedqty1(), (et, vl) -> ((TTrrcvdetail)et).setReceivedqty1(ctb(vl)), "receivedqty1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getReceivedqty2(), (et, vl) -> ((TTrrcvdetail)et).setReceivedqty2(ctl(vl)), "receivedqty2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getReceivedqty3(), (et, vl) -> ((TTrrcvdetail)et).setReceivedqty3(ctl(vl)), "receivedqty3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAdjustqty1(), (et, vl) -> ((TTrrcvdetail)et).setAdjustqty1(ctb(vl)), "adjustqty1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAdjustqty2(), (et, vl) -> ((TTrrcvdetail)et).setAdjustqty2(ctl(vl)), "adjustqty2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAdjustqty3(), (et, vl) -> ((TTrrcvdetail)et).setAdjustqty3(ctl(vl)), "adjustqty3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getRcvtagqty1(), (et, vl) -> ((TTrrcvdetail)et).setRcvtagqty1(ctb(vl)), "rcvtagqty1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getXdocfreeqty1(), (et, vl) -> ((TTrrcvdetail)et).setXdocfreeqty1(ctb(vl)), "xdocfreeqty1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getInspectedqty1(), (et, vl) -> ((TTrrcvdetail)et).setInspectedqty1(ctb(vl)), "inspectedqty1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getInspectedqty2(), (et, vl) -> ((TTrrcvdetail)et).setInspectedqty2(ctl(vl)), "inspectedqty2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getInspectedqty3(), (et, vl) -> ((TTrrcvdetail)et).setInspectedqty3(ctl(vl)), "inspectedqty3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPriceBuy(), (et, vl) -> ((TTrrcvdetail)et).setPriceBuy(ctl(vl)), "priceBuy");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPriceWholesale(), (et, vl) -> ((TTrrcvdetail)et).setPriceWholesale(ctl(vl)), "priceWholesale");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getPriceSale(), (et, vl) -> ((TTrrcvdetail)et).setPriceSale(ctl(vl)), "priceSale");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getNotes(), (et, vl) -> ((TTrrcvdetail)et).setNotes((String)vl), "notes");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getIcdate(), (et, vl) -> ((TTrrcvdetail)et).setIcdate((String)vl), "icdate");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOrderkey(), (et, vl) -> ((TTrrcvdetail)et).setOrderkey(ctb(vl)), "orderkey");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOrderlineno(), (et, vl) -> ((TTrrcvdetail)et).setOrderlineno(ctl(vl)), "orderlineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOwnerorderno(), (et, vl) -> ((TTrrcvdetail)et).setOwnerorderno((String)vl), "ownerorderno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOwnerorderlineno(), (et, vl) -> ((TTrrcvdetail)et).setOwnerorderlineno(ctl(vl)), "ownerorderlineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getCustorderno(), (et, vl) -> ((TTrrcvdetail)et).setCustorderno((String)vl), "custorderno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getCustorderlineno(), (et, vl) -> ((TTrrcvdetail)et).setCustorderlineno(ctl(vl)), "custorderlineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getOrdertype(), (et, vl) -> ((TTrrcvdetail)et).setOrdertype((String)vl), "ordertype");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getRcvqtyerrorflg(), (et, vl) -> ((TTrrcvdetail)et).setRcvqtyerrorflg(ctb(vl)), "rcvqtyerrorflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLogicflg1(), (et, vl) -> ((TTrrcvdetail)et).setLogicflg1(ctb(vl)), "logicflg1");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLogicflg2(), (et, vl) -> ((TTrrcvdetail)et).setLogicflg2(ctb(vl)), "logicflg2");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getLogicflg3(), (et, vl) -> ((TTrrcvdetail)et).setLogicflg3(ctb(vl)), "logicflg3");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getMovelineno(), (et, vl) -> ((TTrrcvdetail)et).setMovelineno(ctl(vl)), "movelineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAssylineno(), (et, vl) -> ((TTrrcvdetail)et).setAssylineno(ctl(vl)), "assylineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getProducelineno(), (et, vl) -> ((TTrrcvdetail)et).setProducelineno(ctl(vl)), "producelineno");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getChecklastlotflg(), (et, vl) -> ((TTrrcvdetail)et).setChecklastlotflg(ctb(vl)), "checklastlotflg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getTrpalletId(), (et, vl) -> ((TTrrcvdetail)et).setTrpalletId(ctl(vl)), "trpalletId");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getDelFlg(), (et, vl) -> ((TTrrcvdetail)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getVersionNo(), (et, vl) -> ((TTrrcvdetail)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getControlNo(), (et, vl) -> ((TTrrcvdetail)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAddDt(), (et, vl) -> ((TTrrcvdetail)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAddUser(), (et, vl) -> ((TTrrcvdetail)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getAddProcess(), (et, vl) -> ((TTrrcvdetail)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getUpdDt(), (et, vl) -> ((TTrrcvdetail)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getUpdUser(), (et, vl) -> ((TTrrcvdetail)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((TTrrcvdetail)et).getUpdProcess(), (et, vl) -> ((TTrrcvdetail)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "T_TRRCVDETAIL";
    protected final String _tableDispName = "T_TRRCVDETAIL";
    protected final String _tablePropertyName = "TTrrcvdetail";
    protected final TableSqlName _tableSqlName = new TableSqlName("T_TRRCVDETAIL", _tableDbName);
    ...
    protected final ColumnInfo _columnReceivePlanHId = cci("RECEIVE_PLAN_H_ID", "RECEIVE_PLAN_H_ID", null, null, Long.class, "receivePlanHId", null, false, false, true, "bigint", 19, 0, null, null, false, null, null, "TTrrcv", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.TTrrcvdetail"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.TTrrcvdetailCB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.TTrrcvdetailBhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<TTrrcvdetail> getEntityType() { return TTrrcvdetail.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public TTrrcvdetail newEntity() { return new TTrrcvdetail(); }
    ...
    { doAcceptPrimaryKeyMap((TTrrcvdetail)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((TTrrcvdetail)et, mp); }
