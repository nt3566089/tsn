...
/**
 * The DB meta of W_WKSOCANCELPICK1. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class WWksocancelpick1Dbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final WWksocancelpick1Dbm _instance = new WWksocancelpick1Dbm();
    private WWksocancelpick1Dbm() {}
    public static WWksocancelpick1Dbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getPrintkey(), (et, vl) -> ((WWksocancelpick1)et).setPrintkey(ctl(vl)), "printkey");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getWarehousecd(), (et, vl) -> ((WWksocancelpick1)et).setWarehousecd((String)vl), "warehousecd");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getWarehouseSname(), (et, vl) -> ((WWksocancelpick1)et).setWarehouseSname((String)vl), "warehouseSname");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getPickeddate(), (et, vl) -> ((WWksocancelpick1)et).setPickeddate((String)vl), "pickeddate");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getWorkallocateid(), (et, vl) -> ((WWksocancelpick1)et).setWorkallocateid(ctb(vl)), "workallocateid");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getFloor(), (et, vl) -> ((WWksocancelpick1)et).setFloor((String)vl), "floor");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getLoccd(), (et, vl) -> ((WWksocancelpick1)et).setLoccd((String)vl), "loccd");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getProductCd(), (et, vl) -> ((WWksocancelpick1)et).setProductCd((String)vl), "productCd");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getItemSname(), (et, vl) -> ((WWksocancelpick1)et).setItemSname((String)vl), "itemSname");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getLot1(), (et, vl) -> ((WWksocancelpick1)et).setLot1((String)vl), "lot1");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getLot4(), (et, vl) -> ((WWksocancelpick1)et).setLot4((String)vl), "lot4");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getLot3(), (et, vl) -> ((WWksocancelpick1)et).setLot3((String)vl), "lot3");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getPickedqtyC(), (et, vl) -> ((WWksocancelpick1)et).setPickedqtyC(ctb(vl)), "pickedqtyC");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getPickedqtyP(), (et, vl) -> ((WWksocancelpick1)et).setPickedqtyP(ctb(vl)), "pickedqtyP");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getUsernum3(), (et, vl) -> ((WWksocancelpick1)et).setUsernum3(ctl(vl)), "usernum3");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getPrintpageno(), (et, vl) -> ((WWksocancelpick1)et).setPrintpageno(ctl(vl)), "printpageno");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getSeqsortkey(), (et, vl) -> ((WWksocancelpick1)et).setSeqsortkey(ctb(vl)), "seqsortkey");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getDelFlg(), (et, vl) -> ((WWksocancelpick1)et).setDelFlg((String)vl), "delFlg");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getVersionNo(), (et, vl) -> ((WWksocancelpick1)et).setVersionNo(ctl(vl)), "versionNo");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getControlNo(), (et, vl) -> ((WWksocancelpick1)et).setControlNo(ctl(vl)), "controlNo");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getAddDt(), (et, vl) -> ((WWksocancelpick1)et).setAddDt(cttp(vl)), "addDt");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getAddUser(), (et, vl) -> ((WWksocancelpick1)et).setAddUser((String)vl), "addUser");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getAddProcess(), (et, vl) -> ((WWksocancelpick1)et).setAddProcess((String)vl), "addProcess");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getUpdDt(), (et, vl) -> ((WWksocancelpick1)et).setUpdDt(cttp(vl)), "updDt");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getUpdUser(), (et, vl) -> ((WWksocancelpick1)et).setUpdUser((String)vl), "updUser");
        setupEpg(_epgMap, et -> ((WWksocancelpick1)et).getUpdProcess(), (et, vl) -> ((WWksocancelpick1)et).setUpdProcess((String)vl), "updProcess");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "W_WKSOCANCELPICK1";
    protected final String _tableDispName = "W_WKSOCANCELPICK1";
    protected final String _tablePropertyName = "WWksocancelpick1";
    protected final TableSqlName _tableSqlName = new TableSqlName("W_WKSOCANCELPICK1", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.WWksocancelpick1"; }
    public String getConditionBeanTypeName() { return "com.oneslogi.base.dbflute.cbean.WWksocancelpick1CB"; }
    public String getBehaviorTypeName() { return "com.oneslogi.base.dbflute.exbhv.WWksocancelpick1Bhv"; }

    // ===================================================================================
    //                                                                         Object Type
    //                                                                         ===========
    public Class<WWksocancelpick1> getEntityType() { return WWksocancelpick1.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public WWksocancelpick1 newEntity() { return new WWksocancelpick1(); }
    ...
    { doAcceptPrimaryKeyMap((WWksocancelpick1)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((WWksocancelpick1)et, mp); }
