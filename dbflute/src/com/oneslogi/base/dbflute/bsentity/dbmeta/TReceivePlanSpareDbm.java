...
public class TReceivePlanSpareDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnReceivePlanBId = cci("RECEIVE_PLAN_B_ID", "RECEIVE_PLAN_B_ID", null, null, Long.class, "receivePlanBId", null, true, true, true, "bigint identity", 19, 0, null, null, false, null, null, "TReceivePlanB", null, null, false);
