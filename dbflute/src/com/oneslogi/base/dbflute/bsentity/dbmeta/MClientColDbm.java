...
public class MClientColDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnClientColId = cci("CLIENT_COL_ID", "CLIENT_COL_ID", null, null, Long.class, "clientColId", null, true, true, true, "bigint identity", 19, 0, null, null, false, null, null, null, null, null, false);
    ...
    public ForeignInfo foreignBDict() {
        ...
        return cfi("M_CLIENT_COL_FK2", "BDict", this, BDictDbm.getInstance(), mp, 2, null, false, false, false, false, null, null, false, "MClientColList", false);
    }
    /**
