...
/**
 * The entity of B_COL_EXT_BASE as TABLE. <br>
 * 列マスタ拡張基本
 * <pre>
 * [primary-key]
 *     COL_EXT_BASE_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long colExtBaseId = entity.getColExtBaseId();
 ...
 * entity.setColExtBaseId(colExtBaseId);
 ...
 */
public abstract class BsBColExtBase extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_colExtBaseId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBColExtBase) {
            BsBColExtBase other = (BsBColExtBase)obj;
            if (!xSV(_colExtBaseId, other._colExtBaseId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_colExtBaseId));
    ...
    @Override
    public BColExtBase clone() {
        return (BColExtBase)super.clone();
    }
     ...
     * 列マスタ拡張基本
     * @return The value of the column 'COL_EXT_BASE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getColExtBaseId() {
        checkSpecifiedProperty("colExtBaseId");
     ...
     * 列マスタ拡張基本
     * @param colExtBaseId The value of the column 'COL_EXT_BASE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setColExtBaseId(Long colExtBaseId) {
        registerModifiedProperty("colExtBaseId");
        _colExtBaseId = colExtBaseId;
    }
