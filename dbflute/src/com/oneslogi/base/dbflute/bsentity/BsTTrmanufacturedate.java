...
/**
 * The entity of T_TRMANUFACTUREDATE as TABLE. <br>
 * 製造年月日
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trmanufacturedateId = entity.getTrmanufacturedateId();
 ...
 * entity.setTrmanufacturedateId(trmanufacturedateId);
 ...
 */
public abstract class BsTTrmanufacturedate extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _trmanufacturedateId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trmanufacturedateId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrmanufacturedate) {
            BsTTrmanufacturedate other = (BsTTrmanufacturedate)obj;
            if (!xSV(_trmanufacturedateId, other._trmanufacturedateId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _trmanufacturedateId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_trmanufacturedateId));
    ...
    @Override
    public TTrmanufacturedate clone() {
        return (TTrmanufacturedate)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] TRMANUFACTUREDATE_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 製造年月日ID
     * @return The value of the column 'TRMANUFACTUREDATE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrmanufacturedateId() {
        checkSpecifiedProperty("trmanufacturedateId");
        return _trmanufacturedateId;
    }

    /**
     * [set] TRMANUFACTUREDATE_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 製造年月日ID
     * @param trmanufacturedateId The value of the column 'TRMANUFACTUREDATE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrmanufacturedateId(Long trmanufacturedateId) {
        registerModifiedProperty("trmanufacturedateId");
        _trmanufacturedateId = trmanufacturedateId;
    }
