...
/**
 * The entity of T_TRALLINVHISTORY as TABLE. <br>
 * 統合在庫実績参照用
 * <pre>
 * [primary-key]
 *     TRALLINVHISTORY_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trallinvhistoryId = entity.getTrallinvhistoryId();
 ...
 * entity.setTrallinvhistoryId(trallinvhistoryId);
 ...
 */
public abstract class BsTTrallinvhistory extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _trallinvhistoryId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trallinvhistoryId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrallinvhistory) {
            BsTTrallinvhistory other = (BsTTrallinvhistory)obj;
            if (!xSV(_trallinvhistoryId, other._trallinvhistoryId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_trallinvhistoryId));
    ...
    @Override
    public TTrallinvhistory clone() {
        return (TTrallinvhistory)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] TRALLINVHISTORY_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 統合在庫実績参照用ID
     * @return The value of the column 'TRALLINVHISTORY_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrallinvhistoryId() {
        checkSpecifiedProperty("trallinvhistoryId");
        return _trallinvhistoryId;
    }

    /**
     * [set] TRALLINVHISTORY_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 統合在庫実績参照用ID
     * @param trallinvhistoryId The value of the column 'TRALLINVHISTORY_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrallinvhistoryId(Long trallinvhistoryId) {
        registerModifiedProperty("trallinvhistoryId");
        _trallinvhistoryId = trallinvhistoryId;
    }
