...
/**
 * The entity of E_SERIAL_INPUT as TABLE. <br>
 * シリアルNo.受信
 * <pre>
 * [primary-key]
 *     SERIAL_INPUT_ID
 ...
 */
public abstract class BsESerialInput extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_serialInputId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsESerialInput) {
            BsESerialInput other = (BsESerialInput)obj;
    ...
    @Override
    public ESerialInput clone() {
        return (ESerialInput)super.clone();
    }
     ...
     * シリアルNo.受信テーブルID
     * @return The value of the column 'SERIAL_INPUT_ID'. (basically NotNull if selected: for the constraint)
     */
     ...
     * シリアルNo.受信テーブルID
     * @param serialInputId The value of the column 'SERIAL_INPUT_ID'. (basically NotNull if update: for the constraint)
     */
