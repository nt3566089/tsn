...
/**
 * The entity of T_TRINVREQUEST as TABLE. <br>
 * 在庫照会要求情報
 * <pre>
 * [primary-key]
 *     TRINVREQUEST_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trinvrequestId = entity.getTrinvrequestId();
 * java.math.BigDecimal invinqkey = entity.getInvinqkey();
 * java.math.BigDecimal questlineno = entity.getQuestlineno();
 ...
 * entity.setTrinvrequestId(trinvrequestId);
 * entity.setInvinqkey(invinqkey);
 * entity.setQuestlineno(questlineno);
 ...
 */
public abstract class BsTTrinvrequest extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trinvrequestId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrinvrequest) {
            BsTTrinvrequest other = (BsTTrinvrequest)obj;
            if (!xSV(_trinvrequestId, other._trinvrequestId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_trinvrequestId));
        sb.append(dm).append(xfND(_invinqkey));
        sb.append(dm).append(xfND(_questlineno));
    ...
    @Override
    public TTrinvrequest clone() {
        return (TTrinvrequest)super.clone();
    }
     ...
     * 在庫照会要求情報ID
     * @return The value of the column 'TRINVREQUEST_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrinvrequestId() {
        checkSpecifiedProperty("trinvrequestId");
     ...
     * 在庫照会要求情報ID
     * @param trinvrequestId The value of the column 'TRINVREQUEST_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrinvrequestId(Long trinvrequestId) {
        registerModifiedProperty("trinvrequestId");
        _trinvrequestId = trinvrequestId;
    }

    /**
     * [get] INVINQKEY: {NotNull, decimal(16, 6)} <br>
     * 在庫照会キー
     * @return The value of the column 'INVINQKEY'. (basically NotNull if selected: for the constraint)
     */
    public java.math.BigDecimal getInvinqkey() {
        checkSpecifiedProperty("invinqkey");
        return _invinqkey;
    }
     ...
     * 在庫照会キー
     * @param invinqkey The value of the column 'INVINQKEY'. (basically NotNull if update: for the constraint)
     */
    public void setInvinqkey(java.math.BigDecimal invinqkey) {
        registerModifiedProperty("invinqkey");
        _invinqkey = invinqkey;
    }

    /**
     * [get] QUESTLINENO: {NotNull, decimal(16, 6)} <br>
     * 在庫照会要求行No.
     * @return The value of the column 'QUESTLINENO'. (basically NotNull if selected: for the constraint)
     */
    public java.math.BigDecimal getQuestlineno() {
        checkSpecifiedProperty("questlineno");
        return _questlineno;
    }
     ...
     * 在庫照会要求行No.
     * @param questlineno The value of the column 'QUESTLINENO'. (basically NotNull if update: for the constraint)
     */
    public void setQuestlineno(java.math.BigDecimal questlineno) {
        registerModifiedProperty("questlineno");
        _questlineno = questlineno;
    }

    /**
     * [get] INVINQNO: {varchar(30)} <br>
     * 在庫照会No.
     * @return The value of the column 'INVINQNO'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 在庫照会No.
     * @param invinqno The value of the column 'INVINQNO'. (NullAllowed: null update allowed for no constraint)
     */
     ...
     * 在庫照会日
     * @return The value of the column 'INVINQDATE'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 在庫照会日
     * @param invinqdate The value of the column 'INVINQDATE'. (NullAllowed: null update allowed for no constraint)
     */
