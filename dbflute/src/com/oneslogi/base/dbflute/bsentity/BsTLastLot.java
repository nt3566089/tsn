...
/**
 * The entity of T_LAST_LOT as TABLE. <br>
 * 最終ロット管理
 * <pre>
 * [primary-key]
 *     LAST_LOT_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long lastLotId = entity.getLastLotId();
 ...
 */
public abstract class BsTLastLot extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_lastLotId == null) { return false; }
     ...
     */
    public void uniqueBy(Long customerId, Long productId) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTLastLot) {
            BsTLastLot other = (BsTLastLot)obj;
            if (!xSV(_lastLotId, other._lastLotId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_lastLotId));
    ...
    @Override
    public TLastLot clone() {
        return (TLastLot)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 最終ロットID
     * @return The value of the column 'LAST_LOT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getLastLotId() {
        checkSpecifiedProperty("lastLotId");
        return _lastLotId;
    }

    /**
     * [set] LAST_LOT_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 最終ロットID
     * @param lastLotId The value of the column 'LAST_LOT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setLastLotId(Long lastLotId) {
        registerModifiedProperty("lastLotId");
        _lastLotId = lastLotId;
    }
