...
/**
 * The entity of T_TRSORTDETAIL as TABLE. <br>
 * 仕分明細
 * <pre>
 * [primary-key]
 ...
 * String sortusercd = entity.getSortusercd();
 ...
 * entity.setSortusercd(sortusercd);
 ...
 */
public abstract class BsTTrsortdetail extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_sortusercd));
    ...
    @Override
    public TTrsortdetail clone() {
        return (TTrsortdetail)super.clone();
    }
     ...
     * 仕分担当者
     * @return The value of the column 'SORTUSERCD'. (NullAllowed even if selected: for no constraint)
     */
    public String getSortusercd() {
        checkSpecifiedProperty("sortusercd");
        return convertEmptyToNull(_sortusercd);
    }

    /**
     * [set] SORTUSERCD: {varchar(30)} <br>
     * 仕分担当者
     * @param sortusercd The value of the column 'SORTUSERCD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSortusercd(String sortusercd) {
        registerModifiedProperty("sortusercd");
        _sortusercd = sortusercd;
    }
