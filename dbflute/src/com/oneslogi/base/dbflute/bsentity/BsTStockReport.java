...
/**
 * The entity of T_STOCK_REPORT as TABLE. <br>
 * 在庫日報
 * <pre>
 * [primary-key]
 *     STOCK_ID
 ...
 * String lastreceivedate = entity.getLastreceivedate();
 * String lastshipdate = entity.getLastshipdate();
 ...
 * entity.setLastreceivedate(lastreceivedate);
 * entity.setLastshipdate(lastshipdate);
 ...
 */
public abstract class BsTStockReport extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTStockReport) {
            BsTStockReport other = (BsTStockReport)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_lastreceivedate));
        sb.append(dm).append(xfND(_lastshipdate));
    ...
    @Override
    public TStockReport clone() {
        return (TStockReport)super.clone();
    }
     ...
     * 最終入荷日
     * @return The value of the column 'LASTRECEIVEDATE'. (NullAllowed even if selected: for no constraint)
     */
    public String getLastreceivedate() {
        checkSpecifiedProperty("lastreceivedate");
        return convertEmptyToNull(_lastreceivedate);
    }

    /**
     * [set] LASTRECEIVEDATE: {varchar(8)} <br>
     * 最終入荷日
     * @param lastreceivedate The value of the column 'LASTRECEIVEDATE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setLastreceivedate(String lastreceivedate) {
        registerModifiedProperty("lastreceivedate");
     ...
     * 最終出荷日
     * @return The value of the column 'LASTSHIPDATE'. (NullAllowed even if selected: for no constraint)
     */
    public String getLastshipdate() {
        checkSpecifiedProperty("lastshipdate");
        return convertEmptyToNull(_lastshipdate);
    }

    /**
     * [set] LASTSHIPDATE: {varchar(8)} <br>
     * 最終出荷日
     * @param lastshipdate The value of the column 'LASTSHIPDATE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setLastshipdate(String lastshipdate) {
        registerModifiedProperty("lastshipdate");
        _lastshipdate = lastshipdate;
    }
