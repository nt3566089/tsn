...
/**
 * The entity of T_TRWORK as TABLE. <br>
 * 作業実績(基盤)
 * <pre>
 * [primary-key]
 *     SEQUENCENO
 ...
 * java.sql.Timestamp worktime = entity.getWorktime();
 ...
 */
public abstract class BsTTrwork extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_sequenceno == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrwork) {
            BsTTrwork other = (BsTTrwork)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_errcd));
    ...
    @Override
    public TTrwork clone() {
        return (TTrwork)super.clone();
    }
     ...
     * 作業実績ID
     * @return The value of the column 'SEQUENCENO'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 作業実績ID
     * @param sequenceno The value of the column 'SEQUENCENO'. (basically NotNull if update: for the constraint)
     */
     ...
     * ユーザCD
     * @return The value of the column 'USERCD'. (basically NotNull if selected: for the constraint)
     */
     ...
     * ユーザCD
     * @param usercd The value of the column 'USERCD'. (basically NotNull if update: for the constraint)
     */
     ...
     * エラーCD
     * @return The value of the column 'ERRCD'. (NullAllowed even if selected: for no constraint)
     */
    public String getErrcd() {
        checkSpecifiedProperty("errcd");
        return convertEmptyToNull(_errcd);
    }

    /**
     * [set] ERRCD: {varchar(30)} <br>
     * エラーCD
     * @param errcd The value of the column 'ERRCD'. (NullAllowed: null update allowed for no constraint)
     */
    public void setErrcd(String errcd) {
        registerModifiedProperty("errcd");
        _errcd = errcd;
    }
