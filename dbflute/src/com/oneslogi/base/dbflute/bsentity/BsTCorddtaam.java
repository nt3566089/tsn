...
/**
 * The entity of T_CORDDTAAM as TABLE. <br>
 * さしずデータ（実績）
 * <pre>
 * [primary-key]
 *     ORDER_RECORD_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long orderRecordId = entity.getOrderRecordId();
 ...
 * Long srdlvdtlsnm = entity.getSrdlvdtlsnm();
 ...
 */
public abstract class BsTCorddtaam extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_orderRecordId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTCorddtaam) {
            BsTCorddtaam other = (BsTCorddtaam)obj;
            if (!xSV(_orderRecordId, other._orderRecordId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_orderRecordId));
    ...
    @Override
    public TCorddtaam clone() {
        return (TCorddtaam)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] ORDER_RECORD_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * さしずデータ(実績)ID
     * @return The value of the column 'ORDER_RECORD_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getOrderRecordId() {
        checkSpecifiedProperty("orderRecordId");
        return _orderRecordId;
    }

    /**
     * [set] ORDER_RECORD_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * さしずデータ(実績)ID
     * @param orderRecordId The value of the column 'ORDER_RECORD_ID'. (basically NotNull if update: for the constraint)
     */
    public void setOrderRecordId(Long orderRecordId) {
        registerModifiedProperty("orderRecordId");
        _orderRecordId = orderRecordId;
    }

    /**
     * [get] ORDER_H_ID: {NotNull, bigint(19)} <br>
     * さしずヘッダID
    ...
    /**
     * [set] ORDER_H_ID: {NotNull, bigint(19)} <br>
     * さしずヘッダID
