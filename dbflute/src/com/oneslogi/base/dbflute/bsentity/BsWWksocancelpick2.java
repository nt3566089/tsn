...
/**
 * The entity of W_WKSOCANCELPICK2 as TABLE. <br>
 * 棚出済リスト情報中間2
 * <pre>
 * [primary-key]
 *     
 ...
 * java.math.BigDecimal pickedqtyB = entity.getPickedqtyB();
 * java.math.BigDecimal pickedqtyP = entity.getPickedqtyP();
 * java.math.BigDecimal pickedqtyC2 = entity.getPickedqtyC2();
 ...
 * entity.setPickedqtyB(pickedqtyB);
 * entity.setPickedqtyP(pickedqtyP);
 * entity.setPickedqtyC2(pickedqtyC2);
 ...
 */
public abstract class BsWWksocancelpick2 extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWWksocancelpick2) {
            BsWWksocancelpick2 other = (BsWWksocancelpick2)obj;
            ...
            if (!xSV(_pickedqtyB, other._pickedqtyB)) { return false; }
            if (!xSV(_pickedqtyP, other._pickedqtyP)) { return false; }
            if (!xSV(_pickedqtyC2, other._pickedqtyC2)) { return false; }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _pickedqtyB);
        hs = xCH(hs, _pickedqtyP);
        hs = xCH(hs, _pickedqtyC2);
        hs = xCH(hs, _usernum3);
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_pickedqtyB));
        sb.append(dm).append(xfND(_pickedqtyP));
        sb.append(dm).append(xfND(_pickedqtyC2));
    ...
    @Override
    public WWksocancelpick2 clone() {
        return (WWksocancelpick2)super.clone();
    }
    ...
    /**
     * [get] PICKEDQTY_B: {decimal(16, 6)} <br>
     * 棚出済数量（カートン）
     * @return The value of the column 'PICKEDQTY_B'. (NullAllowed even if selected: for no constraint)
     */
    public java.math.BigDecimal getPickedqtyB() {
        checkSpecifiedProperty("pickedqtyB");
        return _pickedqtyB;
    }

    /**
     * [set] PICKEDQTY_B: {decimal(16, 6)} <br>
     * 棚出済数量（カートン）
     * @param pickedqtyB The value of the column 'PICKEDQTY_B'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPickedqtyB(java.math.BigDecimal pickedqtyB) {
        registerModifiedProperty("pickedqtyB");
        _pickedqtyB = pickedqtyB;
    }
    ...
    /**
     * [get] PICKEDQTY_C2: {decimal(16, 6)} <br>
     * 棚出済数量（ケース2）
     * @return The value of the column 'PICKEDQTY_C2'. (NullAllowed even if selected: for no constraint)
     */
    public java.math.BigDecimal getPickedqtyC2() {
        checkSpecifiedProperty("pickedqtyC2");
        return _pickedqtyC2;
    }

    /**
     * [set] PICKEDQTY_C2: {decimal(16, 6)} <br>
     * 棚出済数量（ケース2）
     * @param pickedqtyC2 The value of the column 'PICKEDQTY_C2'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPickedqtyC2(java.math.BigDecimal pickedqtyC2) {
        registerModifiedProperty("pickedqtyC2");
        _pickedqtyC2 = pickedqtyC2;
    }
