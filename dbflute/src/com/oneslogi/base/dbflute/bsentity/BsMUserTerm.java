...
/**
 * The entity of M_USER_TERM as TABLE. <br>
 * ユーザマスタ適用期間
 * <pre>
 * [primary-key]
 *     COMMON_AUTH_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long commonAuthId = entity.getCommonAuthId();
 ...
 */
public abstract class BsMUserTerm extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_commonAuthId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMUserTerm) {
            BsMUserTerm other = (BsMUserTerm)obj;
            if (!xSV(_commonAuthId, other._commonAuthId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    @Override
    public MUserTerm clone() {
        return (MUserTerm)super.clone();
    }
     ...
     * 共通認証ID
     * @return The value of the column 'COMMON_AUTH_ID'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 共通認証ID
     * @param commonAuthId The value of the column 'COMMON_AUTH_ID'. (basically NotNull if update: for the constraint)
     */
     ...
     * 業務システムコード
     * @return The value of the column 'BIZ_SYSTEM_CD'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 業務システムコード
     * @param bizSystemCd The value of the column 'BIZ_SYSTEM_CD'. (basically NotNull if update: for the constraint)
     */
     ...
     * ユーザロールコード
     * @return The value of the column 'USER_ROLE_CD'. (basically NotNull if selected: for the constraint)
     */
     ...
     * ユーザロールコード
     * @param userRoleCd The value of the column 'USER_ROLE_CD'. (basically NotNull if update: for the constraint)
     */
     ...
     * 有効開始年月日
     * @return The value of the column 'VALID_FRDATEH'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 有効開始年月日
     * @param validFrdateh The value of the column 'VALID_FRDATEH'. (basically NotNull if update: for the constraint)
     */
     ...
     * 有効終了年月日
     * @return The value of the column 'VALID_TODATEH'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 有効終了年月日
     * @param validTodateh The value of the column 'VALID_TODATEH'. (basically NotNull if update: for the constraint)
     */
