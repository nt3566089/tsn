...
/**
 * The entity of T_TRPALLETSYMBOLJT as TABLE. <br>
 * パレット内個体情報（国免）
 * <pre>
 * [primary-key]
 ...
 * java.math.BigDecimal sojtid = entity.getSojtid();
 ...
 */
public abstract class BsTTrpalletsymboljt extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrpalletsymboljt) {
            BsTTrpalletsymboljt other = (BsTTrpalletsymboljt)obj;
    ...
    @Override
    public TTrpalletsymboljt clone() {
        return (TTrpalletsymboljt)super.clone();
    }
     ...
     * 出庫指図ID
     * @return The value of the column 'SOJTID'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 出庫指図ID
     * @param sojtid The value of the column 'SOJTID'. (NullAllowed: null update allowed for no constraint)
     */
     ...
     * 出荷指図明細ID
     * @return The value of the column 'SOJTLINENO'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 出荷指図明細ID
     * @param sojtlineno The value of the column 'SOJTLINENO'. (NullAllowed: null update allowed for no constraint)
     */
