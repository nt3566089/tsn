...
/**
 * The entity of B_ITEM_VALID as TABLE. <br>
 * 項目検証マスタ
 * <pre>
 * [primary-key]
 *     ITEM_ID
 ...
 */
public abstract class BsBItemValid extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBItemValid) {
            BsBItemValid other = (BsBItemValid)obj;
    ...
    @Override
    public BItemValid clone() {
        return (BItemValid)super.clone();
    }
