...
/**
 * The entity of E_SHIP_INOUT_PLAN_SHIP as TABLE. <br>
 * 輸送受払計画受信テーブル(輸送)(国産)
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long shipInoutPlanShipId = entity.getShipInoutPlanShipId();
 ...
 * entity.setShipInoutPlanShipId(shipInoutPlanShipId);
 ...
 */
public abstract class BsEShipInoutPlanShip extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_shipInoutPlanShipId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEShipInoutPlanShip) {
            BsEShipInoutPlanShip other = (BsEShipInoutPlanShip)obj;
            if (!xSV(_shipInoutPlanShipId, other._shipInoutPlanShipId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _shipInoutPlanShipId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_shipInoutPlanShipId));
    ...
    @Override
    public EShipInoutPlanShip clone() {
        return (EShipInoutPlanShip)super.clone();
    }
     ...
     * 輸送受払計画受信(輸送)(国産)ID
     * @return The value of the column 'SHIP_INOUT_PLAN_SHIP_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getShipInoutPlanShipId() {
        checkSpecifiedProperty("shipInoutPlanShipId");
     ...
     * 輸送受払計画受信(輸送)(国産)ID
     * @param shipInoutPlanShipId The value of the column 'SHIP_INOUT_PLAN_SHIP_ID'. (basically NotNull if update: for the constraint)
     */
    public void setShipInoutPlanShipId(Long shipInoutPlanShipId) {
        registerModifiedProperty("shipInoutPlanShipId");
        _shipInoutPlanShipId = shipInoutPlanShipId;
    }
