...
/**
 * The entity of E_SORTING_STOCK as TABLE. <br>
 * 仕分在庫実績受信テーブル
 * <pre>
 * [primary-key]
 *     SORTING_STOCK_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long sortingStockId = entity.getSortingStockId();
 ...
 * entity.setSortingStockId(sortingStockId);
 ...
 */
public abstract class BsESortingStock extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _sortingStockId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_sortingStockId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsESortingStock) {
            BsESortingStock other = (BsESortingStock)obj;
            if (!xSV(_sortingStockId, other._sortingStockId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_sortingStockId));
    ...
    @Override
    public ESortingStock clone() {
        return (ESortingStock)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] SORTING_STOCK_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 仕分在庫実績受信ID
     * @return The value of the column 'SORTING_STOCK_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getSortingStockId() {
        checkSpecifiedProperty("sortingStockId");
        return _sortingStockId;
    }

    /**
     * [set] SORTING_STOCK_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 仕分在庫実績受信ID
     * @param sortingStockId The value of the column 'SORTING_STOCK_ID'. (basically NotNull if update: for the constraint)
     */
    public void setSortingStockId(Long sortingStockId) {
        registerModifiedProperty("sortingStockId");
        _sortingStockId = sortingStockId;
    }
