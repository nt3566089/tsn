...
/**
 * The entity of P_REPORT as TABLE. <br>
 * 帳票マスタ
 * <pre>
 * [primary-key]
 *     REPORT_ID
 ...
 */
public abstract class BsPReport extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
     ...
     */
    public void uniqueBy(String reportCd) {
        __uniqueDrivenProperties.clear();
        __uniqueDrivenProperties.addPropertyName("reportCd");
    ...
    protected List<PReportLayout> _pReportLayoutList;

    /**
     * [get] P_REPORT_LAYOUT by REPORT_ID, named 'PReportLayoutList'.
     * @return The entity list of referrer property 'PReportLayoutList'. (NotNull: even if no loading, returns empty list)
     */
    public List<PReportLayout> getPReportLayoutList() {
        if (_pReportLayoutList == null) { _pReportLayoutList = newReferrerList(); }
        return _pReportLayoutList;
    }

    /**
     * [set] P_REPORT_LAYOUT by REPORT_ID, named 'PReportLayoutList'.
     * @param pReportLayoutList The entity list of referrer property 'PReportLayoutList'. (NullAllowed)
     */
    public void setPReportLayoutList(List<PReportLayout> pReportLayoutList) {
        _pReportLayoutList = pReportLayoutList;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPReport) {
            BsPReport other = (BsPReport)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_pReportLayoutList != null) { for (PReportLayout et : _pReportLayoutList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "pReportLayoutList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildRelationString(String dm) {
        StringBuilder sb = new StringBuilder();
        if (_pReportLayoutList != null && !_pReportLayoutList.isEmpty())
        { sb.append(dm).append("pReportLayoutList"); }
        if (sb.length() > dm.length()) {
    ...
    @Override
    public PReport clone() {
        return (PReport)super.clone();
    }
