...
/**
 * The entity of T_TRFLEXIBILACCEPTPLAN as TABLE. <br>
 * 融通輸送受払計画情報
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trflexibilacceptplanId = entity.getTrflexibilacceptplanId();
 ...
 * entity.setTrflexibilacceptplanId(trflexibilacceptplanId);
 ...
 */
public abstract class BsTTrflexibilacceptplan extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trflexibilacceptplanId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrflexibilacceptplan) {
            BsTTrflexibilacceptplan other = (BsTTrflexibilacceptplan)obj;
            if (!xSV(_trflexibilacceptplanId, other._trflexibilacceptplanId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _trflexibilacceptplanId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_trflexibilacceptplanId));
    ...
    @Override
    public TTrflexibilacceptplan clone() {
        return (TTrflexibilacceptplan)super.clone();
    }
     ...
     * 融通輸送受払計画情報ID
     * @return The value of the column 'TRFLEXIBILACCEPTPLAN_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrflexibilacceptplanId() {
        checkSpecifiedProperty("trflexibilacceptplanId");
     ...
     * 融通輸送受払計画情報ID
     * @param trflexibilacceptplanId The value of the column 'TRFLEXIBILACCEPTPLAN_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrflexibilacceptplanId(Long trflexibilacceptplanId) {
        registerModifiedProperty("trflexibilacceptplanId");
        _trflexibilacceptplanId = trflexibilacceptplanId;
    }
