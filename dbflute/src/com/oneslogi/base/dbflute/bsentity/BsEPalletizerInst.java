...
/**
 * The entity of E_PALLETIZER_INST as TABLE. <br>
 * パレタイザー投入実績受信テーブル
 * <pre>
 * [primary-key]
 *     PALLETIZER_INST_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long palletizerInstId = entity.getPalletizerInstId();
 ...
 * String printMachineNumber = entity.getPrintMachineNumber();
 * String createno = entity.getCreateno();
 * String custorderlineno = entity.getCustorderlineno();
 * String palletizeStartFlg = entity.getPalletizeStartFlg();
 ...
 * entity.setPalletizerInstId(palletizerInstId);
 ...
 * entity.setPrintMachineNumber(printMachineNumber);
 * entity.setCreateno(createno);
 * entity.setCustorderlineno(custorderlineno);
 * entity.setPalletizeStartFlg(palletizeStartFlg);
 ...
 */
public abstract class BsEPalletizerInst extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _palletizerInstId;
    ...
    protected String _printMachineNumber;

    /** CREATENO: {varchar(255)} */
    protected String _createno;

    /** CUSTORDERLINENO: {varchar(255)} */
    protected String _custorderlineno;

    /** PALLETIZE_START_FLG: {varchar(255)} */
    protected String _palletizeStartFlg;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_palletizerInstId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEPalletizerInst) {
            BsEPalletizerInst other = (BsEPalletizerInst)obj;
            if (!xSV(_palletizerInstId, other._palletizerInstId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_palletizerInstId));
        ...
        sb.append(dm).append(xfND(_printMachineNumber));
        sb.append(dm).append(xfND(_createno));
        sb.append(dm).append(xfND(_custorderlineno));
        sb.append(dm).append(xfND(_palletizeStartFlg));
    ...
    @Override
    public EPalletizerInst clone() {
        return (EPalletizerInst)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] PALLETIZER_INST_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * パレタイザー投入実績受信ID
     * @return The value of the column 'PALLETIZER_INST_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getPalletizerInstId() {
        checkSpecifiedProperty("palletizerInstId");
        return _palletizerInstId;
    }

    /**
     * [set] PALLETIZER_INST_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * パレタイザー投入実績受信ID
     * @param palletizerInstId The value of the column 'PALLETIZER_INST_ID'. (basically NotNull if update: for the constraint)
     */
    public void setPalletizerInstId(Long palletizerInstId) {
        registerModifiedProperty("palletizerInstId");
        _palletizerInstId = palletizerInstId;
    }
    ...
    /**
     * [get] PRINT_MACHINE_NUMBER: {varchar(255)} <br>
     * 印刷機番号
     * @return The value of the column 'PRINT_MACHINE_NUMBER'. (NullAllowed even if selected: for no constraint)
     */
    public String getPrintMachineNumber() {
        checkSpecifiedProperty("printMachineNumber");
        return convertEmptyToNull(_printMachineNumber);
    }

    /**
     * [set] PRINT_MACHINE_NUMBER: {varchar(255)} <br>
     * 印刷機番号
     * @param printMachineNumber The value of the column 'PRINT_MACHINE_NUMBER'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPrintMachineNumber(String printMachineNumber) {
        registerModifiedProperty("printMachineNumber");
        _printMachineNumber = printMachineNumber;
    }
    ...
    /**
     * [get] CUSTORDERLINENO: {varchar(255)} <br>
     * ロットエンドフラグ
    ...
    public String getCustorderlineno() {
        ...
        return convertEmptyToNull(_custorderlineno);
    }

    /**
     * [set] CUSTORDERLINENO: {varchar(255)} <br>
     * ロットエンドフラグ
    ...
    /**
     * [get] PALLETIZE_START_FLG: {varchar(255)} <br>
     * パレタイズ開始フラグ
     * @return The value of the column 'PALLETIZE_START_FLG'. (NullAllowed even if selected: for no constraint)
     */
    public String getPalletizeStartFlg() {
        checkSpecifiedProperty("palletizeStartFlg");
        return convertEmptyToNull(_palletizeStartFlg);
    }

    /**
     * [set] PALLETIZE_START_FLG: {varchar(255)} <br>
     * パレタイズ開始フラグ
     * @param palletizeStartFlg The value of the column 'PALLETIZE_START_FLG'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPalletizeStartFlg(String palletizeStartFlg) {
        registerModifiedProperty("palletizeStartFlg");
        _palletizeStartFlg = palletizeStartFlg;
    }
