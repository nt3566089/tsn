...
/**
 * The entity of M_CLIENT_ITEM as TABLE. <br>
 * 荷主項目マスタ
 * <pre>
 * [primary-key]
 *     CLIENT_ITEM_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long clientItemId = entity.getClientItemId();
 ...
 * entity.setClientItemId(clientItemId);
 ...
 */
public abstract class BsMClientItem extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_clientItemId == null) { return false; }
     ...
     */
    public void uniqueBy(Long clientId, Long itemId, Long dictId) {
        ...
        setClientId(clientId);setItemId(itemId);setDictId(dictId);
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMClientItem) {
            BsMClientItem other = (BsMClientItem)obj;
            if (!xSV(_clientItemId, other._clientItemId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_clientItemId));
    ...
    @Override
    public MClientItem clone() {
        return (MClientItem)super.clone();
    }
     ...
     * 荷主項目ID
     * @return The value of the column 'CLIENT_ITEM_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getClientItemId() {
        checkSpecifiedProperty("clientItemId");
     ...
     * 荷主項目ID
     * @param clientItemId The value of the column 'CLIENT_ITEM_ID'. (basically NotNull if update: for the constraint)
     */
    public void setClientItemId(Long clientItemId) {
        registerModifiedProperty("clientItemId");
