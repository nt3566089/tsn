...
/**
 * The entity of T_ALLOC_LOT as TABLE. <br>
 * 引当ロット管理
 * <pre>
 * [primary-key]
 *     ALLOC_INST_B_ID
 ...
 */
public abstract class BsTAllocLot extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTAllocLot) {
            BsTAllocLot other = (BsTAllocLot)obj;
    ...
    @Override
    public TAllocLot clone() {
        return (TAllocLot)super.clone();
    }
