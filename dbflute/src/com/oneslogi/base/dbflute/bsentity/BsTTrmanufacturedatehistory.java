...
/**
 * The entity of T_TRMANUFACTUREDATEHISTORY as TABLE. <br>
 * 製造年月日履歴
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trmanufacturedatehistoryId = entity.getTrmanufacturedatehistoryId();
 ...
 * entity.setTrmanufacturedatehistoryId(trmanufacturedatehistoryId);
 ...
 */
public abstract class BsTTrmanufacturedatehistory extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trmanufacturedatehistoryId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrmanufacturedatehistory) {
            BsTTrmanufacturedatehistory other = (BsTTrmanufacturedatehistory)obj;
            if (!xSV(_trmanufacturedatehistoryId, other._trmanufacturedatehistoryId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _trmanufacturedatehistoryId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_trmanufacturedatehistoryId));
    ...
    @Override
    public TTrmanufacturedatehistory clone() {
        return (TTrmanufacturedatehistory)super.clone();
    }
     ...
     * 製造年月日履歴ID
     * @return The value of the column 'TRMANUFACTUREDATEHISTORY_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrmanufacturedatehistoryId() {
        checkSpecifiedProperty("trmanufacturedatehistoryId");
     ...
     * 製造年月日履歴ID
     * @param trmanufacturedatehistoryId The value of the column 'TRMANUFACTUREDATEHISTORY_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrmanufacturedatehistoryId(Long trmanufacturedatehistoryId) {
        registerModifiedProperty("trmanufacturedatehistoryId");
        _trmanufacturedatehistoryId = trmanufacturedatehistoryId;
    }
