...
/**
 * The entity of E_STOCK_INQUIRY_REQUEST as TABLE. <br>
 * 在庫照会要求受信テーブル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long stockInquiryRequestId = entity.getStockInquiryRequestId();
 ...
 * entity.setStockInquiryRequestId(stockInquiryRequestId);
 ...
 */
public abstract class BsEStockInquiryRequest extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_stockInquiryRequestId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEStockInquiryRequest) {
            BsEStockInquiryRequest other = (BsEStockInquiryRequest)obj;
            if (!xSV(_stockInquiryRequestId, other._stockInquiryRequestId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _stockInquiryRequestId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_stockInquiryRequestId));
    ...
    @Override
    public EStockInquiryRequest clone() {
        return (EStockInquiryRequest)super.clone();
    }
     ...
     * 在庫照会要求受信ID
     * @return The value of the column 'STOCK_INQUIRY_REQUEST_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getStockInquiryRequestId() {
        checkSpecifiedProperty("stockInquiryRequestId");
     ...
     * 在庫照会要求受信ID
     * @param stockInquiryRequestId The value of the column 'STOCK_INQUIRY_REQUEST_ID'. (basically NotNull if update: for the constraint)
     */
    public void setStockInquiryRequestId(Long stockInquiryRequestId) {
        registerModifiedProperty("stockInquiryRequestId");
        _stockInquiryRequestId = stockInquiryRequestId;
    }
     ...
     * 在庫照会No
     * @return The value of the column 'INV_INQ_NO'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 在庫照会No
     * @param invInqNo The value of the column 'INV_INQ_NO'. (NullAllowed: null update allowed for no constraint)
     */
     ...
     * 在庫照会日
     * @return The value of the column 'INV_INQ_DATE'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 在庫照会日
     * @param invInqDate The value of the column 'INV_INQ_DATE'. (NullAllowed: null update allowed for no constraint)
     */
