...
/**
 * The entity of H_SHIPPING_SPARE as TABLE. <br>
 * 出荷予備履歴
 * <pre>
 * [primary-key]
 *     SHIPPING_INST_B_ID
 ...
 */
public abstract class BsHShippingSpare extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsHShippingSpare) {
            BsHShippingSpare other = (BsHShippingSpare)obj;
    ...
    @Override
    public HShippingSpare clone() {
        return (HShippingSpare)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] SHIPPING_INST_B_ID: {PK, ID, NotNull, bigint identity(19), FK to H_SHIPPING_B} <br>
     * 出荷指示ボディID
    ...
    /**
     * [set] SHIPPING_INST_B_ID: {PK, ID, NotNull, bigint identity(19), FK to H_SHIPPING_B} <br>
     * 出荷指示ボディID
