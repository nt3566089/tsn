...
/**
 * The entity of M_CENTER_SCREEN as TABLE. <br>
 * 拠点画面マスタ
 * <pre>
 * [primary-key]
 *     CENTER_SCREEN_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long centerScreenId = entity.getCenterScreenId();
 ...
 * entity.setCenterScreenId(centerScreenId);
 ...
 */
public abstract class BsMCenterScreen extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _centerScreenId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_centerScreenId == null) { return false; }
     ...
     */
    public void uniqueBy(Long centerId, Long screenId, Long dictId) {
        ...
        setCenterId(centerId);setScreenId(screenId);setDictId(dictId);
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMCenterScreen) {
            BsMCenterScreen other = (BsMCenterScreen)obj;
            if (!xSV(_centerScreenId, other._centerScreenId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_centerScreenId));
    ...
    @Override
    public MCenterScreen clone() {
        return (MCenterScreen)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 拠点画面ID
     * @return The value of the column 'CENTER_SCREEN_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getCenterScreenId() {
        checkSpecifiedProperty("centerScreenId");
        return _centerScreenId;
    }

    /**
     * [set] CENTER_SCREEN_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 拠点画面ID
     * @param centerScreenId The value of the column 'CENTER_SCREEN_ID'. (basically NotNull if update: for the constraint)
     */
    public void setCenterScreenId(Long centerScreenId) {
        registerModifiedProperty("centerScreenId");
        _centerScreenId = centerScreenId;
    }
