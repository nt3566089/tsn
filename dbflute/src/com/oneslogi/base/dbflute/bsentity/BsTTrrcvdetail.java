...
/**
 * The entity of T_TRRCVDETAIL as TABLE. <br>
 * 入庫予定明細
 * <pre>
 * [primary-key]
 *     RECEIVE_PLAN_B_ID
 ...
 */
public abstract class BsTTrrcvdetail extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrrcvdetail) {
            BsTTrrcvdetail other = (BsTTrrcvdetail)obj;
    ...
    @Override
    public TTrrcvdetail clone() {
        return (TTrrcvdetail)super.clone();
    }
