...
/**
 * The entity of T_TRINVREANSWER as TABLE. <br>
 * 在庫照会回答情報
 * <pre>
 * [primary-key]
 *     TRINVREANSWER_ID
 ...
 * java.math.BigDecimal answerlineno = entity.getAnswerlineno();
 ...
 * entity.setAnswerlineno(answerlineno);
 ...
 */
public abstract class BsTTrinvreanswer extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected java.math.BigDecimal _answerlineno;
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrinvreanswer) {
            BsTTrinvreanswer other = (BsTTrinvreanswer)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_answerlineno));
    ...
    @Override
    public TTrinvreanswer clone() {
        return (TTrinvreanswer)super.clone();
    }
    ...
    /**
     * [get] ANSWERLINENO: {NotNull, decimal(16, 6)} <br>
     * 在庫照会回答行No.
     * @return The value of the column 'ANSWERLINENO'. (basically NotNull if selected: for the constraint)
     */
    public java.math.BigDecimal getAnswerlineno() {
        checkSpecifiedProperty("answerlineno");
        return _answerlineno;
    }

    /**
     * [set] ANSWERLINENO: {NotNull, decimal(16, 6)} <br>
     * 在庫照会回答行No.
     * @param answerlineno The value of the column 'ANSWERLINENO'. (basically NotNull if update: for the constraint)
     */
    public void setAnswerlineno(java.math.BigDecimal answerlineno) {
        registerModifiedProperty("answerlineno");
        _answerlineno = answerlineno;
    }
    ...
    /**
     * [get] GETDATE: {varchar(8)} <br>
     * データ取得日時
     * @return The value of the column 'GETDATE'. (NullAllowed even if selected: for no constraint)
     */
    ...
    /**
     * [set] GETDATE: {varchar(8)} <br>
     * データ取得日時
     * @param getdate The value of the column 'GETDATE'. (NullAllowed: null update allowed for no constraint)
     */
