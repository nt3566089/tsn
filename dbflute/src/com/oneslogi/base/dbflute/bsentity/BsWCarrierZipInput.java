...
/**
 * The entity of W_CARRIER_ZIP_INPUT as TABLE. <br>
 * 運送業者郵便番号マスタ取込ワーク
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long carrierZipInputId = entity.getCarrierZipInputId();
 ...
 * entity.setCarrierZipInputId(carrierZipInputId);
 ...
 */
public abstract class BsWCarrierZipInput extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_carrierZipInputId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWCarrierZipInput) {
            BsWCarrierZipInput other = (BsWCarrierZipInput)obj;
            if (!xSV(_carrierZipInputId, other._carrierZipInputId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_carrierZipInputId));
    ...
    @Override
    public WCarrierZipInput clone() {
        return (WCarrierZipInput)super.clone();
    }
     ...
     * 運送業者郵便番号マスタ取込ワークID
     * @return The value of the column 'CARRIER_ZIP_INPUT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getCarrierZipInputId() {
        checkSpecifiedProperty("carrierZipInputId");
     ...
     * 運送業者郵便番号マスタ取込ワークID
     * @param carrierZipInputId The value of the column 'CARRIER_ZIP_INPUT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setCarrierZipInputId(Long carrierZipInputId) {
        registerModifiedProperty("carrierZipInputId");
        _carrierZipInputId = carrierZipInputId;
    }
