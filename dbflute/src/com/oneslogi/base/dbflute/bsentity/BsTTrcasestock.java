...
/**
 * The entity of T_TRCASESTOCK as TABLE. <br>
 * ケース補充情報
 * <pre>
 * [primary-key]
 *     TRCASESTOCK_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trcasestockId = entity.getTrcasestockId();
 ...
 * java.math.BigDecimal assortedindex = entity.getAssortedindex();
 * java.math.BigDecimal pulltype = entity.getPulltype();
 ...
 * entity.setTrcasestockId(trcasestockId);
 ...
 */
public abstract class BsTTrcasestock extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trcasestockId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrcasestock) {
            BsTTrcasestock other = (BsTTrcasestock)obj;
            if (!xSV(_trcasestockId, other._trcasestockId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_trcasestockId));
        ...
        sb.append(dm).append(xfND(_pulltype));
    ...
    @Override
    public TTrcasestock clone() {
        return (TTrcasestock)super.clone();
    }
     ...
     * ケース補充情報ID
     * @return The value of the column 'TRCASESTOCK_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrcasestockId() {
        checkSpecifiedProperty("trcasestockId");
     ...
     * ケース補充情報ID
     * @param trcasestockId The value of the column 'TRCASESTOCK_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrcasestockId(Long trcasestockId) {
        registerModifiedProperty("trcasestockId");
        _trcasestockId = trcasestockId;
    }
     ...
     * 出庫区分
     * @return The value of the column 'PULLTYPE'. (basically NotNull if selected: for the constraint)
     */
    public java.math.BigDecimal getPulltype() {
        checkSpecifiedProperty("pulltype");
        return _pulltype;
    }
     ...
     * 出庫区分
     * @param pulltype The value of the column 'PULLTYPE'. (basically NotNull if update: for the constraint)
     */
    public void setPulltype(java.math.BigDecimal pulltype) {
        registerModifiedProperty("pulltype");
        _pulltype = pulltype;
    }
