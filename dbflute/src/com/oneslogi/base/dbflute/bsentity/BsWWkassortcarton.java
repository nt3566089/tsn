...
/**
 * The entity of W_WKASSORTCARTON as TABLE. <br>
 * カートン詰合せワーク
 * <pre>
 * [primary-key]
 *     SEQNO, SYMBOLNO
 ...
 * java.math.BigDecimal moveqty = entity.getMoveqty();
 * java.math.BigDecimal moveqtybowl = entity.getMoveqtybowl();
 * java.math.BigDecimal tosymbolno = entity.getTosymbolno();
 ...
 * entity.setMoveqty(moveqty);
 * entity.setMoveqtybowl(moveqtybowl);
 * entity.setTosymbolno(tosymbolno);
 ...
 */
public abstract class BsWWkassortcarton extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWWkassortcarton) {
            BsWWkassortcarton other = (BsWWkassortcarton)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_moveqty));
        sb.append(dm).append(xfND(_moveqtybowl));
        sb.append(dm).append(xfND(_tosymbolno));
    ...
    @Override
    public WWkassortcarton clone() {
        return (WWkassortcarton)super.clone();
    }
     ...
     * 移動数量（カートン）
     * @return The value of the column 'MOVEQTY'. (basically NotNull if selected: for the constraint)
     */
    public java.math.BigDecimal getMoveqty() {
        checkSpecifiedProperty("moveqty");
        return _moveqty;
    }
     ...
     * 移動数量（カートン）
     * @param moveqty The value of the column 'MOVEQTY'. (basically NotNull if update: for the constraint)
     */
    public void setMoveqty(java.math.BigDecimal moveqty) {
        registerModifiedProperty("moveqty");
        _moveqty = moveqty;
    }
     ...
     * 詰合せ先シンボル管理番号
     * @return The value of the column 'TOSYMBOLNO'. (basically NotNull if selected: for the constraint)
     */
    public java.math.BigDecimal getTosymbolno() {
        checkSpecifiedProperty("tosymbolno");
        return _tosymbolno;
    }
     ...
     * 詰合せ先シンボル管理番号
     * @param tosymbolno The value of the column 'TOSYMBOLNO'. (basically NotNull if update: for the constraint)
     */
    public void setTosymbolno(java.math.BigDecimal tosymbolno) {
        registerModifiedProperty("tosymbolno");
        _tosymbolno = tosymbolno;
    }
