...
/**
 * The entity of M_HT_DICT as TABLE. <br>
 * SD辞書マスタ
 * <pre>
 * [primary-key]
 *     DICT_ID
 ...
 */
public abstract class BsMHtDict extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMHtDict) {
            BsMHtDict other = (BsMHtDict)obj;
    ...
    @Override
    public MHtDict clone() {
        return (MHtDict)super.clone();
    }
