...
/**
 * The entity of M_PRODUCT_TERM as TABLE. <br>
 * 銘柄マスタ適用期間
 * <pre>
 * [primary-key]
 *     PRODUCT_ID
 ...
 */
public abstract class BsMProductTerm extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMProductTerm) {
            BsMProductTerm other = (BsMProductTerm)obj;
    ...
    @Override
    public MProductTerm clone() {
        return (MProductTerm)super.clone();
    }
