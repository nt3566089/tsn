...
public abstract class BsBClassDtl extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected BClassDtlSub _bClassDtlSubAsOne;

    /**
     * [get] B_CLASS_DTL_SUB by CLASS_DTL_ID, named 'BClassDtlSubAsOne'.
     * @return the entity of foreign property(referrer-as-one) 'BClassDtlSubAsOne'. (NullAllowed: when e.g. no data, no setupSelect)
     */
    public BClassDtlSub getBClassDtlSubAsOne() {
        return _bClassDtlSubAsOne;
    }

    /**
     * [set] B_CLASS_DTL_SUB by CLASS_DTL_ID, named 'BClassDtlSubAsOne'.
     * @param BClassDtlSubAsOne The entity of foreign property(referrer-as-one) 'BClassDtlSubAsOne'. (NullAllowed)
     */
    public void setBClassDtlSubAsOne(BClassDtlSub BClassDtlSubAsOne) {
        _bClassDtlSubAsOne = BClassDtlSubAsOne;
    }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        { sb.append(li).append(xbRDS(_bClassDtlSubAsOne, "bClassDtlSubAsOne")); }
    ...
    protected String doBuildRelationString(String dm) {
        ...
        if (_bClassDtlSubAsOne != null)
        { sb.append(dm).append("bClassDtlSubAsOne"); }
