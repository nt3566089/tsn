...
/**
 * The entity of P_USER_AUTO_PRINT_SETTING as TABLE. <br>
 * ユーザ別自動印刷設定マスタ
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long userAutoPrintSettingId = entity.getUserAutoPrintSettingId();
 ...
 * entity.setUserAutoPrintSettingId(userAutoPrintSettingId);
 ...
 */
public abstract class BsPUserAutoPrintSetting extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_userAutoPrintSettingId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPUserAutoPrintSetting) {
            BsPUserAutoPrintSetting other = (BsPUserAutoPrintSetting)obj;
            if (!xSV(_userAutoPrintSettingId, other._userAutoPrintSettingId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _userAutoPrintSettingId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_userAutoPrintSettingId));
    ...
    @Override
    public PUserAutoPrintSetting clone() {
        return (PUserAutoPrintSetting)super.clone();
    }
     ...
     * ユーザ別自動印刷設定ID
     * @return The value of the column 'USER_AUTO_PRINT_SETTING_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getUserAutoPrintSettingId() {
        checkSpecifiedProperty("userAutoPrintSettingId");
     ...
     * ユーザ別自動印刷設定ID
     * @param userAutoPrintSettingId The value of the column 'USER_AUTO_PRINT_SETTING_ID'. (basically NotNull if update: for the constraint)
     */
    public void setUserAutoPrintSettingId(Long userAutoPrintSettingId) {
        registerModifiedProperty("userAutoPrintSettingId");
        _userAutoPrintSettingId = userAutoPrintSettingId;
    }
