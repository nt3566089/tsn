...
/**
 * The entity of T_SHIPPING_INST_SPARE as TABLE. <br>
 * 出荷指示予備
 * <pre>
 * [primary-key]
 *     SHIPPING_INST_B_ID
 ...
 */
public abstract class BsTShippingInstSpare extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTShippingInstSpare) {
            BsTShippingInstSpare other = (BsTShippingInstSpare)obj;
    ...
    @Override
    public TShippingInstSpare clone() {
        return (TShippingInstSpare)super.clone();
    }
