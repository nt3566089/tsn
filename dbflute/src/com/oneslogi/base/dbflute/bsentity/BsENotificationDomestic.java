...
/**
 * The entity of E_NOTIFICATION_DOMESTIC as TABLE. <br>
 * 受入通知情報受信テーブル（国産）
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long notificationDomesticId = entity.getNotificationDomesticId();
 ...
 * entity.setNotificationDomesticId(notificationDomesticId);
 ...
 */
public abstract class BsENotificationDomestic extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _notificationDomesticId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_notificationDomesticId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsENotificationDomestic) {
            BsENotificationDomestic other = (BsENotificationDomestic)obj;
            if (!xSV(_notificationDomesticId, other._notificationDomesticId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _notificationDomesticId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_notificationDomesticId));
    ...
    @Override
    public ENotificationDomestic clone() {
        return (ENotificationDomestic)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 受入通知情報受信（国産）ID
     * @return The value of the column 'NOTIFICATION_DOMESTIC_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getNotificationDomesticId() {
        checkSpecifiedProperty("notificationDomesticId");
        return _notificationDomesticId;
    }

    /**
     * [set] NOTIFICATION_DOMESTIC_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 受入通知情報受信（国産）ID
     * @param notificationDomesticId The value of the column 'NOTIFICATION_DOMESTIC_ID'. (basically NotNull if update: for the constraint)
     */
    public void setNotificationDomesticId(Long notificationDomesticId) {
        registerModifiedProperty("notificationDomesticId");
        _notificationDomesticId = notificationDomesticId;
    }
