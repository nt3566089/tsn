...
/**
 * The entity of T_TRIFDTLTRANSEXP as TABLE. <br>
 * 一次輸送詳細拡張
 * <pre>
 * [primary-key]
 *     TRIFDTLTRANSEXP_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trifdtltransexpId = entity.getTrifdtltransexpId();
 ...
 * entity.setTrifdtltransexpId(trifdtltransexpId);
 ...
 */
public abstract class BsTTrifdtltransexp extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trifdtltransexpId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrifdtltransexp) {
            BsTTrifdtltransexp other = (BsTTrifdtltransexp)obj;
            if (!xSV(_trifdtltransexpId, other._trifdtltransexpId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_trifdtltransexpId));
    ...
    @Override
    public TTrifdtltransexp clone() {
        return (TTrifdtltransexp)super.clone();
    }
     ...
     * 一次輸送詳細拡張ID
     * @return The value of the column 'TRIFDTLTRANSEXP_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrifdtltransexpId() {
        checkSpecifiedProperty("trifdtltransexpId");
     ...
     * 一次輸送詳細拡張ID
     * @param trifdtltransexpId The value of the column 'TRIFDTLTRANSEXP_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrifdtltransexpId(Long trifdtltransexpId) {
        registerModifiedProperty("trifdtltransexpId");
        _trifdtltransexpId = trifdtltransexpId;
    }
