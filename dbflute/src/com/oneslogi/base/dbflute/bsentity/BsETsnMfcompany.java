...
/**
 * The entity of E_TSN_MFCOMPANY as TABLE. <br>
 * TSN組織マスタ
 * <pre>
 * [primary-key]
 *     TSN_MFCOMPANY_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long tsnMfcompanyId = entity.getTsnMfcompanyId();
 ...
 * entity.setTsnMfcompanyId(tsnMfcompanyId);
 ...
 */
public abstract class BsETsnMfcompany extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_tsnMfcompanyId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsETsnMfcompany) {
            BsETsnMfcompany other = (BsETsnMfcompany)obj;
            if (!xSV(_tsnMfcompanyId, other._tsnMfcompanyId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_tsnMfcompanyId));
    ...
    @Override
    public ETsnMfcompany clone() {
        return (ETsnMfcompany)super.clone();
    }
     ...
     * TSN組織マスタID
     * @return The value of the column 'TSN_MFCOMPANY_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTsnMfcompanyId() {
        checkSpecifiedProperty("tsnMfcompanyId");
     ...
     * TSN組織マスタID
     * @param tsnMfcompanyId The value of the column 'TSN_MFCOMPANY_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTsnMfcompanyId(Long tsnMfcompanyId) {
        registerModifiedProperty("tsnMfcompanyId");
        _tsnMfcompanyId = tsnMfcompanyId;
    }
