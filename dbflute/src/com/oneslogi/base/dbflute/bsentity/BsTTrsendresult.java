...
/**
 * The entity of T_TRSENDRESULT as TABLE. <br>
 * 発送実績情報
 * <pre>
 * [primary-key]
 *     TRSENDRESULT_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trsendresultId = entity.getTrsendresultId();
 ...
 * Long planqty = entity.getPlanqty();
 ...
 * entity.setTrsendresultId(trsendresultId);
 ...
 */
public abstract class BsTTrsendresult extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trsendresultId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrsendresult) {
            BsTTrsendresult other = (BsTTrsendresult)obj;
            if (!xSV(_trsendresultId, other._trsendresultId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_trsendresultId));
        ...
        sb.append(dm).append(xfND(_planqty));
    ...
    @Override
    public TTrsendresult clone() {
        return (TTrsendresult)super.clone();
    }
     ...
     * 発送実績情報ID
     * @return The value of the column 'TRSENDRESULT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrsendresultId() {
        checkSpecifiedProperty("trsendresultId");
     ...
     * 発送実績情報ID
     * @param trsendresultId The value of the column 'TRSENDRESULT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrsendresultId(Long trsendresultId) {
        registerModifiedProperty("trsendresultId");
        _trsendresultId = trsendresultId;
    }
     ...
     * 計画数量
     * @return The value of the column 'PLANQTY'. (NullAllowed even if selected: for no constraint)
     */
    public Long getPlanqty() {
        checkSpecifiedProperty("planqty");
        return _planqty;
    }
     ...
     * 計画数量
     * @param planqty The value of the column 'PLANQTY'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPlanqty(Long planqty) {
        registerModifiedProperty("planqty");
        _planqty = planqty;
    }
