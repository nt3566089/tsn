...
/**
 * The entity of E_BONDED_RECEIVE_SEND as TABLE. <br>
 * 入庫実績送信（需給）
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsEBondedReceiveSend extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEBondedReceiveSend) {
            BsEBondedReceiveSend other = (BsEBondedReceiveSend)obj;
    ...
    @Override
    public EBondedReceiveSend clone() {
        return (EBondedReceiveSend)super.clone();
    }
