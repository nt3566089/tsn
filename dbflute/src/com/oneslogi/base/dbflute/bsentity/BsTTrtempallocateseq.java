...
/**
 * The entity of T_TRTEMPALLOCATESEQ as TABLE. <br>
 * 仮引当順
 * <pre>
 * [primary-key]
 *     TEMPORARY_ALLOC_ID
 ...
 */
public abstract class BsTTrtempallocateseq extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_temporaryAllocId == null) { return false; }
    ...
    protected List<TTrtempallocateseqdetail> _tTrtempallocateseqdetailList;

    /**
     * [get] T_TRTEMPALLOCATESEQDETAIL by TEMPORARY_ALLOC_ID, named 'TTrtempallocateseqdetailList'.
     * @return The entity list of referrer property 'TTrtempallocateseqdetailList'. (NotNull: even if no loading, returns empty list)
     */
    public List<TTrtempallocateseqdetail> getTTrtempallocateseqdetailList() {
        if (_tTrtempallocateseqdetailList == null) { _tTrtempallocateseqdetailList = newReferrerList(); }
        return _tTrtempallocateseqdetailList;
    }

    /**
     * [set] T_TRTEMPALLOCATESEQDETAIL by TEMPORARY_ALLOC_ID, named 'TTrtempallocateseqdetailList'.
     * @param tTrtempallocateseqdetailList The entity list of referrer property 'TTrtempallocateseqdetailList'. (NullAllowed)
     */
    public void setTTrtempallocateseqdetailList(List<TTrtempallocateseqdetail> tTrtempallocateseqdetailList) {
        _tTrtempallocateseqdetailList = tTrtempallocateseqdetailList;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrtempallocateseq) {
            BsTTrtempallocateseq other = (BsTTrtempallocateseq)obj;
            if (!xSV(_temporaryAllocId, other._temporaryAllocId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_tTrtempallocateseqdetailList != null) { for (TTrtempallocateseqdetail et : _tTrtempallocateseqdetailList)
        { if (et != null) { sb.append(li).append(xbRDS(et, "tTrtempallocateseqdetailList")); } } }
        return sb.toString();
    }
    ...
    protected String doBuildRelationString(String dm) {
        StringBuilder sb = new StringBuilder();
        if (_tTrtempallocateseqdetailList != null && !_tTrtempallocateseqdetailList.isEmpty())
        { sb.append(dm).append("tTrtempallocateseqdetailList"); }
        if (sb.length() > dm.length()) {
    ...
    @Override
    public TTrtempallocateseq clone() {
        return (TTrtempallocateseq)super.clone();
    }
