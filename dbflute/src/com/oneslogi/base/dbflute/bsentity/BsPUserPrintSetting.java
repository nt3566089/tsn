...
/**
 * The entity of P_USER_PRINT_SETTING as TABLE. <br>
 * ユーザ別印刷設定情報
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long userPrintSettingId = entity.getUserPrintSettingId();
 ...
 * entity.setUserPrintSettingId(userPrintSettingId);
 ...
 */
public abstract class BsPUserPrintSetting extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _userPrintSettingId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_userPrintSettingId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPUserPrintSetting) {
            BsPUserPrintSetting other = (BsPUserPrintSetting)obj;
            if (!xSV(_userPrintSettingId, other._userPrintSettingId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_userPrintSettingId));
    ...
    @Override
    public PUserPrintSetting clone() {
        return (PUserPrintSetting)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] USER_PRINT_SETTING_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * ユーザ別印刷設定ID
     * @return The value of the column 'USER_PRINT_SETTING_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getUserPrintSettingId() {
        checkSpecifiedProperty("userPrintSettingId");
        return _userPrintSettingId;
    }

    /**
     * [set] USER_PRINT_SETTING_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * ユーザ別印刷設定ID
     * @param userPrintSettingId The value of the column 'USER_PRINT_SETTING_ID'. (basically NotNull if update: for the constraint)
     */
    public void setUserPrintSettingId(Long userPrintSettingId) {
        registerModifiedProperty("userPrintSettingId");
        _userPrintSettingId = userPrintSettingId;
    }
