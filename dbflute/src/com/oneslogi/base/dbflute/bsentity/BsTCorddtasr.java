...
/**
 * The entity of T_CORDDTASR as TABLE. <br>
 * さしずデータ(仕分中）
 * <pre>
 * [primary-key]
 *     ORDER_SORT_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long orderSortId = entity.getOrderSortId();
 ...
 * entity.setOrderSortId(orderSortId);
 ...
 */
public abstract class BsTCorddtasr extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_orderSortId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTCorddtasr) {
            BsTCorddtasr other = (BsTCorddtasr)obj;
            if (!xSV(_orderSortId, other._orderSortId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_orderSortId));
    ...
    @Override
    public TCorddtasr clone() {
        return (TCorddtasr)super.clone();
    }
     ...
     * さしずデータ(仕分中)ID
     * @return The value of the column 'ORDER_SORT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getOrderSortId() {
        checkSpecifiedProperty("orderSortId");
        return _orderSortId;
    }
     ...
     * さしずデータ(仕分中)ID
     * @param orderSortId The value of the column 'ORDER_SORT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setOrderSortId(Long orderSortId) {
        registerModifiedProperty("orderSortId");
        _orderSortId = orderSortId;
    }
