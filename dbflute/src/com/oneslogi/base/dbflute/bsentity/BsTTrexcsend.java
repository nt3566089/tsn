...
/**
 * The entity of T_TREXCSEND as TABLE. <br>
 * 輸入製品追跡情報取得除外
 * <pre>
 * [primary-key]
 *     SYMBOLNO
 ...
 */
public abstract class BsTTrexcsend extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrexcsend) {
            BsTTrexcsend other = (BsTTrexcsend)obj;
    ...
    @Override
    public TTrexcsend clone() {
        return (TTrexcsend)super.clone();
    }
