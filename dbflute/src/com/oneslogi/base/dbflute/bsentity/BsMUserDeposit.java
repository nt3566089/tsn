...
/**
 * The entity of M_USER_DEPOSIT as TABLE. <br>
 * ユーザ預託マスタ
 * <pre>
 * [primary-key]
 *     USER_DEPOSIT_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long userDepositId = entity.getUserDepositId();
 ...
 * entity.setUserDepositId(userDepositId);
 ...
 */
public abstract class BsMUserDeposit extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_userDepositId == null) { return false; }
     ...
     */
    public void uniqueBy(Long userId, Long customerId) {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMUserDeposit) {
            BsMUserDeposit other = (BsMUserDeposit)obj;
            if (!xSV(_userDepositId, other._userDepositId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_userDepositId));
    ...
    @Override
    public MUserDeposit clone() {
        return (MUserDeposit)super.clone();
    }
     ...
     * ユーザ預託ID
     * @return The value of the column 'USER_DEPOSIT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getUserDepositId() {
        checkSpecifiedProperty("userDepositId");
     ...
     * ユーザ預託ID
     * @param userDepositId The value of the column 'USER_DEPOSIT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setUserDepositId(Long userDepositId) {
        registerModifiedProperty("userDepositId");
        _userDepositId = userDepositId;
    }
