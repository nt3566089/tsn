...
/**
 * The entity of E_CRELAYBS as TABLE. <br>
 * 中継拠点マスタ受信テーブル
 * <pre>
 * [primary-key]
 *     CRELAYBS_ID
 ...
 */
public abstract class BsECrelaybs extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsECrelaybs) {
            BsECrelaybs other = (BsECrelaybs)obj;
    ...
    @Override
    public ECrelaybs clone() {
        return (ECrelaybs)super.clone();
    }
