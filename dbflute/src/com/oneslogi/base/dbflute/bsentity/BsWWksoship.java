...
/**
 * The entity of W_WKSOSHIP as TABLE. <br>
 * 積込検品中間テーブル
 * <pre>
 * [primary-key]
 *     WKSORECEIVE_ID
 ...
 * String palletBarcode = entity.getPalletBarcode();
 ...
 * entity.setLot4(lot4);
 * entity.setPalletBarcode(palletBarcode);
 ...
 */
public abstract class BsWWksoship extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWWksoship) {
            BsWWksoship other = (BsWWksoship)obj;
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_palletBarcode));
    ...
    @Override
    public WWksoship clone() {
        return (WWksoship)super.clone();
    }
     ...
     * P/LNo.
     * @return The value of the column 'PLNO'. (basically NotNull if selected: for the constraint)
     */
     ...
     * P/LNo.
     * @param plno The value of the column 'PLNO'. (basically NotNull if update: for the constraint)
     */
     ...
     * パレット明細バーコード
     * @return The value of the column 'PALLET_BARCODE'. (NullAllowed even if selected: for no constraint)
     */
    public String getPalletBarcode() {
        checkSpecifiedProperty("palletBarcode");
        return convertEmptyToNull(_palletBarcode);
    }

    /**
     * [set] PALLET_BARCODE: {varchar(255)} <br>
     * パレット明細バーコード
     * @param palletBarcode The value of the column 'PALLET_BARCODE'. (NullAllowed: null update allowed for no constraint)
     */
    public void setPalletBarcode(String palletBarcode) {
        registerModifiedProperty("palletBarcode");
