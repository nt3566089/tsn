...
/**
 * The entity of H_PACKING_B as TABLE. <br>
 * 梱包ボディ履歴
 * <pre>
 * [primary-key]
 *     PACKING_B_ID
 ...
 */
public abstract class BsHPackingB extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected HPackingH _hPackingH;

    /**
     * [get] H_PACKING_H by my PACKING_H_ID, named 'HPackingH'. <br>
     * @return The entity of foreign property 'HPackingH'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public HPackingH getHPackingH() {
        return _hPackingH;
    }

    /**
     * [set] H_PACKING_H by my PACKING_H_ID, named 'HPackingH'.
     * @param hPackingH The entity of foreign property 'HPackingH'. (NullAllowed)
     */
    public void setHPackingH(HPackingH hPackingH) {
        _hPackingH = hPackingH;
    }

    /** H_SHIPPING_B by my SHIPPING_INST_B_ID, named 'HShippingB'. */
    protected HShippingB _hShippingB;

    /**
     * [get] H_SHIPPING_B by my SHIPPING_INST_B_ID, named 'HShippingB'. <br>
     * @return The entity of foreign property 'HShippingB'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public HShippingB getHShippingB() {
        return _hShippingB;
    }

    /**
     * [set] H_SHIPPING_B by my SHIPPING_INST_B_ID, named 'HShippingB'.
     * @param hShippingB The entity of foreign property 'HShippingB'. (NullAllowed)
     */
    public void setHShippingB(HShippingB hShippingB) {
        _hShippingB = hShippingB;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsHPackingB) {
            BsHPackingB other = (BsHPackingB)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_hPackingH != null)
        { sb.append(li).append(xbRDS(_hPackingH, "hPackingH")); }
        if (_hShippingB != null)
        { sb.append(li).append(xbRDS(_hShippingB, "hShippingB")); }
        if (_hStock != null)
    ...
    protected String doBuildRelationString(String dm) {
        StringBuilder sb = new StringBuilder();
        if (_hPackingH != null)
        { sb.append(dm).append("hPackingH"); }
        if (_hShippingB != null)
        { sb.append(dm).append("hShippingB"); }
        if (_hStock != null)
    ...
    @Override
    public HPackingB clone() {
        return (HPackingB)super.clone();
    }
