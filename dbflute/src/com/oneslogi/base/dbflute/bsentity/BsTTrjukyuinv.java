...
/**
 * The entity of T_TRJUKYUINV as TABLE. <br>
 * 需給在庫情報
 * <pre>
 * [primary-key]
 *     TRJUKYUINV_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long trjukyuinvId = entity.getTrjukyuinvId();
 * String recvstockdate = entity.getRecvstockdate();
 ...
 * entity.setTrjukyuinvId(trjukyuinvId);
 * entity.setRecvstockdate(recvstockdate);
 ...
 */
public abstract class BsTTrjukyuinv extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_trjukyuinvId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrjukyuinv) {
            BsTTrjukyuinv other = (BsTTrjukyuinv)obj;
            if (!xSV(_trjukyuinvId, other._trjukyuinvId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_trjukyuinvId));
        sb.append(dm).append(xfND(_recvstockdate));
    ...
    @Override
    public TTrjukyuinv clone() {
        return (TTrjukyuinv)super.clone();
    }
     ...
     * 需給在庫情報_ID
     * @return The value of the column 'TRJUKYUINV_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getTrjukyuinvId() {
        checkSpecifiedProperty("trjukyuinvId");
     ...
     * 需給在庫情報_ID
     * @param trjukyuinvId The value of the column 'TRJUKYUINV_ID'. (basically NotNull if update: for the constraint)
     */
    public void setTrjukyuinvId(Long trjukyuinvId) {
        registerModifiedProperty("trjukyuinvId");
        _trjukyuinvId = trjukyuinvId;
    }

    /**
     * [get] RECVSTOCKDATE: {NotNull, varchar(8)} <br>
     * 在庫年月日
     * @return The value of the column 'RECVSTOCKDATE'. (basically NotNull if selected: for the constraint)
     */
    public String getRecvstockdate() {
        checkSpecifiedProperty("recvstockdate");
        return convertEmptyToNull(_recvstockdate);
    }

    /**
     * [set] RECVSTOCKDATE: {NotNull, varchar(8)} <br>
     * 在庫年月日
     * @param recvstockdate The value of the column 'RECVSTOCKDATE'. (basically NotNull if update: for the constraint)
     */
    public void setRecvstockdate(String recvstockdate) {
        registerModifiedProperty("recvstockdate");
        _recvstockdate = recvstockdate;
    }
