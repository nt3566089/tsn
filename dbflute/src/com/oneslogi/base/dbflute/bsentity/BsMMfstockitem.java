...
/**
 * The entity of M_MFSTOCKITEM as TABLE. <br>
 * 銘柄別補充先マスタ
 * <pre>
 * [primary-key]
 *     MFSTOCKITEM_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long mfstockitemId = entity.getMfstockitemId();
 ...
 * entity.setMfstockitemId(mfstockitemId);
 ...
 */
public abstract class BsMMfstockitem extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_mfstockitemId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMMfstockitem) {
            BsMMfstockitem other = (BsMMfstockitem)obj;
            if (!xSV(_mfstockitemId, other._mfstockitemId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_mfstockitemId));
    ...
    @Override
    public MMfstockitem clone() {
        return (MMfstockitem)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] MFSTOCKITEM_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 銘柄別補充先ID
     * @return The value of the column 'MFSTOCKITEM_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getMfstockitemId() {
        checkSpecifiedProperty("mfstockitemId");
        return _mfstockitemId;
    }

    /**
     * [set] MFSTOCKITEM_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 銘柄別補充先ID
     * @param mfstockitemId The value of the column 'MFSTOCKITEM_ID'. (basically NotNull if update: for the constraint)
     */
    public void setMfstockitemId(Long mfstockitemId) {
        registerModifiedProperty("mfstockitemId");
        _mfstockitemId = mfstockitemId;
    }
    ...
    /**
     * [get] LINEBLOCK: {NotNull, varchar(30)} <br>
     * 仕分場ライン／ブロック
     * @return The value of the column 'LINEBLOCK'. (basically NotNull if selected: for the constraint)
     */
    ...
    /**
     * [set] LINEBLOCK: {NotNull, varchar(30)} <br>
     * 仕分場ライン／ブロック
     * @param lineblock The value of the column 'LINEBLOCK'. (basically NotNull if update: for the constraint)
     */
