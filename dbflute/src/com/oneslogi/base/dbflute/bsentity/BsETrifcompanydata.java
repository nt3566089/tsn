...
/**
 * The entity of E_TRIFCOMPANYDATA as TABLE. <br>
 * IF組織
 * <pre>
 * [primary-key]
 *     IFDATAKEY
 ...
 */
public abstract class BsETrifcompanydata extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsETrifcompanydata) {
            BsETrifcompanydata other = (BsETrifcompanydata)obj;
    ...
    @Override
    public ETrifcompanydata clone() {
        return (ETrifcompanydata)super.clone();
    }
