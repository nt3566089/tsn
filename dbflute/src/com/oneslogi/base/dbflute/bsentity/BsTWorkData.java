...
/**
 * The entity of T_WORK_DATA as TABLE. <br>
 * 作業中データ
 * <pre>
 * [primary-key]
 *     WORK_DATA_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long workDataId = entity.getWorkDataId();
 ...
 * entity.setWorkDataId(workDataId);
 ...
 */
public abstract class BsTWorkData extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_workDataId == null) { return false; }
    ...
    protected TWorkLog _tWorkLog;

    /**
     * [get] T_WORK_LOG by my WORK_LOG_ID, named 'TWorkLog'. <br>
     * @return The entity of foreign property 'TWorkLog'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public TWorkLog getTWorkLog() {
        return _tWorkLog;
    }

    /**
     * [set] T_WORK_LOG by my WORK_LOG_ID, named 'TWorkLog'.
     * @param tWorkLog The entity of foreign property 'TWorkLog'. (NullAllowed)
     */
    public void setTWorkLog(TWorkLog tWorkLog) {
        _tWorkLog = tWorkLog;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTWorkData) {
            BsTWorkData other = (BsTWorkData)obj;
            if (!xSV(_workDataId, other._workDataId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_tWorkLog != null)
        { sb.append(li).append(xbRDS(_tWorkLog, "tWorkLog")); }
        return sb.toString();
    }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_workDataId));
    ...
    @Override
    public TWorkData clone() {
        return (TWorkData)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] WORK_DATA_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 作業中データID
     * @return The value of the column 'WORK_DATA_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getWorkDataId() {
        checkSpecifiedProperty("workDataId");
        return _workDataId;
    }

    /**
     * [set] WORK_DATA_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 作業中データID
     * @param workDataId The value of the column 'WORK_DATA_ID'. (basically NotNull if update: for the constraint)
     */
    public void setWorkDataId(Long workDataId) {
        registerModifiedProperty("workDataId");
        _workDataId = workDataId;
    }

    /**
     * [get] USER_CD: {IX+, varchar(30)} <br>
     * ユーザCD
    ...
    /**
     * [get] WORK_LOG_ID: {NotNull, bigint(19), FK to T_WORK_LOG} <br>
     * 作業実績ID
    ...
    /**
     * [set] WORK_LOG_ID: {NotNull, bigint(19), FK to T_WORK_LOG} <br>
     * 作業実績ID
