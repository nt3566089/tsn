...
/**
 * The entity of E_SHIP_NOTIFICATION_INFO as TABLE. <br>
 * 輸送通知情報受信テーブル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long shipNotificationInfoId = entity.getShipNotificationInfoId();
 ...
 * entity.setShipNotificationInfoId(shipNotificationInfoId);
 ...
 */
public abstract class BsEShipNotificationInfo extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected Long _shipNotificationInfoId;
    ...
    public boolean hasPrimaryKeyValue() {
        if (_shipNotificationInfoId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEShipNotificationInfo) {
            BsEShipNotificationInfo other = (BsEShipNotificationInfo)obj;
            if (!xSV(_shipNotificationInfoId, other._shipNotificationInfoId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _shipNotificationInfoId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_shipNotificationInfoId));
    ...
    @Override
    public EShipNotificationInfo clone() {
        return (EShipNotificationInfo)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] SHIP_NOTIFICATION_INFO_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 輸送通知情報受信ID
     * @return The value of the column 'SHIP_NOTIFICATION_INFO_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getShipNotificationInfoId() {
        checkSpecifiedProperty("shipNotificationInfoId");
        return _shipNotificationInfoId;
    }

    /**
     * [set] SHIP_NOTIFICATION_INFO_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 輸送通知情報受信ID
     * @param shipNotificationInfoId The value of the column 'SHIP_NOTIFICATION_INFO_ID'. (basically NotNull if update: for the constraint)
     */
    public void setShipNotificationInfoId(Long shipNotificationInfoId) {
        registerModifiedProperty("shipNotificationInfoId");
        _shipNotificationInfoId = shipNotificationInfoId;
    }
    ...
    /**
     * [get] WAREHOUSE_CD: {varchar(60)} <br>
     * 倉庫CD
    ...
    /**
     * [set] WAREHOUSE_CD: {varchar(60)} <br>
     * 倉庫CD
    ...
    /**
     * [get] SUB_WAREHOUSE_CD: {varchar(60)} <br>
     * 枝倉庫CD
    ...
    /**
     * [set] SUB_WAREHOUSE_CD: {varchar(60)} <br>
     * 枝倉庫CD
