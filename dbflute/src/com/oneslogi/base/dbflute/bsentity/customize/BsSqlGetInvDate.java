...
/**
 * The entity of SqlGetInvDate. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlGetInvDate extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlGetInvDateDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlGetInvDate";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlGetInvDate) {
            BsSqlGetInvDate other = (BsSqlGetInvDate)obj;
    ...
    @Override
    public SqlGetInvDate clone() {
        return (SqlGetInvDate)super.clone();
    }
