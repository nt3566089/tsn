...
/**
 * The DB meta of SqlSortingPlaceMasterListSrw. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class SqlSortingPlaceMasterListSrwDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final SqlSortingPlaceMasterListSrwDbm _instance = new SqlSortingPlaceMasterListSrwDbm();
    private SqlSortingPlaceMasterListSrwDbm() {}
    public static SqlSortingPlaceMasterListSrwDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfrnk(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfrnk((String)vl), "locidfrnk");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfrnkNm(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfrnkNm((String)vl), "locidfrnkNm");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg1(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg1(ctl(vl)), "locidfbrctg1");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg2(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg2(ctl(vl)), "locidfbrctg2");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg3(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg3(ctl(vl)), "locidfbrctg3");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg4(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg4(ctl(vl)), "locidfbrctg4");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg5(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg5(ctl(vl)), "locidfbrctg5");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg6(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg6(ctl(vl)), "locidfbrctg6");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg7(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg7(ctl(vl)), "locidfbrctg7");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg8(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg8(ctl(vl)), "locidfbrctg8");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg9(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg9(ctl(vl)), "locidfbrctg9");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg10(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg10(ctl(vl)), "locidfbrctg10");
        setupEpg(_epgMap, et -> ((SqlSortingPlaceMasterListSrw)et).getLocidfbrctg(), (et, vl) -> ((SqlSortingPlaceMasterListSrw)et).setLocidfbrctg((String)vl), "locidfbrctg");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "SqlSortingPlaceMasterListSrw";
    protected final String _tableDispName = "SqlSortingPlaceMasterListSrw";
    protected final String _tablePropertyName = "sqlSortingPlaceMasterListSrw";
    protected final TableSqlName _tableSqlName = new TableSqlName("SqlSortingPlaceMasterListSrw", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.customize.SqlSortingPlaceMasterListSrw"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<SqlSortingPlaceMasterListSrw> getEntityType() { return SqlSortingPlaceMasterListSrw.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public SqlSortingPlaceMasterListSrw newEntity() { return new SqlSortingPlaceMasterListSrw(); }
    public SqlSortingPlaceMasterListSrw newMyEntity() { return new SqlSortingPlaceMasterListSrw(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((SqlSortingPlaceMasterListSrw)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((SqlSortingPlaceMasterListSrw)et, mp); }
