...
/**
 * The entity of SqlTCcopamDataEntity. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlTCcopamDataEntity extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlTCcopamDataEntityDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlTCcopamDataEntity";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlTCcopamDataEntity) {
            BsSqlTCcopamDataEntity other = (BsSqlTCcopamDataEntity)obj;
    ...
    @Override
    public SqlTCcopamDataEntity clone() {
        return (SqlTCcopamDataEntity)super.clone();
    }
