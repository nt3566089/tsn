...
/**
 * The entity of SqlTrcasedetailCorrectList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlTrcasedetailCorrectList extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlTrcasedetailCorrectListDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlTrcasedetailCorrectList";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlTrcasedetailCorrectList) {
            BsSqlTrcasedetailCorrectList other = (BsSqlTrcasedetailCorrectList)obj;
    ...
    @Override
    public SqlTrcasedetailCorrectList clone() {
        return (SqlTrcasedetailCorrectList)super.clone();
    }
     ...
     * @return The value of the column 'TRCASEDETAIL_ID'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * @param trcasedetailId The value of the column 'TRCASEDETAIL_ID'. (NullAllowed: null update allowed for no constraint)
     */
