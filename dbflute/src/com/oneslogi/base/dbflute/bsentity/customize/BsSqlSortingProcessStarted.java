...
/**
 * The entity of SqlSortingProcessStarted. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlSortingProcessStarted extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlSortingProcessStartedDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlSortingProcessStarted";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlSortingProcessStarted) {
            BsSqlSortingProcessStarted other = (BsSqlSortingProcessStarted)obj;
    ...
    @Override
    public SqlSortingProcessStarted clone() {
        return (SqlSortingProcessStarted)super.clone();
    }
