 ...
 */
public abstract class BsSqlInvDate extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlInvDateDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlInvDate) {
            BsSqlInvDate other = (BsSqlInvDate)obj;
    ...
    @Override
    public SqlInvDate clone() {
        return (SqlInvDate)super.clone();
    }
