...
/**
 * The entity of SqlgetStockwarehoseList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlgetStockwarehoseList extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlgetStockwarehoseListDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlgetStockwarehoseList";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlgetStockwarehoseList) {
            BsSqlgetStockwarehoseList other = (BsSqlgetStockwarehoseList)obj;
    ...
    @Override
    public SqlgetStockwarehoseList clone() {
        return (SqlgetStockwarehoseList)super.clone();
    }
