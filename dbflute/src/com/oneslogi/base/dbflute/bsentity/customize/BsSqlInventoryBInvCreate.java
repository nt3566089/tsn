...
/**
 * The entity of SqlInventoryBInvCreate. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlInventoryBInvCreate extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlInventoryBInvCreateDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlInventoryBInvCreate";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlInventoryBInvCreate) {
            BsSqlInventoryBInvCreate other = (BsSqlInventoryBInvCreate)obj;
    ...
    @Override
    public SqlInventoryBInvCreate clone() {
        return (SqlInventoryBInvCreate)super.clone();
    }
