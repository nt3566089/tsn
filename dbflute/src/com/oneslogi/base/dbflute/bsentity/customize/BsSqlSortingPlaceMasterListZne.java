...
/**
 * The entity of SqlSortingPlaceMasterListZne. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlSortingPlaceMasterListZne extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlSortingPlaceMasterListZneDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlSortingPlaceMasterListZne";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlSortingPlaceMasterListZne) {
            BsSqlSortingPlaceMasterListZne other = (BsSqlSortingPlaceMasterListZne)obj;
    ...
    @Override
    public SqlSortingPlaceMasterListZne clone() {
        return (SqlSortingPlaceMasterListZne)super.clone();
    }
