...
/**
 * The entity of SqlSortingPlaceMasterListBlk. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 * String hdrdboxrsfidNm = entity.getHdrdboxrsfidNm();
 * Long pkgrt = entity.getPkgrt();
 * String sprprsid = entity.getSprprsid();
 * String sprprsidNm = entity.getSprprsidNm();
 ...
 * entity.setHdrdboxrsfidNm(hdrdboxrsfidNm);
 * entity.setPkgrt(pkgrt);
 * entity.setSprprsid(sprprsid);
 * entity.setSprprsidNm(sprprsidNm);
 ...
 */
public abstract class BsSqlSortingPlaceMasterListBlk extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlSortingPlaceMasterListBlkDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlSortingPlaceMasterListBlk) {
            BsSqlSortingPlaceMasterListBlk other = (BsSqlSortingPlaceMasterListBlk)obj;
            ...
            if (!xSV(_hdrdboxrsfidNm, other._hdrdboxrsfidNm)) { return false; }
            if (!xSV(_pkgrt, other._pkgrt)) { return false; }
            if (!xSV(_sprprsid, other._sprprsid)) { return false; }
            if (!xSV(_sprprsidNm, other._sprprsidNm)) { return false; }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _hdrdboxrsfidNm);
        hs = xCH(hs, _pkgrt);
        hs = xCH(hs, _sprprsid);
        hs = xCH(hs, _sprprsidNm);
        hs = xCH(hs, _delFlg);
        hs = xCH(hs, _delFlgNm);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_hdrdboxrsfidNm));
        sb.append(dm).append(xfND(_pkgrt));
        sb.append(dm).append(xfND(_sprprsid));
        sb.append(dm).append(xfND(_sprprsidNm));
    ...
    @Override
    public SqlSortingPlaceMasterListBlk clone() {
        return (SqlSortingPlaceMasterListBlk)super.clone();
    }
     ...
     * @return The value of the column 'HDRDBOXRSFID_NM'. (NullAllowed even if selected: for no constraint)
     */
    public String getHdrdboxrsfidNm() {
        checkSpecifiedProperty("hdrdboxrsfidNm");
        return convertEmptyToNull(_hdrdboxrsfidNm);
    }

    /**
     * [set] HDRDBOXRSFID_NM: {int(10)} <br>
     * @param hdrdboxrsfidNm The value of the column 'HDRDBOXRSFID_NM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setHdrdboxrsfidNm(String hdrdboxrsfidNm) {
        registerModifiedProperty("hdrdboxrsfidNm");
        _hdrdboxrsfidNm = hdrdboxrsfidNm;
    }
     ...
     * @return The value of the column 'SPRPRSID_NM'. (NullAllowed even if selected: for no constraint)
     */
    public String getSprprsidNm() {
        checkSpecifiedProperty("sprprsidNm");
        return convertEmptyToNull(_sprprsidNm);
    }

    /**
     * [set] SPRPRSID_NM: {int(10)} <br>
     * @param sprprsidNm The value of the column 'SPRPRSID_NM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSprprsidNm(String sprprsidNm) {
        registerModifiedProperty("sprprsidNm");
        _sprprsidNm = sprprsidNm;
    }
