...
/**
 * The entity of SqlDrcdizqaInventoryCreateList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlDrcdizqaInventoryCreateList extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlDrcdizqaInventoryCreateListDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlDrcdizqaInventoryCreateList";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlDrcdizqaInventoryCreateList) {
            BsSqlDrcdizqaInventoryCreateList other = (BsSqlDrcdizqaInventoryCreateList)obj;
    ...
    @Override
    public SqlDrcdizqaInventoryCreateList clone() {
        return (SqlDrcdizqaInventoryCreateList)super.clone();
    }
