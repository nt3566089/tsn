...
/**
 * The entity of SqlTTrassortorderCorrectList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlTTrassortorderCorrectList extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlTTrassortorderCorrectListDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlTTrassortorderCorrectList";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlTTrassortorderCorrectList) {
            BsSqlTTrassortorderCorrectList other = (BsSqlTTrassortorderCorrectList)obj;
    ...
    @Override
    public SqlTTrassortorderCorrectList clone() {
        return (SqlTTrassortorderCorrectList)super.clone();
    }
