...
/**
 * The entity of SqlTTrinvcheckinfoList. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsSqlTTrinvcheckinfoList extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return com.oneslogi.base.dbflute.bsentity.customize.dbmeta.SqlTTrinvcheckinfoListDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "SqlTTrinvcheckinfoList";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsSqlTTrinvcheckinfoList) {
            BsSqlTTrinvcheckinfoList other = (BsSqlTTrinvcheckinfoList)obj;
    ...
    @Override
    public SqlTTrinvcheckinfoList clone() {
        return (SqlTTrinvcheckinfoList)super.clone();
    }
