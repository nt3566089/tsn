...
/**
 * The DB meta of SqlNoGoodItemDiffReportList. (Singleton)
 * @author DBFlute(AutoGenerator)
 */
public class SqlNoGoodItemDiffReportListDbm extends AbstractDBMeta {

    // ===================================================================================
    //                                                                           Singleton
    //                                                                           =========
    private static final SqlNoGoodItemDiffReportListDbm _instance = new SqlNoGoodItemDiffReportListDbm();
    private SqlNoGoodItemDiffReportListDbm() {}
    public static SqlNoGoodItemDiffReportListDbm getInstance() { return _instance; }
    ...
    protected void xsetupEpg() {
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getCenterCd(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setCenterCd((String)vl), "centerCd");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getCenterNm(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setCenterNm((String)vl), "centerNm");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getInvdate(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setInvdate((String)vl), "invdate");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getProductCd(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setProductCd((String)vl), "productCd");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getProductAbbr(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setProductAbbr((String)vl), "productAbbr");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getDiffoccArea(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setDiffoccArea((String)vl), "diffoccArea");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getDiffQty1(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setDiffQty1(ctb(vl)), "diffQty1");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getCggdid(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setCggdid((String)vl), "cggdid");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getUserCd(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setUserCd((String)vl), "userCd");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getUserNm(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setUserNm((String)vl), "userNm");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getCggdidNm(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setCggdidNm((String)vl), "cggdidNm");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getInoutkbnNm(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setInoutkbnNm((String)vl), "inoutkbnNm");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getPrintcount(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setPrintcount(ctl(vl)), "printcount");
        setupEpg(_epgMap, et -> ((SqlNoGoodItemDiffReportList)et).getEmtpyflag(), (et, vl) -> ((SqlNoGoodItemDiffReportList)et).setEmtpyflag((String)vl), "emtpyflag");
    }
    ...
    //                                                                          Table Info
    //                                                                          ==========
    protected final String _tableDbName = "SqlNoGoodItemDiffReportList";
    protected final String _tableDispName = "SqlNoGoodItemDiffReportList";
    protected final String _tablePropertyName = "sqlNoGoodItemDiffReportList";
    protected final TableSqlName _tableSqlName = new TableSqlName("SqlNoGoodItemDiffReportList", _tableDbName);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.oneslogi.base.dbflute.exentity.customize.SqlNoGoodItemDiffReportList"; }
    ...
    //                                                                         Object Type
    //                                                                         ===========
    public Class<SqlNoGoodItemDiffReportList> getEntityType() { return SqlNoGoodItemDiffReportList.class; }

    // ===================================================================================
    //                                                                     Object Instance
    //                                                                     ===============
    public SqlNoGoodItemDiffReportList newEntity() { return new SqlNoGoodItemDiffReportList(); }
    public SqlNoGoodItemDiffReportList newMyEntity() { return new SqlNoGoodItemDiffReportList(); }

    // ===================================================================================
    //                                                                   Map Communication
    //                                                                   =================
    public void acceptPrimaryKeyMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptPrimaryKeyMap((SqlNoGoodItemDiffReportList)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((SqlNoGoodItemDiffReportList)et, mp); }
