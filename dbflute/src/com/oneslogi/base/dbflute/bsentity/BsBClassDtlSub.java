...
/**
 * The entity of B_CLASS_DTL_SUB as TABLE. <br>
 * 区分値明細マスタサブ
 * <pre>
 * [primary-key]
 *     CLASS_DTL_ID
 ...
 */
public abstract class BsBClassDtlSub extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBClassDtlSub) {
            BsBClassDtlSub other = (BsBClassDtlSub)obj;
    ...
    @Override
    public BClassDtlSub clone() {
        return (BClassDtlSub)super.clone();
    }
