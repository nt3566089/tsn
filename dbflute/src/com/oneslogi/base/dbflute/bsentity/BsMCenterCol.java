...
/**
 * The entity of M_CENTER_COL as TABLE. <br>
 * 拠点列マスタ
 * <pre>
 * [primary-key]
 *     CENTER_COL_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long centerColId = entity.getCenterColId();
 ...
 * entity.setCenterColId(centerColId);
 ...
 */
public abstract class BsMCenterCol extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_centerColId == null) { return false; }
     ...
     */
    public void uniqueBy(Long centerId, Long colId, Long dictId) {
        ...
        setCenterId(centerId);setColId(colId);setDictId(dictId);
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMCenterCol) {
            BsMCenterCol other = (BsMCenterCol)obj;
            if (!xSV(_centerColId, other._centerColId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_centerColId));
    ...
    @Override
    public MCenterCol clone() {
        return (MCenterCol)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 拠点列 ID
     * @return The value of the column 'CENTER_COL_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getCenterColId() {
        checkSpecifiedProperty("centerColId");
        return _centerColId;
    }

    /**
     * [set] CENTER_COL_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * 拠点列 ID
     * @param centerColId The value of the column 'CENTER_COL_ID'. (basically NotNull if update: for the constraint)
     */
    public void setCenterColId(Long centerColId) {
        registerModifiedProperty("centerColId");
        _centerColId = centerColId;
    }
