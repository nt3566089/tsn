...
/**
 * The entity of M_HT_MESSAGE as TABLE. <br>
 * SDメッセージマスタ
 * <pre>
 * [primary-key]
 *     MESSAGE_ID
 ...
 */
public abstract class BsMHtMessage extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected BMessage _bMessage;

    /**
     * [get] B_MESSAGE by my MESSAGE_ID, named 'BMessage'. <br>
     * @return The entity of foreign property 'BMessage'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    ...
    /**
     * [set] B_MESSAGE by my MESSAGE_ID, named 'BMessage'.
     * @param bMessage The entity of foreign property 'BMessage'. (NullAllowed)
     */
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMHtMessage) {
            BsMHtMessage other = (BsMHtMessage)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_bMessage != null)
        { sb.append(li).append(xbRDS(_bMessage, "bMessage")); }
        return sb.toString();
    }
    ...
    @Override
    public MHtMessage clone() {
        return (MHtMessage)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] MESSAGE_ID: {PK, ID, NotNull, bigint identity(19), FK to B_MESSAGE} <br>
     * メッセージID
    ...
    /**
     * [set] MESSAGE_ID: {PK, ID, NotNull, bigint identity(19), FK to B_MESSAGE} <br>
     * メッセージID
