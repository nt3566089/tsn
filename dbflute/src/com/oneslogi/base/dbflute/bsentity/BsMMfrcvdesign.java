...
/**
 * The entity of M_MFRCVDESIGN as TABLE. <br>
 * 受入デザインマスタ
 * <pre>
 * [primary-key]
 *     MFRCVDESIGN_ID
 ...
 */
public abstract class BsMMfrcvdesign extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_mfrcvdesignId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMMfrcvdesign) {
            BsMMfrcvdesign other = (BsMMfrcvdesign)obj;
    ...
    @Override
    public MMfrcvdesign clone() {
        return (MMfrcvdesign)super.clone();
    }
     ...
     * 受入デザインID
     * @return The value of the column 'MFRCVDESIGN_ID'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 受入デザインID
     * @param mfrcvdesignId The value of the column 'MFRCVDESIGN_ID'. (basically NotNull if update: for the constraint)
     */
     ...
     * 適用開始日
     * @return The value of the column 'RCVFRDATE'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 適用開始日
     * @param rcvfrdate The value of the column 'RCVFRDATE'. (basically NotNull if update: for the constraint)
     */
     ...
     * 適用終了日
     * @return The value of the column 'RCVTODATE'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 適用終了日
     * @param rcvtodate The value of the column 'RCVTODATE'. (basically NotNull if update: for the constraint)
     */
