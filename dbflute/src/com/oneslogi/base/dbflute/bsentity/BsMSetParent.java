...
/**
 * The entity of M_SET_PARENT as TABLE. <br>
 * セット品親マスタ
 * <pre>
 * [primary-key]
 *     SET_PARENT_ID
 ...
 */
public abstract class BsMSetParent extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_setParentId == null) { return false; }
     ...
     */
    public void uniqueBy(Long productId) {
    ...
    /**
     * [get] M_SET_STRUCTURE by SET_PARENT_ID, named 'MSetStructureList'.
    ...
    /**
     * [set] M_SET_STRUCTURE by SET_PARENT_ID, named 'MSetStructureList'.
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMSetParent) {
            BsMSetParent other = (BsMSetParent)obj;
            if (!xSV(_setParentId, other._setParentId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    @Override
    public MSetParent clone() {
        return (MSetParent)super.clone();
    }
