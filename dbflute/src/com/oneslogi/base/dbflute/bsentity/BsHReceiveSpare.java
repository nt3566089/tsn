...
/**
 * The entity of H_RECEIVE_SPARE as TABLE. <br>
 * 入荷予備履歴
 * <pre>
 * [primary-key]
 *     STORE_RECORD_B_ID
 ...
 */
public abstract class BsHReceiveSpare extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    protected HReceiveB _hReceiveB;

    /**
     * [get] H_RECEIVE_B by my STORE_RECORD_B_ID, named 'HReceiveB'. <br>
     * @return The entity of foreign property 'HReceiveB'. (NullAllowed: when e.g. null FK column, no setupSelect)
     */
    public HReceiveB getHReceiveB() {
        return _hReceiveB;
    }

    /**
     * [set] H_RECEIVE_B by my STORE_RECORD_B_ID, named 'HReceiveB'.
     * @param hReceiveB The entity of foreign property 'HReceiveB'. (NullAllowed)
     */
    public void setHReceiveB(HReceiveB hReceiveB) {
        _hReceiveB = hReceiveB;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsHReceiveSpare) {
            BsHReceiveSpare other = (BsHReceiveSpare)obj;
    ...
    protected String doBuildStringWithRelation(String li) {
        ...
        if (_hReceiveB != null)
        { sb.append(li).append(xbRDS(_hReceiveB, "hReceiveB")); }
        return sb.toString();
    }
    ...
    @Override
    public HReceiveSpare clone() {
        return (HReceiveSpare)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] STORE_RECORD_B_ID: {PK, ID, NotNull, bigint identity(19), FK to H_RECEIVE_B} <br>
     * 入庫実績ボディID
    ...
    /**
     * [set] STORE_RECORD_B_ID: {PK, ID, NotNull, bigint identity(19), FK to H_RECEIVE_B} <br>
     * 入庫実績ボディID
