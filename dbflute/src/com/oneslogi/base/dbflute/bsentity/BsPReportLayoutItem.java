...
/**
 * The entity of P_REPORT_LAYOUT_ITEM as TABLE. <br>
 * 帳票レイアウト項目マスタ
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long reportLayoutItemId = entity.getReportLayoutItemId();
 ...
 * entity.setReportLayoutItemId(reportLayoutItemId);
 ...
 */
public abstract class BsPReportLayoutItem extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_reportLayoutItemId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPReportLayoutItem) {
            BsPReportLayoutItem other = (BsPReportLayoutItem)obj;
            if (!xSV(_reportLayoutItemId, other._reportLayoutItemId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_reportLayoutItemId));
    ...
    @Override
    public PReportLayoutItem clone() {
        return (PReportLayoutItem)super.clone();
    }
     ...
     * 帳票レイアウト項目ID
     * @return The value of the column 'REPORT_LAYOUT_ITEM_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getReportLayoutItemId() {
        checkSpecifiedProperty("reportLayoutItemId");
     ...
     * 帳票レイアウト項目ID
     * @param reportLayoutItemId The value of the column 'REPORT_LAYOUT_ITEM_ID'. (basically NotNull if update: for the constraint)
     */
    public void setReportLayoutItemId(Long reportLayoutItemId) {
        registerModifiedProperty("reportLayoutItemId");
        _reportLayoutItemId = reportLayoutItemId;
    }
