...
/**
 * The entity of B_COL_EXT_USER as TABLE. <br>
 * 列マスタ拡張ユーザ
 * <pre>
 * [primary-key]
 *     COL_EXT_USER_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long colExtUserId = entity.getColExtUserId();
 ...
 * entity.setColExtUserId(colExtUserId);
 ...
 */
public abstract class BsBColExtUser extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_colExtUserId == null) { return false; }
     ...
     */
    public void uniqueBy(Long itemId, String colCd, Long userId) {
        ...
        setItemId(itemId);setColCd(colCd);setUserId(userId);
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBColExtUser) {
            BsBColExtUser other = (BsBColExtUser)obj;
            if (!xSV(_colExtUserId, other._colExtUserId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_colExtUserId));
    ...
    @Override
    public BColExtUser clone() {
        return (BColExtUser)super.clone();
    }
     ...
     * 列マスタ拡張ユーザID
     * @return The value of the column 'COL_EXT_USER_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getColExtUserId() {
        checkSpecifiedProperty("colExtUserId");
     ...
     * 列マスタ拡張ユーザID
     * @param colExtUserId The value of the column 'COL_EXT_USER_ID'. (basically NotNull if update: for the constraint)
     */
    public void setColExtUserId(Long colExtUserId) {
        registerModifiedProperty("colExtUserId");
        _colExtUserId = colExtUserId;
    }
     ...
     * 列CD
     * @return The value of the column 'COL_CD'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 列CD
     * @param colCd The value of the column 'COL_CD'. (basically NotNull if update: for the constraint)
     */
