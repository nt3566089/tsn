...
/**
 * The entity of T_TRSHIPINSPECT as TABLE. <br>
 * 出庫検品
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long shippingInspectionId = entity.getShippingInspectionId();
 * Long shipinspectkey = entity.getShipinspectkey();
 ...
 * entity.setShippingInspectionId(shippingInspectionId);
 * entity.setShipinspectkey(shipinspectkey);
 ...
 */
public abstract class BsTTrshipinspect extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_shippingInspectionId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsTTrshipinspect) {
            BsTTrshipinspect other = (BsTTrshipinspect)obj;
            if (!xSV(_shippingInspectionId, other._shippingInspectionId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected int doHashCode(int initial) {
        ...
        hs = xCH(hs, _shippingInspectionId);
        return hs;
    }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_shippingInspectionId));
        sb.append(dm).append(xfND(_shipinspectkey));
    ...
    @Override
    public TTrshipinspect clone() {
        return (TTrshipinspect)super.clone();
    }
     ...
     * 出庫検品ID
     * @return The value of the column 'SHIPPING_INSPECTION_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getShippingInspectionId() {
        checkSpecifiedProperty("shippingInspectionId");
     ...
     * 出庫検品ID
     * @param shippingInspectionId The value of the column 'SHIPPING_INSPECTION_ID'. (basically NotNull if update: for the constraint)
     */
    public void setShippingInspectionId(Long shippingInspectionId) {
        registerModifiedProperty("shippingInspectionId");
        _shippingInspectionId = shippingInspectionId;
    }

    /**
     * [get] SHIPINSPECTKEY: {NotNull, bigint(19)} <br>
     * 出庫検品Ｋｅｙ
     * @return The value of the column 'SHIPINSPECTKEY'. (basically NotNull if selected: for the constraint)
     */
    public Long getShipinspectkey() {
        checkSpecifiedProperty("shipinspectkey");
     ...
     * 出庫検品Ｋｅｙ
     * @param shipinspectkey The value of the column 'SHIPINSPECTKEY'. (basically NotNull if update: for the constraint)
     */
    public void setShipinspectkey(Long shipinspectkey) {
        registerModifiedProperty("shipinspectkey");
        _shipinspectkey = shipinspectkey;
    }
     ...
     * 出庫検品残ID
     * @return The value of the column 'SHIPPING_INSPECTION_REMAINING_ID'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * 出庫検品残ID
     * @param shippingInspectionRemainingId The value of the column 'SHIPPING_INSPECTION_REMAINING_ID'. (NullAllowed: null update allowed for no constraint)
     */
