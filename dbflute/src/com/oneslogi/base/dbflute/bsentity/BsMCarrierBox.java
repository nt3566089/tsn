...
/**
 * The entity of M_CARRIER_BOX as TABLE. <br>
 * 運送業者荷材マスタ
 * <pre>
 * [primary-key]
 *     CARRIER_BOX_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long carrierBoxId = entity.getCarrierBoxId();
 ...
 * entity.setCarrierBoxId(carrierBoxId);
 ...
 */
public abstract class BsMCarrierBox extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_carrierBoxId == null) { return false; }
     ...
     */
    public void uniqueBy(Long carrierId, Long boxId) {
        __uniqueDrivenProperties.clear();
        __uniqueDrivenProperties.addPropertyName("carrierId");
        __uniqueDrivenProperties.addPropertyName("boxId");
        setCarrierId(carrierId);setBoxId(boxId);
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMCarrierBox) {
            BsMCarrierBox other = (BsMCarrierBox)obj;
            if (!xSV(_carrierBoxId, other._carrierBoxId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_carrierBoxId));
    ...
    @Override
    public MCarrierBox clone() {
        return (MCarrierBox)super.clone();
    }
     ...
     * 運送業者荷材ID
     * @return The value of the column 'CARRIER_BOX_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getCarrierBoxId() {
        checkSpecifiedProperty("carrierBoxId");
     ...
     * 運送業者荷材ID
     * @param carrierBoxId The value of the column 'CARRIER_BOX_ID'. (basically NotNull if update: for the constraint)
     */
    public void setCarrierBoxId(Long carrierBoxId) {
        registerModifiedProperty("carrierBoxId");
        _carrierBoxId = carrierBoxId;
    }
     ...
     * 荷材サイズCD
     * @return The value of the column 'BOX_SIZE_CD'. (basically NotNull if selected: for the constraint)
     */
     ...
     * 荷材サイズCD
     * @param boxSizeCd The value of the column 'BOX_SIZE_CD'. (basically NotNull if update: for the constraint)
     */
