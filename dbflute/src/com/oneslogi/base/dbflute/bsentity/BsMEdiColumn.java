...
/**
 * The entity of M_EDI_COLUMN as TABLE. <br>
 * EDI項目マスタ
 * <pre>
 * [primary-key]
 *     EDI_COLUMN_ID
 ...
 * String ediColumnNm = entity.getEdiColumnNm();
 ...
 * entity.setEdiColumnNm(ediColumnNm);
 ...
 */
public abstract class BsMEdiColumn extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_ediColumnId == null) { return false; }
    ...
    /**
     * [get] M_IMPORT_TYPE_B by EDI_COLUMN_ID, named 'MImportTypeBList'.
    ...
    /**
     * [set] M_IMPORT_TYPE_B by EDI_COLUMN_ID, named 'MImportTypeBList'.
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsMEdiColumn) {
            BsMEdiColumn other = (BsMEdiColumn)obj;
            if (!xSV(_ediColumnId, other._ediColumnId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_ediColumnNm));
    ...
    @Override
    public MEdiColumn clone() {
        return (MEdiColumn)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] EDI_COLUMN_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * EDI項目ID
     * @return The value of the column 'EDI_COLUMN_ID'. (basically NotNull if selected: for the constraint)
     */
    ...
    /**
     * [set] EDI_COLUMN_ID: {PK, ID, NotNull, bigint identity(19)} <br>
     * EDI項目ID
     * @param ediColumnId The value of the column 'EDI_COLUMN_ID'. (basically NotNull if update: for the constraint)
     */
     ...
     * EDI項目名
     * @return The value of the column 'EDI_COLUMN_NM'. (NullAllowed even if selected: for no constraint)
     */
    public String getEdiColumnNm() {
        checkSpecifiedProperty("ediColumnNm");
        return convertEmptyToNull(_ediColumnNm);
    }

    /**
     * [set] EDI_COLUMN_NM: {varchar(255)} <br>
     * EDI項目名
     * @param ediColumnNm The value of the column 'EDI_COLUMN_NM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setEdiColumnNm(String ediColumnNm) {
        registerModifiedProperty("ediColumnNm");
        _ediColumnNm = ediColumnNm;
    }
