...
/**
 * The entity of E_USER as TABLE. <br>
 * ユーザ情報受信テーブル
 * <pre>
 * [primary-key]
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long receiveLoginInfoId = entity.getReceiveLoginInfoId();
 ...
 * entity.setReceiveLoginInfoId(receiveLoginInfoId);
 ...
 */
public abstract class BsEUser extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_receiveLoginInfoId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsEUser) {
            BsEUser other = (BsEUser)obj;
            if (!xSV(_receiveLoginInfoId, other._receiveLoginInfoId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_receiveLoginInfoId));
     ...
     * ユーザ情報受信ID
     * @return The value of the column 'RECEIVE_LOGIN_INFO_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getReceiveLoginInfoId() {
        checkSpecifiedProperty("receiveLoginInfoId");
     ...
     * ユーザ情報受信ID
     * @param receiveLoginInfoId The value of the column 'RECEIVE_LOGIN_INFO_ID'. (basically NotNull if update: for the constraint)
     */
    public void setReceiveLoginInfoId(Long receiveLoginInfoId) {
        registerModifiedProperty("receiveLoginInfoId");
        _receiveLoginInfoId = receiveLoginInfoId;
    }
