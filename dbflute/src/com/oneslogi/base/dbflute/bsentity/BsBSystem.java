...
/**
 * The entity of B_SYSTEM as TABLE. <br>
 * システム管理マスタ
 * <pre>
 * [primary-key]
 *     SYSTEM_ID
 ...
 * String systemNm = entity.getSystemNm();
 ...
 */
public abstract class BsBSystem extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_systemId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsBSystem) {
            BsBSystem other = (BsBSystem)obj;
            if (!xSV(_systemId, other._systemId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        StringBuilder sb = new StringBuilder();
        sb.append(dm).append(xfND(_systemId));
        sb.append(dm).append(xfND(_systemNm));
    ...
    @Override
    public BSystem clone() {
        return (BSystem)super.clone();
    }
     ...
     * システムID
     * @return The value of the column 'SYSTEM_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getSystemId() {
        checkSpecifiedProperty("systemId");
        return _systemId;
    }
     ...
     * システムID
     * @param systemId The value of the column 'SYSTEM_ID'. (basically NotNull if update: for the constraint)
     */
    public void setSystemId(Long systemId) {
        registerModifiedProperty("systemId");
        _systemId = systemId;
    }
     ...
     * システム名称
     * @return The value of the column 'SYSTEM_NM'. (NullAllowed even if selected: for no constraint)
     */
    public String getSystemNm() {
        checkSpecifiedProperty("systemNm");
        return convertEmptyToNull(_systemNm);
    }

    /**
     * [set] SYSTEM_NM: {varchar(60)} <br>
     * システム名称
     * @param systemNm The value of the column 'SYSTEM_NM'. (NullAllowed: null update allowed for no constraint)
     */
    public void setSystemNm(String systemNm) {
        registerModifiedProperty("systemNm");
        _systemNm = systemNm;
    }
     ...
     * ソルト
     * @return The value of the column 'SALT'. (NullAllowed even if selected: for no constraint)
     */
     ...
     * ソルト
     * @param salt The value of the column 'SALT'. (NullAllowed: null update allowed for no constraint)
     */
