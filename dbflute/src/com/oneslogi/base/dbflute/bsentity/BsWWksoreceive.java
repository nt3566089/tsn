...
/**
 * The entity of W_WKSORECEIVE as TABLE. <br>
 * 出庫場受入検品中間テーブル
 * <pre>
 * [primary-key]
 *     WKSORECEIVE_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long wksoreceiveId = entity.getWksoreceiveId();
 * Long soReceiveKey = entity.getSoReceiveKey();
 ...
 * entity.setWksoreceiveId(wksoreceiveId);
 * entity.setSoReceiveKey(soReceiveKey);
 ...
 */
public abstract class BsWWksoreceive extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_wksoreceiveId == null) { return false; }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWWksoreceive) {
            BsWWksoreceive other = (BsWWksoreceive)obj;
            if (!xSV(_wksoreceiveId, other._wksoreceiveId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_wksoreceiveId));
        sb.append(dm).append(xfND(_soReceiveKey));
    ...
    @Override
    public WWksoreceive clone() {
        return (WWksoreceive)super.clone();
    }
     ...
     * 出庫場受入検品中間テーブルID
     * @return The value of the column 'WKSORECEIVE_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getWksoreceiveId() {
        checkSpecifiedProperty("wksoreceiveId");
     ...
     * 出庫場受入検品中間テーブルID
     * @param wksoreceiveId The value of the column 'WKSORECEIVE_ID'. (basically NotNull if update: for the constraint)
     */
    public void setWksoreceiveId(Long wksoreceiveId) {
        registerModifiedProperty("wksoreceiveId");
        _wksoreceiveId = wksoreceiveId;
    }

    /**
     * [get] SO_RECEIVE_KEY: {NotNull, bigint(19)} <br>
     * 出庫場受入検品キー
     * @return The value of the column 'SO_RECEIVE_KEY'. (basically NotNull if selected: for the constraint)
     */
    public Long getSoReceiveKey() {
        checkSpecifiedProperty("soReceiveKey");
     ...
     * 出庫場受入検品キー
     * @param soReceiveKey The value of the column 'SO_RECEIVE_KEY'. (basically NotNull if update: for the constraint)
     */
    public void setSoReceiveKey(Long soReceiveKey) {
        registerModifiedProperty("soReceiveKey");
        _soReceiveKey = soReceiveKey;
    }
