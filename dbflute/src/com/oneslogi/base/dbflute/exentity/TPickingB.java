...
import com.oneslogi.base.dbflute.bsentity.BsTPickingB;
 ...
 */
public class TPickingB extends BsTPickingB {
	...
	public TShippingInstB chaseTShippingInstB() {
		return _tShippingInstB != null ? _tShippingInstB : new TShippingInstB();
	}
