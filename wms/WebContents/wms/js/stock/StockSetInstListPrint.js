/**
 * @ngdoc overview
 * @name oneslogiWms.StockSetInstListPrint
 *
 * @description
 * セット組指示書発行画面
 */

angular.module('oneslogiWms.StockSetInstListPrint',[])
/**
 * @ngdoc service
 * @name oneslogiWms.StockSetInstListPrint.service:stockSetInstListPrintApi
 *
 * @description
 * セット組指示書発行発行WebApi定義<br>
 ...
 * ・resources/stock/stockSetInstListPrint/init 初期化用WebApi<br>
 * ・resources/stock/stockSetInstListPrint/print 発行用WebApi<br>
 */
.factory('stockSetInstListPrintApi', ['AngularAPIClient', function(AngularAPIClient) {
	return {
		...
		stockSetInstListPrint: AngularAPIClient.make(
			[
			 ['init',  'GET', 'resources/stock/stockSetInstListPrint/init'],
			 ['print', 'GET', 'resources/stock/stockSetInstListPrint/print']
			 ]
		)
	};
}])
...
/**
 * @ngdoc object
 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
 *
 * @description
 * セット組指示書発行発行画面<br>
 *
 * 当画面の制御ロジックはここに実装される。
 */
.controller('StockSetInstListPrint', ['$scope', '$route', '$filter', '$location', '$q', 'alertMessage', 'directiveControl', 'gridDirectiveControl', 'optionMessageControl', 'gridOptionMessageControl', 'owsHistory', 'owsCommon', 'userInfo', 'statusInfo', 'modalFactory', 'printFactory', 'stockSetInstListPrintApi', function($scope, $route, $filter, $location, $q, alertMessage, directiveControl, gridDirectiveControl, optionMessageControl, gridOptionMessageControl, owsHistory, owsCommon, userInfo, statusInfo, modalFactory, printFactory, api){
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#initScreen
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * 画面初期化処理<br>
	 *
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#deferredGetDepositStockTypeList
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#deferredGetStockTypeList
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * 在庫区分取得・設定処理（同期可能）<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#initScreenHttp
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * 検索画面初期化用の通信制御処理<br>
	...
	$scope.deferredGetInitData = function(){
		...
		api.stockSetInstListPrint.init().then(function(response){
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#changeClient
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * 荷主変更後処理<br>
...
//				$scope.searchCondition.depositCd = $scope.depositStockTypeList[0].tmoveInstB.depositCd;
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#productBlur
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * 商品コードのロストフォーカス処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#showProduct
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * 商品コード検索ボタン押下処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#showLocation
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	 * ロケーション検索ボタン押下処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint#locationCdBlur
	 * @methodOf oneslogiWms.StockSetInstListPrint.object:StockSetInstListPrint
	 *
	 * @description
	...
	$scope.issue = function() {
		...
		modalInstance.result.then(function(printParam){
			...
			// 発行
			api.stockSetInstListPrint.print(request).then(function(response){
