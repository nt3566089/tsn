/**
 * @ngdoc overview
 * @name oneslogiWms.InventoryWorkListPrint
 *
 * @description
 * 棚卸作業リスト発行画面
 */

angular.module('oneslogiWms.InventoryWorkListPrint',[])
/**
 * @ngdoc service
 * @name oneslogiWms.InventoryWorkListPrint.service:inventoryDiffListPrintApi
 *
 * @description
 * 棚卸作業リスト発行WebApi定義<br>
 ...
 * ・resources/inventory/inventoryWorkListPrint/init 初期化用WebApi<br>
 * ・resources/inventory/inventoryWorkListPrint/print 発行用WebApi<br>
 */
.factory('inventoryWorkListPrintApi', ['AngularAPIClient', function(AngularAPIClient) {
	return {
		stockExistOnlyFlg: AngularAPIClient.make(
			[
		...
		inventoryWorkListPrint: AngularAPIClient.make(
			[
			 ['init',  'GET', 'resources/inventory/inventoryWorkListPrint/init'],
			 ['print', 'GET', 'resources/inventory/inventoryWorkListPrint/print']
			 ]
		)
	};
}])
/**
 * @ngdoc object
 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
 *
 * @description
 * 棚卸作業リスト発行画面<br>
 *
 * 当画面の制御ロジックはここに実装される。
 */
.controller('InventoryWorkListPrint', ['$scope', '$route', '$filter', '$location', '$q', 'alertMessage', 'directiveControl', 'gridDirectiveControl', 'optionMessageControl', 'gridOptionMessageControl', 'owsHistory', 'owsCommon', 'userInfo', 'statusInfo', 'modalFactory', 'printFactory', 'inventoryWorkListPrintApi', function($scope, $route, $filter, $location, $q, alertMessage, directiveControl, gridDirectiveControl, optionMessageControl, gridOptionMessageControl, owsHistory, owsCommon, userInfo, statusInfo, modalFactory, printFactory, api){
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#initScreen
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 画面初期化処理<br>
	 *
...
//		$scope.deferredGetWarehouseCdList();
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#deferredGetDepositStockTypeList
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#deferredGetStockTypeList
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 在庫区分取得・設定処理（同期可能）<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#deferredGetZoneList
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * ゾーン取得・設定処理（同期可能）<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#initScreenHttp
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 検索画面初期化用の通信制御処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#deferredGetConditionList
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 在庫数表示あり取得・設定処理（同期可能）<br>
	 *
	 * サーバとの通信を行い、取得結果を画面項目に反映する。
	 */
	$scope.deferredGetConditionList = function(){
		...
		var request = {};
		request.classCd = "STOCK_QTY_DISPLAY";

		owsCommon.getDataCacheable(api.stockExistOnlyFlg, "keyValueList", request).then(function(response){
			$scope.stockExistOnlyFlg = response.data;
			deferred.resolve();
		});
	...
	$scope.deferredGetInitData = function(){
		...
		api.inventoryWorkListPrint.init().then(function(response){
			...
			// 在庫数表示ありは一つ目を設定
			if ($scope.stockExistOnlyFlg.length > 0) {
				$scope.conditionI.stockExistOnlyFlg = owsCommon.getDefaultValue($scope.stockExistOnlyFlg);
			}
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#changeClient
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 荷主変更後処理<br>
	...
	var setStockTypeList = function(list, clearSelected) {
		...
		//[ON推-品向-439]「在庫区分のデフォルト表示を無くすよう」に修正 2014.12.15 衛 Start
		// 在庫区分は一つ目を設定
//		if (clearSelected) {
...
//			}
//		}
		//[ON推-品向-439]「在庫区分のデフォルト表示を無くすよう」に修正 2014.12.15 衛 End
	};

	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#changeWarehouse
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 倉庫変更後処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#productBlur
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 商品コードのロストフォーカス処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#showProduct
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * 商品コード検索ボタン押下処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#showLocation
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	 * ロケーション検索ボタン押下処理<br>
	...
	/**
	 * @ngdoc method
	 * @name oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint#locationCdBlur
	 * @methodOf oneslogiWms.InventoryWorkListPrint.object:InventoryWorkListPrint
	 *
	 * @description
	...
	$scope.issue = function() {
		...
		modalInstance.result.then(function(printParam){
			...
			// 発行
			api.inventoryWorkListPrint.print(request).then(function(response){
