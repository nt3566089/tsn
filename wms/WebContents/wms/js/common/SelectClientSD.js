angular.module('oneslogiWeb.SelectClient', [])
//サーバへ通信するAPI定義サービスを設定
.factory('SelectClientSDApi', ['AngularAPIClient', function(AngularAPIClient) {
	return {
...
.controller('SelectClientSD', ['$scope', 'SelectClientSDApi', '$state', '$q', 'userInfo', 'statusInfo', '$rootScope', '$location', '$window', 'owsCommon', 'alertMessage', function($scope, api, $state, $q, userInfo, statusInfo, $rootScope, $location, $window, owsCommon, alertMessage) {
