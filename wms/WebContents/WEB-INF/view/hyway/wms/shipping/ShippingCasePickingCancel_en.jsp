...
<%-- ケースピッキングNo --%>
<%-- [#975] HTケースピッキング - 処理単位をトータルピッキングNo.単位からケースピッキングNo.単位に変更 2017.02.21 kawana Start --%>
<text mode="1"
      size="1"
      x="1"
      y="12"
...
<%-- [#975] HTケースピッキング - 処理単位をトータルピッキングNo.単位からケースピッキングNo.単位に変更 2017.02.21 kawana End --%>
