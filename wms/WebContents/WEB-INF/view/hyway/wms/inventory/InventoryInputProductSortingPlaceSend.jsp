...
<text mode="1"
       ...
       x="15"
       y="28"
       >${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputCaseQty4)}
       </text>
<text mode="1"
       size="2"
       x="28"
       y="28"
       >${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputCartonQty4)}
       </text>
...
<text mode="1"
       ...
       x="28"
       y="31"
       >${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputDefectiveQty4)}
       </text>
