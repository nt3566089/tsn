...
<input mode="1"
       ...
       width="7"
       param="caseQty"
       default="${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputCaseQty)}"
       >${screen.inputTextAttr("caseQty")}
       </input>
<input mode="1"
       size="2"
       x="28"
       ...
       width="7"
       param="cartonQty"
       default="${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputCartonQty)}"
...
<input mode="1"
       ...
       width="7"
       param="defectiveQty"
       default="${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputDefectiveQty)}"
       >${screen.inputTextAttr("defectiveQty")}
       </input>
