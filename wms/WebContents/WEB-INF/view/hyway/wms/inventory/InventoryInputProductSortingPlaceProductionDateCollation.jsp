...
<input mode="1"
       ...
       default="${fn:escapeXml(InventoryInputProductSortingPlaceDto.outputRegistrationManufactureDate)}"
       > ${screen.inputTextAttr("manufactureDate")}
       </input>
...
<text mode="1"
      ...
      x="1"
      y="31"
      >${screen.itemNm("prevInspectionManufactureDate")}:
      </text>
<text mode="1"
      size="2"
      x="1"
      y="34"
      > ${fn:escapeXml(InventoryInputProductSortingPlaceDto.fetchedPrevInspectionManufactureDate)}
      </text>
