...
<input mode="1"
       ...
       char="2"
       method="2"
       <%-- CODE39 : 000 0000 0000 0000 0010 --%>
       property="2"
       len="12"
       width="24"
       param="locationCd"
       default="${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputLocationCd)}"
...
<text mode="1"
      ...
      x="1"
      y="16"
      >${screen.itemNm("inventoryKey")}:
      </text>
<text mode="1"
      size="2"
      x="1"
      y="19"
      > ${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputOrFetchedInventoryKey)}
      </text>
...
--%>
<c:choose>
<c:when test="${InventoryInputProductSortingPlaceDto.stockInspectionCategoryValue == \"02\"}">
<text mode="1"
      size="2"
      x="1"
      y="22"
      >${screen.itemNm("piston")}:
      </text>
<text mode="1"
      size="2"
      x="1"
      y="25"
      > ${fn:escapeXml(InventoryInputProductSortingPlaceDto.outputPiston)}
      </text>
</c:when>
</c:choose>
