...
<input mode="1"
       ...
       char="2"
       method="3"
       <%-- DataMatrix/QR Code : 0 0000 0010 0100 0000 0000 --%>
       property="9216"
       len="68"
       width="24"
       param="barcode" 
       default="${fn:escapeXml(InventoryInputProductSortingPlaceDto.inputBarcode)}"
       > ${screen.inputTextAttr("barcode")}
       </input>
