...
public class EcShippingTagDataOutputDto extends PagingDto {
	...
	public static class SqlEcShippingTagDataOutputData implements Serializable {
		// ヘッダ部DTO
		public TEcOrderHDto search = chaseTEcOrderHDto();
	...
	public SqlEcShippingTagDataOutputData data = new SqlEcShippingTagDataOutputData();
}
