...
public class PickingListRePrintDto extends PagingDto {
	...
	public static class PickingListRePrintData implements Serializable {

		//検索条件を入れるDTO
		public TTrsolistDto search = chaseTTrsolistDto();

		//検索結果を入れるDTO
		public List<SqlPickingListRePrintDto> list = new ArrayList<SqlPickingListRePrintDto>();
	...
	public PickingListRePrintData data = new PickingListRePrintData();
}
