...
public class ReceiveInputNoDto extends BaseDto {
	...
	public static TStoreRecordBDto chaseTStoreRecordBDto(TStoreRecordBDto dto) {
		...
		if(dto.getTReceivePlanB().getTReceivePlanSpareAsOne() == null){
			dto.getTReceivePlanB().setTReceivePlanSpareAsOne(new TReceivePlanSpareDto());
		}
	...
	public static class ReceiveInputData implements Serializable {
		...
		//public TStoreRecordHDto blankRow = chaseTStoreRecordHDto();
